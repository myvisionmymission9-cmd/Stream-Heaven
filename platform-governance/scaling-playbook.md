# Stream Heaven Scaling Playbook
...
| Service | HPA max prod | Ownership |
| --- | --- | --- |
...
---
*Stream Heaven Platform Governance — scaling-playbook.md v1.0 — Generated 2026-05-29*

## Appendix — Operational reference (scaling-playbook.md)
