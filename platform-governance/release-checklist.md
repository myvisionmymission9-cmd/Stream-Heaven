# Stream Heaven Release Checklist
...
- [ ] Compare coin economy metrics
- [ ] Close release ticket
- [ ] Update platform-roadmap.md status



### Social App store checklist

- [ ] com.streamheaven.social version code incremented
- [ ] Play data safety form updated
- [ ] Screenshot locales EN + HI minimum
- [ ] Content rating questionnaire current

### Livestream App store checklist

- [ ] com.streamheaven.live version code incremented
- [ ] Play data safety form updated
- [ ] Screenshot locales EN + HI minimum
- [ ] Content rating questionnaire current

### Astro App store checklist

- [ ] com.streamheaven.astro version code incremented
- [ ] Play data safety form updated
- [ ] Screenshot locales EN + HI minimum
- [ ] Content rating questionnaire current

### Media App (OTT) store checklist

- [ ] com.streamheaven.media version code incremented
- [ ] Play data safety form updated
- [ ] Screenshot locales EN + HI minimum
- [ ] Content rating questionnaire current

---
*Stream Heaven Platform Governance — release-checklist.md v1.0 — Generated 2026-05-29*

## Appendix — Operational reference (release-checklist.md)
