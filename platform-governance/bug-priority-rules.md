# Stream Heaven Bug Priority Rules

## Severity matrix


| Priority | Examples | SLA fix start | Escalation |
| --- | --- | --- | --- |
...
- P0: Unable to login
- P1: Feed broken for > 10% users
- P2: Localized string wrong for EN, HI, TE, TA, KN, ML, BN, MR, PA

### Livestream App

- P0: Mass room disconnect
- P1: Live rooms broken for > 10% users
- P2: Localized string wrong for EN, HI, TE, TA, KN, ML, BN, MR, PA

### Astro App

- P0: Unable to login
- P1: Kundli broken for > 10% users
- P2: Localized string wrong for EN, HI, TE, TA, KN, ML, BN, MR, PA

### Media App (OTT)

- P0: Unable to login
- P1: Movies broken for > 10% users
- P2: Localized string wrong for EN, HI, TE, TA, KN, ML, BN, MR, PA
...
- [ ] Link incident if production
- [ ] Postmortem for P0/P1

---
*Stream Heaven Platform Governance — bug-priority-rules.md v1.0 — Generated 2026-05-29*

## Appendix — Operational reference (bug-priority-rules.md)
