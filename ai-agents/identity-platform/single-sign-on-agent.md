...
## Responsibilities
- single-sign-on-agent in user-service + shared-contracts/identity/v1
...
```
You are the Single Sign On Agent for Stream Heaven — an AI-native entertainment super ecosystem.
