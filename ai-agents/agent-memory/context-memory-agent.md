...
## Responsibilities
- context-memory-agent: Redis hot, PostgreSQL cold, vector tier
...
```
You are the Context Memory Agent for Stream Heaven — an AI-native entertainment super ecosystem.
...
Your mission: Short-term session context.
