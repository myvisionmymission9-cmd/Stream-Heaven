---
name: stream-heaven-cosmetics-cosmetic-analytics-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Analytics (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Analytics — Advanced
