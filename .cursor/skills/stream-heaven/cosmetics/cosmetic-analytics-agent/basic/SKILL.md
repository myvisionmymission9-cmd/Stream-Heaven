---
name: stream-heaven-cosmetics-cosmetic-analytics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Analytics (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Analytics — Basic

## When to use

- User invokes **Cosmetic Analytics** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-analytics-agent.md`
- **Role:** Cosmetic Analytics Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-analytics-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Analytics deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Analytics scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-analytics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-analytics-agent/advanced/SKILL.md`
