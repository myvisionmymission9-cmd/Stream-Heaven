---
name: stream-heaven-cosmetics-cosmetic-asset-pipeline-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Asset Pipeline (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Asset Pipeline — Advanced
