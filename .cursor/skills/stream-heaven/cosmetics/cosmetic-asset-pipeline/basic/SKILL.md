---
name: stream-heaven-cosmetics-cosmetic-asset-pipeline-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Asset Pipeline (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Asset Pipeline — Basic

## When to use

- User invokes **Cosmetic Asset Pipeline** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-asset-pipeline.md`
- **Role:** Cosmetic Asset Pipeline specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-asset-pipeline.md` and copy its `## Prompt Template` block
