---
name: stream-heaven-cosmetics-royalty-status-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Royalty Status (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Royalty Status — Basic

## When to use

- User invokes **Royalty Status** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/royalty-status-agent.md`
- **Role:** Royalty Status Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/royalty-status-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Royalty Status deliverables in cosmetics domain for Stream Heaven Phase 11. (Royalty Status scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/royalty-status-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/royalty-status-agent/advanced/SKILL.md`
