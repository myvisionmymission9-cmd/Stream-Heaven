---
name: stream-heaven-cosmetics-gradient-chat-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gradient Chat (phase 11).
...
- User invokes **Gradient Chat** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/gradient-chat-agent.md`
- **Role:** Gradient Chat Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/gradient-chat-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Gradient Chat deliverables in cosmetics domain for Stream Heaven Phase 11. (Gradient Chat scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/gradient-chat-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/gradient-chat-agent/advanced/SKILL.md`
