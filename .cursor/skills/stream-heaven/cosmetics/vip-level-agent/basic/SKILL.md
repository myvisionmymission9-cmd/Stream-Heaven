---
name: stream-heaven-cosmetics-vip-level-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Vip Level (phase 11).
...
- User invokes **Vip Level** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/vip-level-agent.md`
- **Role:** Vip Level Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/vip-level-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Vip Level deliverables in cosmetics domain for Stream Heaven Phase 11. (Vip Level scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/vip-level-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/vip-level-agent/advanced/SKILL.md`
