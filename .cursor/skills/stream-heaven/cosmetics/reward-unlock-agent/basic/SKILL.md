---
name: stream-heaven-cosmetics-reward-unlock-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reward Unlock (phase 11).
...
- User invokes **Reward Unlock** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/reward-unlock-agent.md`
- **Role:** Reward Unlock Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/reward-unlock-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/reward-unlock-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/reward-unlock-agent/advanced/SKILL.md`
