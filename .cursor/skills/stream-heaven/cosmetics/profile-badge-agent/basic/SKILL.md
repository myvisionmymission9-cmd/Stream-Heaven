---
name: stream-heaven-cosmetics-profile-badge-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Profile Badge (phase 11).
...
- User invokes **Profile Badge** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/profile-badge-agent.md`
- **Role:** Profile Badge Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/profile-badge-agent.md` and copy its `## Prompt Template` block
...
Design:
- Scaffold NestJS user-service (port 3002) PostgreSQL schema for profiles, handles, and privacy flags. (Profile Badge scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/profile-badge-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/profile-badge-agent/advanced/SKILL.md`
