---
name: stream-heaven-cosmetics-cosmetic-collection-set-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Collection Set (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Collection Set — Basic

## When to use

- User invokes **Cosmetic Collection Set** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-collection-set-agent.md`
- **Role:** Cosmetic Collection Set Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-collection-set-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Collection Set deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Collection Set scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-collection-set-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-collection-set-agent/advanced/SKILL.md`
