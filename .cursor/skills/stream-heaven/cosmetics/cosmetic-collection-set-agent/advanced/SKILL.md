---
name: stream-heaven-cosmetics-cosmetic-collection-set-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Collection Set (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Collection Set — Advanced
