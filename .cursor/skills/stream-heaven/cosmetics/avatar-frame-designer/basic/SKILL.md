---
name: stream-heaven-cosmetics-avatar-frame-designer-basic
description: >-
  Basic Cursor skill for Stream Heaven Avatar Frame Designer (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Avatar Frame Designer — Basic

## When to use

- User invokes **Avatar Frame Designer** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/avatar-frame-designer.md`
- **Role:** Avatar Frame Designer specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/avatar-frame-designer.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/avatar-frame-designer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/avatar-frame-designer/advanced/SKILL.md`
