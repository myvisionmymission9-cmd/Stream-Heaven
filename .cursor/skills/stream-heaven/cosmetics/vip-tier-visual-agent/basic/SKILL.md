---
name: stream-heaven-cosmetics-vip-tier-visual-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Vip Tier Visual (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Vip Tier Visual — Basic

## When to use

- User invokes **Vip Tier Visual** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/vip-tier-visual-agent.md`
- **Role:** Vip Tier Visual Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/vip-tier-visual-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Vip Tier Visual deliverables in cosmetics domain for Stream Heaven Phase 11. (Vip Tier Visual scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/vip-tier-visual-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/vip-tier-visual-agent/advanced/SKILL.md`
