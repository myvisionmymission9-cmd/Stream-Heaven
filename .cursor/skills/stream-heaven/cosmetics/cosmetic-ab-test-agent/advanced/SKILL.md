---
name: stream-heaven-cosmetics-cosmetic-ab-test-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Ab Test (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Ab Test — Advanced
