---
name: stream-heaven-cosmetics-cosmetic-ab-test-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Ab Test (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Ab Test — Basic

## When to use

- User invokes **Cosmetic Ab Test** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-ab-test-agent.md`
- **Role:** Cosmetic Ab Test Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-ab-test-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-ab-test-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-ab-test-agent/advanced/SKILL.md`
