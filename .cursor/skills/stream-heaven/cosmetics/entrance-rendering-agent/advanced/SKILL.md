---
name: stream-heaven-cosmetics-entrance-rendering-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Entrance Rendering (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Entrance Rendering — Advanced
