---
name: stream-heaven-cosmetics-entrance-rendering-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Entrance Rendering (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Entrance Rendering — Basic

## When to use

- User invokes **Entrance Rendering** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/entrance-rendering-agent.md`
- **Role:** Entrance Rendering Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/entrance-rendering-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Entrance Rendering deliverables in cosmetics domain for Stream Heaven Phase 11. (Entrance Rendering scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/entrance-rendering-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/entrance-rendering-agent/advanced/SKILL.md`
