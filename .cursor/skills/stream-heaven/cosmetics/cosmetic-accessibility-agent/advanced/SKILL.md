---
name: stream-heaven-cosmetics-cosmetic-accessibility-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Accessibility (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Accessibility — Advanced
