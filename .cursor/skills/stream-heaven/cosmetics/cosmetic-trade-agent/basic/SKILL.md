---
name: stream-heaven-cosmetics-cosmetic-trade-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Trade (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Trade — Basic

## When to use

- User invokes **Cosmetic Trade** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-trade-agent.md`
- **Role:** Cosmetic Trade Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-trade-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-trade-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-trade-agent/advanced/SKILL.md`
