---
name: stream-heaven-cosmetics-seasonal-frame-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Seasonal Frame (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Seasonal Frame — Basic

## When to use

- User invokes **Seasonal Frame** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/seasonal-frame-agent.md`
- **Role:** Seasonal Frame Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/seasonal-frame-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Seasonal Frame deliverables in cosmetics domain for Stream Heaven Phase 11. (Seasonal Frame scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/seasonal-frame-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/seasonal-frame-agent/advanced/SKILL.md`
