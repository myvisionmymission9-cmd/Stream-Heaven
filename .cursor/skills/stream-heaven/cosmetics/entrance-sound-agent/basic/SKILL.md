---
name: stream-heaven-cosmetics-entrance-sound-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Entrance Sound (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Entrance Sound — Basic

## When to use

- User invokes **Entrance Sound** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/entrance-sound-agent.md`
- **Role:** Entrance Sound Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/entrance-sound-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Entrance Sound deliverables in cosmetics domain for Stream Heaven Phase 11. (Entrance Sound scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/entrance-sound-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/entrance-sound-agent/advanced/SKILL.md`
