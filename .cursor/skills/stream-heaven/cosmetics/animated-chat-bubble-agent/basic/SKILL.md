---
name: stream-heaven-cosmetics-animated-chat-bubble-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Animated Chat Bubble (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Animated Chat Bubble — Basic

## When to use

- User invokes **Animated Chat Bubble** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/animated-chat-bubble-agent.md`
- **Role:** Animated Chat Bubble Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/animated-chat-bubble-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Animated Chat Bubble deliverables in cosmetics domain for Stream Heaven Phase 11. (Animated Chat Bubble scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/animated-chat-bubble-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/animated-chat-bubble-agent/advanced/SKILL.md`
