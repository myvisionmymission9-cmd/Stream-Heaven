---
name: stream-heaven-cosmetics-animated-chat-bubble-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Animated Chat Bubble (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Animated Chat Bubble — Advanced
