---
name: stream-heaven-cosmetics-entrance-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Entrance Sync (phase 11).
...
- User invokes **Entrance Sync** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/entrance-sync-agent.md`
- **Role:** Entrance Sync Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/entrance-sync-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Entrance Sync deliverables in cosmetics domain for Stream Heaven Phase 11. (Entrance Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/entrance-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/entrance-sync-agent/advanced/SKILL.md`
