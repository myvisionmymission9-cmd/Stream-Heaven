---
name: stream-heaven-cosmetics-frame-rendering-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Frame Rendering (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Frame Rendering — Basic

## When to use

- User invokes **Frame Rendering** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/frame-rendering-agent.md`
- **Role:** Frame Rendering Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/frame-rendering-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Frame Rendering deliverables in cosmetics domain for Stream Heaven Phase 11. (Frame Rendering scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/frame-rendering-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/frame-rendering-agent/advanced/SKILL.md`
