---
name: stream-heaven-cosmetics-cosmetic-pricing-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Pricing (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Pricing — Advanced
