---
name: stream-heaven-cosmetics-cosmetic-pricing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Pricing (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Pricing — Basic

## When to use

- User invokes **Cosmetic Pricing** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-pricing-agent.md`
- **Role:** Cosmetic Pricing Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-pricing-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Pricing deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Pricing scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-pricing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-pricing-agent/advanced/SKILL.md`
