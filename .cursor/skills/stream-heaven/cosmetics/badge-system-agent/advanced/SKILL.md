---
name: stream-heaven-cosmetics-badge-system-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Badge System (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Badge System — Advanced
...
Architect:
- Design and implement cosmetics capabilities for Stream Heaven. (Badge System scope)
