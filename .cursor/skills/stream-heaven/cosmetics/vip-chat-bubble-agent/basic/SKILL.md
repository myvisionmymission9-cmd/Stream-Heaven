---
name: stream-heaven-cosmetics-vip-chat-bubble-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Vip Chat Bubble (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Vip Chat Bubble — Basic

## When to use

- User invokes **Vip Chat Bubble** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/vip-chat-bubble-agent.md`
- **Role:** Vip Chat Bubble Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/vip-chat-bubble-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Vip Chat Bubble deliverables in cosmetics domain for Stream Heaven Phase 11. (Vip Chat Bubble scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/vip-chat-bubble-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/vip-chat-bubble-agent/advanced/SKILL.md`
