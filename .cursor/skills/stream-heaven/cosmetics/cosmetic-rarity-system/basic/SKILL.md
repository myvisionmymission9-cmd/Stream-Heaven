---
name: stream-heaven-cosmetics-cosmetic-rarity-system-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Rarity System (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Rarity System — Basic

## When to use

- User invokes **Cosmetic Rarity System** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-rarity-system.md`
- **Role:** Cosmetic Rarity System specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-rarity-system.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement cosmetics capabilities for Stream Heaven. (Cosmetic Rarity System scope)
