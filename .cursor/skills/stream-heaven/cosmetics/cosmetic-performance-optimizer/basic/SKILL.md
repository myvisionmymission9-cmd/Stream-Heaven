---
name: stream-heaven-cosmetics-cosmetic-performance-optimizer-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Performance Optimizer (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Performance Optimizer — Basic

## When to use

- User invokes **Cosmetic Performance Optimizer** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-performance-optimizer.md`
- **Role:** Cosmetic Performance Optimizer specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-performance-optimizer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement cosmetics capabilities for Stream Heaven. (Cosmetic Performance Optimizer scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-performance-optimizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-performance-optimizer/advanced/SKILL.md`
