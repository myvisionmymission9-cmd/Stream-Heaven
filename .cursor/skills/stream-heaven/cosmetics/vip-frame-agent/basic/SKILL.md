---
name: stream-heaven-cosmetics-vip-frame-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Vip Frame (phase 11).
...
- User invokes **Vip Frame** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/vip-frame-agent.md`
- **Role:** Vip Frame Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/vip-frame-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Vip Frame deliverables in cosmetics domain for Stream Heaven Phase 11. (Vip Frame scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/vip-frame-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/vip-frame-agent/advanced/SKILL.md`
