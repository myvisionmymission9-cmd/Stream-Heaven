---
name: stream-heaven-cosmetics-cosmetic-cross-app-sync-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Cross App Sync (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Cross App Sync — Advanced
