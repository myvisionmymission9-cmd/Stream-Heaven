---
name: stream-heaven-cosmetics-cosmetic-cross-app-sync-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Cross App Sync (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Cross App Sync — Basic

## When to use

- User invokes **Cosmetic Cross App Sync** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-cross-app-sync.md`
- **Role:** Cosmetic Cross App Sync specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-cross-app-sync.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement cosmetics capabilities for Stream Heaven. (Cosmetic Cross App Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-cross-app-sync/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-cross-app-sync/advanced/SKILL.md`
