---
name: stream-heaven-cosmetics-cosmetic-localization-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Localization (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Localization — Advanced
