---
name: stream-heaven-cosmetics-cosmetic-localization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Localization (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Localization — Basic

## When to use

- User invokes **Cosmetic Localization** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-localization-agent.md`
- **Role:** Cosmetic Localization Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-localization-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Localization deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Localization scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-localization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-localization-agent/advanced/SKILL.md`
