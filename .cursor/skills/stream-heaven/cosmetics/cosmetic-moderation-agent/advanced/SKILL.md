---
name: stream-heaven-cosmetics-cosmetic-moderation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Moderation (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Moderation — Advanced
