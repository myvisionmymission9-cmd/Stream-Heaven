---
name: stream-heaven-cosmetics-cosmetic-moderation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Moderation (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Moderation — Basic

## When to use

- User invokes **Cosmetic Moderation** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-moderation-agent.md`
- **Role:** Cosmetic Moderation Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-moderation-agent.md` and copy its `## Prompt Template` block
