---
name: stream-heaven-cosmetics-message-style-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Message Style (phase 11).
...
- User invokes **Message Style** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/message-style-agent.md`
- **Role:** Message Style Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/message-style-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Message Style deliverables in cosmetics domain for Stream Heaven Phase 11. (Message Style scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/message-style-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/message-style-agent/advanced/SKILL.md`
