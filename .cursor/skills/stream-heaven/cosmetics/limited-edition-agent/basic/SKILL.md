---
name: stream-heaven-cosmetics-limited-edition-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Limited Edition (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Limited Edition — Basic

## When to use

- User invokes **Limited Edition** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/limited-edition-agent.md`
- **Role:** Limited Edition Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/limited-edition-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Limited Edition deliverables in cosmetics domain for Stream Heaven Phase 11. (Limited Edition scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/limited-edition-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/limited-edition-agent/advanced/SKILL.md`
