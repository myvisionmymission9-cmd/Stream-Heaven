---
name: stream-heaven-cosmetics-cosmetic-gift-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Gift (phase 11).
...
- User invokes **Cosmetic Gift** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-gift-agent.md`
- **Role:** Cosmetic Gift Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-gift-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Gift deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Gift scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-gift-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-gift-agent/advanced/SKILL.md`
