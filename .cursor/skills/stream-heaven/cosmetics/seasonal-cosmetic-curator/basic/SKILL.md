---
name: stream-heaven-cosmetics-seasonal-cosmetic-curator-basic
description: >-
  Basic Cursor skill for Stream Heaven Seasonal Cosmetic Curator (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Seasonal Cosmetic Curator — Basic

## When to use

- User invokes **Seasonal Cosmetic Curator** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/seasonal-cosmetic-curator.md`
- **Role:** Seasonal Cosmetic Curator specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/seasonal-cosmetic-curator.md` and copy its `## Prompt Template` block
...
Build:
- Own Seasonal Cosmetic deliverables in cosmetics domain for Stream Heaven Phase 11. (Seasonal Cosmetic Curator scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/seasonal-cosmetic-curator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/seasonal-cosmetic-curator/advanced/SKILL.md`
