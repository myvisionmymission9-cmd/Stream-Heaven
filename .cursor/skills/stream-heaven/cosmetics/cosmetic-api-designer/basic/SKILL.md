---
name: stream-heaven-cosmetics-cosmetic-api-designer-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Api Designer (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Api Designer — Basic

## When to use

- User invokes **Cosmetic Api Designer** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-api-designer.md`
- **Role:** Cosmetic Api Designer specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-api-designer.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Api deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Api Designer scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-api-designer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-api-designer/advanced/SKILL.md`
