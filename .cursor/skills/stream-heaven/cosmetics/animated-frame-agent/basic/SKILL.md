---
name: stream-heaven-cosmetics-animated-frame-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Animated Frame (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Animated Frame — Basic

## When to use

- User invokes **Animated Frame** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/animated-frame-agent.md`
- **Role:** Animated Frame Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/animated-frame-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Animated Frame deliverables in cosmetics domain for Stream Heaven Phase 11. (Animated Frame scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/animated-frame-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/animated-frame-agent/advanced/SKILL.md`
