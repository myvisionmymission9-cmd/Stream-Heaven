---
name: stream-heaven-cosmetics-inventory-management-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Inventory Management (phase 11).
...
- User invokes **Inventory Management** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/inventory-management-agent.md`
- **Role:** Inventory Management Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/inventory-management-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Inventory Management deliverables in cosmetics domain for Stream Heaven Phase 11. (Inventory Management scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/inventory-management-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/inventory-management-agent/advanced/SKILL.md`
