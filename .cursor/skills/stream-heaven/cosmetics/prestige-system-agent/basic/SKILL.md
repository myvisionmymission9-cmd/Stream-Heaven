---
name: stream-heaven-cosmetics-prestige-system-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Prestige System (phase 11).
...
- User invokes **Prestige System** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/prestige-system-agent.md`
- **Role:** Prestige System Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/prestige-system-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Prestige System deliverables in cosmetics domain for Stream Heaven Phase 11. (Prestige System scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/prestige-system-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/prestige-system-agent/advanced/SKILL.md`
