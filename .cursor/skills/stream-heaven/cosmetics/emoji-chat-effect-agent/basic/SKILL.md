---
name: stream-heaven-cosmetics-emoji-chat-effect-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Emoji Chat Effect (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Emoji Chat Effect — Basic

## When to use

- User invokes **Emoji Chat Effect** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/emoji-chat-effect-agent.md`
- **Role:** Emoji Chat Effect Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/emoji-chat-effect-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Emoji Chat Effect deliverables in cosmetics domain for Stream Heaven Phase 11. (Emoji Chat Effect scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/emoji-chat-effect-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/emoji-chat-effect-agent/advanced/SKILL.md`
