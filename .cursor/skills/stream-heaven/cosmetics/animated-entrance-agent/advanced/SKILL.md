---
name: stream-heaven-cosmetics-animated-entrance-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Animated Entrance (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Animated Entrance — Advanced
