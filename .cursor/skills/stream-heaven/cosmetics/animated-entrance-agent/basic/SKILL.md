---
name: stream-heaven-cosmetics-animated-entrance-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Animated Entrance (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Animated Entrance — Basic

## When to use

- User invokes **Animated Entrance** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/animated-entrance-agent.md`
- **Role:** Animated Entrance Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/animated-entrance-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Animated Entrance deliverables in cosmetics domain for Stream Heaven Phase 11. (Animated Entrance scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/animated-entrance-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/animated-entrance-agent/advanced/SKILL.md`
