---
name: stream-heaven-cosmetics-cosmetic-inventory-manager-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Inventory Manager (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Inventory Manager — Advanced
