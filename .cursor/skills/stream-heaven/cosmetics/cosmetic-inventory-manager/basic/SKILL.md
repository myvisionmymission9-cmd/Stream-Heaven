---
name: stream-heaven-cosmetics-cosmetic-inventory-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Inventory Manager (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Inventory Manager — Basic

## When to use

- User invokes **Cosmetic Inventory Manager** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-inventory-manager.md`
- **Role:** Cosmetic Inventory Manager specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-inventory-manager.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Inventory deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Inventory Manager scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-inventory-manager/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-inventory-manager/advanced/SKILL.md`
