---
name: stream-heaven-cosmetics-profile-frame-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Profile Frame (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Profile Frame — Advanced
...
Architect:
- Scaffold NestJS user-service (port 3002) PostgreSQL schema for profiles, handles, and privacy flags. (Profile Frame scope)
