---
name: stream-heaven-cosmetics-chat-bubble-themer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Chat Bubble Themer (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Chat Bubble Themer — Advanced
