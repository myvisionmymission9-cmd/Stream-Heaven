---
name: stream-heaven-cosmetics-cosmetic-preview-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Preview (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Preview — Basic

## When to use

- User invokes **Cosmetic Preview** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-preview-agent.md`
- **Role:** Cosmetic Preview Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-preview-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Preview deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Preview scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-preview-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-preview-agent/advanced/SKILL.md`
