---
name: stream-heaven-cosmetics-cosmetic-preview-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Preview (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Preview — Advanced
