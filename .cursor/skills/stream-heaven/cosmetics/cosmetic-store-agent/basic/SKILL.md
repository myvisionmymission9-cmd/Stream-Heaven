---
name: stream-heaven-cosmetics-cosmetic-store-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Store (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Store — Basic

## When to use

- User invokes **Cosmetic Store** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-store-agent.md`
- **Role:** Cosmetic Store Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-store-agent.md` and copy its `## Prompt Template` block
...
Build:
- Design Cosmetic Store growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Cosmetic Store scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-store-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-store-agent/advanced/SKILL.md`
