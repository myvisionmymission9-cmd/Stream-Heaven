---
name: stream-heaven-cosmetics-cosmetic-limited-drop-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Limited Drop (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Limited Drop — Basic

## When to use

- User invokes **Cosmetic Limited Drop** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-limited-drop-agent.md`
- **Role:** Cosmetic Limited Drop Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-limited-drop-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Limited Drop deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Limited Drop scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-limited-drop-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-limited-drop-agent/advanced/SKILL.md`
