---
name: stream-heaven-cosmetics-cosmetic-limited-drop-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Limited Drop (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Limited Drop — Advanced
