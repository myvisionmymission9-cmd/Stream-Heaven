---
name: stream-heaven-cosmetics-profile-skin-designer-basic
description: >-
  Basic Cursor skill for Stream Heaven Profile Skin Designer (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Profile Skin Designer — Basic

## When to use

- User invokes **Profile Skin Designer** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/profile-skin-designer.md`
- **Role:** Profile Skin Designer specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/profile-skin-designer.md` and copy its `## Prompt Template` block
...
Design:
- Scaffold NestJS user-service (port 3002) PostgreSQL schema for profiles, handles, and privacy flags. (Profile Skin Designer scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/profile-skin-designer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/profile-skin-designer/advanced/SKILL.md`
