---
name: stream-heaven-cosmetics-frame-unlock-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Frame Unlock (phase 11).
...
- User invokes **Frame Unlock** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/frame-unlock-agent.md`
- **Role:** Frame Unlock Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/frame-unlock-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Frame Unlock deliverables in cosmetics domain for Stream Heaven Phase 11. (Frame Unlock scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/frame-unlock-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/frame-unlock-agent/advanced/SKILL.md`
