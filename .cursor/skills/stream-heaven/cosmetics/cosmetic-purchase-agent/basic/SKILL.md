---
name: stream-heaven-cosmetics-cosmetic-purchase-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Purchase (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Purchase — Basic

## When to use

- User invokes **Cosmetic Purchase** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-purchase-agent.md`
- **Role:** Cosmetic Purchase Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-purchase-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Purchase deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Purchase scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-purchase-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-purchase-agent/advanced/SKILL.md`
