---
name: stream-heaven-cosmetics-cosmetic-purchase-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Purchase (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Purchase — Advanced
