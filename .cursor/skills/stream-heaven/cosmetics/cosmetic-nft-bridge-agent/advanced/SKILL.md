---
name: stream-heaven-cosmetics-cosmetic-nft-bridge-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Nft Bridge (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Nft Bridge — Advanced
