---
name: stream-heaven-cosmetics-exclusive-access-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Exclusive Access (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Exclusive Access — Advanced
