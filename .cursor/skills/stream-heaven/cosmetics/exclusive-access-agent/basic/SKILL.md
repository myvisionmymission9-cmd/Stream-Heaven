---
name: stream-heaven-cosmetics-exclusive-access-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Exclusive Access (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Exclusive Access — Basic

## When to use

- User invokes **Exclusive Access** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/exclusive-access-agent.md`
- **Role:** Exclusive Access Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/exclusive-access-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Exclusive Access deliverables in cosmetics domain for Stream Heaven Phase 11. (Exclusive Access scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/exclusive-access-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/exclusive-access-agent/advanced/SKILL.md`
