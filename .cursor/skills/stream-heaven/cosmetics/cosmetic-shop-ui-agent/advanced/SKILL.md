---
name: stream-heaven-cosmetics-cosmetic-shop-ui-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cosmetic Shop Ui (phase 11).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cosmetic Shop Ui — Advanced
