---
name: stream-heaven-cosmetics-cosmetic-shop-ui-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cosmetic Shop Ui (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Cosmetic Shop Ui — Basic

## When to use

- User invokes **Cosmetic Shop Ui** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/cosmetic-shop-ui-agent.md`
- **Role:** Cosmetic Shop Ui Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/cosmetic-shop-ui-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Cosmetic Shop Ui deliverables in cosmetics domain for Stream Heaven Phase 11. (Cosmetic Shop Ui scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/cosmetic-shop-ui-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/cosmetic-shop-ui-agent/advanced/SKILL.md`
