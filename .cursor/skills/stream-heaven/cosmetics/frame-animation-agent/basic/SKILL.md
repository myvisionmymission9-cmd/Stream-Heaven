---
name: stream-heaven-cosmetics-frame-animation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Frame Animation (phase 11).
  Single-agent execution with governance prefix and structural validation.
---

# Frame Animation — Basic

## When to use

- User invokes **Frame Animation** or work in **cosmetics** (phase 11)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cosmetics/frame-animation-agent.md`
- **Role:** Frame Animation Agent specialist for Stream Heaven's cosmetics domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cosmetics/frame-animation-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Frame Animation deliverables in cosmetics domain for Stream Heaven Phase 11. (Frame Animation scope)
...
- Basic: `.cursor/skills/stream-heaven/cosmetics/frame-animation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cosmetics/frame-animation-agent/advanced/SKILL.md`
