---
name: stream-heaven-safety-anti-fake-profile-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Anti Fake Profile (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Anti Fake Profile — Advanced
