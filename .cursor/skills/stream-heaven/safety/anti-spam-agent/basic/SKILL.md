---
name: stream-heaven-safety-anti-spam-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Anti Spam (phase 20).
...
- User invokes **Anti Spam** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/anti-spam-agent.md`
- **Role:** Spam in DM, comments, live chat.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/anti-spam-agent.md` and copy its `## Prompt Template` block
...
Build:
- anti-spam-agent with human appeals via appeal-review-agent. (Anti Spam scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/anti-spam-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/anti-spam-agent/advanced/SKILL.md`
