---
name: stream-heaven-safety-content-safety-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Content Safety (phase 20).
...
- User invokes **Content Safety** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/content-safety-agent.md`
- **Role:** Content Safety Agent specialist for Stream Heaven's safety domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/content-safety-agent.md` and copy its `## Prompt Template` block
...
Build:
- Define moderation policies and enforcement hooks for Content Safety across social and livestream surfaces. (Content Safety scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/content-safety-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/content-safety-agent/advanced/SKILL.md`
