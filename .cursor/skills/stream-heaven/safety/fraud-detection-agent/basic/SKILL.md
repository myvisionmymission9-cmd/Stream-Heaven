---
name: stream-heaven-safety-fraud-detection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Fraud Detection (phase 20).
...
- User invokes **Fraud Detection** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/fraud-detection-agent.md`
- **Role:** Payments and gift fraud scoring.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/fraud-detection-agent.md` and copy its `## Prompt Template` block
...
Build:
- fraud-detection-agent with human appeals via appeal-review-agent. (Fraud Detection scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/fraud-detection-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/fraud-detection-agent/advanced/SKILL.md`
