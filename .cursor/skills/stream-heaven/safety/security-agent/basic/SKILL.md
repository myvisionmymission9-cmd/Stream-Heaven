---
name: stream-heaven-safety-security-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Security (phase 20).
...
- User invokes **Security** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/security-agent.md`
- **Role:** AppSec standards and threat models.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/security-agent.md` and copy its `## Prompt Template` block
...
Build:
- security-agent with human appeals via appeal-review-agent. (Security scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/security-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/security-agent/advanced/SKILL.md`
