---
name: stream-heaven-safety-identity-verification-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Identity Verification (phase 20).
...
- User invokes **Identity Verification** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/identity-verification-agent.md`
- **Role:** ID and liveness verification.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/identity-verification-agent.md` and copy its `## Prompt Template` block
...
Build:
- identity-verification-agent with human appeals via appeal-review-agent. (Identity Verification scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/identity-verification-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/identity-verification-agent/advanced/SKILL.md`
