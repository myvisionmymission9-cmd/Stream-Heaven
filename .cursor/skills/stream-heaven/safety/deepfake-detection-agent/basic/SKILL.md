---
name: stream-heaven-safety-deepfake-detection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Deepfake Detection (phase 20).
...
- Open agent: `ai-agents/safety/deepfake-detection-agent.md` and copy its `## Prompt Template` block
