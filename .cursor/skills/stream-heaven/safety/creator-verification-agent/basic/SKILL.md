---
name: stream-heaven-safety-creator-verification-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Verification (phase 20).
...
- User invokes **Creator Verification** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/creator-verification-agent.md`
- **Role:** Creator KYC and badges.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/creator-verification-agent.md` and copy its `## Prompt Template` block
...
Build:
- creator-verification-agent with human appeals via appeal-review-agent. (Creator Verification scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/creator-verification-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/creator-verification-agent/advanced/SKILL.md`
