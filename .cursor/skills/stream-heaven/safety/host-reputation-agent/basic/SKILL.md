---
name: stream-heaven-safety-host-reputation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Host Reputation (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Host Reputation — Basic

## When to use

- User invokes **Host Reputation** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/host-reputation-agent.md`
- **Role:** Host strikes and reputation.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/host-reputation-agent.md` and copy its `## Prompt Template` block
...
Build:
- host-reputation-agent with human appeals via appeal-review-agent. (Host Reputation scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/host-reputation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/host-reputation-agent/advanced/SKILL.md`
