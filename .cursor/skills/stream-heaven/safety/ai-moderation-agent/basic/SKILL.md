---
name: stream-heaven-safety-ai-moderation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ai Moderation (phase 20).
...
- User invokes **Ai Moderation** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/ai-moderation-agent.md`
- **Role:** AI classifiers for UGC and live.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/ai-moderation-agent.md` and copy its `## Prompt Template` block
...
Build:
- ai-moderation-agent with human appeals via appeal-review-agent. (Ai Moderation scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/ai-moderation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/ai-moderation-agent/advanced/SKILL.md`
