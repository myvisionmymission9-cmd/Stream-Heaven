---
name: stream-heaven-safety-age-gate-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Age Gate (phase 20).
...
- User invokes **Age Gate** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/age-gate-agent.md`
- **Role:** Age Gate Agent specialist for Stream Heaven's safety domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/age-gate-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Age Gate deliverables in safety domain for Stream Heaven Phase 20. (Age Gate scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/age-gate-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/age-gate-agent/advanced/SKILL.md`
