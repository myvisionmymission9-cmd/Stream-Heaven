---
name: stream-heaven-safety-trust-score-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Trust Score (phase 20).
...
- User invokes **Trust Score** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/trust-score-agent.md`
- **Role:** Trust scores for feature gating.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/trust-score-agent.md` and copy its `## Prompt Template` block
...
Build:
- trust-score-agent with human appeals via appeal-review-agent. (Trust Score scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/trust-score-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/trust-score-agent/advanced/SKILL.md`
