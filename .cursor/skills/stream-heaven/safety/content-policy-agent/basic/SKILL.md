---
name: stream-heaven-safety-content-policy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Content Policy (phase 20).
...
- User invokes **Content Policy** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/content-policy-agent.md`
- **Role:** Policy matrices per app/locale.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/content-policy-agent.md` and copy its `## Prompt Template` block
...
Build:
- content-policy-agent with human appeals via appeal-review-agent. (Content Policy scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/content-policy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/content-policy-agent/advanced/SKILL.md`
