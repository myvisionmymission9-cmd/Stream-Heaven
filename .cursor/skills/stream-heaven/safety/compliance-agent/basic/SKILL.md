---
name: stream-heaven-safety-compliance-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Compliance (phase 20).
...
- User invokes **Compliance** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/compliance-agent.md`
- **Role:** Regulatory and store compliance.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/compliance-agent.md` and copy its `## Prompt Template` block
...
Follow:
- compliance-agent with human appeals via appeal-review-agent. (Compliance scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/compliance-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/compliance-agent/advanced/SKILL.md`
