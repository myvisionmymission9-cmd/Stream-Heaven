---
name: stream-heaven-safety-trust-safety-reviewer-basic
description: >-
  Basic Cursor skill for Stream Heaven Trust Safety Reviewer (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Trust Safety Reviewer — Basic

## When to use

- User invokes **Trust Safety Reviewer** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/trust-safety-reviewer.md`
- **Role:** Trust Safety Reviewer specialist for Stream Heaven's safety domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/trust-safety-reviewer.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/safety/trust-safety-reviewer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/trust-safety-reviewer/advanced/SKILL.md`
