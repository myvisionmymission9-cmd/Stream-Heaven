---
name: stream-heaven-safety-community-reputation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Community Reputation (phase 20).
...
- User invokes **Community Reputation** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/community-reputation-agent.md`
- **Role:** Community karma weights.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/community-reputation-agent.md` and copy its `## Prompt Template` block
...
Build:
- community-reputation-agent with human appeals via appeal-review-agent. (Community Reputation scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/community-reputation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/community-reputation-agent/advanced/SKILL.md`
