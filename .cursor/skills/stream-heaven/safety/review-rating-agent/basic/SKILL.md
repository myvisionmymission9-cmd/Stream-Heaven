---
name: stream-heaven-safety-review-rating-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Review Rating (phase 20).
...
- User invokes **Review Rating** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/review-rating-agent.md`
- **Role:** Review fraud and integrity.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/review-rating-agent.md` and copy its `## Prompt Template` block
...
Build:
- review-rating-agent with human appeals via appeal-review-agent. (Review Rating scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/review-rating-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/review-rating-agent/advanced/SKILL.md`
