---
name: stream-heaven-safety-harassment-detection-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Harassment Detection (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Harassment Detection — Advanced
