---
name: stream-heaven-safety-harassment-detection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Harassment Detection (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Harassment Detection — Basic

## When to use

- User invokes **Harassment Detection** or work in **safety** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/safety/harassment-detection-agent.md`
- **Role:** Harassment Detection Agent specialist for Stream Heaven's safety domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/safety/harassment-detection-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Harassment Detection deliverables in safety domain for Stream Heaven Phase 20. (Harassment Detection scope)
...
- Basic: `.cursor/skills/stream-heaven/safety/harassment-detection-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/safety/harassment-detection-agent/advanced/SKILL.md`
