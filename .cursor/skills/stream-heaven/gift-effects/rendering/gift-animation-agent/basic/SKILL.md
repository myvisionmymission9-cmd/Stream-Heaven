---
name: stream-heaven-gift-effects-rendering-gift-animation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Animation (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Gift Animation — Basic

## When to use

- User invokes **Gift Animation** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/gift-animation-agent.md`
- **Role:** Lottie/Rive pipelines and assets.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/gift-animation-agent.md` and copy its `## Prompt Template` block
...
Build:
- gift-animation-agent in shared-contracts/gifts/v1. (Gift Animation scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-animation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-animation-agent/advanced/SKILL.md`
