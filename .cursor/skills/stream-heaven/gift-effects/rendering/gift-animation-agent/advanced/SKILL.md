---
name: stream-heaven-gift-effects-rendering-gift-animation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Animation (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Animation — Advanced
