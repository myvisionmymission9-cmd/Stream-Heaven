---
name: stream-heaven-gift-effects-rendering-gift-trigger-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Trigger (phase 10).
...
- User invokes **Gift Trigger** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/gift-trigger-agent.md`
- **Role:** Gift triggers — validation and dispatch.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/gift-trigger-agent.md` and copy its `## Prompt Template` block
...
Build:
- gift-trigger-agent in shared-contracts/gifts/v1. (Gift Trigger scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-trigger-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-trigger-agent/advanced/SKILL.md`
