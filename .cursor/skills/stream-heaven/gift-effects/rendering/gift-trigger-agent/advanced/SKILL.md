---
name: stream-heaven-gift-effects-rendering-gift-trigger-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Trigger (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Trigger — Advanced
