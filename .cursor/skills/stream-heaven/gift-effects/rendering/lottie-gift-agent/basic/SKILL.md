---
name: stream-heaven-gift-effects-rendering-lottie-gift-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Lottie Gift (phase 10).
...
- User invokes **Lottie Gift** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/lottie-gift-agent.md`
- **Role:** Lottie Gift Agent specialist for Stream Heaven's rendering domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/lottie-gift-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/lottie-gift-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/lottie-gift-agent/advanced/SKILL.md`
