---
name: stream-heaven-gift-effects-rendering-particle-system-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Particle System (phase 10).
...
- User invokes **Particle System** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/particle-system-agent.md`
- **Role:** Particle System Agent specialist for Stream Heaven's rendering domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/particle-system-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Particle System deliverables in rendering domain for Stream Heaven Phase 10. (Particle System scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/particle-system-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/particle-system-agent/advanced/SKILL.md`
