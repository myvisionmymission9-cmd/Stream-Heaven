---
name: stream-heaven-gift-effects-rendering-gpu-shader-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gpu Shader Specialist (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gpu Shader Specialist — Advanced
