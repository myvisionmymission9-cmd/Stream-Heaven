---
name: stream-heaven-gift-effects-rendering-gpu-shader-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Gpu Shader Specialist (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Gpu Shader Specialist — Basic

## When to use

- User invokes **Gpu Shader Specialist** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/gpu-shader-specialist.md`
- **Role:** Gpu Shader Specialist specialist for Stream Heaven's rendering domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/gpu-shader-specialist.md` and copy its `## Prompt Template` block
...
Build:
- Own Gpu Shader deliverables in rendering domain for Stream Heaven Phase 10. (Gpu Shader Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/gpu-shader-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/gpu-shader-specialist/advanced/SKILL.md`
