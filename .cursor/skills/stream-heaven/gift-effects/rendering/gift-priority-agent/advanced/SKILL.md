---
name: stream-heaven-gift-effects-rendering-gift-priority-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Priority (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Priority — Advanced
