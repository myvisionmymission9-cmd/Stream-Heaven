---
name: stream-heaven-gift-effects-rendering-gift-priority-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Priority (phase 10).
...
- User invokes **Gift Priority** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/gift-priority-agent.md`
- **Role:** Priority when FX budget saturated.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/gift-priority-agent.md` and copy its `## Prompt Template` block
...
Build:
- gift-priority-agent in shared-contracts/gifts/v1. (Gift Priority scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-priority-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-priority-agent/advanced/SKILL.md`
