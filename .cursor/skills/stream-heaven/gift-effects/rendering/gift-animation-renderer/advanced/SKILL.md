---
name: stream-heaven-gift-effects-rendering-gift-animation-renderer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Animation Renderer (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Animation Renderer — Advanced
