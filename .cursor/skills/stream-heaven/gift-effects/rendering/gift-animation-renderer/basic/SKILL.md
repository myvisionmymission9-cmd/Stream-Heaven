---
name: stream-heaven-gift-effects-rendering-gift-animation-renderer-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Animation Renderer (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Gift Animation Renderer — Basic

## When to use

- User invokes **Gift Animation Renderer** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/gift-animation-renderer.md`
- **Role:** Gift Animation Renderer specialist for Stream Heaven's rendering domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/gift-animation-renderer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement rendering capabilities for Stream Heaven. (Gift Animation Renderer scope)
