---
name: stream-heaven-gift-effects-rendering-gift-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Sync (phase 10).
...
- User invokes **Gift Sync** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/gift-sync-agent.md`
- **Role:** Cross-client gift sync and ordering.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/gift-sync-agent.md` and copy its `## Prompt Template` block
...
Build:
- gift-sync-agent in shared-contracts/gifts/v1. (Gift Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-sync-agent/advanced/SKILL.md`
