---
name: stream-heaven-gift-effects-rendering-gift-economy-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Economy (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Economy — Advanced
