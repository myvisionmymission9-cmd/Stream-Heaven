---
name: stream-heaven-gift-effects-rendering-gift-economy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Economy (phase 10).
...
- User invokes **Gift Economy** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/gift-economy-agent.md`
- **Role:** Catalog pricing and wallet debits.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/gift-economy-agent.md` and copy its `## Prompt Template` block
...
Build:
- gift-economy-agent in shared-contracts/gifts/v1. (Gift Economy scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-economy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-economy-agent/advanced/SKILL.md`
