---
name: stream-heaven-gift-effects-rendering-gift-rendering-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Rendering (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Gift Rendering — Basic

## When to use

- User invokes **Gift Rendering** or work in **gift-effects/rendering** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/rendering/gift-rendering-agent.md`
- **Role:** GPU/CPU render path per device.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/rendering/gift-rendering-agent.md` and copy its `## Prompt Template` block
...
Build:
- gift-rendering-agent in shared-contracts/gifts/v1. (Gift Rendering scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-rendering-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/rendering/gift-rendering-agent/advanced/SKILL.md`
