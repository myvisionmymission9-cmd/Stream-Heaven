---
name: stream-heaven-gift-effects-rendering-gift-rendering-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Rendering (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Rendering — Advanced
