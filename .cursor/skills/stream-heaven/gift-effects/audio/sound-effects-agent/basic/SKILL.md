---
name: stream-heaven-gift-effects-audio-sound-effects-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Sound Effects (phase 10).
...
- User invokes **Sound Effects** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/sound-effects-agent.md`
- **Role:** SFX library and CDN prefetch.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/sound-effects-agent.md` and copy its `## Prompt Template` block
...
Build:
- sound-effects-agent audio graph in Flutter + platform channels. (Sound Effects scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/sound-effects-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/sound-effects-agent/advanced/SKILL.md`
