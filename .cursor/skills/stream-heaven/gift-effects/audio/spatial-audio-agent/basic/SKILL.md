---
name: stream-heaven-gift-effects-audio-spatial-audio-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Spatial Audio (phase 10).
...
- User invokes **Spatial Audio** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/spatial-audio-agent.md`
- **Role:** Spatial audio for multi-guest stages.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/spatial-audio-agent.md` and copy its `## Prompt Template` block
...
Build:
- spatial-audio-agent audio graph in Flutter + platform channels. (Spatial Audio scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/spatial-audio-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/spatial-audio-agent/advanced/SKILL.md`
