---
name: stream-heaven-gift-effects-audio-gift-sound-effect-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Sound Effect (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Gift Sound Effect — Basic

## When to use

- User invokes **Gift Sound Effect** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/gift-sound-effect-agent.md`
- **Role:** Ai Agents/Gift Effects/Audio/Gift Sound Effect specialist for Stream Heaven's gift-audio domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/gift-sound-effect-agent.md` and copy its `## Prompt Template` block
...
Build:
- Curate SFX library mapped to gift SKUs with loudness normalization (LUFS targets). (Gift Sound Effect scope)
