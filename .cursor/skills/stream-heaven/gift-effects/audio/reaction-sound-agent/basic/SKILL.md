---
name: stream-heaven-gift-effects-audio-reaction-sound-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reaction Sound (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Reaction Sound — Basic

## When to use

- User invokes **Reaction Sound** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/reaction-sound-agent.md`
- **Role:** Reaction packs with normalization.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/reaction-sound-agent.md` and copy its `## Prompt Template` block
...
Build:
- reaction-sound-agent audio graph in Flutter + platform channels. (Reaction Sound scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/reaction-sound-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/reaction-sound-agent/advanced/SKILL.md`
