---
name: stream-heaven-gift-effects-audio-reaction-sound-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Reaction Sound (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Reaction Sound — Advanced
