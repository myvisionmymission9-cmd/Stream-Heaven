---
name: stream-heaven-gift-effects-audio-haptic-feedback-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Haptic Feedback (phase 10).
...
- User invokes **Haptic Feedback** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/haptic-feedback-agent.md`
- **Role:** Haptic Feedback Agent specialist for Stream Heaven's audio domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/haptic-feedback-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/haptic-feedback-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/haptic-feedback-agent/advanced/SKILL.md`
