---
name: stream-heaven-gift-effects-audio-gift-sound-designer-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Sound Designer (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Gift Sound Designer — Basic

## When to use

- User invokes **Gift Sound Designer** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/gift-sound-designer.md`
- **Role:** Gift Sound Designer specialist for Stream Heaven's audio domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/gift-sound-designer.md` and copy its `## Prompt Template` block
...
Build:
- Own Gift Sound deliverables in audio domain for Stream Heaven Phase 10. (Gift Sound Designer scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/gift-sound-designer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/gift-sound-designer/advanced/SKILL.md`
