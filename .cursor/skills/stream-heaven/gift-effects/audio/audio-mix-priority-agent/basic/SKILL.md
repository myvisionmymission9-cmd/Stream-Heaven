---
name: stream-heaven-gift-effects-audio-audio-mix-priority-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Audio Mix Priority (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Audio Mix Priority — Basic

## When to use

- User invokes **Audio Mix Priority** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/audio-mix-priority-agent.md`
- **Role:** Audio Mix Priority Agent specialist for Stream Heaven's audio domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/audio-mix-priority-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Audio Mix Priority deliverables in audio domain for Stream Heaven Phase 10. (Audio Mix Priority scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/audio-mix-priority-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/audio-mix-priority-agent/advanced/SKILL.md`
