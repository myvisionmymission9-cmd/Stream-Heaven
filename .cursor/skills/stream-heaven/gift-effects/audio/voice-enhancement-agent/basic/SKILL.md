---
name: stream-heaven-gift-effects-audio-voice-enhancement-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Voice Enhancement (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Voice Enhancement — Basic

## When to use

- User invokes **Voice Enhancement** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/voice-enhancement-agent.md`
- **Role:** Voice clarity and noise suppression.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/voice-enhancement-agent.md` and copy its `## Prompt Template` block
...
Build:
- voice-enhancement-agent audio graph in Flutter + platform channels. (Voice Enhancement scope)
