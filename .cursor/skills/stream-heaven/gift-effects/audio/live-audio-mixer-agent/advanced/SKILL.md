---
name: stream-heaven-gift-effects-audio-live-audio-mixer-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Live Audio Mixer (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Live Audio Mixer — Advanced
