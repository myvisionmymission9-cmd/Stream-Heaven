---
name: stream-heaven-gift-effects-audio-live-audio-mixer-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Live Audio Mixer (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Live Audio Mixer — Basic

## When to use

- User invokes **Live Audio Mixer** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/live-audio-mixer-agent.md`
- **Role:** Live bus mixing host/guest/music.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/live-audio-mixer-agent.md` and copy its `## Prompt Template` block
...
Build:
- live-audio-mixer-agent audio graph in Flutter + platform channels. (Live Audio Mixer scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/live-audio-mixer-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/live-audio-mixer-agent/advanced/SKILL.md`
