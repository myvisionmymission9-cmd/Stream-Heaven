---
name: stream-heaven-gift-effects-audio-background-audio-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Background Audio (phase 10).
...
- User invokes **Background Audio** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/background-audio-agent.md`
- **Role:** Background music licensing and ducking.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/background-audio-agent.md` and copy its `## Prompt Template` block
...
Build:
- background-audio-agent audio graph in Flutter + platform channels. (Background Audio scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/background-audio-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/background-audio-agent/advanced/SKILL.md`
