---
name: stream-heaven-gift-effects-audio-gift-sound-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Sound (phase 10).
...
- User invokes **Gift Sound** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/gift-sound-agent.md`
- **Role:** Per-gift sounds and play limits.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/gift-sound-agent.md` and copy its `## Prompt Template` block
...
Build:
- gift-sound-agent audio graph in Flutter + platform channels. (Gift Sound scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/gift-sound-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/gift-sound-agent/advanced/SKILL.md`
