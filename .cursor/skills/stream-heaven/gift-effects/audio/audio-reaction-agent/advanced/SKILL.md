---
name: stream-heaven-gift-effects-audio-audio-reaction-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Audio Reaction (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Audio Reaction — Advanced
