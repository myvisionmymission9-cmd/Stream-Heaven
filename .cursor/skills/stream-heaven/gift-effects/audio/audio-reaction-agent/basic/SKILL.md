---
name: stream-heaven-gift-effects-audio-audio-reaction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Audio Reaction (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Audio Reaction — Basic

## When to use

- User invokes **Audio Reaction** or work in **gift-effects/audio** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/audio/audio-reaction-agent.md`
- **Role:** Audio stingers for reactions.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/audio/audio-reaction-agent.md` and copy its `## Prompt Template` block
...
Build:
- audio-reaction-agent audio graph in Flutter + platform channels. (Audio Reaction scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/audio/audio-reaction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/audio/audio-reaction-agent/advanced/SKILL.md`
