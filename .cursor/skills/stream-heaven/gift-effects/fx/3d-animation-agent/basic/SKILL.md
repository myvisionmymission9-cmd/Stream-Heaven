---
name: stream-heaven-gift-effects-fx-3d-animation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven 3d Animation (phase 10).
...
- User invokes **3d Animation** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/3d-animation-agent.md`
- **Role:** 3D gift LOD per device.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/3d-animation-agent.md` and copy its `## Prompt Template` block
...
Build:
- 3d-animation-agent gated by effect-budget-optimizer. (3d Animation scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/3d-animation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/3d-animation-agent/advanced/SKILL.md`
