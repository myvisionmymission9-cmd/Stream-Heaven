---
name: stream-heaven-gift-effects-fx-gift-queue-manager-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Queue Manager (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Queue Manager — Advanced
