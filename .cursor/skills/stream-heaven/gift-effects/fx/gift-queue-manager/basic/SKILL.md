---
name: stream-heaven-gift-effects-fx-gift-queue-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Queue Manager (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Gift Queue Manager — Basic

## When to use

- User invokes **Gift Queue Manager** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/gift-queue-manager.md`
- **Role:** Gift Queue Manager specialist for Stream Heaven's fx domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/gift-queue-manager.md` and copy its `## Prompt Template` block
...
Build:
- Own Gift Queue deliverables in fx domain for Stream Heaven Phase 10. (Gift Queue Manager scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/gift-queue-manager/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/gift-queue-manager/advanced/SKILL.md`
