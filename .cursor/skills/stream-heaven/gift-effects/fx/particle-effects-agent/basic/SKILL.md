---
name: stream-heaven-gift-effects-fx-particle-effects-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Particle Effects (phase 10).
...
- User invokes **Particle Effects** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/particle-effects-agent.md`
- **Role:** Particle gifts with GPU caps.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/particle-effects-agent.md` and copy its `## Prompt Template` block
...
Build:
- particle-effects-agent gated by effect-budget-optimizer. (Particle Effects scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/particle-effects-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/particle-effects-agent/advanced/SKILL.md`
