---
name: stream-heaven-gift-effects-fx-combo-effect-chainer-basic
description: >-
  Basic Cursor skill for Stream Heaven Combo Effect Chainer (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Combo Effect Chainer — Basic

## When to use

- User invokes **Combo Effect Chainer** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/combo-effect-chainer.md`
- **Role:** Combo Effect Chainer specialist for Stream Heaven's fx domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/combo-effect-chainer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement fx capabilities for Stream Heaven. (Combo Effect Chainer scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/combo-effect-chainer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/combo-effect-chainer/advanced/SKILL.md`
