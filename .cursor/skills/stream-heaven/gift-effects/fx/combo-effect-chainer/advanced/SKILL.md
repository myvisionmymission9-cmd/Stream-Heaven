---
name: stream-heaven-gift-effects-fx-combo-effect-chainer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Combo Effect Chainer (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Combo Effect Chainer — Advanced
