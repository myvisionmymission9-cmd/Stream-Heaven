---
name: stream-heaven-gift-effects-fx-effect-budget-optimizer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Effect Budget Optimizer (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Effect Budget Optimizer — Advanced
