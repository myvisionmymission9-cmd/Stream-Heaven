---
name: stream-heaven-gift-effects-fx-gpu-effects-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gpu Effects (phase 10).
...
- User invokes **Gpu Effects** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/gpu-effects-agent.md`
- **Role:** GPU scheduling and crash guards.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/gpu-effects-agent.md` and copy its `## Prompt Template` block
...
Build:
- gpu-effects-agent gated by effect-budget-optimizer. (Gpu Effects scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/gpu-effects-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/gpu-effects-agent/advanced/SKILL.md`
