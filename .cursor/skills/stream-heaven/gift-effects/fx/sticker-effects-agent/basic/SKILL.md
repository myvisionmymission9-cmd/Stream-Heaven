---
name: stream-heaven-gift-effects-fx-sticker-effects-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Sticker Effects (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Sticker Effects — Basic

## When to use

- User invokes **Sticker Effects** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/sticker-effects-agent.md`
- **Role:** Sticker overlays live/replay.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/sticker-effects-agent.md` and copy its `## Prompt Template` block
...
Build:
- sticker-effects-agent gated by effect-budget-optimizer. (Sticker Effects scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/sticker-effects-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/sticker-effects-agent/advanced/SKILL.md`
