---
name: stream-heaven-gift-effects-fx-sticker-effects-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Sticker Effects (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Sticker Effects — Advanced
