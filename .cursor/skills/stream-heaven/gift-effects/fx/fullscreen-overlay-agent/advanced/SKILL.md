---
name: stream-heaven-gift-effects-fx-fullscreen-overlay-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Fullscreen Overlay (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Fullscreen Overlay — Advanced
