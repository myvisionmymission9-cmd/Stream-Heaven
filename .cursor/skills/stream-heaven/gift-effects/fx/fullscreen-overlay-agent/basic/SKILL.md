---
name: stream-heaven-gift-effects-fx-fullscreen-overlay-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Fullscreen Overlay (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Fullscreen Overlay — Basic

## When to use

- User invokes **Fullscreen Overlay** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/fullscreen-overlay-agent.md`
- **Role:** Fullscreen Overlay Agent specialist for Stream Heaven's fx domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/fullscreen-overlay-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Fullscreen Overlay deliverables in fx domain for Stream Heaven Phase 10. (Fullscreen Overlay scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/fullscreen-overlay-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/fullscreen-overlay-agent/advanced/SKILL.md`
