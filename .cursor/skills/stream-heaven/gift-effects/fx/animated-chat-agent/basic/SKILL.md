---
name: stream-heaven-gift-effects-fx-animated-chat-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Animated Chat (phase 10).
...
- User invokes **Animated Chat** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/animated-chat-agent.md`
- **Role:** Animated subscriber chat.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/animated-chat-agent.md` and copy its `## Prompt Template` block
...
Build:
- animated-chat-agent gated by effect-budget-optimizer. (Animated Chat scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/animated-chat-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/animated-chat-agent/advanced/SKILL.md`
