---
name: stream-heaven-gift-effects-fx-dynamic-lighting-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Dynamic Lighting (phase 10).
...
- User invokes **Dynamic Lighting** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/dynamic-lighting-agent.md`
- **Role:** Lighting accents on host video.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/dynamic-lighting-agent.md` and copy its `## Prompt Template` block
...
Build:
- dynamic-lighting-agent gated by effect-budget-optimizer. (Dynamic Lighting scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/dynamic-lighting-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/dynamic-lighting-agent/advanced/SKILL.md`
