---
name: stream-heaven-gift-effects-fx-screen-overlay-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Screen Overlay (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Screen Overlay — Basic

## When to use

- User invokes **Screen Overlay** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/screen-overlay-agent.md`
- **Role:** Overlays without blocking touches.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/screen-overlay-agent.md` and copy its `## Prompt Template` block
...
Build:
- screen-overlay-agent gated by effect-budget-optimizer. (Screen Overlay scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/screen-overlay-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/screen-overlay-agent/advanced/SKILL.md`
