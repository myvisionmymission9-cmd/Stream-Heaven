---
name: stream-heaven-gift-effects-fx-screen-overlay-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Screen Overlay (phase 10).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Screen Overlay — Advanced
