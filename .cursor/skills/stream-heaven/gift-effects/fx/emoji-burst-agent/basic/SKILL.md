---
name: stream-heaven-gift-effects-fx-emoji-burst-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Emoji Burst (phase 10).
...
- User invokes **Emoji Burst** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/emoji-burst-agent.md`
- **Role:** Emoji bursts on reactions.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/emoji-burst-agent.md` and copy its `## Prompt Template` block
...
Build:
- emoji-burst-agent gated by effect-budget-optimizer. (Emoji Burst scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/emoji-burst-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/emoji-burst-agent/advanced/SKILL.md`
