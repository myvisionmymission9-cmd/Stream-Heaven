---
name: stream-heaven-gift-effects-fx-heart-rain-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Heart Rain (phase 10).
...
- User invokes **Heart Rain** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/heart-rain-agent.md`
- **Role:** Heart-rain with client aggregation.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/heart-rain-agent.md` and copy its `## Prompt Template` block
...
Build:
- heart-rain-agent gated by effect-budget-optimizer. (Heart Rain scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/heart-rain-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/heart-rain-agent/advanced/SKILL.md`
