---
name: stream-heaven-gift-effects-fx-shader-effects-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Shader Effects (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Shader Effects — Basic

## When to use

- User invokes **Shader Effects** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/shader-effects-agent.md`
- **Role:** Shader gifts and fallbacks.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/shader-effects-agent.md` and copy its `## Prompt Template` block
...
Build:
- shader-effects-agent gated by effect-budget-optimizer. (Shader Effects scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/shader-effects-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/shader-effects-agent/advanced/SKILL.md`
