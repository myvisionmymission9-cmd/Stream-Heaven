---
name: stream-heaven-gift-effects-fx-floating-comment-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Floating Comment (phase 10).
  Single-agent execution with governance prefix and structural validation.
---

# Floating Comment — Basic
...
- Open agent: `ai-agents/gift-effects/fx/floating-comment-agent.md` and copy its `## Prompt Template` block
