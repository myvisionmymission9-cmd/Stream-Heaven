---
name: stream-heaven-gift-effects-fx-motion-graphics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Motion Graphics (phase 10).
...
- User invokes **Motion Graphics** or work in **gift-effects/fx** (phase 10)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/gift-effects/fx/motion-graphics-agent.md`
- **Role:** Campaign motion templates.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/gift-effects/fx/motion-graphics-agent.md` and copy its `## Prompt Template` block
...
Build:
- motion-graphics-agent gated by effect-budget-optimizer. (Motion Graphics scope)
...
- Basic: `.cursor/skills/stream-heaven/gift-effects/fx/motion-graphics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/gift-effects/fx/motion-graphics-agent/advanced/SKILL.md`
