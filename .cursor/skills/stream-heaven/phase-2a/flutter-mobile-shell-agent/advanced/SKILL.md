---
name: stream-heaven-phase-2a-flutter-mobile-shell-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Flutter Mobile Shell (phase 2a).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Flutter Mobile Shell — Advanced
