---
name: stream-heaven-platform-knowledge-reference-app-analysis-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Reference App Analysis (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Reference App Analysis — Advanced
