---
name: stream-heaven-platform-knowledge-reference-app-analysis-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reference App Analysis (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Reference App Analysis — Basic

## When to use

- User invokes **Reference App Analysis** or work in **platform-knowledge** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-knowledge/reference-app-analysis-agent.md`
- **Role:** Reference App Analysis Agent specialist for Stream Heaven's platform-knowledge domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-knowledge/reference-app-analysis-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Reference App Analysis deliverables in platform-knowledge domain for Stream Heaven Phase 20. (Reference App Analysis scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-knowledge/reference-app-analysis-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-knowledge/reference-app-analysis-agent/advanced/SKILL.md`
