---
name: stream-heaven-platform-knowledge-market-trends-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Market Trends (phase 20).
...
- User invokes **Market Trends** or work in **platform-knowledge** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-knowledge/market-trends-agent.md`
- **Role:** Market Trends Agent specialist for Stream Heaven's platform-knowledge domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-knowledge/market-trends-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Market Trends deliverables in platform-knowledge domain for Stream Heaven Phase 20. (Market Trends scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-knowledge/market-trends-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-knowledge/market-trends-agent/advanced/SKILL.md`
