---
name: stream-heaven-platform-knowledge-doc-generator-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Doc Generator (phase 20).
...
- User invokes **Doc Generator** or work in **platform-knowledge** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-knowledge/doc-generator-agent.md`
- **Role:** Doc Generator Agent specialist for Stream Heaven's platform knowledge domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-knowledge/doc-generator-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Doc Generator deliverables in platform-knowledge domain for Stream Heaven Phase 20. (Doc Generator scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-knowledge/doc-generator-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-knowledge/doc-generator-agent/advanced/SKILL.md`
