---
name: stream-heaven-platform-knowledge-doc-generator-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Doc Generator (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Doc Generator — Advanced
