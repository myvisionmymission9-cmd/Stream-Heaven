---
name: stream-heaven-platform-knowledge-onboarding-doc-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Onboarding Doc (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Onboarding Doc — Advanced
