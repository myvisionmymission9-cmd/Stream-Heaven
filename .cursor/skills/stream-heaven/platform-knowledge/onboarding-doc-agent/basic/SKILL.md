---
name: stream-heaven-platform-knowledge-onboarding-doc-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Onboarding Doc (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Onboarding Doc — Basic

## When to use

- User invokes **Onboarding Doc** or work in **platform-knowledge** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-knowledge/onboarding-doc-agent.md`
- **Role:** Onboarding Doc Agent specialist for Stream Heaven's platform knowledge domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-knowledge/onboarding-doc-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Onboarding Doc deliverables in platform-knowledge domain for Stream Heaven Phase 20. (Onboarding Doc scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-knowledge/onboarding-doc-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-knowledge/onboarding-doc-agent/advanced/SKILL.md`
