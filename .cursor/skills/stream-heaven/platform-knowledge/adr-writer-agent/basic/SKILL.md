---
name: stream-heaven-platform-knowledge-adr-writer-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Adr Writer (phase 20).
...
- User invokes **Adr Writer** or work in **platform-knowledge** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-knowledge/adr-writer-agent.md`
- **Role:** Adr Writer Agent specialist for Stream Heaven's platform knowledge domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-knowledge/adr-writer-agent.md` and copy its `## Prompt Template` block
