---
name: stream-heaven-platform-knowledge-api-doc-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Api Doc Sync (phase 20).
...
- User invokes **Api Doc Sync** or work in **platform-knowledge** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-knowledge/api-doc-sync-agent.md`
- **Role:** Api Doc Sync Agent specialist for Stream Heaven's platform knowledge domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-knowledge/api-doc-sync-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Api Doc Sync deliverables in platform-knowledge domain for Stream Heaven Phase 20. (Api Doc Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-knowledge/api-doc-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-knowledge/api-doc-sync-agent/advanced/SKILL.md`
