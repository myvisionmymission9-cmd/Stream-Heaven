---
name: stream-heaven-platform-knowledge-competitive-intelligence-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Competitive Intelligence (phase 20).
...
- User invokes **Competitive Intelligence** or work in **platform-knowledge** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-knowledge/competitive-intelligence-agent.md`
- **Role:** Competitive Intelligence Agent specialist for Stream Heaven's platform-knowledge domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-knowledge/competitive-intelligence-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Competitive Intelligence deliverables in platform-knowledge domain for Stream Heaven Phase 20. (Competitive Intelligence scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-knowledge/competitive-intelligence-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-knowledge/competitive-intelligence-agent/advanced/SKILL.md`
