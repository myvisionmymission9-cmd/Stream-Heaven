---
name: stream-heaven-data-science-behavior-prediction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Behavior Prediction (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Behavior Prediction — Basic

## When to use

- User invokes **Behavior Prediction** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/behavior-prediction-agent.md`
- **Role:** Behavior Prediction Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/behavior-prediction-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Behavior Prediction deliverables in data-science domain for Stream Heaven Phase 14. (Behavior Prediction scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/behavior-prediction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/behavior-prediction-agent/advanced/SKILL.md`
