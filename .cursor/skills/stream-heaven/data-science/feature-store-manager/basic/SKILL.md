---
name: stream-heaven-data-science-feature-store-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Feature Store Manager (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Feature Store Manager — Basic

## When to use

- User invokes **Feature Store Manager** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/feature-store-manager.md`
- **Role:** Feature Store Manager specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/feature-store-manager.md` and copy its `## Prompt Template` block
