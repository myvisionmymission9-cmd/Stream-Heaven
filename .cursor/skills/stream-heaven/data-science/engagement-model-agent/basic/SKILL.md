---
name: stream-heaven-data-science-engagement-model-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Engagement Model (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Engagement Model — Basic

## When to use

- User invokes **Engagement Model** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/engagement-model-agent.md`
- **Role:** Engagement Model Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/engagement-model-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Engagement Model ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Engagement Model scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/engagement-model-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/engagement-model-agent/advanced/SKILL.md`
