---
name: stream-heaven-data-science-segmentation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Segmentation (phase 14).
...
- User invokes **Segmentation** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/segmentation-agent.md`
- **Role:** Segmentation Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/segmentation-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Segmentation deliverables in data-science domain for Stream Heaven Phase 14. (Segmentation scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/segmentation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/segmentation-agent/advanced/SKILL.md`
