---
name: stream-heaven-data-science-experiment-platform-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Experiment Platform (phase 14).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Experiment Platform — Advanced
