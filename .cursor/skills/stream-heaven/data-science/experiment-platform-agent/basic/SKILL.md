---
name: stream-heaven-data-science-experiment-platform-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Experiment Platform (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Experiment Platform — Basic

## When to use

- User invokes **Experiment Platform** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/experiment-platform-agent.md`
- **Role:** Experiment Platform Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/experiment-platform-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Experiment Platform deliverables in data-science domain for Stream Heaven Phase 14. (Experiment Platform scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/experiment-platform-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/experiment-platform-agent/advanced/SKILL.md`
