---
name: stream-heaven-data-science-ranking-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ranking Optimization (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Ranking Optimization — Basic

## When to use

- User invokes **Ranking Optimization** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/ranking-optimization-agent.md`
- **Role:** Ranking Optimization Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/ranking-optimization-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Ranking Optimization ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Ranking Optimization scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/ranking-optimization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/ranking-optimization-agent/advanced/SKILL.md`
