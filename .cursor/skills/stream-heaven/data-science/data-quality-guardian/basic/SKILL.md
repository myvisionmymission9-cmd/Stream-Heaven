---
name: stream-heaven-data-science-data-quality-guardian-basic
description: >-
  Basic Cursor skill for Stream Heaven Data Quality Guardian (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Data Quality Guardian — Basic

## When to use

- User invokes **Data Quality Guardian** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/data-quality-guardian.md`
- **Role:** Data Quality Guardian specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/data-quality-guardian.md` and copy its `## Prompt Template` block
...
Design:
- Own Data Quality deliverables in data-science domain for Stream Heaven Phase 14. (Data Quality Guardian scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/data-quality-guardian/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/data-quality-guardian/advanced/SKILL.md`
