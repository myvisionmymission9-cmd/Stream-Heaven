---
name: stream-heaven-data-science-ltv-modeling-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ltv Modeling (phase 14).
...
- User invokes **Ltv Modeling** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/ltv-modeling-agent.md`
- **Role:** Ltv Modeling Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/ltv-modeling-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Ltv Modeling ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Ltv Modeling scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/ltv-modeling-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/ltv-modeling-agent/advanced/SKILL.md`
