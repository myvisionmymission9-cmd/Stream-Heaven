---
name: stream-heaven-data-science-lifetime-value-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Lifetime Value (phase 14).
...
- User invokes **Lifetime Value** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/lifetime-value-agent.md`
- **Role:** Lifetime Value Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/lifetime-value-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Lifetime Value deliverables in data-science domain for Stream Heaven Phase 14. (Lifetime Value scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/lifetime-value-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/lifetime-value-agent/advanced/SKILL.md`
