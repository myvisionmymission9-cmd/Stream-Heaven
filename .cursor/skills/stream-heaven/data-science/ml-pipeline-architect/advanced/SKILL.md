---
name: stream-heaven-data-science-ml-pipeline-architect-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ml Pipeline Architect (phase 14).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Ml Pipeline Architect — Advanced
...
Architect:
- Design and implement data science capabilities for Stream Heaven. (Ml Pipeline Architect scope)
