---
name: stream-heaven-data-science-transformer-research-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Transformer Research (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Transformer Research — Basic

## When to use

- User invokes **Transformer Research** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/transformer-research-agent.md`
- **Role:** Transformer Research Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/transformer-research-agent.md` and copy its `## Prompt Template` block
...
### Indexing Pipeline
Build:
- Own Transformer Research deliverables in data-science domain for Stream Heaven Phase 14. (Transformer Research scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/transformer-research-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/transformer-research-agent/advanced/SKILL.md`
