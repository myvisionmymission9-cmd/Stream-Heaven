---
name: stream-heaven-data-science-ab-test-analyst-basic
description: >-
  Basic Cursor skill for Stream Heaven Ab Test Analyst (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Ab Test Analyst — Basic

## When to use

- User invokes **Ab Test Analyst** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/ab-test-analyst.md`
- **Role:** Ab Test Analyst specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/ab-test-analyst.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement data science capabilities for Stream Heaven. (Ab Test Analyst scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/ab-test-analyst/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/ab-test-analyst/advanced/SKILL.md`
