---
name: stream-heaven-data-science-multimodal-ai-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Multimodal Ai (phase 14).
...
- User invokes **Multimodal Ai** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/multimodal-ai-agent.md`
- **Role:** Multimodal Ai Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/multimodal-ai-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Multimodal Ai deliverables in data-science domain for Stream Heaven Phase 14. (Multimodal Ai scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/multimodal-ai-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/multimodal-ai-agent/advanced/SKILL.md`
