---
name: stream-heaven-data-science-cohort-analysis-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cohort Analysis (phase 14).
...
- Open agent: `ai-agents/data-science/cohort-analysis-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement data science capabilities for Stream Heaven. (Cohort Analysis scope)
