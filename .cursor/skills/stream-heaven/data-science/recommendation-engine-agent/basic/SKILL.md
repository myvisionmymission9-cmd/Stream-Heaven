---
name: stream-heaven-data-science-recommendation-engine-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Recommendation Engine (phase 14).
...
- User invokes **Recommendation Engine** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/recommendation-engine-agent.md`
- **Role:** Recommendation Engine Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/recommendation-engine-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Recommendation ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Recommendation Engine scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/recommendation-engine-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/recommendation-engine-agent/advanced/SKILL.md`
