---
name: stream-heaven-data-science-anomaly-detection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Anomaly Detection (phase 14).
...
- User invokes **Anomaly Detection** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/anomaly-detection-agent.md`
- **Role:** Anomaly Detection Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/anomaly-detection-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Anomaly Detection deliverables in data-science domain for Stream Heaven Phase 14. (Anomaly Detection scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/anomaly-detection-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/anomaly-detection-agent/advanced/SKILL.md`
