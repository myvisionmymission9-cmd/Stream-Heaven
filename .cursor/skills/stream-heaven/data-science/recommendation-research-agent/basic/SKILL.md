---
name: stream-heaven-data-science-recommendation-research-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Recommendation Research (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Recommendation Research — Basic

## When to use

- User invokes **Recommendation Research** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/recommendation-research-agent.md`
- **Role:** Recommendation Research Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/recommendation-research-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/data-science/recommendation-research-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/recommendation-research-agent/advanced/SKILL.md`
