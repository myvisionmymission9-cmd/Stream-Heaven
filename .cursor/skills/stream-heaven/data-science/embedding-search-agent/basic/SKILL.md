---
name: stream-heaven-data-science-embedding-search-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Embedding Search (phase 14).
...
- User invokes **Embedding Search** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/embedding-search-agent.md`
- **Role:** Embedding Search Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/embedding-search-agent.md` and copy its `## Prompt Template` block
...
### Indexing Pipeline
Build:
- Design Embedding Search ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Embedding Search scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/embedding-search-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/embedding-search-agent/advanced/SKILL.md`
