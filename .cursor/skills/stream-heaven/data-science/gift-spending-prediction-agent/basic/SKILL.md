---
name: stream-heaven-data-science-gift-spending-prediction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Spending Prediction (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Gift Spending Prediction — Basic

## When to use

- User invokes **Gift Spending Prediction** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/gift-spending-prediction-agent.md`
- **Role:** Gift Spending Prediction Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/gift-spending-prediction-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Gift Spending Prediction deliverables in data-science domain for Stream Heaven Phase 14. (Gift Spending Prediction scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/gift-spending-prediction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/gift-spending-prediction-agent/advanced/SKILL.md`
