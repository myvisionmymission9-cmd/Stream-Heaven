---
name: stream-heaven-data-science-gift-spending-prediction-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Spending Prediction (phase 14).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Spending Prediction — Advanced
