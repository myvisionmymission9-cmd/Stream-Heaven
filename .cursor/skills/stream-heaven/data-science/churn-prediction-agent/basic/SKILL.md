---
name: stream-heaven-data-science-churn-prediction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Churn Prediction (phase 14).
...
- User invokes **Churn Prediction** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/churn-prediction-agent.md`
- **Role:** Churn Prediction Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/churn-prediction-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Churn Prediction deliverables in data-science domain for Stream Heaven Phase 14. (Churn Prediction scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/churn-prediction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/churn-prediction-agent/advanced/SKILL.md`
