---
name: stream-heaven-data-science-ranking-model-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ranking Model (phase 14).
...
- User invokes **Ranking Model** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/ranking-model-agent.md`
- **Role:** Ranking Model Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/ranking-model-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Ranking Model ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Ranking Model scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/ranking-model-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/ranking-model-agent/advanced/SKILL.md`
