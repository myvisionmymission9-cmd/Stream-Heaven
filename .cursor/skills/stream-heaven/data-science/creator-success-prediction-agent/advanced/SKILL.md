---
name: stream-heaven-data-science-creator-success-prediction-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Success Prediction (phase 14).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Creator Success Prediction — Advanced
