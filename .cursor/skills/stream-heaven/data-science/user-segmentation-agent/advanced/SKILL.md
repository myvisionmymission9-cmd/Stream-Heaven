---
name: stream-heaven-data-science-user-segmentation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven User Segmentation (phase 14).
...
Architect:
- Own User Segmentation deliverables in data-science domain for Stream Heaven Phase 14. (User Segmentation scope)
