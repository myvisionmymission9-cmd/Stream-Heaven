---
name: stream-heaven-data-science-audience-clustering-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Audience Clustering (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Audience Clustering — Basic

## When to use

- User invokes **Audience Clustering** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/audience-clustering-agent.md`
- **Role:** Audience Clustering Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/audience-clustering-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/data-science/audience-clustering-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/audience-clustering-agent/advanced/SKILL.md`
