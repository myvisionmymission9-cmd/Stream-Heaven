---
name: stream-heaven-data-science-funnel-analytics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Funnel Analytics (phase 14).
  Single-agent execution with governance prefix and structural validation.
---

# Funnel Analytics — Basic

## When to use

- User invokes **Funnel Analytics** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/funnel-analytics-agent.md`
- **Role:** Funnel Analytics Agent specialist for Stream Heaven's data science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/funnel-analytics-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Funnel Analytics deliverables in data-science domain for Stream Heaven Phase 14. (Funnel Analytics scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/funnel-analytics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/funnel-analytics-agent/advanced/SKILL.md`
