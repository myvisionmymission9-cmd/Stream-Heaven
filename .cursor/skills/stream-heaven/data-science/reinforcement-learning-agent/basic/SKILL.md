---
name: stream-heaven-data-science-reinforcement-learning-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reinforcement Learning (phase 14).
...
- User invokes **Reinforcement Learning** or work in **data-science** (phase 14)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/data-science/reinforcement-learning-agent.md`
- **Role:** Reinforcement Learning Agent specialist for Stream Heaven's data-science domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/data-science/reinforcement-learning-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Reinforcement Learning deliverables in data-science domain for Stream Heaven Phase 14. (Reinforcement Learning scope)
...
- Basic: `.cursor/skills/stream-heaven/data-science/reinforcement-learning-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/data-science/reinforcement-learning-agent/advanced/SKILL.md`
