---
name: stream-heaven-identity-platform-device-identity-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Device Identity (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Device Identity — Basic

## When to use

- User invokes **Device Identity** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/device-identity-agent.md`
- **Role:** Trusted device registry.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/device-identity-agent.md` and copy its `## Prompt Template` block
...
Design:
- device-identity-agent in user-service + shared-contracts/identity/v1. (Device Identity scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/device-identity-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/device-identity-agent/advanced/SKILL.md`
