---
name: stream-heaven-identity-platform-device-identity-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Device Identity (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Device Identity — Advanced
