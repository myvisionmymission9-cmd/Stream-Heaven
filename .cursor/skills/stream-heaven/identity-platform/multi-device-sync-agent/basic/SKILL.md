---
name: stream-heaven-identity-platform-multi-device-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Multi Device Sync (phase 18).
...
- User invokes **Multi Device Sync** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/multi-device-sync-agent.md`
- **Role:** Multi-device login sync.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/multi-device-sync-agent.md` and copy its `## Prompt Template` block
...
Design:
- multi-device-sync-agent in user-service + shared-contracts/identity/v1. (Multi Device Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/multi-device-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/multi-device-sync-agent/advanced/SKILL.md`
