---
name: stream-heaven-identity-platform-identity-graph-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Identity Graph (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Identity Graph — Advanced
