---
name: stream-heaven-identity-platform-universal-user-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Universal User (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Universal User — Advanced
