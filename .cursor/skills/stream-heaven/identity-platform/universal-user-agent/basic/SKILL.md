---
name: stream-heaven-identity-platform-universal-user-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Universal User (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Universal User — Basic

## When to use

- User invokes **Universal User** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/universal-user-agent.md`
- **Role:** Canonical user across all four apps.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/universal-user-agent.md` and copy its `## Prompt Template` block
...
Design:
- universal-user-agent in user-service + shared-contracts/identity/v1. (Universal User scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/universal-user-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/universal-user-agent/advanced/SKILL.md`
