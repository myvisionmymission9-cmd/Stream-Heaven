---
name: stream-heaven-identity-platform-device-trust-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Device Trust (phase 18).
...
- User invokes **Device Trust** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/device-trust-agent.md`
- **Role:** Device Trust Agent specialist for Stream Heaven's identity platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/device-trust-agent.md` and copy its `## Prompt Template` block
...
Build:
- Define moderation policies and enforcement hooks for Device Trust across social and livestream surfaces. (Device Trust scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/device-trust-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/device-trust-agent/advanced/SKILL.md`
