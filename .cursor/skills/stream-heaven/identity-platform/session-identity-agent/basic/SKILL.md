---
name: stream-heaven-identity-platform-session-identity-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Session Identity (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Session Identity — Basic

## When to use

- User invokes **Session Identity** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/session-identity-agent.md`
- **Role:** Session tokens and revocation.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/session-identity-agent.md` and copy its `## Prompt Template` block
...
Design:
- session-identity-agent in user-service + shared-contracts/identity/v1. (Session Identity scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/session-identity-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/session-identity-agent/advanced/SKILL.md`
