---
name: stream-heaven-identity-platform-single-sign-on-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Single Sign On (phase 18).
...
- User invokes **Single Sign On** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/single-sign-on-agent.md`
- **Role:** SSO across apps.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/single-sign-on-agent.md` and copy its `## Prompt Template` block
...
Design:
- single-sign-on-agent in user-service + shared-contracts/identity/v1. (Single Sign On scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/single-sign-on-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/single-sign-on-agent/advanced/SKILL.md`
