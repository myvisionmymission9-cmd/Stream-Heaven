---
name: stream-heaven-identity-platform-identity-resolution-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Identity Resolution (phase 18).
...
- User invokes **Identity Resolution** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/identity-resolution-agent.md`
- **Role:** Duplicate identity resolution.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/identity-resolution-agent.md` and copy its `## Prompt Template` block
...
Design:
- identity-resolution-agent in user-service + shared-contracts/identity/v1. (Identity Resolution scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/identity-resolution-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/identity-resolution-agent/advanced/SKILL.md`
