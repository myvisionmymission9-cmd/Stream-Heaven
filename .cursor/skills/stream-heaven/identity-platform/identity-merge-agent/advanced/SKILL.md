---
name: stream-heaven-identity-platform-identity-merge-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Identity Merge (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Identity Merge — Advanced
