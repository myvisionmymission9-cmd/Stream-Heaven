---
name: stream-heaven-identity-platform-account-linking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Account Linking (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Account Linking — Basic

## When to use

- User invokes **Account Linking** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/account-linking-agent.md`
- **Role:** Link phone, email, OAuth.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/account-linking-agent.md` and copy its `## Prompt Template` block
...
Design:
- account-linking-agent in user-service + shared-contracts/identity/v1. (Account Linking scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/account-linking-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/account-linking-agent/advanced/SKILL.md`
