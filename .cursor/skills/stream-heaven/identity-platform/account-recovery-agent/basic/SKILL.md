---
name: stream-heaven-identity-platform-account-recovery-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Account Recovery (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Account Recovery — Basic

## When to use

- User invokes **Account Recovery** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/account-recovery-agent.md`
- **Role:** Recovery via OTP and backups.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/account-recovery-agent.md` and copy its `## Prompt Template` block
...
Design:
- account-recovery-agent in user-service + shared-contracts/identity/v1. (Account Recovery scope)
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/account-recovery-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/account-recovery-agent/advanced/SKILL.md`
