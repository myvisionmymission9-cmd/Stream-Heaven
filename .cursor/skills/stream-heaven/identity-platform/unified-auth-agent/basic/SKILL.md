---
name: stream-heaven-identity-platform-unified-auth-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Unified Auth (phase 18).
...
- User invokes **Unified Auth** or work in **identity-platform** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/identity-platform/unified-auth-agent.md`
- **Role:** Unified Auth Agent specialist for Stream Heaven's identity platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/identity-platform/unified-auth-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/identity-platform/unified-auth-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/identity-platform/unified-auth-agent/advanced/SKILL.md`
