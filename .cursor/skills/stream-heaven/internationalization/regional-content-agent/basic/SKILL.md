---
name: stream-heaven-internationalization-regional-content-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Regional Content (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Regional Content — Basic

## When to use

- User invokes **Regional Content** or work in **internationalization** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/internationalization/regional-content-agent.md`
- **Role:** Regional Content Agent specialist for Stream Heaven's internationalization domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/internationalization/regional-content-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/internationalization/regional-content-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/internationalization/regional-content-agent/advanced/SKILL.md`
