---
name: stream-heaven-internationalization-rtl-layout-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Rtl Layout (phase 20).
...
- User invokes **Rtl Layout** or work in **internationalization** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/internationalization/rtl-layout-agent.md`
- **Role:** Rtl Layout Agent specialist for Stream Heaven's internationalization domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/internationalization/rtl-layout-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Rtl Layout deliverables in internationalization domain for Stream Heaven Phase 20. (Rtl Layout scope)
...
- Basic: `.cursor/skills/stream-heaven/internationalization/rtl-layout-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/internationalization/rtl-layout-agent/advanced/SKILL.md`
