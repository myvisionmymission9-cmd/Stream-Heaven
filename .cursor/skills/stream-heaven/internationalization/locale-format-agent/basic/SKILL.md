---
name: stream-heaven-internationalization-locale-format-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Locale Format (phase 20).
...
- User invokes **Locale Format** or work in **internationalization** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/internationalization/locale-format-agent.md`
- **Role:** Locale Format Agent specialist for Stream Heaven's internationalization domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/internationalization/locale-format-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/internationalization/locale-format-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/internationalization/locale-format-agent/advanced/SKILL.md`
