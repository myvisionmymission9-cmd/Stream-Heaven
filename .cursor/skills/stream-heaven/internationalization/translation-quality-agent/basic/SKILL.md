---
name: stream-heaven-internationalization-translation-quality-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Translation Quality (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Translation Quality — Basic

## When to use

- User invokes **Translation Quality** or work in **internationalization** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/internationalization/translation-quality-agent.md`
- **Role:** Translation Quality Agent specialist for Stream Heaven's internationalization domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/internationalization/translation-quality-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Translation Quality deliverables in internationalization domain for Stream Heaven Phase 20. (Translation Quality scope)
...
- Basic: `.cursor/skills/stream-heaven/internationalization/translation-quality-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/internationalization/translation-quality-agent/advanced/SKILL.md`
