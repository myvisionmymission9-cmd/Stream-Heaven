---
name: stream-heaven-internationalization-localization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Localization (phase 20).
...
- User invokes **Localization** or work in **internationalization** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/internationalization/localization-agent.md`
- **Role:** Localization Agent specialist for Stream Heaven's internationalization domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/internationalization/localization-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Localization deliverables in internationalization domain for Stream Heaven Phase 20. (Localization scope)
...
- Basic: `.cursor/skills/stream-heaven/internationalization/localization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/internationalization/localization-agent/advanced/SKILL.md`
