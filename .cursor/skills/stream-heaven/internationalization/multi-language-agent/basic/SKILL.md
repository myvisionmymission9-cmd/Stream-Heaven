---
name: stream-heaven-internationalization-multi-language-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Multi Language (phase 20).
...
- User invokes **Multi Language** or work in **internationalization** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/internationalization/multi-language-agent.md`
- **Role:** Multi Language Agent specialist for Stream Heaven's internationalization domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/internationalization/multi-language-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Multi Language deliverables in internationalization domain for Stream Heaven Phase 20. (Multi Language scope)
...
- Basic: `.cursor/skills/stream-heaven/internationalization/multi-language-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/internationalization/multi-language-agent/advanced/SKILL.md`
