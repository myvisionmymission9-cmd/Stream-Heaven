---
name: stream-heaven-community-governance-community-leader-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Community Leader (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Community Leader — Basic

## When to use

- User invokes **Community Leader** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/community-leader-agent.md`
- **Role:** Community Leader Agent specialist for Stream Heaven's community governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/community-leader-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Own Community Leader deliverables in community-governance domain for Stream Heaven Phase 20. (Community Leader scope)
...
- Basic: `.cursor/skills/stream-heaven/community-governance/community-leader-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/community-governance/community-leader-agent/advanced/SKILL.md`
