---
name: stream-heaven-community-governance-host-behavior-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Host Behavior (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Host Behavior — Advanced
