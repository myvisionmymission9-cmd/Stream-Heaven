---
name: stream-heaven-community-governance-host-behavior-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Host Behavior (phase 20).
...
- User invokes **Host Behavior** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/host-behavior-agent.md`
- **Role:** Host Behavior Agent specialist for Stream Heaven's community-governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/host-behavior-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Own Host Behavior deliverables in community-governance domain for Stream Heaven Phase 20. (Host Behavior scope)
...
- Basic: `.cursor/skills/stream-heaven/community-governance/host-behavior-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/community-governance/host-behavior-agent/advanced/SKILL.md`
