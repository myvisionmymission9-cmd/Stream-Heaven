---
name: stream-heaven-community-governance-shadow-ban-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Shadow Ban (phase 20).
...
- User invokes **Shadow Ban** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/shadow-ban-agent.md`
- **Role:** Shadow Ban Agent specialist for Stream Heaven's community governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/shadow-ban-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Own Shadow Ban deliverables in community-governance domain for Stream Heaven Phase 20. (Shadow Ban scope)
