---
name: stream-heaven-community-governance-toxicity-monitor-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Toxicity Monitor (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Toxicity Monitor — Advanced
