---
name: stream-heaven-community-governance-toxicity-monitor-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Toxicity Monitor (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Toxicity Monitor — Basic

## When to use

- User invokes **Toxicity Monitor** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/toxicity-monitor-agent.md`
- **Role:** Toxicity Monitor Agent specialist for Stream Heaven's community-governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/toxicity-monitor-agent.md` and copy its `## Prompt Template` block
