---
name: stream-heaven-community-governance-appeals-system-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Appeals System (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Appeals System — Advanced
...
Design:
- Own Appeals System deliverables in community-governance domain for Stream Heaven Phase 20. (Appeals System scope)
