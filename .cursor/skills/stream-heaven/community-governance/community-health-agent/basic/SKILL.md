---
name: stream-heaven-community-governance-community-health-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Community Health (phase 20).
...
- User invokes **Community Health** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/community-health-agent.md`
- **Role:** Community Health Agent specialist for Stream Heaven's community-governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/community-health-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Own Community Health deliverables in community-governance domain for Stream Heaven Phase 20. (Community Health scope)
...
- Basic: `.cursor/skills/stream-heaven/community-governance/community-health-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/community-governance/community-health-agent/advanced/SKILL.md`
