---
name: stream-heaven-community-governance-creator-policy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Policy (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Policy — Basic

## When to use

- User invokes **Creator Policy** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/creator-policy-agent.md`
- **Role:** Creator Policy Agent specialist for Stream Heaven's community-governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/creator-policy-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Audit Creator Policy work against platform-governance/ docs before implementation or merge approval. (Creator Policy scope)
