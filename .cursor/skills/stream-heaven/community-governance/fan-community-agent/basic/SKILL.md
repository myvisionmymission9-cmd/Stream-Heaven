---
name: stream-heaven-community-governance-fan-community-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Fan Community (phase 20).
...
- User invokes **Fan Community** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/fan-community-agent.md`
- **Role:** Fan Community Agent specialist for Stream Heaven's community-governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/fan-community-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Own Fan Community deliverables in community-governance domain for Stream Heaven Phase 20. (Fan Community scope)
...
- Basic: `.cursor/skills/stream-heaven/community-governance/fan-community-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/community-governance/fan-community-agent/advanced/SKILL.md`
