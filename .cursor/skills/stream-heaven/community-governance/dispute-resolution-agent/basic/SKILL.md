---
name: stream-heaven-community-governance-dispute-resolution-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Dispute Resolution (phase 20).
...
- User invokes **Dispute Resolution** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/dispute-resolution-agent.md`
- **Role:** Dispute Resolution Agent specialist for Stream Heaven's community-governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/dispute-resolution-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Own Dispute Resolution deliverables in community-governance domain for Stream Heaven Phase 20. (Dispute Resolution scope)
...
- Basic: `.cursor/skills/stream-heaven/community-governance/dispute-resolution-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/community-governance/dispute-resolution-agent/advanced/SKILL.md`
