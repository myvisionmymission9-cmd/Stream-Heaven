---
name: stream-heaven-community-governance-appeal-review-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Appeal Review (phase 20).
...
- User invokes **Appeal Review** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/appeal-review-agent.md`
- **Role:** Appeal Review Agent specialist for Stream Heaven's community governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/appeal-review-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/community-governance/appeal-review-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/community-governance/appeal-review-agent/advanced/SKILL.md`
