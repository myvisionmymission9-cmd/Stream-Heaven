---
name: stream-heaven-community-governance-community-guidelines-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Community Guidelines (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Community Guidelines — Basic

## When to use

- User invokes **Community Guidelines** or work in **community-governance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/community-governance/community-guidelines-agent.md`
- **Role:** Community Guidelines Agent specialist for Stream Heaven's community governance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/community-governance/community-guidelines-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Own Community Guidelines deliverables in community-governance domain for Stream Heaven Phase 20. (Community Guidelines scope)
...
- Basic: `.cursor/skills/stream-heaven/community-governance/community-guidelines-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/community-governance/community-guidelines-agent/advanced/SKILL.md`
