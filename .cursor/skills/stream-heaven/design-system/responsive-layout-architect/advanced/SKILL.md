---
name: stream-heaven-design-system-responsive-layout-architect-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Responsive Layout Architect (phase 6).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Responsive Layout Architect — Advanced
