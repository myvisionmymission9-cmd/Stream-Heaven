---
name: stream-heaven-design-system-responsive-layout-architect-basic
description: >-
  Basic Cursor skill for Stream Heaven Responsive Layout Architect (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Responsive Layout Architect — Basic

## When to use

- User invokes **Responsive Layout Architect** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/responsive-layout-architect.md`
- **Role:** Responsive Layout Architect specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/responsive-layout-architect.md` and copy its `## Prompt Template` block
...
Define:
- Own Responsive Layout deliverables in design-system domain for Stream Heaven Phase 6. (Responsive Layout Architect scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/responsive-layout-architect/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/responsive-layout-architect/advanced/SKILL.md`
