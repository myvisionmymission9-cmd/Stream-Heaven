---
name: stream-heaven-design-system-micro-interactions-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Micro Interactions (phase 6).
...
- User invokes **Micro Interactions** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/micro-interactions-agent.md`
- **Role:** Micro Interactions Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/micro-interactions-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Micro Interactions deliverables in design-system domain for Stream Heaven Phase 6. (Micro Interactions scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/micro-interactions-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/micro-interactions-agent/advanced/SKILL.md`
