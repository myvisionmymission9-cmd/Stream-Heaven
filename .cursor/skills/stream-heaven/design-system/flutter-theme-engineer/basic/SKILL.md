---
name: stream-heaven-design-system-flutter-theme-engineer-basic
description: >-
  Basic Cursor skill for Stream Heaven Flutter Theme Engineer (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Flutter Theme Engineer — Basic

## When to use

- User invokes **Flutter Theme Engineer** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/flutter-theme-engineer.md`
- **Role:** Flutter Theme Engineer specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/flutter-theme-engineer.md` and copy its `## Prompt Template` block
...
Define:
- Implement Flutter Theme in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Flutter Theme Engineer scope)
