---
name: stream-heaven-design-system-motion-design-lead-basic
description: >-
  Basic Cursor skill for Stream Heaven Motion Design Lead (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Motion Design Lead — Basic

## When to use

- User invokes **Motion Design Lead** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/motion-design-lead.md`
- **Role:** Motion Design Lead specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/motion-design-lead.md` and copy its `## Prompt Template` block
...
Define:
- Own Motion Design deliverables in design-system domain for Stream Heaven Phase 6. (Motion Design Lead scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/motion-design-lead/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/motion-design-lead/advanced/SKILL.md`
