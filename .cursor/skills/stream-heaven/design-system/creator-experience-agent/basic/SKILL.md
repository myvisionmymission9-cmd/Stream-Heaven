---
name: stream-heaven-design-system-creator-experience-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Experience (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Experience — Basic

## When to use

- User invokes **Creator Experience** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/creator-experience-agent.md`
- **Role:** Creator Experience Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/creator-experience-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/design-system/creator-experience-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/creator-experience-agent/advanced/SKILL.md`
