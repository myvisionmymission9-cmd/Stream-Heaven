---
name: stream-heaven-design-system-design-director-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Design Director (phase 6).
...
- User invokes **Design Director** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/design-director-agent.md`
- **Role:** Design Director Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/design-director-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/design-system/design-director-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/design-director-agent/advanced/SKILL.md`
