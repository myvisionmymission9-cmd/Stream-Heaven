---
name: stream-heaven-design-system-design-director-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Design Director (phase 6).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Design Director — Advanced
