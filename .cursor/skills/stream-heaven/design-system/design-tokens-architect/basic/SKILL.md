---
name: stream-heaven-design-system-design-tokens-architect-basic
description: >-
  Basic Cursor skill for Stream Heaven Design Tokens Architect (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Design Tokens Architect — Basic

## When to use

- User invokes **Design Tokens Architect** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/design-tokens-architect.md`
- **Role:** Design Tokens Architect specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/design-tokens-architect.md` and copy its `## Prompt Template` block
...
Define:
- Own Design Tokens deliverables in design-system domain for Stream Heaven Phase 6. (Design Tokens Architect scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/design-tokens-architect/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/design-tokens-architect/advanced/SKILL.md`
