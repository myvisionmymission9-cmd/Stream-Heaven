---
name: stream-heaven-design-system-color-system-curator-basic
description: >-
  Basic Cursor skill for Stream Heaven Color System Curator (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Color System Curator — Basic

## When to use

- User invokes **Color System Curator** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/color-system-curator.md`
- **Role:** Color System Curator specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/color-system-curator.md` and copy its `## Prompt Template` block
...
Define:
- Own Color System deliverables in design-system domain for Stream Heaven Phase 6. (Color System Curator scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/color-system-curator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/color-system-curator/advanced/SKILL.md`
