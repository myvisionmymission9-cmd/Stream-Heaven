---
name: stream-heaven-design-system-brand-consistency-guardian-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Brand Consistency Guardian (phase 6).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Brand Consistency Guardian — Advanced
