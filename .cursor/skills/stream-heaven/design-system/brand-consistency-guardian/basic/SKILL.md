---
name: stream-heaven-design-system-brand-consistency-guardian-basic
description: >-
  Basic Cursor skill for Stream Heaven Brand Consistency Guardian (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Brand Consistency Guardian — Basic

## When to use

- User invokes **Brand Consistency Guardian** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/brand-consistency-guardian.md`
- **Role:** Brand Consistency Guardian specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/brand-consistency-guardian.md` and copy its `## Prompt Template` block
...
Define:
- Own Brand Consistency deliverables in design-system domain for Stream Heaven Phase 6. (Brand Consistency Guardian scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/brand-consistency-guardian/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/brand-consistency-guardian/advanced/SKILL.md`
