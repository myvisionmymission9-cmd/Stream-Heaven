---
name: stream-heaven-design-system-component-library-lead-basic
description: >-
  Basic Cursor skill for Stream Heaven Component Library Lead (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Component Library Lead — Basic

## When to use

- User invokes **Component Library Lead** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/component-library-lead.md`
- **Role:** Component Library Lead specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/component-library-lead.md` and copy its `## Prompt Template` block
...
Define:
- Own Component Library deliverables in design-system domain for Stream Heaven Phase 6. (Component Library Lead scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/component-library-lead/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/component-library-lead/advanced/SKILL.md`
