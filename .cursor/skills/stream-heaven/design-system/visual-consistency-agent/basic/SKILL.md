---
name: stream-heaven-design-system-visual-consistency-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Visual Consistency (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Visual Consistency — Basic

## When to use

- User invokes **Visual Consistency** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/visual-consistency-agent.md`
- **Role:** Visual Consistency Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/visual-consistency-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Visual Consistency deliverables in design-system domain for Stream Heaven Phase 6. (Visual Consistency scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/visual-consistency-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/visual-consistency-agent/advanced/SKILL.md`
