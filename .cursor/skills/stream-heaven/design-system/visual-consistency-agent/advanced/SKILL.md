---
name: stream-heaven-design-system-visual-consistency-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Visual Consistency (phase 6).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Visual Consistency — Advanced
