---
name: stream-heaven-design-system-figma-sync-coordinator-basic
description: >-
  Basic Cursor skill for Stream Heaven Figma Sync Coordinator (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Figma Sync Coordinator — Basic
...
- Open agent: `ai-agents/design-system/figma-sync-coordinator.md` and copy its `## Prompt Template` block
...
Define:
- Design and implement design system capabilities for Stream Heaven. (Figma Sync Coordinator scope)
