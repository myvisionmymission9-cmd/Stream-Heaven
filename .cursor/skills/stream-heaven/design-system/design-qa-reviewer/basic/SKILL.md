---
name: stream-heaven-design-system-design-qa-reviewer-basic
description: >-
  Basic Cursor skill for Stream Heaven Design Qa Reviewer (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Design Qa Reviewer — Basic

## When to use

- User invokes **Design Qa Reviewer** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/design-qa-reviewer.md`
- **Role:** Design Qa Reviewer specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/design-qa-reviewer.md` and copy its `## Prompt Template` block
