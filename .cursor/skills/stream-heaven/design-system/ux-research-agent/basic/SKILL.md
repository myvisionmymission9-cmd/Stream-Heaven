---
name: stream-heaven-design-system-ux-research-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ux Research (phase 6).
...
- User invokes **Ux Research** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/ux-research-agent.md`
- **Role:** Ux Research Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/ux-research-agent.md` and copy its `## Prompt Template` block
...
### Indexing Pipeline
Build:
- Own Ux Research deliverables in design-system domain for Stream Heaven Phase 6. (Ux Research scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/ux-research-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/ux-research-agent/advanced/SKILL.md`
