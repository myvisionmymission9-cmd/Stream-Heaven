---
name: stream-heaven-design-system-design-system-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Design System (phase 6).
...
Architect:
- Design and implement design system capabilities for Stream Heaven. (Design System scope)
