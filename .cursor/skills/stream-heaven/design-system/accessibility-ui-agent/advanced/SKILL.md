---
name: stream-heaven-design-system-accessibility-ui-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Accessibility Ui (phase 6).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Accessibility Ui — Advanced
