---
name: stream-heaven-design-system-accessibility-ui-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Accessibility Ui (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Accessibility Ui — Basic

## When to use

- User invokes **Accessibility Ui** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/accessibility-ui-agent.md`
- **Role:** Accessibility Ui Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/accessibility-ui-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Accessibility Ui deliverables in design-system domain for Stream Heaven Phase 6. (Accessibility Ui scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/accessibility-ui-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/accessibility-ui-agent/advanced/SKILL.md`
