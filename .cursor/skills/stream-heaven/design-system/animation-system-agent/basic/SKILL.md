---
name: stream-heaven-design-system-animation-system-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Animation System (phase 6).
...
- User invokes **Animation System** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/animation-system-agent.md`
- **Role:** Animation System Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/animation-system-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/design-system/animation-system-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/animation-system-agent/advanced/SKILL.md`
