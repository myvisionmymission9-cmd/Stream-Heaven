---
name: stream-heaven-design-system-dark-mode-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Dark Mode Specialist (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Dark Mode Specialist — Basic

## When to use

- User invokes **Dark Mode Specialist** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/dark-mode-specialist.md`
- **Role:** Dark Mode Specialist specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/dark-mode-specialist.md` and copy its `## Prompt Template` block
...
Define:
- Own Dark Mode deliverables in design-system domain for Stream Heaven Phase 6. (Dark Mode Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/dark-mode-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/dark-mode-specialist/advanced/SKILL.md`
