---
name: stream-heaven-design-system-dark-mode-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Dark Mode Specialist (phase 6).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Dark Mode Specialist — Advanced
