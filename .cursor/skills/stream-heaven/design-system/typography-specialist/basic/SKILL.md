---
name: stream-heaven-design-system-typography-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Typography Specialist (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Typography Specialist — Basic

## When to use

- User invokes **Typography Specialist** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/typography-specialist.md`
- **Role:** Typography Specialist specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/typography-specialist.md` and copy its `## Prompt Template` block
...
Define:
- Own Typography deliverables in design-system domain for Stream Heaven Phase 6. (Typography Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/typography-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/typography-specialist/advanced/SKILL.md`
