---
name: stream-heaven-design-system-accessibility-auditor-basic
description: >-
  Basic Cursor skill for Stream Heaven Accessibility Auditor (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Accessibility Auditor — Basic

## When to use

- User invokes **Accessibility Auditor** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/accessibility-auditor.md`
- **Role:** Accessibility Auditor specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/accessibility-auditor.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement design system capabilities for Stream Heaven. (Accessibility Auditor scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/accessibility-auditor/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/accessibility-auditor/advanced/SKILL.md`
