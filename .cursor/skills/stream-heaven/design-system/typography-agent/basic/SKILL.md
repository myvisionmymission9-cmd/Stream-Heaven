---
name: stream-heaven-design-system-typography-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Typography (phase 6).
...
- User invokes **Typography** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/typography-agent.md`
- **Role:** Typography Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/typography-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Typography deliverables in design-system domain for Stream Heaven Phase 6. (Typography scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/typography-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/typography-agent/advanced/SKILL.md`
