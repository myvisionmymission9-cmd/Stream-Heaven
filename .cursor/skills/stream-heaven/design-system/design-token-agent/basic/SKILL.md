---
name: stream-heaven-design-system-design-token-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Design Token (phase 6).
...
- User invokes **Design Token** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/design-token-agent.md`
- **Role:** Design Token Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/design-token-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Design Token deliverables in design-system domain for Stream Heaven Phase 6. (Design Token scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/design-token-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/design-token-agent/advanced/SKILL.md`
