---
name: stream-heaven-design-system-localization-ui-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Localization Ui Specialist (phase 6).
  Single-agent execution with governance prefix and structural validation.
---

# Localization Ui Specialist — Basic

## When to use

- User invokes **Localization Ui Specialist** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/localization-ui-specialist.md`
- **Role:** Localization Ui Specialist specialist for Stream Heaven's design system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/localization-ui-specialist.md` and copy its `## Prompt Template` block
...
Define:
- Own Localization Ui deliverables in design-system domain for Stream Heaven Phase 6. (Localization Ui Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/localization-ui-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/localization-ui-specialist/advanced/SKILL.md`
