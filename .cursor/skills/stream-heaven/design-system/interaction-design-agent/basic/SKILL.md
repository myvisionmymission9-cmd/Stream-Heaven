---
name: stream-heaven-design-system-interaction-design-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Interaction Design (phase 6).
...
- User invokes **Interaction Design** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/interaction-design-agent.md`
- **Role:** Interaction Design Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/interaction-design-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Interaction Design deliverables in design-system domain for Stream Heaven Phase 6. (Interaction Design scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/interaction-design-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/interaction-design-agent/advanced/SKILL.md`
