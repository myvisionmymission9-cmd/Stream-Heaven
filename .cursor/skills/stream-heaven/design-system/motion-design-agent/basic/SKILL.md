---
name: stream-heaven-design-system-motion-design-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Motion Design (phase 6).
...
- User invokes **Motion Design** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/motion-design-agent.md`
- **Role:** Motion Design Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/motion-design-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Motion Design deliverables in design-system domain for Stream Heaven Phase 6. (Motion Design scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/motion-design-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/motion-design-agent/advanced/SKILL.md`
