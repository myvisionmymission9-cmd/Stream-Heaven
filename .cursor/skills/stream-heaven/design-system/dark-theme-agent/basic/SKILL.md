---
name: stream-heaven-design-system-dark-theme-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Dark Theme (phase 6).
...
- User invokes **Dark Theme** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/dark-theme-agent.md`
- **Role:** Dark Theme Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/dark-theme-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Dark Theme deliverables in design-system domain for Stream Heaven Phase 6. (Dark Theme scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/dark-theme-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/dark-theme-agent/advanced/SKILL.md`
