---
name: stream-heaven-design-system-mobile-navigation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Mobile Navigation (phase 6).
...
- User invokes **Mobile Navigation** or work in **design-system** (phase 6)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/design-system/mobile-navigation-agent.md`
- **Role:** Mobile Navigation Agent specialist for Stream Heaven's design-system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/design-system/mobile-navigation-agent.md` and copy its `## Prompt Template` block
...
Define:
- Own Mobile Navigation deliverables in design-system domain for Stream Heaven Phase 6. (Mobile Navigation scope)
...
- Basic: `.cursor/skills/stream-heaven/design-system/mobile-navigation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/design-system/mobile-navigation-agent/advanced/SKILL.md`
