---
name: stream-heaven-event-system-pubsub-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Pubsub (phase 18).
...
- User invokes **Pubsub** or work in **event-system** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/event-system/pubsub-agent.md`
- **Role:** Pub/sub cross-service notify.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/event-system/pubsub-agent.md` and copy its `## Prompt Template` block
...
Design:
- pubsub-agent validated by event-schema-guardian. (Pubsub scope)
...
- Basic: `.cursor/skills/stream-heaven/event-system/pubsub-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/event-system/pubsub-agent/advanced/SKILL.md`
