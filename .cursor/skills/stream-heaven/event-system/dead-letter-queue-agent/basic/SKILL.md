---
name: stream-heaven-event-system-dead-letter-queue-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Dead Letter Queue (phase 18).
...
- User invokes **Dead Letter Queue** or work in **event-system** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/event-system/dead-letter-queue-agent.md`
- **Role:** DLQ inspect, replay, alert.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/event-system/dead-letter-queue-agent.md` and copy its `## Prompt Template` block
...
Design:
- dead-letter-queue-agent validated by event-schema-guardian. (Dead Letter Queue scope)
...
- Basic: `.cursor/skills/stream-heaven/event-system/dead-letter-queue-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/event-system/dead-letter-queue-agent/advanced/SKILL.md`
