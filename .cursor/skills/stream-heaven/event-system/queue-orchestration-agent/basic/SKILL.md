---
name: stream-heaven-event-system-queue-orchestration-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Queue Orchestration (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Queue Orchestration — Basic
...
- Open agent: `ai-agents/event-system/queue-orchestration-agent.md` and copy its `## Prompt Template` block
