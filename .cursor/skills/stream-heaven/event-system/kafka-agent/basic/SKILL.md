---
name: stream-heaven-event-system-kafka-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Kafka (phase 18).
...
- User invokes **Kafka** or work in **event-system** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/event-system/kafka-agent.md`
- **Role:** Kafka topics and retention.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/event-system/kafka-agent.md` and copy its `## Prompt Template` block
...
Design:
- kafka-agent validated by event-schema-guardian. (Kafka scope)
...
- Basic: `.cursor/skills/stream-heaven/event-system/kafka-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/event-system/kafka-agent/advanced/SKILL.md`
