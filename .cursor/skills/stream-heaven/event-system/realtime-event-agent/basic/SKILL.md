---
name: stream-heaven-event-system-realtime-event-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Realtime Event (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Realtime Event — Basic

## When to use

- User invokes **Realtime Event** or work in **event-system** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/event-system/realtime-event-agent.md`
- **Role:** Bridge to Socket.IO fanout.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/event-system/realtime-event-agent.md` and copy its `## Prompt Template` block
...
Design:
- realtime-event-agent validated by event-schema-guardian. (Realtime Event scope)
...
- Basic: `.cursor/skills/stream-heaven/event-system/realtime-event-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/event-system/realtime-event-agent/advanced/SKILL.md`
