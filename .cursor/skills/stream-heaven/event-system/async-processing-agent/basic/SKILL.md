---
name: stream-heaven-event-system-async-processing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Async Processing (phase 18).
...
- User invokes **Async Processing** or work in **event-system** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/event-system/async-processing-agent.md`
- **Role:** Async workers and idempotency.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/event-system/async-processing-agent.md` and copy its `## Prompt Template` block
...
Design:
- async-processing-agent validated by event-schema-guardian. (Async Processing scope)
...
- Basic: `.cursor/skills/stream-heaven/event-system/async-processing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/event-system/async-processing-agent/advanced/SKILL.md`
