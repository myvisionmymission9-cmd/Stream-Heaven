---
name: stream-heaven-event-system-dead-letter-handler-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Dead Letter Handler (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Dead Letter Handler — Advanced
