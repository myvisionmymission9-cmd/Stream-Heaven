---
name: stream-heaven-event-system-dead-letter-handler-basic
description: >-
  Basic Cursor skill for Stream Heaven Dead Letter Handler (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Dead Letter Handler — Basic

## When to use

- User invokes **Dead Letter Handler** or work in **event-system** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/event-system/dead-letter-handler.md`
- **Role:** Dead Letter Handler specialist for Stream Heaven's event system domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/event-system/dead-letter-handler.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement event system capabilities for Stream Heaven. (Dead Letter Handler scope)
...
- Basic: `.cursor/skills/stream-heaven/event-system/dead-letter-handler/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/event-system/dead-letter-handler/advanced/SKILL.md`
