---
name: stream-heaven-event-system-event-replay-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Event Replay (phase 18).
...
Scale:
- Design and implement event system capabilities for Stream Heaven. (Event Replay scope)
