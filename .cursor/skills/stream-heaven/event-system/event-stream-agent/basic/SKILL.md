---
name: stream-heaven-event-system-event-stream-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Event Stream (phase 18).
...
- User invokes **Event Stream** or work in **event-system** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/event-system/event-stream-agent.md`
- **Role:** Event streaming backbone.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/event-system/event-stream-agent.md` and copy its `## Prompt Template` block
...
Design:
- event-stream-agent validated by event-schema-guardian. (Event Stream scope)
...
- Basic: `.cursor/skills/stream-heaven/event-system/event-stream-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/event-system/event-stream-agent/advanced/SKILL.md`
