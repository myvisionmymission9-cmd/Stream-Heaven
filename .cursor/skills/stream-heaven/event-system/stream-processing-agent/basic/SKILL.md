---
name: stream-heaven-event-system-stream-processing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Stream Processing (phase 18).
...
- User invokes **Stream Processing** or work in **event-system** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/event-system/stream-processing-agent.md`
- **Role:** Windowed stream aggregates.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/event-system/stream-processing-agent.md` and copy its `## Prompt Template` block
...
Design:
- stream-processing-agent validated by event-schema-guardian. (Stream Processing scope)
...
- Basic: `.cursor/skills/stream-heaven/event-system/stream-processing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/event-system/stream-processing-agent/advanced/SKILL.md`
