---
name: stream-heaven-event-system-event-schema-guardian-basic
description: >-
  Basic Cursor skill for Stream Heaven Event Schema Guardian (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Event Schema Guardian — Basic
...
- Open agent: `ai-agents/event-system/event-schema-guardian.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement event system capabilities for Stream Heaven. (Event Schema Guardian scope)
