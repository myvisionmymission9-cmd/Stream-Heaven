---
name: stream-heaven-founder-war-room-runway-calculator-basic
description: >-
  Basic Cursor skill for Stream Heaven Runway Calculator (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Runway Calculator — Basic

## When to use

- User invokes **Runway Calculator** or work in **founder-war-room** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/founder-war-room/runway-calculator.md`
- **Role:** Runway Calculator specialist for Stream Heaven's founder war room domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/founder-war-room/runway-calculator.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement founder war room capabilities for Stream Heaven. (Runway Calculator scope)
