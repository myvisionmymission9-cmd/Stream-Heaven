---
name: stream-heaven-founder-war-room-fundraise-deck-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Fundraise Deck (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Fundraise Deck — Advanced
