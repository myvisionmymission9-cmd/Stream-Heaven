---
name: stream-heaven-founder-war-room-fundraise-deck-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Fundraise Deck (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Fundraise Deck — Basic

## When to use

- User invokes **Fundraise Deck** or work in **founder-war-room** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/founder-war-room/fundraise-deck-agent.md`
- **Role:** Fundraise Deck Agent specialist for Stream Heaven's founder war room domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/founder-war-room/fundraise-deck-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Own Fundraise Deck deliverables in founder-war-room domain for Stream Heaven Phase 20. (Fundraise Deck scope)
...
- Basic: `.cursor/skills/stream-heaven/founder-war-room/fundraise-deck-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/founder-war-room/fundraise-deck-agent/advanced/SKILL.md`
