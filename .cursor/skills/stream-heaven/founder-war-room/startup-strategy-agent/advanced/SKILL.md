---
name: stream-heaven-founder-war-room-startup-strategy-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Startup Strategy (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Startup Strategy — Advanced
