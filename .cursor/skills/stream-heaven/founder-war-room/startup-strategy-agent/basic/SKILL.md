---
name: stream-heaven-founder-war-room-startup-strategy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Startup Strategy (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Startup Strategy — Basic

## When to use

- User invokes **Startup Strategy** or work in **founder-war-room** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/founder-war-room/startup-strategy-agent.md`
- **Role:** Startup Strategy Agent specialist for Stream Heaven's founder-war-room domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/founder-war-room/startup-strategy-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Startup Strategy across Social, Livestream, Astro, and Media strategic priorities. (Startup Strategy scope)
...
- Basic: `.cursor/skills/stream-heaven/founder-war-room/startup-strategy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/founder-war-room/startup-strategy-agent/advanced/SKILL.md`
