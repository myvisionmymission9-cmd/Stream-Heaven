---
name: stream-heaven-founder-war-room-competitive-landscape-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Competitive Landscape (phase 20).
...
- User invokes **Competitive Landscape** or work in **founder-war-room** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/founder-war-room/competitive-landscape-agent.md`
- **Role:** Competitive Landscape Agent specialist for Stream Heaven's founder war room domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/founder-war-room/competitive-landscape-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Own Competitive Landscape deliverables in founder-war-room domain for Stream Heaven Phase 20. (Competitive Landscape scope)
...
- Basic: `.cursor/skills/stream-heaven/founder-war-room/competitive-landscape-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/founder-war-room/competitive-landscape-agent/advanced/SKILL.md`
