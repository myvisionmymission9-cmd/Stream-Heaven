---
name: stream-heaven-founder-war-room-competitive-war-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Competitive War (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Competitive War — Basic

## When to use

- User invokes **Competitive War** or work in **founder-war-room** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/founder-war-room/competitive-war-agent.md`
- **Role:** Competitive War Agent specialist for Stream Heaven's founder-war-room domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/founder-war-room/competitive-war-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/founder-war-room/competitive-war-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/founder-war-room/competitive-war-agent/advanced/SKILL.md`
