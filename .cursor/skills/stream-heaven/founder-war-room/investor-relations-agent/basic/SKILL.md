---
name: stream-heaven-founder-war-room-investor-relations-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Investor Relations (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Investor Relations — Basic

## When to use

- User invokes **Investor Relations** or work in **founder-war-room** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/founder-war-room/investor-relations-agent.md`
- **Role:** Investor Relations Agent specialist for Stream Heaven's founder-war-room domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/founder-war-room/investor-relations-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Own Investor Relations deliverables in founder-war-room domain for Stream Heaven Phase 20. (Investor Relations scope)
...
- Basic: `.cursor/skills/stream-heaven/founder-war-room/investor-relations-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/founder-war-room/investor-relations-agent/advanced/SKILL.md`
