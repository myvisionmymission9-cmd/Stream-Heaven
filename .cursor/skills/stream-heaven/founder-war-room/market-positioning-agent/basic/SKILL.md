---
name: stream-heaven-founder-war-room-market-positioning-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Market Positioning (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Market Positioning — Basic
...
- Open agent: `ai-agents/founder-war-room/market-positioning-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Design and implement founder war room capabilities for Stream Heaven. (Market Positioning scope)
