---
name: stream-heaven-founder-war-room-growth-roadmap-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Growth Roadmap (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Growth Roadmap — Advanced
