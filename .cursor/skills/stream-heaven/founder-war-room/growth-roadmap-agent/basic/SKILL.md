---
name: stream-heaven-founder-war-room-growth-roadmap-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Growth Roadmap (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Growth Roadmap — Basic

## When to use

- User invokes **Growth Roadmap** or work in **founder-war-room** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/founder-war-room/growth-roadmap-agent.md`
- **Role:** Growth Roadmap Agent specialist for Stream Heaven's founder-war-room domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/founder-war-room/growth-roadmap-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/founder-war-room/growth-roadmap-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/founder-war-room/growth-roadmap-agent/advanced/SKILL.md`
