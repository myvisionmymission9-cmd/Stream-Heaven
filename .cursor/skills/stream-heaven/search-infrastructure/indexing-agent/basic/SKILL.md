---
name: stream-heaven-search-infrastructure-indexing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Indexing (phase 20).
...
- User invokes **Indexing** or work in **search-infrastructure** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/search-infrastructure/indexing-agent.md`
- **Role:** Indexing Agent specialist for Stream Heaven's search-infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/search-infrastructure/indexing-agent.md` and copy its `## Prompt Template` block
...
### Indexing Pipeline
Build:
- Design Indexing ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Indexing scope)
...
- Basic: `.cursor/skills/stream-heaven/search-infrastructure/indexing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/search-infrastructure/indexing-agent/advanced/SKILL.md`
