---
name: stream-heaven-search-infrastructure-autocomplete-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Autocomplete (phase 20).
...
- User invokes **Autocomplete** or work in **search-infrastructure** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/search-infrastructure/autocomplete-agent.md`
- **Role:** Autocomplete Agent specialist for Stream Heaven's search infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/search-infrastructure/autocomplete-agent.md` and copy its `## Prompt Template` block
...
### Indexing Pipeline
Build:
- Design Autocomplete ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Autocomplete scope)
...
- Basic: `.cursor/skills/stream-heaven/search-infrastructure/autocomplete-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/search-infrastructure/autocomplete-agent/advanced/SKILL.md`
