---
name: stream-heaven-search-infrastructure-elasticsearch-admin-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Elasticsearch Admin (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Elasticsearch Admin — Basic

## When to use

- User invokes **Elasticsearch Admin** or work in **search-infrastructure** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/search-infrastructure/elasticsearch-admin-agent.md`
- **Role:** Elasticsearch Admin Agent specialist for Stream Heaven's search infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/search-infrastructure/elasticsearch-admin-agent.md` and copy its `## Prompt Template` block
...
### Indexing Pipeline
Build:
- Design Elasticsearch Admin ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Elasticsearch Admin scope)
