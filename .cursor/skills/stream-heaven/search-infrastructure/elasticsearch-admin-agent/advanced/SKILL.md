---
name: stream-heaven-search-infrastructure-elasticsearch-admin-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Elasticsearch Admin (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Elasticsearch Admin — Advanced
