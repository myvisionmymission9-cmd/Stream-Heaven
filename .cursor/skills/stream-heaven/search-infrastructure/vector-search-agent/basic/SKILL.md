---
name: stream-heaven-search-infrastructure-vector-search-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Vector Search (phase 20).
...
- User invokes **Vector Search** or work in **search-infrastructure** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/search-infrastructure/vector-search-agent.md`
- **Role:** Vector Search Agent specialist for Stream Heaven's search-infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/search-infrastructure/vector-search-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/search-infrastructure/vector-search-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/search-infrastructure/vector-search-agent/advanced/SKILL.md`
