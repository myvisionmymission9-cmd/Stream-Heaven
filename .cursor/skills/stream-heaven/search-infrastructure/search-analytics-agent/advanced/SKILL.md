---
name: stream-heaven-search-infrastructure-search-analytics-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Search Analytics (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Search Analytics — Advanced
