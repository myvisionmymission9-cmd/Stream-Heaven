---
name: stream-heaven-search-infrastructure-search-cache-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Search Cache (phase 20).
...
Architect:
- Design PostgreSQL schemas, indexes, and migrations for Search Cache with rollback plans. (Search Cache scope)
