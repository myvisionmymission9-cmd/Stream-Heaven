---
name: stream-heaven-search-infrastructure-search-ranking-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Search Ranking (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Search Ranking — Advanced
