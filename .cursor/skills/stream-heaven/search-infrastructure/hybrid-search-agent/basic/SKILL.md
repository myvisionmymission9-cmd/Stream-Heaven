---
name: stream-heaven-search-infrastructure-hybrid-search-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Hybrid Search (phase 20).
...
- User invokes **Hybrid Search** or work in **search-infrastructure** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/search-infrastructure/hybrid-search-agent.md`
- **Role:** Hybrid Search Agent specialist for Stream Heaven's search-infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/search-infrastructure/hybrid-search-agent.md` and copy its `## Prompt Template` block
...
### Indexing Pipeline
Build:
- Design Hybrid Search ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Hybrid Search scope)
