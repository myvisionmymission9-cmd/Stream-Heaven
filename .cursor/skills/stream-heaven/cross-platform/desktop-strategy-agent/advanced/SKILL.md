---
name: stream-heaven-cross-platform-desktop-strategy-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Desktop Strategy (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Desktop Strategy — Advanced
