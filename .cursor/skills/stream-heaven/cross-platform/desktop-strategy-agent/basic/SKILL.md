---
name: stream-heaven-cross-platform-desktop-strategy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Desktop Strategy (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Desktop Strategy — Basic

## When to use

- User invokes **Desktop Strategy** or work in **cross-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cross-platform/desktop-strategy-agent.md`
- **Role:** Desktop Strategy Agent specialist for Stream Heaven's cross platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cross-platform/desktop-strategy-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Provide executive guidance for Desktop Strategy across Social, Livestream, Astro, and Media strategic priorities. (Desktop Strategy scope)
...
- Basic: `.cursor/skills/stream-heaven/cross-platform/desktop-strategy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cross-platform/desktop-strategy-agent/advanced/SKILL.md`
