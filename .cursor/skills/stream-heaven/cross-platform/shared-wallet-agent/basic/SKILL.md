---
name: stream-heaven-cross-platform-shared-wallet-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Shared Wallet (phase 20).
...
- User invokes **Shared Wallet** or work in **cross-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cross-platform/shared-wallet-agent.md`
- **Role:** Shared Wallet Agent specialist for Stream Heaven's cross-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cross-platform/shared-wallet-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/cross-platform/shared-wallet-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cross-platform/shared-wallet-agent/advanced/SKILL.md`
