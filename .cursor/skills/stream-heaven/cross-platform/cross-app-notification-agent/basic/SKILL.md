---
name: stream-heaven-cross-platform-cross-app-notification-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross App Notification (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Cross App Notification — Basic

## When to use

- User invokes **Cross App Notification** or work in **cross-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cross-platform/cross-app-notification-agent.md`
- **Role:** Cross App Notification Agent specialist for Stream Heaven's cross-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cross-platform/cross-app-notification-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Cross App Notification deliverables in cross-platform domain for Stream Heaven Phase 20. (Cross App Notification scope)
...
- Basic: `.cursor/skills/stream-heaven/cross-platform/cross-app-notification-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cross-platform/cross-app-notification-agent/advanced/SKILL.md`
