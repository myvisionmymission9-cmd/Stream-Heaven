---
name: stream-heaven-cross-platform-cross-app-notification-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross App Notification (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross App Notification — Advanced
