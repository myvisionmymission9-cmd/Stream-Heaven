---
name: stream-heaven-cross-platform-cross-platform-session-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross Platform Session (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Cross Platform Session — Basic

## When to use

- User invokes **Cross Platform Session** or work in **cross-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cross-platform/cross-platform-session-agent.md`
- **Role:** Cross Platform Session Agent specialist for Stream Heaven's cross-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cross-platform/cross-platform-session-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/cross-platform/cross-platform-session-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cross-platform/cross-platform-session-agent/advanced/SKILL.md`
