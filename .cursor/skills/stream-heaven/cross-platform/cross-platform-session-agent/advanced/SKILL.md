---
name: stream-heaven-cross-platform-cross-platform-session-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross Platform Session (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross Platform Session — Advanced
