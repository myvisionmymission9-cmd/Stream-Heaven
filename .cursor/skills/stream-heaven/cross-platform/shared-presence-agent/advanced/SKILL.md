---
name: stream-heaven-cross-platform-shared-presence-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Shared Presence (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Shared Presence — Advanced
