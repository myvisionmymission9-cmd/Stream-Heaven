---
name: stream-heaven-cross-platform-shared-presence-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Shared Presence (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Shared Presence — Basic

## When to use

- User invokes **Shared Presence** or work in **cross-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cross-platform/shared-presence-agent.md`
- **Role:** Shared Presence Agent specialist for Stream Heaven's cross-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cross-platform/shared-presence-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/cross-platform/shared-presence-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cross-platform/shared-presence-agent/advanced/SKILL.md`
