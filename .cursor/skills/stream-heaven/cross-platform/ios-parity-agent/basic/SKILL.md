---
name: stream-heaven-cross-platform-ios-parity-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ios Parity (phase 20).
...
- User invokes **Ios Parity** or work in **cross-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cross-platform/ios-parity-agent.md`
- **Role:** Ios Parity Agent specialist for Stream Heaven's cross platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cross-platform/ios-parity-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/cross-platform/ios-parity-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cross-platform/ios-parity-agent/advanced/SKILL.md`
