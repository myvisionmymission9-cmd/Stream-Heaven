---
name: stream-heaven-cross-platform-shared-identity-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Shared Identity (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Shared Identity — Basic

## When to use

- User invokes **Shared Identity** or work in **cross-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cross-platform/shared-identity-agent.md`
- **Role:** Shared Identity Agent specialist for Stream Heaven's cross-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cross-platform/shared-identity-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Implement Shared Identity flows in NestJS auth-service with Firebase Admin SDK verification. (Shared Identity scope)
...
- Basic: `.cursor/skills/stream-heaven/cross-platform/shared-identity-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cross-platform/shared-identity-agent/advanced/SKILL.md`
