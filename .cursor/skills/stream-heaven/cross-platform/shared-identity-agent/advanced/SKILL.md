---
name: stream-heaven-cross-platform-shared-identity-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Shared Identity (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Shared Identity — Advanced
