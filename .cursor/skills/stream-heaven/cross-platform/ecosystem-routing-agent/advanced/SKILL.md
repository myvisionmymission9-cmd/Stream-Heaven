---
name: stream-heaven-cross-platform-ecosystem-routing-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ecosystem Routing (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Ecosystem Routing — Advanced
