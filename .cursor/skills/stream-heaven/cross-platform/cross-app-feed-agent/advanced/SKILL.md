---
name: stream-heaven-cross-platform-cross-app-feed-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross App Feed (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross App Feed — Advanced
...
Architect:
- Design and implement cross platform capabilities for Stream Heaven. (Cross App Feed scope)
