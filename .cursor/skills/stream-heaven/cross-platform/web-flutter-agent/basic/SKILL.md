---
name: stream-heaven-cross-platform-web-flutter-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Web Flutter (phase 20).
...
- Open agent: `ai-agents/cross-platform/web-flutter-agent.md` and copy its `## Prompt Template` block
...
Define:
- Design and implement cross platform capabilities for Stream Heaven. (Web Flutter scope)
