---
name: stream-heaven-cross-platform-android-parity-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Android Parity (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Android Parity — Basic

## When to use

- User invokes **Android Parity** or work in **cross-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/cross-platform/android-parity-agent.md`
- **Role:** Android Parity Agent specialist for Stream Heaven's cross platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/cross-platform/android-parity-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Android Parity deliverables in cross-platform domain for Stream Heaven Phase 20. (Android Parity scope)
...
- Basic: `.cursor/skills/stream-heaven/cross-platform/android-parity-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/cross-platform/android-parity-agent/advanced/SKILL.md`
