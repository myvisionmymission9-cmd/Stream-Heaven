---
name: stream-heaven-agent-memory-memory-indexing-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Memory Indexing (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Memory Indexing — Advanced
