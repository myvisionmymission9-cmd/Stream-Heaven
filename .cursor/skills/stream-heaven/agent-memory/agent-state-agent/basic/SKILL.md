---
name: stream-heaven-agent-memory-agent-state-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Agent State (phase 18).
...
- Open agent: `ai-agents/agent-memory/agent-state-agent.md` and copy its `## Prompt Template` block
