---
name: stream-heaven-agent-memory-memory-pruning-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Memory Pruning (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Memory Pruning — Basic

## When to use

- User invokes **Memory Pruning** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/memory-pruning-agent.md`
- **Role:** Memory Pruning Agent specialist for Stream Heaven's agent memory domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/memory-pruning-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Memory Pruning deliverables in agent-memory domain for Stream Heaven Phase 18. (Memory Pruning scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/memory-pruning-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/memory-pruning-agent/advanced/SKILL.md`
