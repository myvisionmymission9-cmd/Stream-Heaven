---
name: stream-heaven-agent-memory-memory-retrieval-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Memory Retrieval (phase 18).
...
- User invokes **Memory Retrieval** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/memory-retrieval-agent.md`
- **Role:** Memory Retrieval Agent specialist for Stream Heaven's agent memory domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/memory-retrieval-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Memory Retrieval deliverables in agent-memory domain for Stream Heaven Phase 18. (Memory Retrieval scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/memory-retrieval-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/memory-retrieval-agent/advanced/SKILL.md`
