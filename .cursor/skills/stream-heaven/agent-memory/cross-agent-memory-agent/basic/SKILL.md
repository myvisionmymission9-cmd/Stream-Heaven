---
name: stream-heaven-agent-memory-cross-agent-memory-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross Agent Memory (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Cross Agent Memory — Basic

## When to use

- User invokes **Cross Agent Memory** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/cross-agent-memory-agent.md`
- **Role:** Shared memory across agents.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/cross-agent-memory-agent.md` and copy its `## Prompt Template` block
...
Setup:
- cross-agent-memory-agent: Redis hot, PostgreSQL cold, vector tier. (Cross Agent Memory scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/cross-agent-memory-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/cross-agent-memory-agent/advanced/SKILL.md`
