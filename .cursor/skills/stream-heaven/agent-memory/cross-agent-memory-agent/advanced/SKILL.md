---
name: stream-heaven-agent-memory-cross-agent-memory-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross Agent Memory (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross Agent Memory — Advanced
