---
name: stream-heaven-agent-memory-long-term-memory-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Long Term Memory (phase 18).
...
- User invokes **Long Term Memory** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/long-term-memory-agent.md`
- **Role:** Durable memory retention.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/long-term-memory-agent.md` and copy its `## Prompt Template` block
...
Setup:
- long-term-memory-agent: Redis hot, PostgreSQL cold, vector tier. (Long Term Memory scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/long-term-memory-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/long-term-memory-agent/advanced/SKILL.md`
