---
name: stream-heaven-agent-memory-context-store-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Context Store (phase 18).
...
- User invokes **Context Store** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/context-store-agent.md`
- **Role:** Context Store Agent specialist for Stream Heaven's agent memory domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/context-store-agent.md` and copy its `## Prompt Template` block
