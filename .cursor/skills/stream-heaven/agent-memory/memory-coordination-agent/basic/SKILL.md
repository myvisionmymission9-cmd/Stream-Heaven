---
name: stream-heaven-agent-memory-memory-coordination-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Memory Coordination (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Memory Coordination — Basic

## When to use

- User invokes **Memory Coordination** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/memory-coordination-agent.md`
- **Role:** Coordinate agent memory writes.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/memory-coordination-agent.md` and copy its `## Prompt Template` block
...
Setup:
- memory-coordination-agent: Redis hot, PostgreSQL cold, vector tier. (Memory Coordination scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/memory-coordination-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/memory-coordination-agent/advanced/SKILL.md`
