---
name: stream-heaven-agent-memory-memory-coordination-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Memory Coordination (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Memory Coordination — Advanced
