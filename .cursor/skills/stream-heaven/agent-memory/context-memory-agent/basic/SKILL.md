---
name: stream-heaven-agent-memory-context-memory-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Context Memory (phase 18).
...
- User invokes **Context Memory** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/context-memory-agent.md`
- **Role:** Short-term session context.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/context-memory-agent.md` and copy its `## Prompt Template` block
...
Setup:
- context-memory-agent: Redis hot, PostgreSQL cold, vector tier. (Context Memory scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/context-memory-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/context-memory-agent/advanced/SKILL.md`
