---
name: stream-heaven-agent-memory-conversation-memory-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Conversation Memory (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Conversation Memory — Advanced
