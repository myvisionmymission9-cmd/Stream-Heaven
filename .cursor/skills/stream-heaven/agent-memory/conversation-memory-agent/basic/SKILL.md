---
name: stream-heaven-agent-memory-conversation-memory-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Conversation Memory (phase 18).
...
- User invokes **Conversation Memory** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/conversation-memory-agent.md`
- **Role:** Thread memory for support.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/conversation-memory-agent.md` and copy its `## Prompt Template` block
...
Setup:
- conversation-memory-agent: Redis hot, PostgreSQL cold, vector tier. (Conversation Memory scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/conversation-memory-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/conversation-memory-agent/advanced/SKILL.md`
