---
name: stream-heaven-agent-memory-cross-chat-sync-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross Chat Sync (phase 18).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross Chat Sync — Advanced
