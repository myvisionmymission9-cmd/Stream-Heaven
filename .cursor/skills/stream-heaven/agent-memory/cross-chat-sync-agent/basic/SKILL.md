---
name: stream-heaven-agent-memory-cross-chat-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross Chat Sync (phase 18).
  Single-agent execution with governance prefix and structural validation.
---

# Cross Chat Sync — Basic

## When to use

- User invokes **Cross Chat Sync** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/cross-chat-sync-agent.md`
- **Role:** Cross Chat Sync Agent specialist for Stream Heaven's agent memory domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/cross-chat-sync-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Cross Chat Sync deliverables in agent-memory domain for Stream Heaven Phase 18. (Cross Chat Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/cross-chat-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/cross-chat-sync-agent/advanced/SKILL.md`
