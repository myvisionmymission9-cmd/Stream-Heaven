---
name: stream-heaven-agent-memory-semantic-memory-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Semantic Memory (phase 18).
...
- User invokes **Semantic Memory** or work in **agent-memory** (phase 18)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/agent-memory/semantic-memory-agent.md`
- **Role:** Semantic embeddings store.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/agent-memory/semantic-memory-agent.md` and copy its `## Prompt Template` block
...
Setup:
- semantic-memory-agent: Redis hot, PostgreSQL cold, vector tier. (Semantic Memory scope)
...
- Basic: `.cursor/skills/stream-heaven/agent-memory/semantic-memory-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/agent-memory/semantic-memory-agent/advanced/SKILL.md`
