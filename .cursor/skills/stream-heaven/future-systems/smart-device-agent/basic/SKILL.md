---
name: stream-heaven-future-systems-smart-device-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Smart Device (phase 20).
...
- User invokes **Smart Device** or work in **future-systems** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/future-systems/smart-device-agent.md`
- **Role:** Smart Device Agent specialist for Stream Heaven's future-systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/future-systems/smart-device-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Smart Device deliverables in future-systems domain for Stream Heaven Phase 20. (Smart Device scope)
...
- Basic: `.cursor/skills/stream-heaven/future-systems/smart-device-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/future-systems/smart-device-agent/advanced/SKILL.md`
