---
name: stream-heaven-future-systems-ar-effects-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ar Effects (phase 20).
...
- User invokes **Ar Effects** or work in **future-systems** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/future-systems/ar-effects-agent.md`
- **Role:** Ar Effects Agent specialist for Stream Heaven's future-systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/future-systems/ar-effects-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Ar Effects deliverables in future-systems domain for Stream Heaven Phase 20. (Ar Effects scope)
...
- Basic: `.cursor/skills/stream-heaven/future-systems/ar-effects-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/future-systems/ar-effects-agent/advanced/SKILL.md`
