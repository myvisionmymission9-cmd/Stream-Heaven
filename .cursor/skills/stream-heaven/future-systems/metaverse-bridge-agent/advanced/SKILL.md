---
name: stream-heaven-future-systems-metaverse-bridge-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Metaverse Bridge (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Metaverse Bridge — Advanced
...
Architect:
- Design and implement future systems capabilities for Stream Heaven. (Metaverse Bridge scope)
