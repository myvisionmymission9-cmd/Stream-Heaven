---
name: stream-heaven-future-systems-metaverse-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Metaverse (phase 20).
...
- User invokes **Metaverse** or work in **future-systems** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/future-systems/metaverse-agent.md`
- **Role:** Metaverse Agent specialist for Stream Heaven's future-systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/future-systems/metaverse-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Metaverse deliverables in future-systems domain for Stream Heaven Phase 20. (Metaverse scope)
...
- Basic: `.cursor/skills/stream-heaven/future-systems/metaverse-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/future-systems/metaverse-agent/advanced/SKILL.md`
