---
name: stream-heaven-future-systems-wearable-integration-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Wearable Integration (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Wearable Integration — Advanced
