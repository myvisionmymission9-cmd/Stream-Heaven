---
name: stream-heaven-future-systems-wearable-integration-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Wearable Integration (phase 20).
...
- User invokes **Wearable Integration** or work in **future-systems** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/future-systems/wearable-integration-agent.md`
- **Role:** Wearable Integration Agent specialist for Stream Heaven's future-systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/future-systems/wearable-integration-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Wearable deliverables in future-systems domain for Stream Heaven Phase 20. (Wearable Integration scope)
...
- Basic: `.cursor/skills/stream-heaven/future-systems/wearable-integration-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/future-systems/wearable-integration-agent/advanced/SKILL.md`
