---
name: stream-heaven-enterprise-security-zero-trust-network-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Zero Trust Network (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Zero Trust Network — Basic

## When to use

- User invokes **Zero Trust Network** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/zero-trust-network-agent.md`
- **Role:** Zero-trust network policies.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/zero-trust-network-agent.md` and copy its `## Prompt Template` block
...
Build:
- zero-trust-network-agent aligned with soc2-compliance-agent controls. (Zero Trust Network scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/zero-trust-network-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/zero-trust-network-agent/advanced/SKILL.md`
