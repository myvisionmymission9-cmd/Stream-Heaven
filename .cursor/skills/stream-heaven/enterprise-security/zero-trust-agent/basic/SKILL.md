---
name: stream-heaven-enterprise-security-zero-trust-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Zero Trust (phase 20).
...
- User invokes **Zero Trust** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/zero-trust-agent.md`
- **Role:** Zero Trust Agent specialist for Stream Heaven's enterprise-security domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/zero-trust-agent.md` and copy its `## Prompt Template` block
...
Build:
- Define moderation policies and enforcement hooks for Zero Trust across social and livestream surfaces. (Zero Trust scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/zero-trust-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/zero-trust-agent/advanced/SKILL.md`
