---
name: stream-heaven-enterprise-security-credential-security-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Credential Security (phase 20).
...
- User invokes **Credential Security** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/credential-security-agent.md`
- **Role:** Credential Security Agent specialist for Stream Heaven's enterprise-security domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/credential-security-agent.md` and copy its `## Prompt Template` block
...
Apply:
- Threat-model Credential Security attack surfaces across NestJS APIs, Flutter clients, and Socket.IO channels. (Credential Security scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/credential-security-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/credential-security-agent/advanced/SKILL.md`
