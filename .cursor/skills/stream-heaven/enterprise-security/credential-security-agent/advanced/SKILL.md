---
name: stream-heaven-enterprise-security-credential-security-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Credential Security (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Credential Security — Advanced
