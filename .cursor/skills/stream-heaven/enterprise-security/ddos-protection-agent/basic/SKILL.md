---
name: stream-heaven-enterprise-security-ddos-protection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ddos Protection (phase 20).
...
- User invokes **Ddos Protection** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/ddos-protection-agent.md`
- **Role:** Ddos Protection Agent specialist for Stream Heaven's enterprise-security domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/ddos-protection-agent.md` and copy its `## Prompt Template` block
...
Apply:
- Threat-model Ddos Protection attack surfaces across NestJS APIs, Flutter clients, and Socket.IO channels. (Ddos Protection scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/ddos-protection-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/ddos-protection-agent/advanced/SKILL.md`
