---
name: stream-heaven-enterprise-security-security-audit-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Security Audit (phase 20).
...
- User invokes **Security Audit** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/security-audit-agent.md`
- **Role:** Continuous security audits.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/security-audit-agent.md` and copy its `## Prompt Template` block
...
Apply:
- security-audit-agent aligned with soc2-compliance-agent controls. (Security Audit scope)
