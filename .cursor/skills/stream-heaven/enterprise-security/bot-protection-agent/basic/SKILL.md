---
name: stream-heaven-enterprise-security-bot-protection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Bot Protection (phase 20).
...
- User invokes **Bot Protection** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/bot-protection-agent.md`
- **Role:** Bot Protection Agent specialist for Stream Heaven's enterprise-security domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/bot-protection-agent.md` and copy its `## Prompt Template` block
...
Apply:
- Threat-model Bot Protection attack surfaces across NestJS APIs, Flutter clients, and Socket.IO channels. (Bot Protection scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/bot-protection-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/bot-protection-agent/advanced/SKILL.md`
