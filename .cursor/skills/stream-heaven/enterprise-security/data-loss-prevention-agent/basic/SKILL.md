---
name: stream-heaven-enterprise-security-data-loss-prevention-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Data Loss Prevention (phase 20).
...
- User invokes **Data Loss Prevention** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/data-loss-prevention-agent.md`
- **Role:** DLP for exports and logs.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/data-loss-prevention-agent.md` and copy its `## Prompt Template` block
...
Apply:
- data-loss-prevention-agent aligned with soc2-compliance-agent controls. (Data Loss Prevention scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/data-loss-prevention-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/data-loss-prevention-agent/advanced/SKILL.md`
