---
name: stream-heaven-enterprise-security-encryption-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Encryption (phase 20).
...
- User invokes **Encryption** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/encryption-agent.md`
- **Role:** Encryption Agent specialist for Stream Heaven's enterprise-security domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/encryption-agent.md` and copy its `## Prompt Template` block
...
Apply:
- Threat-model Encryption attack surfaces across NestJS APIs, Flutter clients, and Socket.IO channels. (Encryption scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/encryption-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/encryption-agent/advanced/SKILL.md`
