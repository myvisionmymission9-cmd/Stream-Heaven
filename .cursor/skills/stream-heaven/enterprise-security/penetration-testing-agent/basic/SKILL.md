---
name: stream-heaven-enterprise-security-penetration-testing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Penetration Testing (phase 20).
...
- User invokes **Penetration Testing** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/penetration-testing-agent.md`
- **Role:** Penetration Testing Agent specialist for Stream Heaven's enterprise-security domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/penetration-testing-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/penetration-testing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/penetration-testing-agent/advanced/SKILL.md`
