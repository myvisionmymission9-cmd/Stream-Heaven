---
name: stream-heaven-enterprise-security-iam-policy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Iam Policy (phase 20).
...
- User invokes **Iam Policy** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/iam-policy-agent.md`
- **Role:** IAM least-privilege policies.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/iam-policy-agent.md` and copy its `## Prompt Template` block
...
Apply:
- iam-policy-agent aligned with soc2-compliance-agent controls. (Iam Policy scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/iam-policy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/iam-policy-agent/advanced/SKILL.md`
