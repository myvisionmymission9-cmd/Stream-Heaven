---
name: stream-heaven-enterprise-security-breach-response-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Breach Response (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Breach Response — Basic

## When to use

- User invokes **Breach Response** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/breach-response-agent.md`
- **Role:** Breach playbooks and forensics.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/breach-response-agent.md` and copy its `## Prompt Template` block
...
Apply:
- breach-response-agent aligned with soc2-compliance-agent controls. (Breach Response scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/breach-response-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/breach-response-agent/advanced/SKILL.md`
