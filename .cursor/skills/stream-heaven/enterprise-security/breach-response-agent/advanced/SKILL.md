---
name: stream-heaven-enterprise-security-breach-response-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Breach Response (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Breach Response — Advanced
