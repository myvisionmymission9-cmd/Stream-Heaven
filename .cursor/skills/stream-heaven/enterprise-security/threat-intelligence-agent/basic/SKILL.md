---
name: stream-heaven-enterprise-security-threat-intelligence-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Threat Intelligence (phase 20).
...
- User invokes **Threat Intelligence** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/threat-intelligence-agent.md`
- **Role:** Threat Intelligence Agent specialist for Stream Heaven's enterprise-security domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/threat-intelligence-agent.md` and copy its `## Prompt Template` block
...
Apply:
- Threat-model Threat Intelligence attack surfaces across NestJS APIs, Flutter clients, and Socket.IO channels. (Threat Intelligence scope)
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/threat-intelligence-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/threat-intelligence-agent/advanced/SKILL.md`
