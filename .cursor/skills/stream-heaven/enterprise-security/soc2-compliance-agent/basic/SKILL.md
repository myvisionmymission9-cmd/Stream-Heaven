---
name: stream-heaven-enterprise-security-soc2-compliance-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Soc2 Compliance (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Soc2 Compliance — Basic

## When to use

- User invokes **Soc2 Compliance** or work in **enterprise-security** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/enterprise-security/soc2-compliance-agent.md`
- **Role:** Soc2 Compliance Agent specialist for Stream Heaven's enterprise security domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/enterprise-security/soc2-compliance-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/enterprise-security/soc2-compliance-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/enterprise-security/soc2-compliance-agent/advanced/SKILL.md`
