---
name: stream-heaven-enterprise-security-secrets-rotation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Secrets Rotation (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Secrets Rotation — Basic
...
- Open agent: `ai-agents/enterprise-security/secrets-rotation-agent.md` and copy its `## Prompt Template` block
...
Apply:
- Design and implement enterprise security capabilities for Stream Heaven. (Secrets Rotation scope)
