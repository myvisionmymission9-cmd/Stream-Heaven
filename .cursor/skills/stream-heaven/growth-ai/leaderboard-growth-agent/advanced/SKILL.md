---
name: stream-heaven-growth-ai-leaderboard-growth-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Leaderboard Growth (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Leaderboard Growth — Advanced
