---
name: stream-heaven-growth-ai-push-notification-optimizer-basic
description: >-
  Basic Cursor skill for Stream Heaven Push Notification Optimizer (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Push Notification Optimizer — Basic

## When to use

- User invokes **Push Notification Optimizer** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/push-notification-optimizer.md`
- **Role:** Push Notification Optimizer specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/push-notification-optimizer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement growth ai capabilities for Stream Heaven. (Push Notification Optimizer scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/push-notification-optimizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/push-notification-optimizer/advanced/SKILL.md`
