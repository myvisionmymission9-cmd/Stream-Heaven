---
name: stream-heaven-growth-ai-growth-compliance-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Growth Compliance (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Growth Compliance — Basic
...
- Open agent: `ai-agents/growth-ai/growth-compliance-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Design Growth Compliance growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Growth Compliance scope)
