---
name: stream-heaven-growth-ai-content-discovery-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Content Discovery (phase 15).
...
- User invokes **Content Discovery** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/content-discovery-agent.md`
- **Role:** Content Discovery Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/content-discovery-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Content Discovery deliverables in growth-ai domain for Stream Heaven Phase 15. (Content Discovery scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/content-discovery-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/content-discovery-agent/advanced/SKILL.md`
