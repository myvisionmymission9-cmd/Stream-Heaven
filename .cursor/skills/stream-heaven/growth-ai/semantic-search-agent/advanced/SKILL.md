---
name: stream-heaven-growth-ai-semantic-search-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Semantic Search (phase 15).
...
Combine:
- Design and implement growth ai capabilities for Stream Heaven. (Semantic Search scope)
