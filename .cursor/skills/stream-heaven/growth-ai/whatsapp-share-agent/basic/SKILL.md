---
name: stream-heaven-growth-ai-whatsapp-share-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Whatsapp Share (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Whatsapp Share — Basic

## When to use

- User invokes **Whatsapp Share** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/whatsapp-share-agent.md`
- **Role:** Whatsapp Share Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/whatsapp-share-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Whatsapp Share with cursor pagination and moderation hooks. (Whatsapp Share scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/whatsapp-share-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/whatsapp-share-agent/advanced/SKILL.md`
