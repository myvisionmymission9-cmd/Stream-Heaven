---
name: stream-heaven-growth-ai-influencer-outreach-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Influencer Outreach (phase 15).
...
- User invokes **Influencer Outreach** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/influencer-outreach-agent.md`
- **Role:** Influencer Outreach Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/influencer-outreach-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Influencer Outreach deliverables in growth-ai domain for Stream Heaven Phase 15. (Influencer Outreach scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/influencer-outreach-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/influencer-outreach-agent/advanced/SKILL.md`
