---
name: stream-heaven-growth-ai-cross-app-discovery-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross App Discovery (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross App Discovery — Advanced
