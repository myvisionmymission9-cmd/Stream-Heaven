---
name: stream-heaven-growth-ai-aso-keywords-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Aso Keywords (phase 15).
...
- User invokes **Aso Keywords** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/aso-keywords-agent.md`
- **Role:** Aso Keywords Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/aso-keywords-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Aso Keywords deliverables in growth-ai domain for Stream Heaven Phase 15. (Aso Keywords scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/aso-keywords-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/aso-keywords-agent/advanced/SKILL.md`
