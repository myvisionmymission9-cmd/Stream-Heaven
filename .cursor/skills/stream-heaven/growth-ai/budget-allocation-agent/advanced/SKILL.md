---
name: stream-heaven-growth-ai-budget-allocation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Budget Allocation (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Budget Allocation — Advanced
...
Operate:
- Own Budget Allocation deliverables in growth-ai domain for Stream Heaven Phase 15. (Budget Allocation scope)
