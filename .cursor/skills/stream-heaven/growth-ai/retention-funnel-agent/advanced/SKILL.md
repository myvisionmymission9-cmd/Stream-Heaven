---
name: stream-heaven-growth-ai-retention-funnel-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Retention Funnel (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Retention Funnel — Advanced
