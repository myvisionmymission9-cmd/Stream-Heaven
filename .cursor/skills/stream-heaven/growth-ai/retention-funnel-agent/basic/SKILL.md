---
name: stream-heaven-growth-ai-retention-funnel-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Retention Funnel (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Retention Funnel — Basic

## When to use

- User invokes **Retention Funnel** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/retention-funnel-agent.md`
- **Role:** Retention Funnel Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/retention-funnel-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Retention Funnel deliverables in growth-ai domain for Stream Heaven Phase 15. (Retention Funnel scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/retention-funnel-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/retention-funnel-agent/advanced/SKILL.md`
