---
name: stream-heaven-growth-ai-feed-ranking-ml-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feed Ranking Ml (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Feed Ranking Ml — Basic

## When to use

- User invokes **Feed Ranking Ml** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/feed-ranking-ml-agent.md`
- **Role:** Feed Ranking Ml Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/feed-ranking-ml-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Feed Ranking Ml with cursor pagination and moderation hooks. (Feed Ranking Ml scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/feed-ranking-ml-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/feed-ranking-ml-agent/advanced/SKILL.md`
