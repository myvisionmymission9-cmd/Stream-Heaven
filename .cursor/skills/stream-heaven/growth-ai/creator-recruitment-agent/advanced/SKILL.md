---
name: stream-heaven-growth-ai-creator-recruitment-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Recruitment (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Creator Recruitment — Advanced
