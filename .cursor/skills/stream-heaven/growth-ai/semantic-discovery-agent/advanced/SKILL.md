---
name: stream-heaven-growth-ai-semantic-discovery-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Semantic Discovery (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Semantic Discovery — Advanced
