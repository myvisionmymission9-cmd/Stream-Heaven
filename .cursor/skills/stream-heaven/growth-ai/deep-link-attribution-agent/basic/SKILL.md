---
name: stream-heaven-growth-ai-deep-link-attribution-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Deep Link Attribution (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Deep Link Attribution — Basic

## When to use

- User invokes **Deep Link Attribution** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/deep-link-attribution-agent.md`
- **Role:** Deep Link Attribution Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/deep-link-attribution-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Deep Link Attribution deliverables in growth-ai domain for Stream Heaven Phase 15. (Deep Link Attribution scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/deep-link-attribution-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/deep-link-attribution-agent/advanced/SKILL.md`
