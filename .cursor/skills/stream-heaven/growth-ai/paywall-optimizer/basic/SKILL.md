---
name: stream-heaven-growth-ai-paywall-optimizer-basic
description: >-
  Basic Cursor skill for Stream Heaven Paywall Optimizer (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Paywall Optimizer — Basic

## When to use

- User invokes **Paywall Optimizer** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/paywall-optimizer.md`
- **Role:** Paywall Optimizer specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/paywall-optimizer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement growth ai capabilities for Stream Heaven. (Paywall Optimizer scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/paywall-optimizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/paywall-optimizer/advanced/SKILL.md`
