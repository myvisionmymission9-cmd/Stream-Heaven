---
name: stream-heaven-growth-ai-regional-campaign-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Regional Campaign (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Regional Campaign — Basic

## When to use

- User invokes **Regional Campaign** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/regional-campaign-agent.md`
- **Role:** Regional Campaign Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/regional-campaign-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Regional Campaign growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Regional Campaign scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/regional-campaign-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/regional-campaign-agent/advanced/SKILL.md`
