---
name: stream-heaven-growth-ai-recommendation-feedback-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Recommendation Feedback (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Recommendation Feedback — Advanced
