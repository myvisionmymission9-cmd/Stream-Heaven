---
name: stream-heaven-growth-ai-watch-behavior-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Watch Behavior (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Watch Behavior — Basic

## When to use

- User invokes **Watch Behavior** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/watch-behavior-agent.md`
- **Role:** Watch Behavior Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/watch-behavior-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Watch Behavior deliverables in growth-ai domain for Stream Heaven Phase 15. (Watch Behavior scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/watch-behavior-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/watch-behavior-agent/advanced/SKILL.md`
