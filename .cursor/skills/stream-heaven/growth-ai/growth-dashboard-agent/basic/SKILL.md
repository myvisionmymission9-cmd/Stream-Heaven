---
name: stream-heaven-growth-ai-growth-dashboard-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Growth Dashboard (phase 15).
...
- User invokes **Growth Dashboard** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/growth-dashboard-agent.md`
- **Role:** Growth Dashboard Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/growth-dashboard-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Growth Dashboard growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Growth Dashboard scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/growth-dashboard-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/growth-dashboard-agent/advanced/SKILL.md`
