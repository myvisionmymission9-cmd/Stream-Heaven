---
name: stream-heaven-growth-ai-growth-dashboard-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Growth Dashboard (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Growth Dashboard — Advanced
