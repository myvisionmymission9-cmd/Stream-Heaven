---
name: stream-heaven-growth-ai-rewatch-detection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Rewatch Detection (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Rewatch Detection — Basic

## When to use

- User invokes **Rewatch Detection** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/rewatch-detection-agent.md`
- **Role:** Rewatch Detection Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/rewatch-detection-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Rewatch Detection deliverables in growth-ai domain for Stream Heaven Phase 15. (Rewatch Detection scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/rewatch-detection-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/rewatch-detection-agent/advanced/SKILL.md`
