---
name: stream-heaven-growth-ai-rewatch-detection-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Rewatch Detection (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Rewatch Detection — Advanced
