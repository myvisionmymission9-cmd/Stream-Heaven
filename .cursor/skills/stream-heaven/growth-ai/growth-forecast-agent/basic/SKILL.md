---
name: stream-heaven-growth-ai-growth-forecast-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Growth Forecast (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Growth Forecast — Basic

## When to use

- User invokes **Growth Forecast** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/growth-forecast-agent.md`
- **Role:** Growth Forecast Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/growth-forecast-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Growth Forecast growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Growth Forecast scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/growth-forecast-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/growth-forecast-agent/advanced/SKILL.md`
