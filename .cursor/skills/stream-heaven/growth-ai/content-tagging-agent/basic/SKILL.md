---
name: stream-heaven-growth-ai-content-tagging-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Content Tagging (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Content Tagging — Basic

## When to use

- User invokes **Content Tagging** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/content-tagging-agent.md`
- **Role:** Content Tagging Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/content-tagging-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Content Tagging deliverables in growth-ai domain for Stream Heaven Phase 15. (Content Tagging scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/content-tagging-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/content-tagging-agent/advanced/SKILL.md`
