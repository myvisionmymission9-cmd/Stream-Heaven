---
name: stream-heaven-growth-ai-scroll-behavior-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Scroll Behavior (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Scroll Behavior — Basic

## When to use

- User invokes **Scroll Behavior** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/scroll-behavior-agent.md`
- **Role:** Scroll Behavior Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/scroll-behavior-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Scroll Behavior deliverables in growth-ai domain for Stream Heaven Phase 15. (Scroll Behavior scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/scroll-behavior-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/scroll-behavior-agent/advanced/SKILL.md`
