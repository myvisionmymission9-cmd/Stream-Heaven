---
name: stream-heaven-growth-ai-festive-campaign-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Festive Campaign (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Festive Campaign — Advanced
