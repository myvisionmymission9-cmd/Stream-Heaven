---
name: stream-heaven-growth-ai-email-campaign-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Email Campaign (phase 15).
...
- User invokes **Email Campaign** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/email-campaign-agent.md`
- **Role:** Email Campaign Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/email-campaign-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Email Campaign growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Email Campaign scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/email-campaign-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/email-campaign-agent/advanced/SKILL.md`
