---
name: stream-heaven-growth-ai-sms-otp-growth-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Sms Otp Growth (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Sms Otp Growth — Basic

## When to use

- User invokes **Sms Otp Growth** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/sms-otp-growth-agent.md`
- **Role:** Sms Otp Growth Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/sms-otp-growth-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Sms Otp Growth flows in NestJS auth-service with Firebase Admin SDK verification. (Sms Otp Growth scope)
