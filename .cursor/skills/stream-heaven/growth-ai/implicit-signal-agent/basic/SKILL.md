---
name: stream-heaven-growth-ai-implicit-signal-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Implicit Signal (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Implicit Signal — Basic

## When to use

- User invokes **Implicit Signal** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/implicit-signal-agent.md`
- **Role:** Implicit Signal Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/implicit-signal-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Implicit Signal deliverables in growth-ai domain for Stream Heaven Phase 15. (Implicit Signal scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/implicit-signal-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/implicit-signal-agent/advanced/SKILL.md`
