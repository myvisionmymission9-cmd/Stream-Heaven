---
name: stream-heaven-growth-ai-feature-store-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feature Store (phase 15).
...
- User invokes **Feature Store** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/feature-store-agent.md`
- **Role:** Feature Store Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/feature-store-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Feature Store growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Feature Store scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/feature-store-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/feature-store-agent/advanced/SKILL.md`
