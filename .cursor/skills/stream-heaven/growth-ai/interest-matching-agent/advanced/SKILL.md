---
name: stream-heaven-growth-ai-interest-matching-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Interest Matching (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Interest Matching — Advanced
