---
name: stream-heaven-growth-ai-interest-matching-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Interest Matching (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Interest Matching — Basic

## When to use

- User invokes **Interest Matching** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/interest-matching-agent.md`
- **Role:** Interest Matching Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/interest-matching-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Interest Matching deliverables in growth-ai domain for Stream Heaven Phase 15. (Interest Matching scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/interest-matching-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/interest-matching-agent/advanced/SKILL.md`
