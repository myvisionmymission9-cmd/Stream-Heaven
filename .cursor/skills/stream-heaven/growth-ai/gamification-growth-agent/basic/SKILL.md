---
name: stream-heaven-growth-ai-gamification-growth-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gamification Growth (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Gamification Growth — Basic

## When to use

- User invokes **Gamification Growth** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/gamification-growth-agent.md`
- **Role:** Gamification Growth Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/gamification-growth-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Gamification Growth growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Gamification Growth scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/gamification-growth-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/gamification-growth-agent/advanced/SKILL.md`
