---
name: stream-heaven-growth-ai-winback-campaign-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Winback Campaign (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Winback Campaign — Basic

## When to use

- User invokes **Winback Campaign** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/winback-campaign-agent.md`
- **Role:** Winback Campaign Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/winback-campaign-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Winback Campaign growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Winback Campaign scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/winback-campaign-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/winback-campaign-agent/advanced/SKILL.md`
