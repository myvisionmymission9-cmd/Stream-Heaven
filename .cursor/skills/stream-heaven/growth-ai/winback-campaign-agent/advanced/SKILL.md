---
name: stream-heaven-growth-ai-winback-campaign-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Winback Campaign (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Winback Campaign — Advanced
