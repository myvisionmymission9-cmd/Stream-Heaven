---
name: stream-heaven-growth-ai-partnership-growth-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Partnership Growth (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Partnership Growth — Basic

## When to use

- User invokes **Partnership Growth** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/partnership-growth-agent.md`
- **Role:** Partnership Growth Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/partnership-growth-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Partnership Growth growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Partnership Growth scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/partnership-growth-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/partnership-growth-agent/advanced/SKILL.md`
