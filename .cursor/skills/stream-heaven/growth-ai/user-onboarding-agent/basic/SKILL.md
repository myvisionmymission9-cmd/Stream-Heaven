---
name: stream-heaven-growth-ai-user-onboarding-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven User Onboarding (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# User Onboarding — Basic

## When to use

- User invokes **User Onboarding** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/user-onboarding-agent.md`
- **Role:** User Onboarding Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/user-onboarding-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own User Onboarding deliverables in growth-ai domain for Stream Heaven Phase 15. (User Onboarding scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/user-onboarding-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/user-onboarding-agent/advanced/SKILL.md`
