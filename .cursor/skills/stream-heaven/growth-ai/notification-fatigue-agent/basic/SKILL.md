---
name: stream-heaven-growth-ai-notification-fatigue-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Notification Fatigue (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Notification Fatigue — Basic

## When to use

- User invokes **Notification Fatigue** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/notification-fatigue-agent.md`
- **Role:** Notification Fatigue Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/notification-fatigue-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Notification Fatigue deliverables in growth-ai domain for Stream Heaven Phase 15. (Notification Fatigue scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/notification-fatigue-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/notification-fatigue-agent/advanced/SKILL.md`
