---
name: stream-heaven-growth-ai-notification-fatigue-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Notification Fatigue (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Notification Fatigue — Advanced
