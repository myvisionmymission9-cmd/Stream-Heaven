---
name: stream-heaven-growth-ai-competitive-intel-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Competitive Intel (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Competitive Intel — Basic

## When to use

- User invokes **Competitive Intel** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/competitive-intel-agent.md`
- **Role:** Competitive Intel Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/competitive-intel-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Competitive Intel deliverables in growth-ai domain for Stream Heaven Phase 15. (Competitive Intel scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/competitive-intel-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/competitive-intel-agent/advanced/SKILL.md`
