---
name: stream-heaven-growth-ai-negative-feedback-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Negative Feedback (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Negative Feedback — Advanced
