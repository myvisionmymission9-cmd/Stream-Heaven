---
name: stream-heaven-growth-ai-negative-feedback-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Negative Feedback (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Negative Feedback — Basic

## When to use

- User invokes **Negative Feedback** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/negative-feedback-agent.md`
- **Role:** Negative Feedback Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/negative-feedback-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Negative Feedback with cursor pagination and moderation hooks. (Negative Feedback scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/negative-feedback-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/negative-feedback-agent/advanced/SKILL.md`
