---
name: stream-heaven-growth-ai-skip-detection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Skip Detection (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Skip Detection — Basic

## When to use

- User invokes **Skip Detection** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/skip-detection-agent.md`
- **Role:** Skip Detection Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/skip-detection-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Skip Detection deliverables in growth-ai domain for Stream Heaven Phase 15. (Skip Detection scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/skip-detection-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/skip-detection-agent/advanced/SKILL.md`
