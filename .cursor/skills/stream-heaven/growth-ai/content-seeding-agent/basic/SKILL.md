---
name: stream-heaven-growth-ai-content-seeding-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Content Seeding (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Content Seeding — Basic

## When to use

- User invokes **Content Seeding** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/content-seeding-agent.md`
- **Role:** Content Seeding Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/content-seeding-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/content-seeding-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/content-seeding-agent/advanced/SKILL.md`
