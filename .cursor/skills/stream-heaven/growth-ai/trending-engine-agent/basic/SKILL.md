---
name: stream-heaven-growth-ai-trending-engine-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Trending Engine (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Trending Engine — Basic

## When to use

- User invokes **Trending Engine** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/trending-engine-agent.md`
- **Role:** Trending Engine Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/trending-engine-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Trending deliverables in growth-ai domain for Stream Heaven Phase 15. (Trending Engine scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/trending-engine-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/trending-engine-agent/advanced/SKILL.md`
