---
name: stream-heaven-growth-ai-notification-optimization-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Notification Optimization (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Notification Optimization — Advanced
