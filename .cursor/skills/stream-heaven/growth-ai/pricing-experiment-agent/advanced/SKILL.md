---
name: stream-heaven-growth-ai-pricing-experiment-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Pricing Experiment (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Pricing Experiment — Advanced
