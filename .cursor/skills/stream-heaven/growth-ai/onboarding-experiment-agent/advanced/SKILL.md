---
name: stream-heaven-growth-ai-onboarding-experiment-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Onboarding Experiment (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Onboarding Experiment — Advanced
