---
name: stream-heaven-growth-ai-onboarding-experiment-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Onboarding Experiment (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Onboarding Experiment — Basic

## When to use

- User invokes **Onboarding Experiment** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/onboarding-experiment-agent.md`
- **Role:** Onboarding Experiment Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/onboarding-experiment-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Onboarding Experiment deliverables in growth-ai domain for Stream Heaven Phase 15. (Onboarding Experiment scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/onboarding-experiment-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/onboarding-experiment-agent/advanced/SKILL.md`
