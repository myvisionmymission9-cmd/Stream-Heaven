---
name: stream-heaven-growth-ai-churn-prediction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Churn Prediction (phase 15).
...
- User invokes **Churn Prediction** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/churn-prediction-agent.md`
- **Role:** Churn Prediction Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/churn-prediction-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Churn Prediction deliverables in growth-ai domain for Stream Heaven Phase 15. (Churn Prediction scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/churn-prediction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/churn-prediction-agent/advanced/SKILL.md`
