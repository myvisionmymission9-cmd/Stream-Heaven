---
name: stream-heaven-growth-ai-smart-search-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Smart Search (phase 15).
...
- User invokes **Smart Search** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/smart-search-agent.md`
- **Role:** Smart Search Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/smart-search-agent.md` and copy its `## Prompt Template` block
...
### Indexing Pipeline
Build:
- Own Smart Search deliverables in growth-ai domain for Stream Heaven Phase 15. (Smart Search scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/smart-search-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/smart-search-agent/advanced/SKILL.md`
