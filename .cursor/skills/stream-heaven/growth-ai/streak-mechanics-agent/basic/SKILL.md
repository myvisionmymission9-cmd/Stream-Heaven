---
name: stream-heaven-growth-ai-streak-mechanics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Streak Mechanics (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Streak Mechanics — Basic

## When to use

- User invokes **Streak Mechanics** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/streak-mechanics-agent.md`
- **Role:** Streak Mechanics Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/streak-mechanics-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Streak Mechanics deliverables in growth-ai domain for Stream Heaven Phase 15. (Streak Mechanics scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/streak-mechanics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/streak-mechanics-agent/advanced/SKILL.md`
