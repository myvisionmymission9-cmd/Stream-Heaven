---
name: stream-heaven-growth-ai-ranking-system-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ranking System (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Ranking System — Basic

## When to use

- User invokes **Ranking System** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/ranking-system-agent.md`
- **Role:** Ranking System Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/ranking-system-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Ranking System ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Ranking System scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/ranking-system-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/ranking-system-agent/advanced/SKILL.md`
