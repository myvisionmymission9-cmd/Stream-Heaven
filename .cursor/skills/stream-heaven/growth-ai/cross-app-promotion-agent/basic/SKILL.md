---
name: stream-heaven-growth-ai-cross-app-promotion-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross App Promotion (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Cross App Promotion — Basic

## When to use

- User invokes **Cross App Promotion** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/cross-app-promotion-agent.md`
- **Role:** Cross App Promotion Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/cross-app-promotion-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Cross App Promotion deliverables in growth-ai domain for Stream Heaven Phase 15. (Cross App Promotion scope)
