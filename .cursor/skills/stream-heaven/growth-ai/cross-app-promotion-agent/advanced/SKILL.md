---
name: stream-heaven-growth-ai-cross-app-promotion-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross App Promotion (phase 15).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross App Promotion — Advanced
