---
name: stream-heaven-growth-ai-growth-hacker-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Growth Hacker (phase 15).
...
- Open agent: `ai-agents/growth-ai/growth-hacker-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement growth ai capabilities for Stream Heaven. (Growth Hacker scope)
