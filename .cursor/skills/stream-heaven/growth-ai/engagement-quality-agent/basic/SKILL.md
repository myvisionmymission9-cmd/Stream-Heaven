---
name: stream-heaven-growth-ai-engagement-quality-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Engagement Quality (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Engagement Quality — Basic

## When to use

- User invokes **Engagement Quality** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/engagement-quality-agent.md`
- **Role:** Engagement Quality Agent specialist for Stream Heaven's growth-ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/engagement-quality-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Engagement Quality deliverables in growth-ai domain for Stream Heaven Phase 15. (Engagement Quality scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/engagement-quality-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/engagement-quality-agent/advanced/SKILL.md`
