---
name: stream-heaven-growth-ai-social-share-incentive-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Share Incentive (phase 15).
  Single-agent execution with governance prefix and structural validation.
---

# Social Share Incentive — Basic

## When to use

- User invokes **Social Share Incentive** or work in **growth-ai** (phase 15)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/growth-ai/social-share-incentive-agent.md`
- **Role:** Social Share Incentive Agent specialist for Stream Heaven's growth ai domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/growth-ai/social-share-incentive-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Social Share Incentive with cursor pagination and moderation hooks. (Social Share Incentive scope)
...
- Basic: `.cursor/skills/stream-heaven/growth-ai/social-share-incentive-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/growth-ai/social-share-incentive-agent/advanced/SKILL.md`
