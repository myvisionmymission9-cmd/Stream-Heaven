---
name: stream-heaven-ml-platform-model-registry-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Model Registry (phase 20).
...
- User invokes **Model Registry** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/model-registry-agent.md`
- **Role:** Model Registry Agent specialist for Stream Heaven's ml platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/model-registry-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Model Registry ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Model Registry scope)
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/model-registry-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/model-registry-agent/advanced/SKILL.md`
