---
name: stream-heaven-ml-platform-feature-serving-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feature Serving (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Feature Serving — Basic

## When to use

- User invokes **Feature Serving** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/feature-serving-agent.md`
- **Role:** Feature Serving Agent specialist for Stream Heaven's ml platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/feature-serving-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Feature Serving deliverables in ml-platform domain for Stream Heaven Phase 20. (Feature Serving scope)
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/feature-serving-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/feature-serving-agent/advanced/SKILL.md`
