---
name: stream-heaven-ml-platform-inference-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Inference Optimization (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Inference Optimization — Basic

## When to use

- User invokes **Inference Optimization** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/inference-optimization-agent.md`
- **Role:** Inference Optimization Agent specialist for Stream Heaven's ml-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/inference-optimization-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Inference Optimization ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Inference Optimization scope)
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/inference-optimization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/inference-optimization-agent/advanced/SKILL.md`
