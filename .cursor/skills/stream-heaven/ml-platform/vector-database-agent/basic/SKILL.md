---
name: stream-heaven-ml-platform-vector-database-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Vector Database (phase 20).
...
- User invokes **Vector Database** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/vector-database-agent.md`
- **Role:** Vector Database Agent specialist for Stream Heaven's ml-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/vector-database-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/vector-database-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/vector-database-agent/advanced/SKILL.md`
