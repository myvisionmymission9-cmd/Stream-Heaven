---
name: stream-heaven-ml-platform-feature-engineering-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feature Engineering (phase 20).
...
- User invokes **Feature Engineering** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/feature-engineering-agent.md`
- **Role:** Feature Engineering Agent specialist for Stream Heaven's ml-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/feature-engineering-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Feature Engineering deliverables in ml-platform domain for Stream Heaven Phase 20. (Feature Engineering scope)
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/feature-engineering-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/feature-engineering-agent/advanced/SKILL.md`
