---
name: stream-heaven-ml-platform-model-monitoring-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Model Monitoring (phase 20).
...
- User invokes **Model Monitoring** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/model-monitoring-agent.md`
- **Role:** Model Monitoring Agent specialist for Stream Heaven's ml platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/model-monitoring-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Model Monitoring ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Model Monitoring scope)
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/model-monitoring-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/model-monitoring-agent/advanced/SKILL.md`
