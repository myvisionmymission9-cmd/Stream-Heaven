---
name: stream-heaven-ml-platform-embedding-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Embedding (phase 20).
...
- User invokes **Embedding** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/embedding-agent.md`
- **Role:** Embedding Agent specialist for Stream Heaven's ml-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/embedding-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Embedding ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Embedding scope)
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/embedding-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/embedding-agent/advanced/SKILL.md`
