---
name: stream-heaven-ml-platform-gpu-cluster-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gpu Cluster (phase 20).
...
- Open agent: `ai-agents/ml-platform/gpu-cluster-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Gpu Cluster deliverables in ml-platform domain for Stream Heaven Phase 20. (Gpu Cluster scope)
