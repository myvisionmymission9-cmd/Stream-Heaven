---
name: stream-heaven-ml-platform-model-serving-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Model Serving (phase 20).
...
- User invokes **Model Serving** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/model-serving-agent.md`
- **Role:** Model Serving Agent specialist for Stream Heaven's ml-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/model-serving-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Model Serving ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Model Serving scope)
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/model-serving-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/model-serving-agent/advanced/SKILL.md`
