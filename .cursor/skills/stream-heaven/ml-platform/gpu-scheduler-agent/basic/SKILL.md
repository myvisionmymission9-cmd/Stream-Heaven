---
name: stream-heaven-ml-platform-gpu-scheduler-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gpu Scheduler (phase 20).
...
- User invokes **Gpu Scheduler** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/gpu-scheduler-agent.md`
- **Role:** Gpu Scheduler Agent specialist for Stream Heaven's ml platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/gpu-scheduler-agent.md` and copy its `## Prompt Template` block
...
Design:
- Orchestrate Gpu Scheduler workflows across ai-agents/ with explicit task ownership and phase gates. (Gpu Scheduler scope)
