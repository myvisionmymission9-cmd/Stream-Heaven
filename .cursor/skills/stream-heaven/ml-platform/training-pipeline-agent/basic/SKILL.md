---
name: stream-heaven-ml-platform-training-pipeline-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Training Pipeline (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Training Pipeline — Basic

## When to use

- User invokes **Training Pipeline** or work in **ml-platform** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ml-platform/training-pipeline-agent.md`
- **Role:** Training Pipeline Agent specialist for Stream Heaven's ml-platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ml-platform/training-pipeline-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/ml-platform/training-pipeline-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ml-platform/training-pipeline-agent/advanced/SKILL.md`
