---
name: stream-heaven-core-engineering-reliability-chaos-engineering-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Chaos Engineering (phase 5).
...
- User invokes **Chaos Engineering** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/chaos-engineering-agent.md`
- **Role:** Platform chaos experiments (infra plane).

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/chaos-engineering-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Document ai-agents/core-engineering/reliability/chaos-engineering-agent.md standards in platform-governance and ADRs. (Chaos Engineering scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/reliability/chaos-engineering-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/reliability/chaos-engineering-agent/advanced/SKILL.md`
