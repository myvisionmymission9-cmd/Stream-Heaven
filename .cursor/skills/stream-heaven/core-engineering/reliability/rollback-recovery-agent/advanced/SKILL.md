---
name: stream-heaven-core-engineering-reliability-rollback-recovery-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Rollback Recovery (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Rollback Recovery — Advanced
