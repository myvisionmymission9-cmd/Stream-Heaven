---
name: stream-heaven-core-engineering-reliability-rollback-recovery-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Rollback Recovery (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Rollback Recovery — Basic

## When to use

- User invokes **Rollback Recovery** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/rollback-recovery-agent.md`
- **Role:** Rollback Recovery Agent specialist for Stream Heaven's reliability domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/rollback-recovery-agent.md` and copy its `## Prompt Template` block
