---
name: stream-heaven-core-engineering-reliability-production-debugging-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Production Debugging (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Production Debugging — Advanced
...
Architect:
- Define RED metrics, structured logs, and distributed traces for Production Debugging across NestJS and Flutter. (Production Debugging scope)
