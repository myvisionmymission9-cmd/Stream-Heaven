---
name: stream-heaven-core-engineering-reliability-incident-responder-basic
description: >-
  Basic Cursor skill for Stream Heaven Incident Responder (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Incident Responder — Basic

## When to use

- User invokes **Incident Responder** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/incident-responder.md`
- **Role:** Incident Responder specialist for Stream Heaven's reliability domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/incident-responder.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement reliability capabilities for Stream Heaven. (Incident Responder scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/reliability/incident-responder/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/reliability/incident-responder/advanced/SKILL.md`
