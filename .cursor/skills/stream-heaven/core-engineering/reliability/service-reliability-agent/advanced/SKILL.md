---
name: stream-heaven-core-engineering-reliability-service-reliability-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Service Reliability (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Service Reliability — Advanced
