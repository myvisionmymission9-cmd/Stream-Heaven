---
name: stream-heaven-core-engineering-reliability-service-reliability-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Service Reliability (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Service Reliability — Basic

## When to use

- User invokes **Service Reliability** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/service-reliability-agent.md`
- **Role:** Service Reliability Agent specialist for Stream Heaven's reliability domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/service-reliability-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Define RED metrics, structured logs, and distributed traces for Service Reliability across NestJS and Flutter. (Service Reliability scope)
