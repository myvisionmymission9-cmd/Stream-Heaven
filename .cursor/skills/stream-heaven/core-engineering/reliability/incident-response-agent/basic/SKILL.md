---
name: stream-heaven-core-engineering-reliability-incident-response-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Incident Response (phase 5).
...
- User invokes **Incident Response** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/incident-response-agent.md`
- **Role:** Incident Response Agent specialist for Stream Heaven's reliability domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/incident-response-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/reliability/incident-response-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/reliability/incident-response-agent/advanced/SKILL.md`
