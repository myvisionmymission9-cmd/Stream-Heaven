---
name: stream-heaven-core-engineering-reliability-sre-lead-basic
description: >-
  Basic Cursor skill for Stream Heaven Sre Lead (phase 5).
...
- User invokes **Sre Lead** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/sre-lead.md`
- **Role:** Sre Lead specialist for Stream Heaven's reliability domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/sre-lead.md` and copy its `## Prompt Template` block
...
Deploy:
- Define RED metrics, structured logs, and distributed traces for Sre across NestJS and Flutter. (Sre Lead scope)
