---
name: stream-heaven-core-engineering-reliability-capacity-planner-basic
description: >-
  Basic Cursor skill for Stream Heaven Capacity Planner (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Capacity Planner — Basic

## When to use

- User invokes **Capacity Planner** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/capacity-planner.md`
- **Role:** Capacity Planner specialist for Stream Heaven's reliability domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/capacity-planner.md` and copy its `## Prompt Template` block
...
Deploy:
- Define RED metrics, structured logs, and distributed traces for Capacity across NestJS and Flutter. (Capacity Planner scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/reliability/capacity-planner/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/reliability/capacity-planner/advanced/SKILL.md`
