---
name: stream-heaven-core-engineering-reliability-capacity-planner-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Capacity Planner (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Capacity Planner — Advanced
