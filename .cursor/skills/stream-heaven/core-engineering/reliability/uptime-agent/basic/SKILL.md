---
name: stream-heaven-core-engineering-reliability-uptime-agent-basic
description: >-
...
- User invokes **Uptime** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/uptime-agent.md`
- **Role:** Uptime SLOs, error budgets, status comms.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/uptime-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Document ai-agents/core-engineering/reliability/uptime-agent.md standards in platform-governance and ADRs. (Uptime scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/reliability/uptime-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/reliability/uptime-agent/advanced/SKILL.md`
