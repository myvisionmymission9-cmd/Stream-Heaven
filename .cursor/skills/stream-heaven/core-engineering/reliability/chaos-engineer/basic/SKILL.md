---
name: stream-heaven-core-engineering-reliability-chaos-engineer-basic
description: >-
  Basic Cursor skill for Stream Heaven Chaos Engineer (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Chaos Engineer — Basic

## When to use

- User invokes **Chaos Engineer** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/chaos-engineer.md`
- **Role:** Chaos Engineer specialist for Stream Heaven's reliability domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/chaos-engineer.md` and copy its `## Prompt Template` block
...
Deploy:
- Define RED metrics, structured logs, and distributed traces for Chaos across NestJS and Flutter. (Chaos Engineer scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/reliability/chaos-engineer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/reliability/chaos-engineer/advanced/SKILL.md`
