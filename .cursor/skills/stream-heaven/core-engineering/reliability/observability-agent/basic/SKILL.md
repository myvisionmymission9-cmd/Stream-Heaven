---
name: stream-heaven-core-engineering-reliability-observability-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Observability (phase 5).
...
- Open agent: `ai-agents/core-engineering/reliability/observability-agent.md` and copy its `## Prompt Template` block
