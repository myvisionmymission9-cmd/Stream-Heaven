---
name: stream-heaven-core-engineering-reliability-sla-monitor-basic
description: >-
  Basic Cursor skill for Stream Heaven Sla Monitor (phase 5).
...
- User invokes **Sla Monitor** or work in **core-engineering/reliability** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/reliability/sla-monitor.md`
- **Role:** Sla Monitor specialist for Stream Heaven's reliability domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/reliability/sla-monitor.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement reliability capabilities for Stream Heaven. (Sla Monitor scope)
