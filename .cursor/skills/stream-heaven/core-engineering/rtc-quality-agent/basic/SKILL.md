---
name: stream-heaven-core-engineering-rtc-quality-agent-basic
description: >-
...
- User invokes **Rtc Quality** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/rtc-quality-agent.md`
- **Role:** Ai Agents/Core Engineering/Rtc Quality specialist for Stream Heaven's realtime domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/rtc-quality-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Aggregate RTC MOS, packet loss, and jitter from client telemetry. (Rtc Quality scope)
