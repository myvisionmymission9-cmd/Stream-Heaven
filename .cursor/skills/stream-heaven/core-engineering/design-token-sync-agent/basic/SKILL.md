---
name: stream-heaven-core-engineering-design-token-sync-agent-basic
description: >-
...
- User invokes **Design Token Sync** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/design-token-sync-agent.md`
- **Role:** Ai Agents/Core Engineering/Design Token Sync specialist for Stream Heaven's design-system domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/design-token-sync-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Automate token export pipeline from figma-sync-coordinator workflows. (Design Token Sync scope)
