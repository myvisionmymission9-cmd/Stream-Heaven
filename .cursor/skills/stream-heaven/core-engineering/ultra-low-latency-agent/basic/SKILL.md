---
name: stream-heaven-core-engineering-ultra-low-latency-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ultra Low Latency (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Ultra Low Latency — Basic

## When to use

- User invokes **Ultra Low Latency** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/ultra-low-latency-agent.md`
- **Role:** Ai Agents/Core Engineering/Ultra Low Latency specialist for Stream Heaven's realtime domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/ultra-low-latency-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Define when services must use LL RTC profiles vs standard CDN. (Ultra Low Latency scope)
