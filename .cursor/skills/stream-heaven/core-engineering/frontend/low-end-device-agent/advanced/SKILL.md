---
name: stream-heaven-core-engineering-frontend-low-end-device-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Low End Device (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Low End Device — Advanced
