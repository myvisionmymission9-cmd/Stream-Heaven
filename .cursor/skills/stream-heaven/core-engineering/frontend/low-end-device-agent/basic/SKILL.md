---
name: stream-heaven-core-engineering-frontend-low-end-device-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Low End Device (phase 5).
...
- User invokes **Low End Device** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/low-end-device-agent.md`
- **Role:** Low End Device Agent specialist for Stream Heaven's frontend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/low-end-device-agent.md` and copy its `## Prompt Template` block
...
Define:
- Implement Low End Device in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Low End Device scope)
