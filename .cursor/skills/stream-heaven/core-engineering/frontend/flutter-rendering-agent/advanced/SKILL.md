---
name: stream-heaven-core-engineering-frontend-flutter-rendering-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Flutter Rendering (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Flutter Rendering — Advanced
