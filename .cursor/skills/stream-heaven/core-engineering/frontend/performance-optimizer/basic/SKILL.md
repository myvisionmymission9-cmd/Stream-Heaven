---
name: stream-heaven-core-engineering-frontend-performance-optimizer-basic
description: >-
  Basic Cursor skill for Stream Heaven Performance Optimizer (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Performance Optimizer — Basic

## When to use

- User invokes **Performance Optimizer** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/performance-optimizer.md`
- **Role:** Performance Optimizer specialist for Stream Heaven's frontend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/performance-optimizer.md` and copy its `## Prompt Template` block
...
Define:
- Design and implement frontend capabilities for Stream Heaven. (Performance Optimizer scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/frontend/performance-optimizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/frontend/performance-optimizer/advanced/SKILL.md`
