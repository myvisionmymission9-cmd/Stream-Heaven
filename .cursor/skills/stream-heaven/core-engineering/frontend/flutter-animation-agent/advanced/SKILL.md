---
name: stream-heaven-core-engineering-frontend-flutter-animation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Flutter Animation (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Flutter Animation — Advanced
