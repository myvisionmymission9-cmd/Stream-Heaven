---
name: stream-heaven-core-engineering-frontend-flutter-animation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Flutter Animation (phase 5).
...
- User invokes **Flutter Animation** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/flutter-animation-agent.md`
- **Role:** Flutter Animation Agent specialist for Stream Heaven's frontend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/flutter-animation-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/frontend/flutter-animation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/frontend/flutter-animation-agent/advanced/SKILL.md`
