---
name: stream-heaven-core-engineering-frontend-widget-library-curator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Widget Library Curator (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Widget Library Curator — Advanced
