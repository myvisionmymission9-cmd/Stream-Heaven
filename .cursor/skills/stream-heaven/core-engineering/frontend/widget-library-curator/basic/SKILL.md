---
name: stream-heaven-core-engineering-frontend-widget-library-curator-basic
description: >-
  Basic Cursor skill for Stream Heaven Widget Library Curator (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Widget Library Curator — Basic

## When to use

- User invokes **Widget Library Curator** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/widget-library-curator.md`
- **Role:** Widget Library Curator specialist for Stream Heaven's frontend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/widget-library-curator.md` and copy its `## Prompt Template` block
...
Define:
- Implement Widget Library in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Widget Library Curator scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/frontend/widget-library-curator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/frontend/widget-library-curator/advanced/SKILL.md`
