---
name: stream-heaven-core-engineering-frontend-frontend-flutter-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Frontend Flutter (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Frontend Flutter — Advanced
