---
name: stream-heaven-core-engineering-frontend-frontend-flutter-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Frontend Flutter (phase 5).
...
- User invokes **Frontend Flutter** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/frontend-flutter-agent.md`
- **Role:** Frontend Flutter Agent specialist for Stream Heaven's frontend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/frontend-flutter-agent.md` and copy its `## Prompt Template` block
...
Define:
- Implement Frontend Flutter in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Frontend Flutter scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/frontend/frontend-flutter-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/frontend/frontend-flutter-agent/advanced/SKILL.md`
