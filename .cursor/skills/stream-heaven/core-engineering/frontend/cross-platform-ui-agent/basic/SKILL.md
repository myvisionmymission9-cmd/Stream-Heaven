---
name: stream-heaven-core-engineering-frontend-cross-platform-ui-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross Platform Ui (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Cross Platform Ui — Basic

## When to use

- User invokes **Cross Platform Ui** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/cross-platform-ui-agent.md`
- **Role:** Cross Platform Ui Agent specialist for Stream Heaven's frontend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/cross-platform-ui-agent.md` and copy its `## Prompt Template` block
...
Define:
- Implement Cross Platform Ui in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Cross Platform Ui scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/frontend/cross-platform-ui-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/frontend/cross-platform-ui-agent/advanced/SKILL.md`
