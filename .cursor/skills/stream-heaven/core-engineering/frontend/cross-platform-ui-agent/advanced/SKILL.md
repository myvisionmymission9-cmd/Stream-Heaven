---
name: stream-heaven-core-engineering-frontend-cross-platform-ui-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross Platform Ui (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross Platform Ui — Advanced
