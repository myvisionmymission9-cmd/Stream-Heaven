---
name: stream-heaven-core-engineering-frontend-routing-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Routing Specialist (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Routing Specialist — Basic

## When to use

- User invokes **Routing Specialist** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/routing-specialist.md`
- **Role:** Routing Specialist specialist for Stream Heaven's frontend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/routing-specialist.md` and copy its `## Prompt Template` block
...
Define:
- Implement Routing in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Routing Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/frontend/routing-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/frontend/routing-specialist/advanced/SKILL.md`
