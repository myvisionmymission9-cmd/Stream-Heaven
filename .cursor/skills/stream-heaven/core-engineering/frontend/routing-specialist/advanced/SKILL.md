---
name: stream-heaven-core-engineering-frontend-routing-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Routing Specialist (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Routing Specialist — Advanced
