---
name: stream-heaven-core-engineering-frontend-riverpod-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Riverpod Specialist (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Riverpod Specialist — Advanced
