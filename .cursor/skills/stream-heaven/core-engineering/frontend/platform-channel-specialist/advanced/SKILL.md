---
name: stream-heaven-core-engineering-frontend-platform-channel-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Platform Channel Specialist (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Platform Channel Specialist — Advanced
