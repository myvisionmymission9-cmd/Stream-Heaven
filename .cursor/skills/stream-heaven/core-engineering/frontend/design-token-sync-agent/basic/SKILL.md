---
name: stream-heaven-core-engineering-frontend-design-token-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Design Token Sync (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Design Token Sync — Basic

## When to use

- User invokes **Design Token Sync** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/design-token-sync-agent.md`
- **Role:** Design token sync Figma → Flutter theme extensions.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/design-token-sync-agent.md` and copy its `## Prompt Template` block
...
Define:
- Document ai-agents/core-engineering/frontend/design-token-sync-agent.md standards in platform-governance and ADRs. (Design Token Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/frontend/design-token-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/frontend/design-token-sync-agent/advanced/SKILL.md`
