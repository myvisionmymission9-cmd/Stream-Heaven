---
name: stream-heaven-core-engineering-frontend-design-token-sync-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Design Token Sync (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Design Token Sync — Advanced
