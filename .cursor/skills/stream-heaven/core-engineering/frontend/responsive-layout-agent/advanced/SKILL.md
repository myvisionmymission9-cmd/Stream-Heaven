---
name: stream-heaven-core-engineering-frontend-responsive-layout-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Responsive Layout (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Responsive Layout — Advanced
