---
name: stream-heaven-core-engineering-frontend-responsive-layout-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Responsive Layout (phase 5).
...
- User invokes **Responsive Layout** or work in **core-engineering/frontend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/frontend/responsive-layout-agent.md`
- **Role:** Responsive Layout Agent specialist for Stream Heaven's frontend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/frontend/responsive-layout-agent.md` and copy its `## Prompt Template` block
...
Define:
- Implement Responsive Layout in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Responsive Layout scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/frontend/responsive-layout-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/frontend/responsive-layout-agent/advanced/SKILL.md`
