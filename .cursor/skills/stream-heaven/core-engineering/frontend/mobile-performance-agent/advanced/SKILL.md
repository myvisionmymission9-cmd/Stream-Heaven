---
name: stream-heaven-core-engineering-frontend-mobile-performance-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Mobile Performance (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Mobile Performance — Advanced
...
Architect:
- Implement Mobile Performance in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Mobile Performance scope)
