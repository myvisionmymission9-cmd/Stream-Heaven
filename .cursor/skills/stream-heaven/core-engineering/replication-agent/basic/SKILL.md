---
name: stream-heaven-core-engineering-replication-agent-basic
description: >-
...
- User invokes **Replication** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/replication-agent.md`
- **Role:** Ai Agents/Core Engineering/Replication specialist for Stream Heaven's database domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/replication-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design read replica routing for analytics and search heavy queries. (Replication scope)
