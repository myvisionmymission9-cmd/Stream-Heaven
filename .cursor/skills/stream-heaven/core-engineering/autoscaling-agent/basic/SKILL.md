---
name: stream-heaven-core-engineering-autoscaling-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Autoscaling (phase 5).
...
- User invokes **Autoscaling** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/autoscaling-agent.md`
- **Role:** Ai Agents/Core Engineering/Autoscaling specialist for Stream Heaven's infrastructure domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/autoscaling-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Define scaling policies on CPU, queue depth, and Socket.IO connections. (Autoscaling scope)
