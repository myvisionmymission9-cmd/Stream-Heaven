---
name: stream-heaven-core-engineering-voice-sync-agent-basic
description: >-
...
- User invokes **Voice Sync** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/voice-sync-agent.md`
- **Role:** Ai Agents/Core Engineering/Voice Sync specialist for Stream Heaven's realtime domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/voice-sync-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Measure A/V offset using client-side correlation algorithms. (Voice Sync scope)
