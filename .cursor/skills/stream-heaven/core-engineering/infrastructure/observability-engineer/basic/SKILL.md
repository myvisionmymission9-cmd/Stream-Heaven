---
name: stream-heaven-core-engineering-infrastructure-observability-engineer-basic
description: >-
  Basic Cursor skill for Stream Heaven Observability Engineer (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Observability Engineer — Basic

## When to use

- User invokes **Observability Engineer** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/observability-engineer.md`
- **Role:** Observability Engineer specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/observability-engineer.md` and copy its `## Prompt Template` block
...
Deploy:
- Define RED metrics, structured logs, and distributed traces for Observability across NestJS and Flutter. (Observability Engineer scope)
