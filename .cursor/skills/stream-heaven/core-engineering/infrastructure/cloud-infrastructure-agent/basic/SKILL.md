---
name: stream-heaven-core-engineering-infrastructure-cloud-infrastructure-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cloud Infrastructure (phase 5).
...
- User invokes **Cloud Infrastructure** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/cloud-infrastructure-agent.md`
- **Role:** Cloud Infrastructure Agent specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/cloud-infrastructure-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Design AWS and Cloudflare topology for Cloud Infrastructure: compute, CDN, WAF, and Secrets Manager usage. (Cloud Infrastructure scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/cloud-infrastructure-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/cloud-infrastructure-agent/advanced/SKILL.md`
