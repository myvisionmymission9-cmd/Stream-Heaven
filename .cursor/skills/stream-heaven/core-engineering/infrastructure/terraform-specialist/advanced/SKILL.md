---
name: stream-heaven-core-engineering-infrastructure-terraform-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Terraform Specialist (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Terraform Specialist — Advanced
...
Architect:
- Design and implement infrastructure capabilities for Stream Heaven. (Terraform Specialist scope)
