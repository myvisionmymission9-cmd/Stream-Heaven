---
name: stream-heaven-core-engineering-infrastructure-geo-routing-agent-basic
description: >-
...
- User invokes **Geo Routing** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/geo-routing-agent.md`
- **Role:** Geo DNS and traffic routing.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/geo-routing-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Document ai-agents/core-engineering/infrastructure/geo-routing-agent.md standards in platform-governance and ADRs. (Geo Routing scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/geo-routing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/geo-routing-agent/advanced/SKILL.md`
