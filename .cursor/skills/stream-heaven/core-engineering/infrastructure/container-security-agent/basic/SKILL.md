---
name: stream-heaven-core-engineering-infrastructure-container-security-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Container Security (phase 5).
...
- User invokes **Container Security** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/container-security-agent.md`
- **Role:** Container Security Agent specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/container-security-agent.md` and copy its `## Prompt Template` block
