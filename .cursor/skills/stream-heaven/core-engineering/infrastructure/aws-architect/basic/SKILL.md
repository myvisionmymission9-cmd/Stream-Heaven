---
name: stream-heaven-core-engineering-infrastructure-aws-architect-basic
description: >-
  Basic Cursor skill for Stream Heaven Aws Architect (phase 5).
...
- User invokes **Aws Architect** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/aws-architect.md`
- **Role:** Aws Architect specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/aws-architect.md` and copy its `## Prompt Template` block
...
Deploy:
- Design AWS and Cloudflare topology for Aws: compute, CDN, WAF, and Secrets Manager usage. (Aws Architect scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/aws-architect/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/aws-architect/advanced/SKILL.md`
