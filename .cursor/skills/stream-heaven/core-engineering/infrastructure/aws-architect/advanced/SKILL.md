---
name: stream-heaven-core-engineering-infrastructure-aws-architect-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Aws Architect (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Aws Architect — Advanced
