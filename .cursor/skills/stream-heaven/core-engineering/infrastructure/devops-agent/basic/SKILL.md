---
name: stream-heaven-core-engineering-infrastructure-devops-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Devops (phase 5).
...
- User invokes **Devops** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/devops-agent.md`
- **Role:** Devops Agent specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/devops-agent.md` and copy its `## Prompt Template` block
