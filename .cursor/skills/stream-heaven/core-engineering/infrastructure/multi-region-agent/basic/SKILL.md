---
name: stream-heaven-core-engineering-infrastructure-multi-region-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Multi Region (phase 5).
...
- User invokes **Multi Region** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/multi-region-agent.md`
- **Role:** Multi Region Agent specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/multi-region-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Design AWS and Cloudflare topology for Multi Region: compute, CDN, WAF, and Secrets Manager usage. (Multi Region scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/multi-region-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/multi-region-agent/advanced/SKILL.md`
