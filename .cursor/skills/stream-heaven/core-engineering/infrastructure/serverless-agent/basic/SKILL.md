---
name: stream-heaven-core-engineering-infrastructure-serverless-agent-basic
description: >-
...
- User invokes **Serverless** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/serverless-agent.md`
- **Role:** Lambda/serverless for burst workloads.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/serverless-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Document ai-agents/core-engineering/infrastructure/serverless-agent.md standards in platform-governance and ADRs. (Serverless scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/serverless-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/serverless-agent/advanced/SKILL.md`
