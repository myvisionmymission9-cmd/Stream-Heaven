---
name: stream-heaven-core-engineering-infrastructure-edge-caching-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Edge Caching (phase 5).
...
- User invokes **Edge Caching** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/edge-caching-agent.md`
- **Role:** Edge Caching Agent specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/edge-caching-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/edge-caching-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/edge-caching-agent/advanced/SKILL.md`
