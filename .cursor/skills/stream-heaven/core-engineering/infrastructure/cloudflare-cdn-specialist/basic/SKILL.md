---
name: stream-heaven-core-engineering-infrastructure-cloudflare-cdn-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Cloudflare Cdn Specialist (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Cloudflare Cdn Specialist — Basic
...
- Open agent: `ai-agents/core-engineering/infrastructure/cloudflare-cdn-specialist.md` and copy its `## Prompt Template` block
...
Build:
- Own Cloudflare Cdn media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Cloudflare Cdn Specialist scope)
