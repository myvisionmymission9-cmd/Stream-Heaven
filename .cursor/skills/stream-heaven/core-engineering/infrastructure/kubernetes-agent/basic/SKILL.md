---
name: stream-heaven-core-engineering-infrastructure-kubernetes-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Kubernetes (phase 5).
...
- User invokes **Kubernetes** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/kubernetes-agent.md`
- **Role:** Kubernetes Agent specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/kubernetes-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Design AWS and Cloudflare topology for Kubernetes: compute, CDN, WAF, and Secrets Manager usage. (Kubernetes scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/kubernetes-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/kubernetes-agent/advanced/SKILL.md`
