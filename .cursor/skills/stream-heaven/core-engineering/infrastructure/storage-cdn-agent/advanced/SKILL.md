---
name: stream-heaven-core-engineering-infrastructure-storage-cdn-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Storage Cdn (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Storage Cdn — Advanced
