---
name: stream-heaven-core-engineering-infrastructure-storage-cdn-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Storage Cdn (phase 5).
...
- User invokes **Storage Cdn** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/storage-cdn-agent.md`
- **Role:** Storage Cdn Agent specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/storage-cdn-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Storage Cdn media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Storage Cdn scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/storage-cdn-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/storage-cdn-agent/advanced/SKILL.md`
