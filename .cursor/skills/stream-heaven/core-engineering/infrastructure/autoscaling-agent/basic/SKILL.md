---
name: stream-heaven-core-engineering-infrastructure-autoscaling-agent-basic
description: >-
...
- User invokes **Autoscaling** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/autoscaling-agent.md`
- **Role:** HPA/cluster autoscaling policies.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/autoscaling-agent.md` and copy its `## Prompt Template` block
...
Deploy:
- Document ai-agents/core-engineering/infrastructure/autoscaling-agent.md standards in platform-governance and ADRs. (Autoscaling scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/autoscaling-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/autoscaling-agent/advanced/SKILL.md`
