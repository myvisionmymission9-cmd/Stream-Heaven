---
name: stream-heaven-core-engineering-infrastructure-k8s-operator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven K8s Operator (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# K8s Operator — Advanced
