---
name: stream-heaven-core-engineering-infrastructure-k8s-operator-basic
description: >-
  Basic Cursor skill for Stream Heaven K8s Operator (phase 5).
...
- User invokes **K8s Operator** or work in **core-engineering/infrastructure** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/infrastructure/k8s-operator.md`
- **Role:** K8s Operator specialist for Stream Heaven's infrastructure domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/infrastructure/k8s-operator.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement infrastructure capabilities for Stream Heaven. (K8s Operator scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/infrastructure/k8s-operator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/infrastructure/k8s-operator/advanced/SKILL.md`
