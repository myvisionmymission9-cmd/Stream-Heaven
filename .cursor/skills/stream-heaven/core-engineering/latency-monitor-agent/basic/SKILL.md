---
name: stream-heaven-core-engineering-latency-monitor-agent-basic
description: >-
...
- User invokes **Latency Monitor** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/latency-monitor-agent.md`
- **Role:** Ai Agents/Core Engineering/Latency Monitor specialist for Stream Heaven's realtime domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/latency-monitor-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Deploy synthetic probes measuring glass-to-glass live latency. (Latency Monitor scope)
