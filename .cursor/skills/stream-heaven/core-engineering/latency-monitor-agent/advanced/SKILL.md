---
name: stream-heaven-core-engineering-latency-monitor-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Latency Monitor (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Latency Monitor — Advanced
