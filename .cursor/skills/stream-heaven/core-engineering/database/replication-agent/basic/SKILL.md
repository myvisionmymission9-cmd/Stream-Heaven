---
name: stream-heaven-core-engineering-database-replication-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Replication (phase 5).
...
- User invokes **Replication** or work in **core-engineering/database** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/database/replication-agent.md`
- **Role:** Postgres replication, lag monitoring, failover.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/database/replication-agent.md` and copy its `## Prompt Template` block
...
### Cache Key Design
Design:
- Document ai-agents/core-engineering/database/replication-agent.md standards in platform-governance and ADRs. (Replication scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/database/replication-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/database/replication-agent/advanced/SKILL.md`
