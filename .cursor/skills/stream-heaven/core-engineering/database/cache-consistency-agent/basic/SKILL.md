---
name: stream-heaven-core-engineering-database-cache-consistency-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cache Consistency (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Cache Consistency — Basic

## When to use

- User invokes **Cache Consistency** or work in **core-engineering/database** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/database/cache-consistency-agent.md`
- **Role:** Cache Consistency Agent specialist for Stream Heaven's database domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/database/cache-consistency-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/database/cache-consistency-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/database/cache-consistency-agent/advanced/SKILL.md`
