---
name: stream-heaven-core-engineering-database-cache-consistency-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cache Consistency (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cache Consistency — Advanced
