---
name: stream-heaven-core-engineering-database-sharding-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Sharding (phase 5).
...
- User invokes **Sharding** or work in **core-engineering/database** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/database/sharding-agent.md`
- **Role:** Sharding strategy for hot social/live tables.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/database/sharding-agent.md` and copy its `## Prompt Template` block
...
### Cache Key Design
Design:
- Document ai-agents/core-engineering/database/sharding-agent.md standards in platform-governance and ADRs. (Sharding scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/database/sharding-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/database/sharding-agent/advanced/SKILL.md`
