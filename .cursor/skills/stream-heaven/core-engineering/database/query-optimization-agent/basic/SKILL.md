---
name: stream-heaven-core-engineering-database-query-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Query Optimization (phase 5).
...
- User invokes **Query Optimization** or work in **core-engineering/database** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/database/query-optimization-agent.md`
- **Role:** Query Optimization Agent specialist for Stream Heaven's database domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/database/query-optimization-agent.md` and copy its `## Prompt Template` block
...
### Cache Key Design
Design:
- Design PostgreSQL schemas, indexes, and migrations for Query Optimization with rollback plans. (Query Optimization scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/database/query-optimization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/database/query-optimization-agent/advanced/SKILL.md`
