---
name: stream-heaven-core-engineering-database-query-optimizer-basic
description: >-
  Basic Cursor skill for Stream Heaven Query Optimizer (phase 5).
...
- User invokes **Query Optimizer** or work in **core-engineering/database** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/database/query-optimizer.md`
- **Role:** Query Optimizer specialist for Stream Heaven's database domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/database/query-optimizer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement database capabilities for Stream Heaven. (Query Optimizer scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/database/query-optimizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/database/query-optimizer/advanced/SKILL.md`
