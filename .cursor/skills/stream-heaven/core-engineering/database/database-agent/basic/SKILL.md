---
name: stream-heaven-core-engineering-database-database-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Database (phase 5).
...
- User invokes **Database** or work in **core-engineering/database** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/database/database-agent.md`
- **Role:** Database Agent specialist for Stream Heaven's database domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/database/database-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/database/database-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/database/database-agent/advanced/SKILL.md`
