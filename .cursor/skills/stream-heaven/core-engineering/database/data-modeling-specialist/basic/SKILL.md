---
name: stream-heaven-core-engineering-database-data-modeling-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Data Modeling Specialist (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Data Modeling Specialist — Basic
...
- Open agent: `ai-agents/core-engineering/database/data-modeling-specialist.md` and copy its `## Prompt Template` block
