---
name: stream-heaven-core-engineering-database-multi-region-database-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Multi Region Database (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Multi Region Database — Basic

## When to use

- User invokes **Multi Region Database** or work in **core-engineering/database** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/database/multi-region-database-agent.md`
- **Role:** Multi Region Database Agent specialist for Stream Heaven's database domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/database/multi-region-database-agent.md` and copy its `## Prompt Template` block
...
### Cache Key Design
Design:
- Design PostgreSQL schemas, indexes, and migrations for Multi Region Database with rollback plans. (Multi Region Database scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/database/multi-region-database-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/database/multi-region-database-agent/advanced/SKILL.md`
