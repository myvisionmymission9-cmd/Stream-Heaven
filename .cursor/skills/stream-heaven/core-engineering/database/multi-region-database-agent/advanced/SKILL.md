---
name: stream-heaven-core-engineering-database-multi-region-database-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Multi Region Database (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Multi Region Database — Advanced
