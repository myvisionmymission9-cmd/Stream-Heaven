---
name: stream-heaven-core-engineering-database-database-scaling-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Database Scaling (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Database Scaling — Basic

## When to use

- User invokes **Database Scaling** or work in **core-engineering/database** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/database/database-scaling-agent.md`
- **Role:** Database Scaling Agent specialist for Stream Heaven's database domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/database/database-scaling-agent.md` and copy its `## Prompt Template` block
...
### Cache Key Design
Design:
- Design PostgreSQL schemas, indexes, and migrations for Database Scaling with rollback plans. (Database Scaling scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/database/database-scaling-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/database/database-scaling-agent/advanced/SKILL.md`
