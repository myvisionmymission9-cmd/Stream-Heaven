---
name: stream-heaven-core-engineering-background-jobs-agent-basic
description: >-
...
- User invokes **Background Jobs** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/background-jobs-agent.md`
- **Role:** Ai Agents/Core Engineering/Background Jobs specialist for Stream Heaven's backend domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/background-jobs-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Standardize NestJS @Cron and distributed lock usage via Redis. (Background Jobs scope)
