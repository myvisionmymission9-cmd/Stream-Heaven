---
name: stream-heaven-core-engineering-realtime-packet-loss-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Packet Loss (phase 5).
...
- User invokes **Packet Loss** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/packet-loss-agent.md`
- **Role:** Packet Loss Agent specialist for Stream Heaven's realtime domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/packet-loss-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Socket.IO namespaces and Redis adapter scale plan for Packet Loss. (Packet Loss scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/realtime/packet-loss-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/realtime/packet-loss-agent/advanced/SKILL.md`
