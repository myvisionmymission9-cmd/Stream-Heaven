---
name: stream-heaven-core-engineering-realtime-reconnection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reconnection (phase 5).
...
- Open agent: `ai-agents/core-engineering/realtime/reconnection-agent.md` and copy its `## Prompt Template` block
