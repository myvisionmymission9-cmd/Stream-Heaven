---
name: stream-heaven-core-engineering-realtime-websocket-scaler-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Websocket Scaler (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Websocket Scaler — Advanced
