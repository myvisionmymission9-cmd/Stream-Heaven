---
name: stream-heaven-core-engineering-realtime-websocket-scaler-basic
description: >-
  Basic Cursor skill for Stream Heaven Websocket Scaler (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Websocket Scaler — Basic

## When to use

- User invokes **Websocket Scaler** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/websocket-scaler.md`
- **Role:** Websocket Scaler specialist for Stream Heaven's realtime domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/websocket-scaler.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement realtime capabilities for Stream Heaven. (Websocket Scaler scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/realtime/websocket-scaler/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/realtime/websocket-scaler/advanced/SKILL.md`
