---
name: stream-heaven-core-engineering-realtime-rtc-quality-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Rtc Quality (phase 5).
...
- User invokes **Rtc Quality** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/rtc-quality-agent.md`
- **Role:** RTC quality scoring and provider failover.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/rtc-quality-agent.md` and copy its `## Prompt Template` block
...
Design:
- Document ai-agents/core-engineering/realtime/rtc-quality-agent.md standards in platform-governance and ADRs. (Rtc Quality scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/realtime/rtc-quality-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/realtime/rtc-quality-agent/advanced/SKILL.md`
