---
name: stream-heaven-core-engineering-realtime-rtc-quality-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Rtc Quality (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Rtc Quality — Advanced
