---
name: stream-heaven-core-engineering-realtime-ultra-low-latency-agent-basic
description: >-
...
- User invokes **Ultra Low Latency** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/ultra-low-latency-agent.md`
- **Role:** Ultra-low-latency RTC tuning guides.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/ultra-low-latency-agent.md` and copy its `## Prompt Template` block
...
Design:
- Document ai-agents/core-engineering/realtime/ultra-low-latency-agent.md standards in platform-governance and ADRs. (Ultra Low Latency scope)
