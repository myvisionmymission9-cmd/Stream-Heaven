---
name: stream-heaven-core-engineering-realtime-event-broadcaster-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Event Broadcaster (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Event Broadcaster — Advanced
