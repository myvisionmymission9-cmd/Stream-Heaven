---
name: stream-heaven-core-engineering-realtime-event-broadcaster-basic
description: >-
  Basic Cursor skill for Stream Heaven Event Broadcaster (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Event Broadcaster — Basic

## When to use

- User invokes **Event Broadcaster** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/event-broadcaster.md`
- **Role:** Event Broadcaster specialist for Stream Heaven's realtime domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/event-broadcaster.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement realtime capabilities for Stream Heaven. (Event Broadcaster scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/realtime/event-broadcaster/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/realtime/event-broadcaster/advanced/SKILL.md`
