---
name: stream-heaven-core-engineering-realtime-presence-manager-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Presence Manager (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Presence Manager — Advanced
