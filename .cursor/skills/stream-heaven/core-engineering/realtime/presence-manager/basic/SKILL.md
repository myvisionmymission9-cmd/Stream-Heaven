---
name: stream-heaven-core-engineering-realtime-presence-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Presence Manager (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Presence Manager — Basic

## When to use

- User invokes **Presence Manager** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/presence-manager.md`
- **Role:** Presence Manager specialist for Stream Heaven's realtime domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/presence-manager.md` and copy its `## Prompt Template` block
