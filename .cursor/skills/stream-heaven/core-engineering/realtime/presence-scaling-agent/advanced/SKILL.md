---
name: stream-heaven-core-engineering-realtime-presence-scaling-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Presence Scaling (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Presence Scaling — Advanced
...
Scale:
- Design and implement realtime capabilities for Stream Heaven. (Presence Scaling scope)
