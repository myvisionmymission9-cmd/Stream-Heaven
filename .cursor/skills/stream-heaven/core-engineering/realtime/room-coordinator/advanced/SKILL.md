---
name: stream-heaven-core-engineering-realtime-room-coordinator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Room Coordinator (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Room Coordinator — Advanced
