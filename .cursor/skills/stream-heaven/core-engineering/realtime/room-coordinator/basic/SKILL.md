---
name: stream-heaven-core-engineering-realtime-room-coordinator-basic
description: >-
  Basic Cursor skill for Stream Heaven Room Coordinator (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Room Coordinator — Basic

## When to use

- User invokes **Room Coordinator** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/room-coordinator.md`
- **Role:** Room Coordinator specialist for Stream Heaven's realtime domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/room-coordinator.md` and copy its `## Prompt Template` block
...
Design:
- Design Socket.IO namespaces and Redis adapter scale plan for Room. (Room Coordinator scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/realtime/room-coordinator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/realtime/room-coordinator/advanced/SKILL.md`
