---
name: stream-heaven-core-engineering-realtime-voice-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Voice Sync (phase 5).
...
- User invokes **Voice Sync** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/voice-sync-agent.md`
- **Role:** Voice sync lip-alignment for co-hosts.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/voice-sync-agent.md` and copy its `## Prompt Template` block
...
Design:
- Document ai-agents/core-engineering/realtime/voice-sync-agent.md standards in platform-governance and ADRs. (Voice Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/realtime/voice-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/realtime/voice-sync-agent/advanced/SKILL.md`
