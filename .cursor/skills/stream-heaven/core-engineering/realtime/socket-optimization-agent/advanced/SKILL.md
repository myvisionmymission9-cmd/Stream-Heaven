---
name: stream-heaven-core-engineering-realtime-socket-optimization-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Socket Optimization (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Socket Optimization — Advanced
