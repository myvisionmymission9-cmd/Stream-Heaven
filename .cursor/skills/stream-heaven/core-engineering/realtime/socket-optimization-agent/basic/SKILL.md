---
name: stream-heaven-core-engineering-realtime-socket-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Socket Optimization (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Socket Optimization — Basic

## When to use

- User invokes **Socket Optimization** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/socket-optimization-agent.md`
- **Role:** Socket Optimization Agent specialist for Stream Heaven's realtime domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/socket-optimization-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Socket.IO namespaces and Redis adapter scale plan for Socket Optimization. (Socket Optimization scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/realtime/socket-optimization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/realtime/socket-optimization-agent/advanced/SKILL.md`
