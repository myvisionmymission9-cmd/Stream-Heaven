---
name: stream-heaven-core-engineering-realtime-realtime-failover-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Realtime Failover (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Realtime Failover — Advanced
