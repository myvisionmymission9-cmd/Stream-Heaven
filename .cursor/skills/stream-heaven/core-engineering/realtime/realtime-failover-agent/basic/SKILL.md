---
name: stream-heaven-core-engineering-realtime-realtime-failover-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Realtime Failover (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Realtime Failover — Basic

## When to use

- User invokes **Realtime Failover** or work in **core-engineering/realtime** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/realtime/realtime-failover-agent.md`
- **Role:** Realtime Failover Agent specialist for Stream Heaven's realtime domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/realtime/realtime-failover-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Socket.IO namespaces and Redis adapter scale plan for Realtime Failover. (Realtime Failover scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/realtime/realtime-failover-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/realtime/realtime-failover-agent/advanced/SKILL.md`
