---
name: stream-heaven-core-engineering-backend-backend-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Backend (phase 5).
...
- User invokes **Backend** or work in **core-engineering/backend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/backend/backend-agent.md`
- **Role:** Backend Agent specialist for Stream Heaven's backend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/backend/backend-agent.md` and copy its `## Prompt Template` block
...
Define:
- Scaffold or extend NestJS modules for Backend with health checks and structured logging. (Backend scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/backend/backend-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/backend/backend-agent/advanced/SKILL.md`
