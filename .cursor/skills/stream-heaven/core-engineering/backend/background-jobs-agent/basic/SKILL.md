---
name: stream-heaven-core-engineering-backend-background-jobs-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Background Jobs (phase 5).
...
- User invokes **Background Jobs** or work in **core-engineering/backend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/backend/background-jobs-agent.md`
- **Role:** Scheduled jobs, cron, and job dashboards.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/backend/background-jobs-agent.md` and copy its `## Prompt Template` block
...
Define:
- Document ai-agents/core-engineering/backend/background-jobs-agent.md standards in platform-governance and ADRs. (Background Jobs scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/backend/background-jobs-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/backend/background-jobs-agent/advanced/SKILL.md`
