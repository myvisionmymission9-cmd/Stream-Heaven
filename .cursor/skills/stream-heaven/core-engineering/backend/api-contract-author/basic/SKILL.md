---
name: stream-heaven-core-engineering-backend-api-contract-author-basic
description: >-
  Basic Cursor skill for Stream Heaven Api Contract Author (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Api Contract Author — Basic

## When to use

- User invokes **Api Contract Author** or work in **core-engineering/backend** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/backend/api-contract-author.md`
- **Role:** Api Contract Author specialist for Stream Heaven backend contracts, ensuring OpenAPI and realtime event alignment with platform governance and four-app gateway integration.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/backend/api-contract-author.md` and copy its `## Prompt Template` block
...
Design:
- Own contract-first updates in `packages/shared-contracts/openapi/*.v1.yaml` and `events/realtime.v1.json`. (Api Contract Author scope)
