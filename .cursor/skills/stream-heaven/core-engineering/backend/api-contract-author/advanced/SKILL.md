---
name: stream-heaven-core-engineering-backend-api-contract-author-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Api Contract Author (phase 2).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Api Contract Author — Advanced
