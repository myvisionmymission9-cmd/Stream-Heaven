---
name: stream-heaven-core-engineering-backend-service-mesh-coordinator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Service Mesh Coordinator (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Service Mesh Coordinator — Advanced
