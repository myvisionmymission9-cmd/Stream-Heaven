---
name: stream-heaven-core-engineering-backend-service-mesh-coordinator-basic
description: >-
  Basic Cursor skill for Stream Heaven Service Mesh Coordinator (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Service Mesh Coordinator — Basic

## When to use

- User invokes **Service Mesh Coordinator** or work in **core-engineering/backend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/backend/service-mesh-coordinator.md`
- **Role:** Service Mesh Coordinator specialist for Stream Heaven's backend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/backend/service-mesh-coordinator.md` and copy its `## Prompt Template` block
...
Define:
- Scaffold or extend NestJS modules for Service Mesh with health checks and structured logging. (Service Mesh Coordinator scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/backend/service-mesh-coordinator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/backend/service-mesh-coordinator/advanced/SKILL.md`
