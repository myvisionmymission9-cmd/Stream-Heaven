---
name: stream-heaven-core-engineering-backend-middleware-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Middleware Specialist (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Middleware Specialist — Advanced
