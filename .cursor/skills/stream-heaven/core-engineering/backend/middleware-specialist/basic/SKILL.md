---
name: stream-heaven-core-engineering-backend-middleware-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Middleware Specialist (phase 5).
  Single-agent execution with governance prefix and structural validation.
---

# Middleware Specialist — Basic

## When to use

- User invokes **Middleware Specialist** or work in **core-engineering/backend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/backend/middleware-specialist.md`
- **Role:** Middleware Specialist specialist for Stream Heaven's backend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/backend/middleware-specialist.md` and copy its `## Prompt Template` block
