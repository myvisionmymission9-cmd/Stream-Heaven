---
name: stream-heaven-core-engineering-backend-event-driven-architecture-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Event Driven Architecture (phase 5).
...
- User invokes **Event Driven Architecture** or work in **core-engineering/backend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/backend/event-driven-architecture-agent.md`
- **Role:** Event Driven Architecture Agent specialist for Stream Heaven's backend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/backend/event-driven-architecture-agent.md` and copy its `## Prompt Template` block
...
Define:
- Scaffold or extend NestJS modules for Event Driven Architecture with health checks and structured logging. (Event Driven Architecture scope)
...
- Basic: `.cursor/skills/stream-heaven/core-engineering/backend/event-driven-architecture-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/core-engineering/backend/event-driven-architecture-agent/advanced/SKILL.md`
