---
name: stream-heaven-core-engineering-backend-event-driven-architecture-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Event Driven Architecture (phase 5).
