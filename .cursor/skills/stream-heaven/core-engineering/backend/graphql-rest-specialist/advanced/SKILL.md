---
name: stream-heaven-core-engineering-backend-graphql-rest-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Graphql Rest Specialist (phase 5).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Graphql Rest Specialist — Advanced
...
Architect:
- Scaffold or extend NestJS modules for Graphql Rest with health checks and structured logging. (Graphql Rest Specialist scope)
