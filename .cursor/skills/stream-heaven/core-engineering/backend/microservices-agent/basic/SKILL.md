---
name: stream-heaven-core-engineering-backend-microservices-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Microservices (phase 5).
...
- User invokes **Microservices** or work in **core-engineering/backend** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/backend/microservices-agent.md`
- **Role:** Microservices Agent specialist for Stream Heaven's backend domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/backend/microservices-agent.md` and copy its `## Prompt Template` block
...
Define:
- Scaffold or extend NestJS modules for Microservices with health checks and structured logging. (Microservices scope)
