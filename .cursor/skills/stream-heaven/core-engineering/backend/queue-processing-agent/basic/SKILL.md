---
name: stream-heaven-core-engineering-backend-queue-processing-agent-basic
description: >-
...
- Open agent: `ai-agents/core-engineering/backend/queue-processing-agent.md` and copy its `## Prompt Template` block
