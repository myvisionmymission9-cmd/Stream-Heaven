---
name: stream-heaven-core-engineering-sharding-agent-basic
description: >-
...
- User invokes **Sharding** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/sharding-agent.md`
- **Role:** Ai Agents/Core Engineering/Sharding specialist for Stream Heaven's database domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/sharding-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Identify shard keys for live room and wallet transaction tables. (Sharding scope)
