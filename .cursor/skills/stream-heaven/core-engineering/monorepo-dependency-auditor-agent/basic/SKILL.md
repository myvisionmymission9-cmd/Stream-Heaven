---
name: stream-heaven-core-engineering-monorepo-dependency-auditor-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Monorepo Dependency Auditor (phase 1 + ongoing).
  Single-agent execution with governance prefix and structural validation.
---

# Monorepo Dependency Auditor — Basic
...
- Open agent: `ai-agents/core-engineering/monorepo-dependency-auditor-agent.md` and copy its `## Prompt Template` block
