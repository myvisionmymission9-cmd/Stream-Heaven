---
name: stream-heaven-core-engineering-queue-processing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Queue Processing (phase 5).
...
- User invokes **Queue Processing** or work in **core-engineering** (phase 5)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/core-engineering/queue-processing-agent.md`
- **Role:** Ai Agents/Core Engineering/Queue Processing specialist for Stream Heaven's backend domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/core-engineering/queue-processing-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Provide NestJS BullMQ module templates with shared retry policies. (Queue Processing scope)
