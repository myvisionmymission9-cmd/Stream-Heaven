---
name: stream-heaven-games-greedy-lion2-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Greedy Lion2 (phase 9 (Games add-on)).
...
- User invokes **Greedy Lion2** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/greedy-lion2-agent.md`
- **Role:** Greedy Lion 2 Agent specialist for Stream Heaven's sequel greedy-capture game — multi-lane lion chase, power-ups, and team vs solo modes in live lobbies.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/greedy-lion2-agent.md` and copy its `## Prompt Template` block
...
Design:
- Extend Greedy King mechanics with lanes, power-ups, and team scoring (Greedy Lion 2 variant). (Greedy Lion2 scope)
