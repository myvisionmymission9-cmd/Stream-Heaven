---
name: stream-heaven-games-carrom-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Carrom (phase 9 (Games add-on)).
...
- User invokes **Carrom** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/carrom-agent.md`
- **Role:** Carrom Agent specialist for Stream Heaven's physics-lite Carrom board — striker aiming, pocket detection, queen cover rules, and 2-player async-friendly mode.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/carrom-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define Carrom rules ( queen, cover, foul, winner on board clear ). (Carrom scope)
