---
name: stream-heaven-games-games-fair-play-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Games Fair Play (phase 9 (Games add-on)).
  Single-agent execution with governance prefix and structural validation.
---

# Games Fair Play — Basic

## When to use

- User invokes **Games Fair Play** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/games-fair-play-agent.md`
- **Role:** Games Fair Play Agent specialist for Stream Heaven game integrity — CSPRNG shuffles, collusion detection, bot identification, and dispute audit trails.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/games-fair-play-agent.md` and copy its `## Prompt Template` block
...
Design:
- Mandate server-side RNG (Node crypto / HSM-backed in prod) for all card and dice outcomes. (Games Fair Play scope)
