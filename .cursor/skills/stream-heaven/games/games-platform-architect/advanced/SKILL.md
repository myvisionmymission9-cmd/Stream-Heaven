---
name: stream-heaven-games-games-platform-architect-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Games Platform Architect (phase 9 (Games add-on)).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Games Platform Architect — Advanced
