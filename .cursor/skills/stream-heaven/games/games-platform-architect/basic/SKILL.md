---
name: stream-heaven-games-games-platform-architect-basic
description: >-
  Basic Cursor skill for Stream Heaven Games Platform Architect (phase 9 (Games add-on)).
  Single-agent execution with governance prefix and structural validation.
---

# Games Platform Architect — Basic

## When to use

- User invokes **Games Platform Architect** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/games-platform-architect.md`
- **Role:** Games Platform Architect specialist for Stream Heaven's in-app casual gaming layer (BIGO-style), ensuring fair play, wallet integration, and low-latency realtime sync across Livestream and Social surfaces.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/games-platform-architect.md` and copy its `## Prompt Template` block
...
Design:
- Design the games-service microservice boundary and API contracts in packages/shared-contracts. (Games Platform Architect scope)
