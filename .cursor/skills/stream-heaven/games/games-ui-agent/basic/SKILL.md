---
name: stream-heaven-games-games-ui-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Games Ui (phase 9 (Games add-on)).
...
- User invokes **Games Ui** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/games-ui-agent.md`
- **Role:** Games UI Agent specialist for Stream Heaven game screens — lobby, in-game HUD, results, and in-livestream mini-player overlays following design-system tokens.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/games-ui-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design game lobby with stake filters, friend invite, and regional language labels. (Games Ui scope)
