---
name: stream-heaven-games-carrom2-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Carrom2 (phase 9 (Games add-on)).
...
- User invokes **Carrom2** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/carrom2-agent.md`
- **Role:** Carrom 2 Agent specialist for Stream Heaven's enhanced mobile Carrom — precision physics, online 1v1/2v2, and tournament tie-in (successor to base Carrom agent).

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/carrom2-agent.md` and copy its `## Prompt Template` block
...
Design:
- Upgrade carrom-agent baseline with Carrom 2 features: improved physics, foul rules, queen cover flow. (Carrom2 scope)
