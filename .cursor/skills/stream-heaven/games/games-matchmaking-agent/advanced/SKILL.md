---
name: stream-heaven-games-games-matchmaking-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Games Matchmaking (phase 9 (Games add-on)).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Games Matchmaking — Advanced
