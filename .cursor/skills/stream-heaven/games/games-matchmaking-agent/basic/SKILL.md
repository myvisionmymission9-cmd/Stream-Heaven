---
name: stream-heaven-games-games-matchmaking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Games Matchmaking (phase 9 (Games add-on)).
  Single-agent execution with governance prefix and structural validation.
---

# Games Matchmaking — Basic

## When to use

- User invokes **Games Matchmaking** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/games-matchmaking-agent.md`
- **Role:** Games Matchmaking Agent specialist for Stream Heaven game lobbies — skill buckets, coin table tiers, queue times, and bot backfill policies.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/games-matchmaking-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Redis-backed matchmaking queues per game type and stake tier. (Games Matchmaking scope)
