---
name: stream-heaven-games-luck77-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Luck77 (phase 9 (Games add-on)).
...
- User invokes **Luck77** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/luck77-agent.md`
- **Role:** Luck77 Agent specialist for Stream Heaven's fast number-pick casual game — 77-slot wheel/box grid, timed betting rounds, and livestream overlay mini-game.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/luck77-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design server-authoritative Luck77 round loop (bet window, lock, reveal, payout). (Luck77 scope)
