---
name: stream-heaven-games-chicken-run-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Chicken Run (phase 9 (Games add-on)).
...
- User invokes **Chicken Run** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/chicken-run-agent.md`
- **Role:** Chicken Run Agent specialist for Stream Heaven's endless-runner betting game — lane dodge, multiplier milestones, and crash-style cash-out tension.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/chicken-run-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Chicken Run session loop (run start, obstacle RNG, milestone multipliers, crash/cash-out). (Chicken Run scope)
