---
name: stream-heaven-games-games-leaderboard-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Games Leaderboard (phase 9 (Games add-on)).
  Single-agent execution with governance prefix and structural validation.
---

# Games Leaderboard — Basic
...
- Open agent: `ai-agents/games/games-leaderboard-agent.md` and copy its `## Prompt Template` block
