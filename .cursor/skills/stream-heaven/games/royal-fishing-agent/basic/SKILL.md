---
name: stream-heaven-games-royal-fishing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Royal Fishing (phase 9 (Games add-on)).
...
- Open agent: `ai-agents/games/royal-fishing-agent.md` and copy its `## Prompt Template` block
