---
name: stream-heaven-games-games-economy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Games Economy (phase 9 (Games add-on)).
...
- User invokes **Games Economy** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/games-economy-agent.md`
- **Role:** Games Economy Agent specialist for Stream Heaven in-game monetization — table stakes, rake, bonuses, and cross-app coin flows between games-service and wallet-service.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/games-economy-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define stake tiers, min/max buy-in, and platform rake per game type. (Games Economy scope)
