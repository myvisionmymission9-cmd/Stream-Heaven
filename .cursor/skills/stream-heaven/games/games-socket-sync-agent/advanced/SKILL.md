---
name: stream-heaven-games-games-socket-sync-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Games Socket Sync (phase 9 (Games add-on)).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Games Socket Sync — Advanced
