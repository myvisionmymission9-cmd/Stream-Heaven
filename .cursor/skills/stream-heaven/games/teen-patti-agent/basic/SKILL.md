---
name: stream-heaven-games-teen-patti-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Teen Patti (phase 9 (Games add-on)).
...
- User invokes **Teen Patti** or work in **games** (phase 9 (Games add-on))
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/games/teen-patti-agent.md`
- **Role:** Teen Patti Agent specialist for Stream Heaven's Indian card game mode — rules engine, betting rounds, side-show logic, and livestream room integration.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/games/teen-patti-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement server-side Teen Patti rules (boot amount, blind/seen, chaal, side show, show). (Teen Patti scope)
