---
name: stream-heaven-support-ecosystem-user-support-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven User Support (phase 20).
...
- User invokes **User Support** or work in **support-ecosystem** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/support-ecosystem/user-support-agent.md`
- **Role:** User Support Agent specialist for Stream Heaven's support-ecosystem domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/support-ecosystem/user-support-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own User Support deliverables in support-ecosystem domain for Stream Heaven Phase 20. (User Support scope)
...
- Basic: `.cursor/skills/stream-heaven/support-ecosystem/user-support-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/support-ecosystem/user-support-agent/advanced/SKILL.md`
