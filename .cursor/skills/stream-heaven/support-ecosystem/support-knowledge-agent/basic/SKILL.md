---
name: stream-heaven-support-ecosystem-support-knowledge-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Support Knowledge (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Support Knowledge — Basic
...
- Open agent: `ai-agents/support-ecosystem/support-knowledge-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Bootstrap NestJS api-gateway (port 3000) routing for Support Knowledge and Phase 1 service prefixes. (Support Knowledge scope)
