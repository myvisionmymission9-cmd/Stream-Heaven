---
name: stream-heaven-support-ecosystem-chatbot-support-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Chatbot Support (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Chatbot Support — Advanced
