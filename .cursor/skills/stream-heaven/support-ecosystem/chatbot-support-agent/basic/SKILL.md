---
name: stream-heaven-support-ecosystem-chatbot-support-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Chatbot Support (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Chatbot Support — Basic

## When to use

- User invokes **Chatbot Support** or work in **support-ecosystem** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/support-ecosystem/chatbot-support-agent.md`
- **Role:** Chatbot Support Agent specialist for Stream Heaven's support ecosystem domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/support-ecosystem/chatbot-support-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Chatbot Support deliverables in support-ecosystem domain for Stream Heaven Phase 20. (Chatbot Support scope)
...
- Basic: `.cursor/skills/stream-heaven/support-ecosystem/chatbot-support-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/support-ecosystem/chatbot-support-agent/advanced/SKILL.md`
