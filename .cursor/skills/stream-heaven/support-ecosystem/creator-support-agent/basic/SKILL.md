---
name: stream-heaven-support-ecosystem-creator-support-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Support (phase 20).
...
- User invokes **Creator Support** or work in **support-ecosystem** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/support-ecosystem/creator-support-agent.md`
- **Role:** Creator Support Agent specialist for Stream Heaven's support-ecosystem domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/support-ecosystem/creator-support-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/support-ecosystem/creator-support-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/support-ecosystem/creator-support-agent/advanced/SKILL.md`
