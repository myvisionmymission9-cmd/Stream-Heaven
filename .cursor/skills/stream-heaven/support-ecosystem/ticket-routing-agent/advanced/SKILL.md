---
name: stream-heaven-support-ecosystem-ticket-routing-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ticket Routing (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Ticket Routing — Advanced
