---
name: stream-heaven-support-ecosystem-vip-support-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Vip Support (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Vip Support — Advanced
...
Orchestrate:
- Design and implement support ecosystem capabilities for Stream Heaven. (Vip Support scope)
