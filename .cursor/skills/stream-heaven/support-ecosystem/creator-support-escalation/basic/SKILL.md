---
name: stream-heaven-support-ecosystem-creator-support-escalation-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Support Escalation (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Support Escalation — Basic

## When to use

- User invokes **Creator Support Escalation** or work in **support-ecosystem** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/support-ecosystem/creator-support-escalation.md`
- **Role:** Creator Support Escalation specialist for Stream Heaven's support ecosystem domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/support-ecosystem/creator-support-escalation.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement support ecosystem capabilities for Stream Heaven. (Creator Support Escalation scope)
...
- Basic: `.cursor/skills/stream-heaven/support-ecosystem/creator-support-escalation/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/support-ecosystem/creator-support-escalation/advanced/SKILL.md`
