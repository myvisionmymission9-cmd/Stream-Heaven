---
name: stream-heaven-support-ecosystem-refund-management-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Refund Management (phase 20).
...
- User invokes **Refund Management** or work in **support-ecosystem** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/support-ecosystem/refund-management-agent.md`
- **Role:** Refund Management Agent specialist for Stream Heaven's support-ecosystem domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/support-ecosystem/refund-management-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Refund Management deliverables in support-ecosystem domain for Stream Heaven Phase 20. (Refund Management scope)
...
- Basic: `.cursor/skills/stream-heaven/support-ecosystem/refund-management-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/support-ecosystem/refund-management-agent/advanced/SKILL.md`
