---
name: stream-heaven-support-ecosystem-ai-support-chat-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ai Support Chat (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Ai Support Chat — Advanced
