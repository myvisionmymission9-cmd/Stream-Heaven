---
name: stream-heaven-support-ecosystem-ticket-triage-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ticket Triage (phase 20).
...
- User invokes **Ticket Triage** or work in **support-ecosystem** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/support-ecosystem/ticket-triage-agent.md`
- **Role:** Ticket Triage Agent specialist for Stream Heaven's support ecosystem domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/support-ecosystem/ticket-triage-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Ticket Triage deliverables in support-ecosystem domain for Stream Heaven Phase 20. (Ticket Triage scope)
...
- Basic: `.cursor/skills/stream-heaven/support-ecosystem/ticket-triage-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/support-ecosystem/ticket-triage-agent/advanced/SKILL.md`
