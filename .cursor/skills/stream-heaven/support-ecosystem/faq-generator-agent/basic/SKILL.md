---
name: stream-heaven-support-ecosystem-faq-generator-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Faq Generator (phase 20).
...
- User invokes **Faq Generator** or work in **support-ecosystem** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/support-ecosystem/faq-generator-agent.md`
- **Role:** Faq Generator Agent specialist for Stream Heaven's support ecosystem domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/support-ecosystem/faq-generator-agent.md` and copy its `## Prompt Template` block
...
Setup:
- Own Faq Generator deliverables in support-ecosystem domain for Stream Heaven Phase 20. (Faq Generator scope)
