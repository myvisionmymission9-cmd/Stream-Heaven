---
name: stream-heaven-store-growth-store-experiment-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Store Experiment (phase 19).
  Single-agent execution with governance prefix and structural validation.
---

# Store Experiment — Basic

## When to use

- User invokes **Store Experiment** or work in **store-growth** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/store-growth/store-experiment-agent.md`
- **Role:** Store Experiment Agent specialist for Stream Heaven's store growth domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/store-growth/store-experiment-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Store Experiment growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Store Experiment scope)
...
- Basic: `.cursor/skills/stream-heaven/store-growth/store-experiment-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/store-growth/store-experiment-agent/advanced/SKILL.md`
