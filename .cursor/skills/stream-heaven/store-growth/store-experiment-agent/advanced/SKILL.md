---
name: stream-heaven-store-growth-store-experiment-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Store Experiment (phase 19).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Store Experiment — Advanced
