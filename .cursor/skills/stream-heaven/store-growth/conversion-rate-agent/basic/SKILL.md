---
name: stream-heaven-store-growth-conversion-rate-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Conversion Rate (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Conversion Rate — Basic

## When to use

- User invokes **Conversion Rate** or work in **store-growth** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/store-growth/conversion-rate-agent.md`
- **Role:** Store listing conversion experiments.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/store-growth/conversion-rate-agent.md` and copy its `## Prompt Template` block
...
Design:
- conversion-rate-agent per locale store guidelines. (Conversion Rate scope)
...
- Basic: `.cursor/skills/stream-heaven/store-growth/conversion-rate-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/store-growth/conversion-rate-agent/advanced/SKILL.md`
