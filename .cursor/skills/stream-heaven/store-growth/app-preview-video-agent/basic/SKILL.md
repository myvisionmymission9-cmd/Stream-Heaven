---
name: stream-heaven-store-growth-app-preview-video-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven App Preview Video (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# App Preview Video — Basic

## When to use

- User invokes **App Preview Video** or work in **store-growth** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/store-growth/app-preview-video-agent.md`
- **Role:** Preview video storyboards and specs.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/store-growth/app-preview-video-agent.md` and copy its `## Prompt Template` block
...
Design:
- app-preview-video-agent per locale store guidelines. (App Preview Video scope)
...
- Basic: `.cursor/skills/stream-heaven/store-growth/app-preview-video-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/store-growth/app-preview-video-agent/advanced/SKILL.md`
