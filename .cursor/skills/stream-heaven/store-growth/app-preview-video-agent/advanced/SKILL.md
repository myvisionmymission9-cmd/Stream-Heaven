---
name: stream-heaven-store-growth-app-preview-video-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven App Preview Video (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# App Preview Video — Advanced
