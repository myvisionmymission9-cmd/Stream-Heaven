---
name: stream-heaven-store-growth-store-screenshot-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Store Screenshot (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Store Screenshot — Basic

## When to use

- User invokes **Store Screenshot** or work in **store-growth** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/store-growth/store-screenshot-agent.md`
- **Role:** Screenshot/localized creative pipeline.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/store-growth/store-screenshot-agent.md` and copy its `## Prompt Template` block
...
Design:
- store-screenshot-agent per locale store guidelines. (Store Screenshot scope)
...
- Basic: `.cursor/skills/stream-heaven/store-growth/store-screenshot-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/store-growth/store-screenshot-agent/advanced/SKILL.md`
