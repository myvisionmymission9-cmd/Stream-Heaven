---
name: stream-heaven-store-growth-store-screenshot-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Store Screenshot (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Store Screenshot — Advanced
