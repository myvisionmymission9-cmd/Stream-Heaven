---
name: stream-heaven-store-growth-play-store-listing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Play Store Listing (phase 19).
  Single-agent execution with governance prefix and structural validation.
---

# Play Store Listing — Basic

## When to use

- User invokes **Play Store Listing** or work in **store-growth** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/store-growth/play-store-listing-agent.md`
- **Role:** Play Store Listing Agent specialist for Stream Heaven's store growth domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/store-growth/play-store-listing-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Play Store Listing growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (Play Store Listing scope)
