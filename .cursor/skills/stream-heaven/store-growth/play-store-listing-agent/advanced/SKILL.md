---
name: stream-heaven-store-growth-play-store-listing-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Play Store Listing (phase 19).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Play Store Listing — Advanced
