---
name: stream-heaven-store-growth-app-store-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven App Store Optimization (phase 19).
...
- User invokes **App Store Optimization** or work in **store-growth** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/store-growth/app-store-optimization-agent.md`
- **Role:** App Store Optimization Agent specialist for Stream Heaven's store growth domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/store-growth/app-store-optimization-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design App Store Optimization growth loops: referrals, campaigns, store ASO, and share incentives with measurable KPIs. (App Store Optimization scope)
...
- Basic: `.cursor/skills/stream-heaven/store-growth/app-store-optimization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/store-growth/app-store-optimization-agent/advanced/SKILL.md`
