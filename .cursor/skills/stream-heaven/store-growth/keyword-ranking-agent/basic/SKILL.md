---
name: stream-heaven-store-growth-keyword-ranking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Keyword Ranking (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Keyword Ranking — Basic

## When to use

- User invokes **Keyword Ranking** or work in **store-growth** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/store-growth/keyword-ranking-agent.md`
- **Role:** Keyword tracking and ASO iterations.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/store-growth/keyword-ranking-agent.md` and copy its `## Prompt Template` block
...
Design:
- keyword-ranking-agent per locale store guidelines. (Keyword Ranking scope)
