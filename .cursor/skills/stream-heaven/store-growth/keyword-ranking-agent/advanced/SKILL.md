---
name: stream-heaven-store-growth-keyword-ranking-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Keyword Ranking (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Keyword Ranking — Advanced
