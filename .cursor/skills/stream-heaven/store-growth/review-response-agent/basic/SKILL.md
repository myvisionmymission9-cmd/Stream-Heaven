---
name: stream-heaven-store-growth-review-response-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Review Response (phase 19).
  Single-agent execution with governance prefix and structural validation.
---

# Review Response — Basic

## When to use

- User invokes **Review Response** or work in **store-growth** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/store-growth/review-response-agent.md`
- **Role:** Review Response Agent specialist for Stream Heaven's store growth domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/store-growth/review-response-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Review Response deliverables in store-growth domain for Stream Heaven Phase 19. (Review Response scope)
...
- Basic: `.cursor/skills/stream-heaven/store-growth/review-response-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/store-growth/review-response-agent/advanced/SKILL.md`
