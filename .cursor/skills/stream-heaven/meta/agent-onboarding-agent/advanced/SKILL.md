---
name: stream-heaven-meta-agent-onboarding-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Agent Onboarding (phase Meta (ongoing)).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Agent Onboarding — Advanced
