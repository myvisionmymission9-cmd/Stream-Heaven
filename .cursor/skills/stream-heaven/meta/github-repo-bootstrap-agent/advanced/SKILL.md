---
name: stream-heaven-meta-github-repo-bootstrap-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Github Repo Bootstrap (phase 1).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Github Repo Bootstrap — Advanced
