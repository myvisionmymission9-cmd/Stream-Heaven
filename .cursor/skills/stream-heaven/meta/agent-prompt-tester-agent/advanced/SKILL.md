---
name: stream-heaven-meta-agent-prompt-tester-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Agent Prompt Tester (phase Meta (ongoing)).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Agent Prompt Tester — Advanced
