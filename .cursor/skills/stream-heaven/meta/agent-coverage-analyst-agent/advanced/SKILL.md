---
name: stream-heaven-meta-agent-coverage-analyst-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Agent Coverage Analyst (phase Meta (ongoing)).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Agent Coverage Analyst — Advanced
