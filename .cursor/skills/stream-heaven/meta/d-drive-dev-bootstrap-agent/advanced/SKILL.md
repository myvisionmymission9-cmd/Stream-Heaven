---
name: stream-heaven-meta-d-drive-dev-bootstrap-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven D Drive Dev Bootstrap (phase 1).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# D Drive Dev Bootstrap — Advanced
