---
name: stream-heaven-meta-local-dev-bootstrap-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Local Dev Bootstrap (phase 1).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Local Dev Bootstrap — Advanced
