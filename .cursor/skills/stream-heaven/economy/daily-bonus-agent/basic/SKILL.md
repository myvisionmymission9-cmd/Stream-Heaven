---
name: stream-heaven-economy-daily-bonus-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Daily Bonus (phase 13).
...
- User invokes **Daily Bonus** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/daily-bonus-agent.md`
- **Role:** Daily Bonus Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/daily-bonus-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Daily Bonus deliverables in economy domain for Stream Heaven Phase 13. (Daily Bonus scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/daily-bonus-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/daily-bonus-agent/advanced/SKILL.md`
