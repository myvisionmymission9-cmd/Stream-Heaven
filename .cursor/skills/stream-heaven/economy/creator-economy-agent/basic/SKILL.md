---
name: stream-heaven-economy-creator-economy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Economy (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Economy — Basic

## When to use

- User invokes **Creator Economy** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/creator-economy-agent.md`
- **Role:** Creator Economy Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/creator-economy-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Creator Economy deliverables in economy domain for Stream Heaven Phase 13. (Creator Economy scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/creator-economy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/creator-economy-agent/advanced/SKILL.md`
