---
name: stream-heaven-economy-economy-ab-test-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Economy Ab Test (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Economy Ab Test — Basic

## When to use

- User invokes **Economy Ab Test** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/economy-ab-test-agent.md`
- **Role:** Economy Ab Test Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/economy-ab-test-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/economy/economy-ab-test-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/economy-ab-test-agent/advanced/SKILL.md`
