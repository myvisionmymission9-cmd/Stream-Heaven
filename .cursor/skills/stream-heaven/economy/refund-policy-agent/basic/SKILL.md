---
name: stream-heaven-economy-refund-policy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Refund Policy (phase 13).
...
- User invokes **Refund Policy** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/refund-policy-agent.md`
- **Role:** Refund Policy Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/refund-policy-agent.md` and copy its `## Prompt Template` block
