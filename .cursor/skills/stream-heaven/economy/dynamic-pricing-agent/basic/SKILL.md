---
name: stream-heaven-economy-dynamic-pricing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Dynamic Pricing (phase 13).
...
- User invokes **Dynamic Pricing** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/dynamic-pricing-agent.md`
- **Role:** Dynamic Pricing Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/dynamic-pricing-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/economy/dynamic-pricing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/dynamic-pricing-agent/advanced/SKILL.md`
