---
name: stream-heaven-economy-vip-membership-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Vip Membership (phase 13).
...
- User invokes **Vip Membership** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/vip-membership-agent.md`
- **Role:** Vip Membership Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/vip-membership-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Vip Membership deliverables in economy domain for Stream Heaven Phase 13. (Vip Membership scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/vip-membership-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/vip-membership-agent/advanced/SKILL.md`
