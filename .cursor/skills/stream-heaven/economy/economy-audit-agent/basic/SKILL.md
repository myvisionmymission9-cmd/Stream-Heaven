---
name: stream-heaven-economy-economy-audit-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Economy Audit (phase 13).
...
- User invokes **Economy Audit** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/economy-audit-agent.md`
- **Role:** Economy Audit Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/economy-audit-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Economy Audit deliverables in economy domain for Stream Heaven Phase 13. (Economy Audit scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/economy-audit-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/economy-audit-agent/advanced/SKILL.md`
