---
name: stream-heaven-economy-payer-prediction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Payer Prediction (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Payer Prediction — Basic

## When to use

- User invokes **Payer Prediction** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/payer-prediction-agent.md`
- **Role:** Payer Prediction Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/payer-prediction-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Payer Prediction deliverables in economy domain for Stream Heaven Phase 13. (Payer Prediction scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/payer-prediction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/payer-prediction-agent/advanced/SKILL.md`
