---
name: stream-heaven-economy-economy-balance-simulator-basic
description: >-
  Basic Cursor skill for Stream Heaven Economy Balance Simulator (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Economy Balance Simulator — Basic

## When to use

- User invokes **Economy Balance Simulator** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/economy-balance-simulator.md`
- **Role:** Economy Balance Simulator specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/economy-balance-simulator.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement economy capabilities for Stream Heaven. (Economy Balance Simulator scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/economy-balance-simulator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/economy-balance-simulator/advanced/SKILL.md`
