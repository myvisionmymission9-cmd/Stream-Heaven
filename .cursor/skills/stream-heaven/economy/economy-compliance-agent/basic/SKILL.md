---
name: stream-heaven-economy-economy-compliance-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Economy Compliance (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Economy Compliance — Basic

## When to use

- User invokes **Economy Compliance** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/economy-compliance-agent.md`
- **Role:** Economy Compliance Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/economy-compliance-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Audit Economy Compliance work against platform-governance/ docs before implementation or merge approval. (Economy Compliance scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/economy-compliance-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/economy-compliance-agent/advanced/SKILL.md`
