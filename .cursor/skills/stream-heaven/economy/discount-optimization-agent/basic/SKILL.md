---
name: stream-heaven-economy-discount-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Discount Optimization (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Discount Optimization — Basic

## When to use

- User invokes **Discount Optimization** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/discount-optimization-agent.md`
- **Role:** Discount Optimization Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/discount-optimization-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Discount Optimization deliverables in economy domain for Stream Heaven Phase 13. (Discount Optimization scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/discount-optimization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/discount-optimization-agent/advanced/SKILL.md`
