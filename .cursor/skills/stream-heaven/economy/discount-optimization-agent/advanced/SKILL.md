---
name: stream-heaven-economy-discount-optimization-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Discount Optimization (phase 13).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Discount Optimization — Advanced
