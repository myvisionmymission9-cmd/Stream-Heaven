---
name: stream-heaven-economy-reward-economics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reward Economics (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Reward Economics — Basic

## When to use

- User invokes **Reward Economics** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/reward-economics-agent.md`
- **Role:** Reward Economics Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/reward-economics-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Reward Economics deliverables in economy domain for Stream Heaven Phase 13. (Reward Economics scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/reward-economics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/reward-economics-agent/advanced/SKILL.md`
