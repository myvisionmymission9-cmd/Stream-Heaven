---
name: stream-heaven-economy-reward-distribution-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reward Distribution (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Reward Distribution — Basic

## When to use

- User invokes **Reward Distribution** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/reward-distribution-agent.md`
- **Role:** Reward Distribution Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/reward-distribution-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Reward Distribution deliverables in economy domain for Stream Heaven Phase 13. (Reward Distribution scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/reward-distribution-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/reward-distribution-agent/advanced/SKILL.md`
