---
name: stream-heaven-economy-reward-distribution-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Reward Distribution (phase 13).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Reward Distribution — Advanced
