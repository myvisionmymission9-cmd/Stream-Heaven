---
name: stream-heaven-economy-virtual-currency-architect-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Virtual Currency Architect (phase 13).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Virtual Currency Architect — Advanced
