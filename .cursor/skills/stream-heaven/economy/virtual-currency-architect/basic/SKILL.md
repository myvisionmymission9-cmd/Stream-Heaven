---
name: stream-heaven-economy-virtual-currency-architect-basic
description: >-
  Basic Cursor skill for Stream Heaven Virtual Currency Architect (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Virtual Currency Architect — Basic

## When to use

- User invokes **Virtual Currency Architect** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/virtual-currency-architect.md`
- **Role:** Virtual Currency Architect specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/virtual-currency-architect.md` and copy its `## Prompt Template` block
...
Design:
- Own Virtual Currency deliverables in economy domain for Stream Heaven Phase 13. (Virtual Currency Architect scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/virtual-currency-architect/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/virtual-currency-architect/advanced/SKILL.md`
