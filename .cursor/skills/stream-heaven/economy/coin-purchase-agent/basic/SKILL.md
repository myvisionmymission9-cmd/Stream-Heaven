---
name: stream-heaven-economy-coin-purchase-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Coin Purchase (phase 13).
...
- User invokes **Coin Purchase** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/coin-purchase-agent.md`
- **Role:** Coin Purchase Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/coin-purchase-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Coin Purchase deliverables in economy domain for Stream Heaven Phase 13. (Coin Purchase scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/coin-purchase-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/coin-purchase-agent/advanced/SKILL.md`
