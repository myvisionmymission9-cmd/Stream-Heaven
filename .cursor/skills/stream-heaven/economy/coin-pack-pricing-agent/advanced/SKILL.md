---
name: stream-heaven-economy-coin-pack-pricing-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Coin Pack Pricing (phase 13).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Coin Pack Pricing — Advanced
