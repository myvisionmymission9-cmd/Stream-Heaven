---
name: stream-heaven-economy-coin-pack-pricing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Coin Pack Pricing (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Coin Pack Pricing — Basic

## When to use

- User invokes **Coin Pack Pricing** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/coin-pack-pricing-agent.md`
- **Role:** Coin Pack Pricing Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/coin-pack-pricing-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Coin Pack Pricing deliverables in economy domain for Stream Heaven Phase 13. (Coin Pack Pricing scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/coin-pack-pricing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/coin-pack-pricing-agent/advanced/SKILL.md`
