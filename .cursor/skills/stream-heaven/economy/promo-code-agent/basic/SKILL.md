---
name: stream-heaven-economy-promo-code-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Promo Code (phase 13).
...
- User invokes **Promo Code** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/promo-code-agent.md`
- **Role:** Promo Code Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/promo-code-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Promo Code deliverables in economy domain for Stream Heaven Phase 13. (Promo Code scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/promo-code-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/promo-code-agent/advanced/SKILL.md`
