---
name: stream-heaven-economy-subscription-revenue-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Subscription Revenue (phase 13).
...
- User invokes **Subscription Revenue** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/subscription-revenue-agent.md`
- **Role:** Subscription Revenue Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/subscription-revenue-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Subscription Revenue deliverables in economy domain for Stream Heaven Phase 13. (Subscription Revenue scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/subscription-revenue-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/subscription-revenue-agent/advanced/SKILL.md`
