---
name: stream-heaven-economy-iap-integration-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Iap Integration (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Iap Integration — Basic

## When to use

- User invokes **Iap Integration** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/iap-integration-agent.md`
- **Role:** Iap Integration Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/iap-integration-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Iap deliverables in economy domain for Stream Heaven Phase 13. (Iap Integration scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/iap-integration-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/iap-integration-agent/advanced/SKILL.md`
