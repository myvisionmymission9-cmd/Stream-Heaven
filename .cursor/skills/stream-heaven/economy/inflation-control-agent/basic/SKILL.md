---
name: stream-heaven-economy-inflation-control-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Inflation Control (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Inflation Control — Basic

## When to use

- User invokes **Inflation Control** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/inflation-control-agent.md`
- **Role:** Inflation Control Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/inflation-control-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Inflation Control deliverables in economy domain for Stream Heaven Phase 13. (Inflation Control scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/inflation-control-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/inflation-control-agent/advanced/SKILL.md`
