---
name: stream-heaven-economy-inflation-control-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Inflation Control (phase 13).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Inflation Control — Advanced
