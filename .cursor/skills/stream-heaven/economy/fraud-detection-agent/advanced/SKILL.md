---
name: stream-heaven-economy-fraud-detection-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Fraud Detection (phase 13).
...
Scale:
- Own Fraud Detection deliverables in economy domain for Stream Heaven Phase 13. (Fraud Detection scope)
