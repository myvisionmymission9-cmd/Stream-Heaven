---
name: stream-heaven-economy-virtual-goods-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Virtual Goods (phase 13).
...
- User invokes **Virtual Goods** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/virtual-goods-agent.md`
- **Role:** Virtual Goods Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/virtual-goods-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Virtual Goods deliverables in economy domain for Stream Heaven Phase 13. (Virtual Goods scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/virtual-goods-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/virtual-goods-agent/advanced/SKILL.md`
