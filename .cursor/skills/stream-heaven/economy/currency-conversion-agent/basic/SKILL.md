---
name: stream-heaven-economy-currency-conversion-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Currency Conversion (phase 13).
...
- User invokes **Currency Conversion** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/currency-conversion-agent.md`
- **Role:** Currency Conversion Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/currency-conversion-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Currency Conversion deliverables in economy domain for Stream Heaven Phase 13. (Currency Conversion scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/currency-conversion-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/currency-conversion-agent/advanced/SKILL.md`
