---
name: stream-heaven-economy-economy-balancing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Economy Balancing (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Economy Balancing — Basic

## When to use

- User invokes **Economy Balancing** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/economy-balancing-agent.md`
- **Role:** Economy Balancing Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/economy-balancing-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Economy Balancing deliverables in economy domain for Stream Heaven Phase 13. (Economy Balancing scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/economy-balancing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/economy-balancing-agent/advanced/SKILL.md`
