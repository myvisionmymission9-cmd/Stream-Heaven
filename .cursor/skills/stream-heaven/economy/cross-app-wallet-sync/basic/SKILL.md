---
name: stream-heaven-economy-cross-app-wallet-sync-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross App Wallet Sync (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Cross App Wallet Sync — Basic

## When to use

- User invokes **Cross App Wallet Sync** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/cross-app-wallet-sync.md`
- **Role:** Cross App Wallet Sync specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/cross-app-wallet-sync.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement economy capabilities for Stream Heaven. (Cross App Wallet Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/cross-app-wallet-sync/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/cross-app-wallet-sync/advanced/SKILL.md`
