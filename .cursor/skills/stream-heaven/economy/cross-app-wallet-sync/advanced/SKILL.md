---
name: stream-heaven-economy-cross-app-wallet-sync-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross App Wallet Sync (phase 13).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross App Wallet Sync — Advanced
