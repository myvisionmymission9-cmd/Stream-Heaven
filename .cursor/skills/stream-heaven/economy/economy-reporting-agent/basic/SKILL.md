---
name: stream-heaven-economy-economy-reporting-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Economy Reporting (phase 13).
  Single-agent execution with governance prefix and structural validation.
---

# Economy Reporting — Basic

## When to use

- User invokes **Economy Reporting** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/economy-reporting-agent.md`
- **Role:** Economy Reporting Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/economy-reporting-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Economy Reporting deliverables in economy domain for Stream Heaven Phase 13. (Economy Reporting scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/economy-reporting-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/economy-reporting-agent/advanced/SKILL.md`
