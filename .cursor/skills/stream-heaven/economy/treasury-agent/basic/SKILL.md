---
name: stream-heaven-economy-treasury-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Treasury (phase 13).
...
- User invokes **Treasury** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/treasury-agent.md`
- **Role:** Treasury Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/treasury-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Treasury deliverables in economy domain for Stream Heaven Phase 13. (Treasury scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/treasury-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/treasury-agent/advanced/SKILL.md`
