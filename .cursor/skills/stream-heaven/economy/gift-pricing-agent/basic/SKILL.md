---
name: stream-heaven-economy-gift-pricing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Gift Pricing (phase 13).
...
- Open agent: `ai-agents/economy/gift-pricing-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Gift Pricing deliverables in economy domain for Stream Heaven Phase 13. (Gift Pricing scope)
