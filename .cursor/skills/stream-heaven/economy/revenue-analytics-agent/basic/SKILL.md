---
name: stream-heaven-economy-revenue-analytics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Revenue Analytics (phase 13).
...
- User invokes **Revenue Analytics** or work in **economy** (phase 13)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/economy/revenue-analytics-agent.md`
- **Role:** Revenue Analytics Agent specialist for Stream Heaven's economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/economy/revenue-analytics-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Revenue Analytics deliverables in economy domain for Stream Heaven Phase 13. (Revenue Analytics scope)
...
- Basic: `.cursor/skills/stream-heaven/economy/revenue-analytics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/economy/revenue-analytics-agent/advanced/SKILL.md`
