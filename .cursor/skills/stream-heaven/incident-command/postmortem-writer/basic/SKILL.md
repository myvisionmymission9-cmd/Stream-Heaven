---
name: stream-heaven-incident-command-postmortem-writer-basic
description: >-
  Basic Cursor skill for Stream Heaven Postmortem Writer (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Postmortem Writer — Basic

## When to use

- User invokes **Postmortem Writer** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/postmortem-writer.md`
- **Role:** Postmortem Writer specialist for Stream Heaven's incident command domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/postmortem-writer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement incident command capabilities for Stream Heaven. (Postmortem Writer scope)
