---
name: stream-heaven-incident-command-postmortem-writer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Postmortem Writer (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Postmortem Writer — Advanced
