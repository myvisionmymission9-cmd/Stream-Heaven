---
name: stream-heaven-incident-command-incident-commander-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Incident Commander (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Incident Commander — Basic

## When to use

- User invokes **Incident Commander** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/incident-commander-agent.md`
- **Role:** Incident Commander Agent specialist for Stream Heaven's incident command domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/incident-commander-agent.md` and copy its `## Prompt Template` block
...
Route:
- Own Incident Commander deliverables in incident-command domain for Stream Heaven Phase 20. (Incident Commander scope)
...
- Basic: `.cursor/skills/stream-heaven/incident-command/incident-commander-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/incident-command/incident-commander-agent/advanced/SKILL.md`
