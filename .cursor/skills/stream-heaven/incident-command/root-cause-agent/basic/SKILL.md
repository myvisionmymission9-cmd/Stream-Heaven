---
name: stream-heaven-incident-command-root-cause-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Root Cause (phase 20).
...
- User invokes **Root Cause** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/root-cause-agent.md`
- **Role:** Root Cause Agent specialist for Stream Heaven's incident-command domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/root-cause-agent.md` and copy its `## Prompt Template` block
...
Route:
- Own Root Cause deliverables in incident-command domain for Stream Heaven Phase 20. (Root Cause scope)
...
- Basic: `.cursor/skills/stream-heaven/incident-command/root-cause-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/incident-command/root-cause-agent/advanced/SKILL.md`
