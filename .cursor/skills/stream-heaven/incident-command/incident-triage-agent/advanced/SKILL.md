---
name: stream-heaven-incident-command-incident-triage-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Incident Triage (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Incident Triage — Advanced
