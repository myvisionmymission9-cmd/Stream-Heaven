---
name: stream-heaven-incident-command-platform-status-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Platform Status (phase 20).
...
- User invokes **Platform Status** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/platform-status-agent.md`
- **Role:** Platform Status Agent specialist for Stream Heaven's incident-command domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/platform-status-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/incident-command/platform-status-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/incident-command/platform-status-agent/advanced/SKILL.md`
