---
name: stream-heaven-incident-command-platform-status-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Platform Status (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Platform Status — Advanced
