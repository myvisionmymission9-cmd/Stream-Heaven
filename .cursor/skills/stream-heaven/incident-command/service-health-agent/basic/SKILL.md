---
name: stream-heaven-incident-command-service-health-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Service Health (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Service Health — Basic
...
- Open agent: `ai-agents/incident-command/service-health-agent.md` and copy its `## Prompt Template` block
...
Route:
- Own Service Health deliverables in incident-command domain for Stream Heaven Phase 20. (Service Health scope)
