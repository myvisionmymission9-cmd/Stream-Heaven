---
name: stream-heaven-incident-command-downtime-response-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Downtime Response (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Downtime Response — Basic

## When to use

- User invokes **Downtime Response** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/downtime-response-agent.md`
- **Role:** Downtime Response Agent specialist for Stream Heaven's incident-command domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/downtime-response-agent.md` and copy its `## Prompt Template` block
...
Route:
- Own Downtime Response deliverables in incident-command domain for Stream Heaven Phase 20. (Downtime Response scope)
...
- Basic: `.cursor/skills/stream-heaven/incident-command/downtime-response-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/incident-command/downtime-response-agent/advanced/SKILL.md`
