---
name: stream-heaven-incident-command-downtime-response-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Downtime Response (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Downtime Response — Advanced
