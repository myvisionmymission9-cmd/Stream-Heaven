---
name: stream-heaven-incident-command-on-call-rotation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven On Call Rotation (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# On Call Rotation — Advanced
