---
name: stream-heaven-incident-command-status-page-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Status Page (phase 20).
...
- User invokes **Status Page** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/status-page-agent.md`
- **Role:** Status Page Agent specialist for Stream Heaven's incident command domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/status-page-agent.md` and copy its `## Prompt Template` block
...
Route:
- Own Status Page deliverables in incident-command domain for Stream Heaven Phase 20. (Status Page scope)
...
- Basic: `.cursor/skills/stream-heaven/incident-command/status-page-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/incident-command/status-page-agent/advanced/SKILL.md`
