---
name: stream-heaven-incident-command-realtime-alert-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Realtime Alert (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Realtime Alert — Advanced
