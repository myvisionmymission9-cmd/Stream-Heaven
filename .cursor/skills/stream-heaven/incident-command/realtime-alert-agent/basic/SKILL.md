---
name: stream-heaven-incident-command-realtime-alert-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Realtime Alert (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Realtime Alert — Basic

## When to use

- User invokes **Realtime Alert** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/realtime-alert-agent.md`
- **Role:** Realtime Alert Agent specialist for Stream Heaven's incident-command domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/realtime-alert-agent.md` and copy its `## Prompt Template` block
...
Route:
- Design Socket.IO namespaces and Redis adapter scale plan for Realtime Alert. (Realtime Alert scope)
...
- Basic: `.cursor/skills/stream-heaven/incident-command/realtime-alert-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/incident-command/realtime-alert-agent/advanced/SKILL.md`
