---
name: stream-heaven-incident-command-customer-comms-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Customer Comms (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Customer Comms — Basic

## When to use

- User invokes **Customer Comms** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/customer-comms-agent.md`
- **Role:** Customer comms during incidents.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/customer-comms-agent.md` and copy its `## Prompt Template` block
...
Route:
- customer-comms-agent integrated with PagerDuty/webhook stubs. (Customer Comms scope)
...
- Basic: `.cursor/skills/stream-heaven/incident-command/customer-comms-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/incident-command/customer-comms-agent/advanced/SKILL.md`
