---
name: stream-heaven-incident-command-customer-comms-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Customer Comms (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Customer Comms — Advanced
