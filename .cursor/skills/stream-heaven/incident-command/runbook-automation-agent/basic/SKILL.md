---
name: stream-heaven-incident-command-runbook-automation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Runbook Automation (phase 20).
...
- User invokes **Runbook Automation** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/runbook-automation-agent.md`
- **Role:** Automated runbooks for known failures.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/runbook-automation-agent.md` and copy its `## Prompt Template` block
...
Route:
- runbook-automation-agent integrated with PagerDuty/webhook stubs. (Runbook Automation scope)
...
- Basic: `.cursor/skills/stream-heaven/incident-command/runbook-automation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/incident-command/runbook-automation-agent/advanced/SKILL.md`
