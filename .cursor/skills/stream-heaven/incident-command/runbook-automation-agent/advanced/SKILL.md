---
name: stream-heaven-incident-command-runbook-automation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Runbook Automation (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Runbook Automation — Advanced
