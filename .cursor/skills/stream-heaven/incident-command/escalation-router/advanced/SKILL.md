---
name: stream-heaven-incident-command-escalation-router-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Escalation Router (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Escalation Router — Advanced
