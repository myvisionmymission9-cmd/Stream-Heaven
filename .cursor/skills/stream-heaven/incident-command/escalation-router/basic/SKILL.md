---
name: stream-heaven-incident-command-escalation-router-basic
description: >-
  Basic Cursor skill for Stream Heaven Escalation Router (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Escalation Router — Basic

## When to use

- User invokes **Escalation Router** or work in **incident-command** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/incident-command/escalation-router.md`
- **Role:** Escalation Router specialist for Stream Heaven's incident command domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/incident-command/escalation-router.md` and copy its `## Prompt Template` block
...
Route:
- Orchestrate Escalation workflows across ai-agents/ with explicit task ownership and phase gates. (Escalation Router scope)
