---
name: stream-heaven-apps-media-app-episode-cliffhanger-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Episode Cliffhanger (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Episode Cliffhanger — Basic

## When to use

- User invokes **Episode Cliffhanger** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/episode-cliffhanger-agent.md`
- **Role:** Episode Cliffhanger Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/episode-cliffhanger-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Episode Cliffhanger media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Episode Cliffhanger scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/episode-cliffhanger-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/episode-cliffhanger-agent/advanced/SKILL.md`
