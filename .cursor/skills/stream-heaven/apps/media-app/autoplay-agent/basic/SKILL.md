---
name: stream-heaven-apps-media-app-autoplay-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Autoplay (phase 17).
...
- User invokes **Autoplay** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/autoplay-agent.md`
- **Role:** Autoplay Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/autoplay-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Autoplay media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Autoplay scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/autoplay-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/autoplay-agent/advanced/SKILL.md`
