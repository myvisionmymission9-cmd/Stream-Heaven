---
name: stream-heaven-apps-media-app-completion-rate-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Completion Rate (phase 17).
...
- User invokes **Completion Rate** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/completion-rate-agent.md`
- **Role:** Completion Rate Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/completion-rate-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Completion Rate media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Completion Rate scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/completion-rate-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/completion-rate-agent/advanced/SKILL.md`
