---
name: stream-heaven-apps-media-app-completion-rate-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Completion Rate (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Completion Rate — Advanced
