---
name: stream-heaven-apps-media-app-short-drama-script-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Short Drama Script (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Short Drama Script — Basic

## When to use

- User invokes **Short Drama Script** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/short-drama-script-agent.md`
- **Role:** Short Drama Script Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/short-drama-script-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Short Drama Script media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Short Drama Script scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/short-drama-script-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/short-drama-script-agent/advanced/SKILL.md`
