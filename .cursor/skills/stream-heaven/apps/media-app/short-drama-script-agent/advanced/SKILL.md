---
name: stream-heaven-apps-media-app-short-drama-script-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Short Drama Script (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Short Drama Script — Advanced
