---
name: stream-heaven-apps-media-app-short-drama-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Short Drama (phase 17).
...
- User invokes **Short Drama** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/short-drama-agent.md`
- **Role:** Short Drama Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/short-drama-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Short Drama media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Short Drama scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/short-drama-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/short-drama-agent/advanced/SKILL.md`
