---
name: stream-heaven-apps-media-app-binge-retention-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Binge Retention (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Binge Retention — Basic

## When to use

- User invokes **Binge Retention** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/binge-retention-agent.md`
- **Role:** Binge Retention Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/binge-retention-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Binge Retention media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Binge Retention scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/binge-retention-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/binge-retention-agent/advanced/SKILL.md`
