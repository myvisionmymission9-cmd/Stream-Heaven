---
name: stream-heaven-apps-media-app-subtitle-cdn-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Subtitle Cdn (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Subtitle Cdn — Advanced
...
Stream:
- Design and implement media app capabilities for Stream Heaven. (Subtitle Cdn scope)
