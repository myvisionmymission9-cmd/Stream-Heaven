---
name: stream-heaven-apps-media-app-media-analytics-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Media Analytics (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Media Analytics — Advanced
