---
name: stream-heaven-apps-media-app-media-analytics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Analytics (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Media Analytics — Basic

## When to use

- User invokes **Media Analytics** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/media-analytics-agent.md`
- **Role:** Media Analytics Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/media-analytics-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Media Analytics media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Media Analytics scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/media-analytics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/media-analytics-agent/advanced/SKILL.md`
