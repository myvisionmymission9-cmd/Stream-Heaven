---
name: stream-heaven-apps-media-app-media-accessibility-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Media Accessibility (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Media Accessibility — Advanced
