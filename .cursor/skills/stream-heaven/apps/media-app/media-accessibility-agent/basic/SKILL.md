---
name: stream-heaven-apps-media-app-media-accessibility-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Accessibility (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Media Accessibility — Basic

## When to use

- User invokes **Media Accessibility** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/media-accessibility-agent.md`
- **Role:** Media Accessibility Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/media-accessibility-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Media Accessibility media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Media Accessibility scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/media-accessibility-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/media-accessibility-agent/advanced/SKILL.md`
