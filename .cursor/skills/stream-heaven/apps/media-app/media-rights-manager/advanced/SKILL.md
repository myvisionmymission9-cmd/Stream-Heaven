---
name: stream-heaven-apps-media-app-media-rights-manager-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Media Rights Manager (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Media Rights Manager — Advanced
