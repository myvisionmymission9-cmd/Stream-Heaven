---
name: stream-heaven-apps-media-app-media-rights-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Rights Manager (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Media Rights Manager — Basic

## When to use

- User invokes **Media Rights Manager** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/media-rights-manager.md`
- **Role:** Media Rights Manager specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/media-rights-manager.md` and copy its `## Prompt Template` block
...
Design:
- Own Media Rights media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Media Rights Manager scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/media-rights-manager/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/media-rights-manager/advanced/SKILL.md`
