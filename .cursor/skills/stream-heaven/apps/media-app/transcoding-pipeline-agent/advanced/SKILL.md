---
name: stream-heaven-apps-media-app-transcoding-pipeline-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Transcoding Pipeline (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Transcoding Pipeline — Advanced
