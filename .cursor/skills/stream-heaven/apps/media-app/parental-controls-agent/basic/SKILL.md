---
name: stream-heaven-apps-media-app-parental-controls-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Parental Controls (phase 17).
...
- User invokes **Parental Controls** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/parental-controls-agent.md`
- **Role:** Parental Controls Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/parental-controls-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Parental Controls media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Parental Controls scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/parental-controls-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/parental-controls-agent/advanced/SKILL.md`
