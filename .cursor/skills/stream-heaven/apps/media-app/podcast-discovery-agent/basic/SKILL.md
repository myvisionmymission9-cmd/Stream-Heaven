---
name: stream-heaven-apps-media-app-podcast-discovery-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Podcast Discovery (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Podcast Discovery — Basic

## When to use

- User invokes **Podcast Discovery** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/podcast-discovery-agent.md`
- **Role:** Podcast Discovery Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/podcast-discovery-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Podcast Discovery media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Podcast Discovery scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/podcast-discovery-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/podcast-discovery-agent/advanced/SKILL.md`
