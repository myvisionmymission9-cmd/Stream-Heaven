---
name: stream-heaven-apps-media-app-podcast-discovery-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Podcast Discovery (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Podcast Discovery — Advanced
