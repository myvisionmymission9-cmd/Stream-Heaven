---
name: stream-heaven-apps-media-app-video-player-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Video Player (phase 17).
...
- User invokes **Video Player** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/video-player-agent.md`
- **Role:** Video Player Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/video-player-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Video Player media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Video Player scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/video-player-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/video-player-agent/advanced/SKILL.md`
