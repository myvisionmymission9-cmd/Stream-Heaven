---
name: stream-heaven-apps-media-app-video-encoding-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Video Encoding (phase 17).
...
- User invokes **Video Encoding** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/video-encoding-agent.md`
- **Role:** Video Encoding Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/video-encoding-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Video Encoding media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Video Encoding scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/video-encoding-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/video-encoding-agent/advanced/SKILL.md`
