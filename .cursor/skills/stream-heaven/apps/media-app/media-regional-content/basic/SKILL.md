---
name: stream-heaven-apps-media-app-media-regional-content-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Regional Content (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Media Regional Content — Basic

## When to use

- User invokes **Media Regional Content** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/media-regional-content.md`
- **Role:** Media Regional Content specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/media-regional-content.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement media app capabilities for Stream Heaven. (Media Regional Content scope)
