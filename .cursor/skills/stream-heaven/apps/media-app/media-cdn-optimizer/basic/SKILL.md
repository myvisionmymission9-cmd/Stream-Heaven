---
name: stream-heaven-apps-media-app-media-cdn-optimizer-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Cdn Optimizer (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Media Cdn Optimizer — Basic

## When to use

- User invokes **Media Cdn Optimizer** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/media-cdn-optimizer.md`
- **Role:** Media Cdn Optimizer specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/media-cdn-optimizer.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement media app capabilities for Stream Heaven. (Media Cdn Optimizer scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/media-cdn-optimizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/media-cdn-optimizer/advanced/SKILL.md`
