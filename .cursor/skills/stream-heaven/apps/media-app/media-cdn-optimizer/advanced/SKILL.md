---
name: stream-heaven-apps-media-app-media-cdn-optimizer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Media Cdn Optimizer (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Media Cdn Optimizer — Advanced
