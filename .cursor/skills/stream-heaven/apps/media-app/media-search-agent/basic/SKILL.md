---
name: stream-heaven-apps-media-app-media-search-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Search (phase 17).
...
- User invokes **Media Search** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/media-search-agent.md`
- **Role:** Media Search Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/media-search-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/media-search-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/media-search-agent/advanced/SKILL.md`
