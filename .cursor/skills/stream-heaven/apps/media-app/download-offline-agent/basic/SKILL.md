---
name: stream-heaven-apps-media-app-download-offline-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Download Offline (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Download Offline — Basic

## When to use

- User invokes **Download Offline** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/download-offline-agent.md`
- **Role:** Download Offline Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/download-offline-agent.md` and copy its `## Prompt Template` block
