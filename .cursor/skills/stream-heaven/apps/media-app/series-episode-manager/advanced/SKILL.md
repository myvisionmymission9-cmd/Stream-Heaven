---
name: stream-heaven-apps-media-app-series-episode-manager-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Series Episode Manager (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Series Episode Manager — Advanced
