---
name: stream-heaven-apps-media-app-series-episode-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Series Episode Manager (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Series Episode Manager — Basic

## When to use

- User invokes **Series Episode Manager** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/series-episode-manager.md`
- **Role:** Series Episode Manager specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/series-episode-manager.md` and copy its `## Prompt Template` block
...
Design:
- Own Series Episode media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Series Episode Manager scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/series-episode-manager/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/series-episode-manager/advanced/SKILL.md`
