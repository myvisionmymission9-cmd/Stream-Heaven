---
name: stream-heaven-apps-media-app-media-billing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Billing (phase 17).
...
- Open agent: `apps/media-app/agents/media-billing-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Media Billing flows with idempotent ledger entries and PostgreSQL transactional integrity. (Media Billing scope)
