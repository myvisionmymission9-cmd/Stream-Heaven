---
name: stream-heaven-apps-media-app-content-fatigue-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Content Fatigue (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Content Fatigue — Basic

## When to use

- User invokes **Content Fatigue** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/content-fatigue-agent.md`
- **Role:** Content Fatigue Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/content-fatigue-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Content Fatigue media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Content Fatigue scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/content-fatigue-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/content-fatigue-agent/advanced/SKILL.md`
