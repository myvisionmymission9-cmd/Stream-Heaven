---
name: stream-heaven-apps-media-app-content-fatigue-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Content Fatigue (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Content Fatigue — Advanced
