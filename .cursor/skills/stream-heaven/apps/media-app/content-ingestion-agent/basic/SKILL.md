---
name: stream-heaven-apps-media-app-content-ingestion-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Content Ingestion (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Content Ingestion — Basic

## When to use

- User invokes **Content Ingestion** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/content-ingestion-agent.md`
- **Role:** Content Ingestion Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/content-ingestion-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/content-ingestion-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/content-ingestion-agent/advanced/SKILL.md`
