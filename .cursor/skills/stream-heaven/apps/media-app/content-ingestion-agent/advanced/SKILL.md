---
name: stream-heaven-apps-media-app-content-ingestion-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Content Ingestion (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Content Ingestion — Advanced
