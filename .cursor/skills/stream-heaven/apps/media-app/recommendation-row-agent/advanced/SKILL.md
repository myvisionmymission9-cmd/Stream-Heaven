---
name: stream-heaven-apps-media-app-recommendation-row-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Recommendation Row (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Recommendation Row — Advanced
