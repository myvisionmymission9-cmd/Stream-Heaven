---
name: stream-heaven-apps-media-app-recommendation-row-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Recommendation Row (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Recommendation Row — Basic

## When to use

- User invokes **Recommendation Row** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/recommendation-row-agent.md`
- **Role:** Recommendation Row Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/recommendation-row-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Recommendation Row ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Recommendation Row scope)
