---
name: stream-heaven-apps-media-app-watch-next-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Watch Next (phase 17).
...
- User invokes **Watch Next** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/watch-next-agent.md`
- **Role:** Watch Next Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/watch-next-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Watch Next media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Watch Next scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/watch-next-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/watch-next-agent/advanced/SKILL.md`
