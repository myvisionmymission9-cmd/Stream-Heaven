---
name: stream-heaven-apps-media-app-watch-history-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Watch History (phase 17).
...
- User invokes **Watch History** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/watch-history-agent.md`
- **Role:** Watch History Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/watch-history-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Watch History media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Watch History scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/watch-history-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/watch-history-agent/advanced/SKILL.md`
