---
name: stream-heaven-apps-media-app-ott-catalog-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ott Catalog (phase 17).
...
- User invokes **Ott Catalog** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/agents/ott-catalog-agent.md`
- **Role:** Ott Catalog Agent specialist for Stream Heaven's media app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/agents/ott-catalog-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Ott Catalog media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Ott Catalog scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/ott-catalog-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/ott-catalog-agent/advanced/SKILL.md`
