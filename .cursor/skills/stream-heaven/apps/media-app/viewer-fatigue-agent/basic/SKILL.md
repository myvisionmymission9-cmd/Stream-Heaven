---
name: stream-heaven-apps-media-app-viewer-fatigue-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Viewer Fatigue (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Viewer Fatigue — Basic

## When to use

- User invokes **Viewer Fatigue** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/viewer-fatigue-agent.md`
- **Role:** Viewer Fatigue Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/viewer-fatigue-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Viewer Fatigue media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Viewer Fatigue scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/viewer-fatigue-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/viewer-fatigue-agent/advanced/SKILL.md`
