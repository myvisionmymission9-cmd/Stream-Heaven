---
name: stream-heaven-apps-media-app-continue-watching-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Continue Watching (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Continue Watching — Advanced
...
Scale:
- Design and implement media app capabilities for Stream Heaven. (Continue Watching scope)
