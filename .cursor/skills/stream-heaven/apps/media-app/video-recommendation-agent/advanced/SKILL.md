---
name: stream-heaven-apps-media-app-video-recommendation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Video Recommendation (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Video Recommendation — Advanced
