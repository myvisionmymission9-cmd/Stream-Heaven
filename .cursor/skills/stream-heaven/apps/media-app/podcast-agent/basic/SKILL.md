---
name: stream-heaven-apps-media-app-podcast-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Podcast (phase 17).
...
- User invokes **Podcast** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/podcast-agent.md`
- **Role:** Podcast Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/podcast-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Podcast media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Podcast scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/podcast-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/podcast-agent/advanced/SKILL.md`
