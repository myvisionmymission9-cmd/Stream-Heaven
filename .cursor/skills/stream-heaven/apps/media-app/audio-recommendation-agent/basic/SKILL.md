---
name: stream-heaven-apps-media-app-audio-recommendation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Audio Recommendation (phase 17).
  Single-agent execution with governance prefix and structural validation.
---

# Audio Recommendation — Basic

## When to use

- User invokes **Audio Recommendation** or work in **apps/media-app** (phase 17)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/media-app/audio-recommendation-agent.md`
- **Role:** Audio Recommendation Agent specialist for Stream Heaven's media-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/media-app/audio-recommendation-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Audio Recommendation ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Audio Recommendation scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/media-app/audio-recommendation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/media-app/audio-recommendation-agent/advanced/SKILL.md`
