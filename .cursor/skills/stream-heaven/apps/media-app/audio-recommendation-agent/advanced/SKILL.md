---
name: stream-heaven-apps-media-app-audio-recommendation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Audio Recommendation (phase 17).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Audio Recommendation — Advanced
