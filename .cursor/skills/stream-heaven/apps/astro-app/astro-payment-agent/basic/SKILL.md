---
name: stream-heaven-apps-astro-app-astro-payment-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Astro Payment (phase 16).
...
- User invokes **Astro Payment** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/astro-payment-agent.md`
- **Role:** Astro Payment Agent specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/astro-payment-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Astro Payment flows with idempotent ledger entries and PostgreSQL transactional integrity. (Astro Payment scope)
