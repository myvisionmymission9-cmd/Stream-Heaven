---
name: stream-heaven-apps-astro-app-astro-notification-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Astro Notification (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Astro Notification — Advanced
