---
name: stream-heaven-apps-astro-app-astro-notification-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Astro Notification (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Astro Notification — Basic

## When to use

- User invokes **Astro Notification** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/astro-notification-agent.md`
- **Role:** Astro Notification Agent specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/astro-notification-agent.md` and copy its `## Prompt Template` block
