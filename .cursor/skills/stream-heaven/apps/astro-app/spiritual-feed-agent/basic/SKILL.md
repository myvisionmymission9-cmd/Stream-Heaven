---
name: stream-heaven-apps-astro-app-spiritual-feed-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Spiritual Feed (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Spiritual Feed — Basic

## When to use

- User invokes **Spiritual Feed** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/spiritual-feed-agent.md`
- **Role:** Spiritual Feed Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/spiritual-feed-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/spiritual-feed-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/spiritual-feed-agent/advanced/SKILL.md`
