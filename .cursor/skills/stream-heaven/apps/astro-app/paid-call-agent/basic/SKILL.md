---
name: stream-heaven-apps-astro-app-paid-call-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Paid Call (phase 16).
...
- User invokes **Paid Call** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/paid-call-agent.md`
- **Role:** Paid Call Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/paid-call-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Paid Call features in Flutter astro-app with regional language chart copy and UX. (Paid Call scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/paid-call-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/paid-call-agent/advanced/SKILL.md`
