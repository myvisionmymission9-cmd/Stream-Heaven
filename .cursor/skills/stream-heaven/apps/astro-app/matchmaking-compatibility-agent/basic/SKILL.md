---
name: stream-heaven-apps-astro-app-matchmaking-compatibility-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Matchmaking Compatibility (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Matchmaking Compatibility — Basic

## When to use

- User invokes **Matchmaking Compatibility** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/matchmaking-compatibility-agent.md`
- **Role:** Matchmaking Compatibility Agent specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/matchmaking-compatibility-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Matchmaking Compatibility game logic with NestJS APIs and Flutter client flows per games domain standards. (Matchmaking Compatibility scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/matchmaking-compatibility-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/matchmaking-compatibility-agent/advanced/SKILL.md`
