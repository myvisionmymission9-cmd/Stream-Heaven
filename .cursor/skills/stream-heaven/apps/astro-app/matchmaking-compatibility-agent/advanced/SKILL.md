---
name: stream-heaven-apps-astro-app-matchmaking-compatibility-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Matchmaking Compatibility (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Matchmaking Compatibility — Advanced
