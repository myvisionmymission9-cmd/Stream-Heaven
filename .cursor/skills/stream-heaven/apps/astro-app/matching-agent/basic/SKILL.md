---
name: stream-heaven-apps-astro-app-matching-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Matching (phase 16).
...
- User invokes **Matching** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/matching-agent.md`
- **Role:** Matching Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/matching-agent.md` and copy its `## Prompt Template` block
