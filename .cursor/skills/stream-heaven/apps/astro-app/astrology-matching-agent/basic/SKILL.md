---
name: stream-heaven-apps-astro-app-astrology-matching-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Astrology Matching (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Astrology Matching — Basic

## When to use

- User invokes **Astrology Matching** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/astrology-matching-agent.md`
- **Role:** Astrology Matching Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/astrology-matching-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Astrology Matching features in Flutter astro-app with regional language chart copy and UX. (Astrology Matching scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/astrology-matching-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/astrology-matching-agent/advanced/SKILL.md`
