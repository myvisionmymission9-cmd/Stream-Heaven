---
name: stream-heaven-apps-astro-app-astrologer-ranking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Astrologer Ranking (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Astrologer Ranking — Basic

## When to use

- User invokes **Astrologer Ranking** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/astrologer-ranking-agent.md`
- **Role:** Astrologer Ranking Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/astrologer-ranking-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/astrologer-ranking-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/astrologer-ranking-agent/advanced/SKILL.md`
