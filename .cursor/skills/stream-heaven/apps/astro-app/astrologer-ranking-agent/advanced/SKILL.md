---
name: stream-heaven-apps-astro-app-astrologer-ranking-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Astrologer Ranking (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Astrologer Ranking — Advanced
