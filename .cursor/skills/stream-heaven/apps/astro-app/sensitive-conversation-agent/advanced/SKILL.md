---
name: stream-heaven-apps-astro-app-sensitive-conversation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Sensitive Conversation (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Sensitive Conversation — Advanced
