---
name: stream-heaven-apps-astro-app-sensitive-conversation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Sensitive Conversation (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Sensitive Conversation — Basic

## When to use

- User invokes **Sensitive Conversation** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/sensitive-conversation-agent.md`
- **Role:** Sensitive Conversation Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/sensitive-conversation-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Sensitive Conversation features in Flutter astro-app with regional language chart copy and UX. (Sensitive Conversation scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/sensitive-conversation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/sensitive-conversation-agent/advanced/SKILL.md`
