---
name: stream-heaven-apps-astro-app-panchang-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Panchang (phase 16).
...
- User invokes **Panchang** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/panchang-agent.md`
- **Role:** Panchang Agent specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/panchang-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Panchang features in Flutter astro-app with regional language chart copy and UX. (Panchang scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/panchang-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/panchang-agent/advanced/SKILL.md`
