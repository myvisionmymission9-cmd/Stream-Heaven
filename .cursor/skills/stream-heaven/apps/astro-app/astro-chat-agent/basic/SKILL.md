---
name: stream-heaven-apps-astro-app-astro-chat-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Astro Chat (phase 16).
...
- User invokes **Astro Chat** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/astro-chat-agent.md`
- **Role:** Astro Chat Agent specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/astro-chat-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Astro Chat features in Flutter astro-app with regional language chart copy and UX. (Astro Chat scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/astro-chat-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/astro-chat-agent/advanced/SKILL.md`
