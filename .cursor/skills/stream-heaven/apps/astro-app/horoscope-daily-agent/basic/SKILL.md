---
name: stream-heaven-apps-astro-app-horoscope-daily-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Horoscope Daily (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Horoscope Daily — Basic

## When to use

- User invokes **Horoscope Daily** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/horoscope-daily-agent.md`
- **Role:** Horoscope Daily Agent specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/horoscope-daily-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Horoscope Daily features in Flutter astro-app with regional language chart copy and UX. (Horoscope Daily scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/horoscope-daily-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/horoscope-daily-agent/advanced/SKILL.md`
