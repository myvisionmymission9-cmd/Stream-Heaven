---
name: stream-heaven-apps-astro-app-session-booking-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Session Booking (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Session Booking — Advanced
