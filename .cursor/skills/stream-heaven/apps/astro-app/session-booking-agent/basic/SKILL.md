---
name: stream-heaven-apps-astro-app-session-booking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Session Booking (phase 16).
...
- User invokes **Session Booking** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/session-booking-agent.md`
- **Role:** Session Booking Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/session-booking-agent.md` and copy its `## Prompt Template` block
