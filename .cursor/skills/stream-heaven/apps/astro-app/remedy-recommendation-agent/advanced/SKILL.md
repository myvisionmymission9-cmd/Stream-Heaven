---
name: stream-heaven-apps-astro-app-remedy-recommendation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Remedy Recommendation (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Remedy Recommendation — Advanced
