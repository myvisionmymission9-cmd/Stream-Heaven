---
name: stream-heaven-apps-astro-app-astro-regional-calendar-basic
description: >-
  Basic Cursor skill for Stream Heaven Astro Regional Calendar (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Astro Regional Calendar — Basic

## When to use

- User invokes **Astro Regional Calendar** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/astro-regional-calendar.md`
- **Role:** Astro Regional Calendar specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/astro-regional-calendar.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement astro app capabilities for Stream Heaven. (Astro Regional Calendar scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/astro-regional-calendar/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/astro-regional-calendar/advanced/SKILL.md`
