---
name: stream-heaven-apps-astro-app-astro-regional-calendar-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Astro Regional Calendar (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Astro Regional Calendar — Advanced
