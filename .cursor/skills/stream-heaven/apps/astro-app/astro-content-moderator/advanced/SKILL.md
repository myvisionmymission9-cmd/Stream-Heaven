---
name: stream-heaven-apps-astro-app-astro-content-moderator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Astro Content Moderator (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Astro Content Moderator — Advanced
