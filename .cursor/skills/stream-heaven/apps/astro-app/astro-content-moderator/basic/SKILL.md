---
name: stream-heaven-apps-astro-app-astro-content-moderator-basic
description: >-
  Basic Cursor skill for Stream Heaven Astro Content Moderator (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Astro Content Moderator — Basic

## When to use

- User invokes **Astro Content Moderator** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/astro-content-moderator.md`
- **Role:** Astro Content Moderator specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/astro-content-moderator.md` and copy its `## Prompt Template` block
...
Design:
- Implement Astro Content features in Flutter astro-app with regional language chart copy and UX. (Astro Content Moderator scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/astro-content-moderator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/astro-content-moderator/advanced/SKILL.md`
