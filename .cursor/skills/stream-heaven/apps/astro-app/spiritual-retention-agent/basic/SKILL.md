---
name: stream-heaven-apps-astro-app-spiritual-retention-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Spiritual Retention (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Spiritual Retention — Basic

## When to use

- User invokes **Spiritual Retention** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/spiritual-retention-agent.md`
- **Role:** Spiritual Retention Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/spiritual-retention-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Spiritual Retention features in Flutter astro-app with regional language chart copy and UX. (Spiritual Retention scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/spiritual-retention-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/spiritual-retention-agent/advanced/SKILL.md`
