---
name: stream-heaven-apps-astro-app-spiritual-retention-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Spiritual Retention (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Spiritual Retention — Advanced
