---
name: stream-heaven-apps-astro-app-emotion-support-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Emotion Support (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Emotion Support — Advanced
