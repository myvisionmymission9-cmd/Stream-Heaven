---
name: stream-heaven-apps-astro-app-emotion-support-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Emotion Support (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Emotion Support — Basic

## When to use

- User invokes **Emotion Support** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/emotion-support-agent.md`
- **Role:** Emotion Support Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/emotion-support-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Emotion Support features in Flutter astro-app with regional language chart copy and UX. (Emotion Support scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/emotion-support-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/emotion-support-agent/advanced/SKILL.md`
