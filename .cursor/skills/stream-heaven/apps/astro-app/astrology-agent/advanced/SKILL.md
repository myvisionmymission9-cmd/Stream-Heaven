---
name: stream-heaven-apps-astro-app-astrology-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Astrology (phase 16).
...
Architect:
- Implement Astrology features in Flutter astro-app with regional language chart copy and UX. (Astrology scope)
