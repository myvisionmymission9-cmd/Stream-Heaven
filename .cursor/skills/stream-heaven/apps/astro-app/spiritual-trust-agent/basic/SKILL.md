---
name: stream-heaven-apps-astro-app-spiritual-trust-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Spiritual Trust (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Spiritual Trust — Basic

## When to use

- User invokes **Spiritual Trust** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/spiritual-trust-agent.md`
- **Role:** Spiritual Trust Agent specialist for Stream Heaven's astro-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/spiritual-trust-agent.md` and copy its `## Prompt Template` block
...
Build:
- Define moderation policies and enforcement hooks for Spiritual Trust across social and livestream surfaces. (Spiritual Trust scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/spiritual-trust-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/spiritual-trust-agent/advanced/SKILL.md`
