---
name: stream-heaven-apps-astro-app-astro-disclaimer-compliance-basic
description: >-
  Basic Cursor skill for Stream Heaven Astro Disclaimer Compliance (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Astro Disclaimer Compliance — Basic

## When to use

- User invokes **Astro Disclaimer Compliance** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/astro-disclaimer-compliance.md`
- **Role:** Astro Disclaimer Compliance specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/astro-disclaimer-compliance.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement astro app capabilities for Stream Heaven. (Astro Disclaimer Compliance scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/astro-disclaimer-compliance/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/astro-disclaimer-compliance/advanced/SKILL.md`
