---
name: stream-heaven-apps-astro-app-live-consultation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Live Consultation (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Live Consultation — Advanced
