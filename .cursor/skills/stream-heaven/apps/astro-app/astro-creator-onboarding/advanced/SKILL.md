---
name: stream-heaven-apps-astro-app-astro-creator-onboarding-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Astro Creator Onboarding (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Astro Creator Onboarding — Advanced
