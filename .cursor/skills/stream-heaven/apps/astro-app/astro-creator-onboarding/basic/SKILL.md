---
name: stream-heaven-apps-astro-app-astro-creator-onboarding-basic
description: >-
  Basic Cursor skill for Stream Heaven Astro Creator Onboarding (phase 16).
  Single-agent execution with governance prefix and structural validation.
---

# Astro Creator Onboarding — Basic

## When to use

- User invokes **Astro Creator Onboarding** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/astro-creator-onboarding.md`
- **Role:** Astro Creator Onboarding specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/astro-creator-onboarding.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement astro app capabilities for Stream Heaven. (Astro Creator Onboarding scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/astro-creator-onboarding/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/astro-creator-onboarding/advanced/SKILL.md`
