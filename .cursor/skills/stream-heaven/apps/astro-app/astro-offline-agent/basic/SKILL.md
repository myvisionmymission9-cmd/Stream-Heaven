---
name: stream-heaven-apps-astro-app-astro-offline-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Astro Offline (phase 16).
...
- Open agent: `apps/astro-app/agents/astro-offline-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Astro Offline features in Flutter astro-app with regional language chart copy and UX. (Astro Offline scope)
