---
name: stream-heaven-apps-astro-app-consultation-scheduling-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Consultation Scheduling (phase 16).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Consultation Scheduling — Advanced
...
Architect:
- Design and implement astro app capabilities for Stream Heaven. (Consultation Scheduling scope)
