---
name: stream-heaven-apps-astro-app-kundli-chart-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Kundli Chart (phase 16).
...
- User invokes **Kundli Chart** or work in **apps/astro-app** (phase 16)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/astro-app/agents/kundli-chart-agent.md`
- **Role:** Kundli Chart Agent specialist for Stream Heaven's astro app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/astro-app/agents/kundli-chart-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Kundli Chart features in Flutter astro-app with regional language chart copy and UX. (Kundli Chart scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/astro-app/kundli-chart-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/astro-app/kundli-chart-agent/advanced/SKILL.md`
