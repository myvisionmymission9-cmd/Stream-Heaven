---
name: stream-heaven-apps-social-app-group-chat-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Group Chat (phase 8).
...
- User invokes **Group Chat** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/group-chat-agent.md`
- **Role:** Group Chat Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/group-chat-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Group Chat with cursor pagination and moderation hooks. (Group Chat scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/group-chat-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/group-chat-agent/advanced/SKILL.md`
