---
name: stream-heaven-apps-social-app-filters-effects-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Filters Effects (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Filters Effects — Basic
...
- Open agent: `apps/social-app/filters-effects-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Filters Effects with cursor pagination and moderation hooks. (Filters Effects scope)
