---
name: stream-heaven-apps-social-app-like-comment-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Like Comment (phase 8).
...
- User invokes **Like Comment** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/like-comment-agent.md`
- **Role:** Like Comment Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/like-comment-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Like Comment with cursor pagination and moderation hooks. (Like Comment scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/like-comment-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/like-comment-agent/advanced/SKILL.md`
