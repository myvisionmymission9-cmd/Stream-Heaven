---
name: stream-heaven-apps-social-app-viral-amplification-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Viral Amplification (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Viral Amplification — Basic

## When to use

- User invokes **Viral Amplification** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/viral-amplification-agent.md`
- **Role:** Viral Amplification Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/viral-amplification-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Viral Amplification with cursor pagination and moderation hooks. (Viral Amplification scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/viral-amplification-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/viral-amplification-agent/advanced/SKILL.md`
