---
name: stream-heaven-apps-social-app-privacy-controls-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Privacy Controls Specialist (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Privacy Controls Specialist — Basic

## When to use

- User invokes **Privacy Controls Specialist** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/privacy-controls-specialist.md`
- **Role:** Privacy Controls Specialist specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/privacy-controls-specialist.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Privacy Controls with cursor pagination and moderation hooks. (Privacy Controls Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/privacy-controls-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/privacy-controls-specialist/advanced/SKILL.md`
