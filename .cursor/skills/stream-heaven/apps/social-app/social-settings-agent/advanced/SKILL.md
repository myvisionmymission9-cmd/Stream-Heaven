---
name: stream-heaven-apps-social-app-social-settings-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Settings (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Social Settings — Advanced
