---
name: stream-heaven-apps-social-app-social-settings-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Settings (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Social Settings — Basic

## When to use

- User invokes **Social Settings** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/social-settings-agent.md`
- **Role:** Social Settings Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/social-settings-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Social Settings with cursor pagination and moderation hooks. (Social Settings scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/social-settings-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/social-settings-agent/advanced/SKILL.md`
