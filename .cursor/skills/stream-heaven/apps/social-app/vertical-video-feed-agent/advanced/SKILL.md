---
name: stream-heaven-apps-social-app-vertical-video-feed-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Vertical Video Feed (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Vertical Video Feed — Advanced
