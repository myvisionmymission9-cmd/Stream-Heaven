---
name: stream-heaven-apps-social-app-home-feed-api-contract-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Home Feed API Contract (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Home Feed API Contract — Advanced
