---
name: stream-heaven-apps-social-app-social-api-integration-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Api Integration (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Social Api Integration — Basic

## When to use

- User invokes **Social Api Integration** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/social-api-integration.md`
- **Role:** Social Api Integration specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/social-api-integration.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Social Api with cursor pagination and moderation hooks. (Social Api Integration scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/social-api-integration/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/social-api-integration/advanced/SKILL.md`
