---
name: stream-heaven-apps-social-app-social-api-integration-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Api Integration (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Social Api Integration — Advanced
