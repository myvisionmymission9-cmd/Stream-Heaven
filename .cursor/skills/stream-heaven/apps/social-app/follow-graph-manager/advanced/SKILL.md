---
name: stream-heaven-apps-social-app-follow-graph-manager-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Follow Graph Manager (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Follow Graph Manager — Advanced
