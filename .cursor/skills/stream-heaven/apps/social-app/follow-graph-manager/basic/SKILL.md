---
name: stream-heaven-apps-social-app-follow-graph-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Follow Graph Manager (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Follow Graph Manager — Basic

## When to use

- User invokes **Follow Graph Manager** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/follow-graph-manager.md`
- **Role:** Follow Graph Manager specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/follow-graph-manager.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Follow Graph with cursor pagination and moderation hooks. (Follow Graph Manager scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/follow-graph-manager/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/follow-graph-manager/advanced/SKILL.md`
