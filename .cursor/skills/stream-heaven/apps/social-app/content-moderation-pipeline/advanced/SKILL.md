---
name: stream-heaven-apps-social-app-content-moderation-pipeline-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Content Moderation Pipeline (phase 8).
...
Scale:
- Design and implement social app capabilities for Stream Heaven. (Content Moderation Pipeline scope)
