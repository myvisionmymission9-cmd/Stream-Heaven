---
name: stream-heaven-apps-social-app-feed-preload-buffer-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Feed Preload Buffer (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Feed Preload Buffer — Advanced
