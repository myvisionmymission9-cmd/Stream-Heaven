---
name: stream-heaven-apps-social-app-trending-algorithm-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Trending Algorithm (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Trending Algorithm — Advanced
