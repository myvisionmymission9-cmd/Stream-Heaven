---
name: stream-heaven-apps-social-app-social-onboarding-flow-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Onboarding Flow (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Social Onboarding Flow — Advanced
