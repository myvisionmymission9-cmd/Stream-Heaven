---
name: stream-heaven-apps-social-app-social-onboarding-flow-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Onboarding Flow (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Social Onboarding Flow — Basic

## When to use

- User invokes **Social Onboarding Flow** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/social-onboarding-flow.md`
- **Role:** Social Onboarding Flow specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/social-onboarding-flow.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Social Onboarding with cursor pagination and moderation hooks. (Social Onboarding Flow scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/social-onboarding-flow/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/social-onboarding-flow/advanced/SKILL.md`
