---
name: stream-heaven-apps-social-app-profile-page-designer-basic
description: >-
  Basic Cursor skill for Stream Heaven Profile Page Designer (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Profile Page Designer — Basic

## When to use

- User invokes **Profile Page Designer** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/profile-page-designer.md`
- **Role:** Profile Page Designer specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/profile-page-designer.md` and copy its `## Prompt Template` block
...
Design:
- Scaffold NestJS user-service (port 3002) PostgreSQL schema for profiles, handles, and privacy flags. (Profile Page Designer scope)
