---
name: stream-heaven-apps-social-app-social-notification-orchestrator-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Notification Orchestrator (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Social Notification Orchestrator — Basic

## When to use

- User invokes **Social Notification Orchestrator** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/social-notification-orchestrator.md`
- **Role:** Social Notification Orchestrator specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/social-notification-orchestrator.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Social Notification with cursor pagination and moderation hooks. (Social Notification Orchestrator scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/social-notification-orchestrator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/social-notification-orchestrator/advanced/SKILL.md`
