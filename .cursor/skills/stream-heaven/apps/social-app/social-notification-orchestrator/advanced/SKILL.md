---
name: stream-heaven-apps-social-app-social-notification-orchestrator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Notification Orchestrator (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Social Notification Orchestrator — Advanced
