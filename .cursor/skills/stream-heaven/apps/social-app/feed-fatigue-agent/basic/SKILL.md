---
name: stream-heaven-apps-social-app-feed-fatigue-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feed Fatigue (phase 8).
...
- User invokes **Feed Fatigue** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/feed-fatigue-agent.md`
- **Role:** Feed Fatigue Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/feed-fatigue-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Feed Fatigue with cursor pagination and moderation hooks. (Feed Fatigue scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/feed-fatigue-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/feed-fatigue-agent/advanced/SKILL.md`
