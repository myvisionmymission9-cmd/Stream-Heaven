---
name: stream-heaven-apps-social-app-social-graph-analyst-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Graph Analyst (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Social Graph Analyst — Advanced
