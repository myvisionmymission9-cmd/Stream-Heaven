---
name: stream-heaven-apps-social-app-social-graph-analyst-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Graph Analyst (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Social Graph Analyst — Basic

## When to use

- User invokes **Social Graph Analyst** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/social-graph-analyst.md`
- **Role:** Social Graph Analyst specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/social-graph-analyst.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement social app capabilities for Stream Heaven. (Social Graph Analyst scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/social-graph-analyst/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/social-graph-analyst/advanced/SKILL.md`
