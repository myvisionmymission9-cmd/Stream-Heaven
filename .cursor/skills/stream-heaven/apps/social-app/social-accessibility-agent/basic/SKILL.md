---
name: stream-heaven-apps-social-app-social-accessibility-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Accessibility (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Social Accessibility — Basic

## When to use

- User invokes **Social Accessibility** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/social-accessibility-agent.md`
- **Role:** Social Accessibility Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/social-accessibility-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Social Accessibility with cursor pagination and moderation hooks. (Social Accessibility scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/social-accessibility-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/social-accessibility-agent/advanced/SKILL.md`
