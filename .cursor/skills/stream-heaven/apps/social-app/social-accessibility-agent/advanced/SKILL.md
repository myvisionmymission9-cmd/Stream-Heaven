---
name: stream-heaven-apps-social-app-social-accessibility-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Accessibility (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Social Accessibility — Advanced
