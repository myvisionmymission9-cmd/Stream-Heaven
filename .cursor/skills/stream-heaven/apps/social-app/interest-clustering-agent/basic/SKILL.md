---
name: stream-heaven-apps-social-app-interest-clustering-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Interest Clustering (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Interest Clustering — Basic

## When to use

- User invokes **Interest Clustering** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/interest-clustering-agent.md`
- **Role:** Interest Clustering Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/interest-clustering-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Interest Clustering with cursor pagination and moderation hooks. (Interest Clustering scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/interest-clustering-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/interest-clustering-agent/advanced/SKILL.md`
