---
name: stream-heaven-apps-social-app-interest-clustering-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Interest Clustering (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Interest Clustering — Advanced
