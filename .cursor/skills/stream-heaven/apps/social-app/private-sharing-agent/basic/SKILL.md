---
name: stream-heaven-apps-social-app-private-sharing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Private Sharing (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Private Sharing — Basic

## When to use

- User invokes **Private Sharing** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/private-sharing-agent.md`
- **Role:** Private Sharing Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/private-sharing-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Private Sharing with cursor pagination and moderation hooks. (Private Sharing scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/private-sharing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/private-sharing-agent/advanced/SKILL.md`
