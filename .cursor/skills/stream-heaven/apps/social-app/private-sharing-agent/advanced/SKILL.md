---
name: stream-heaven-apps-social-app-private-sharing-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Private Sharing (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Private Sharing — Advanced
