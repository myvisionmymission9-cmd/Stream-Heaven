---
name: stream-heaven-apps-social-app-follow-system-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Follow System (phase 8).
...
- User invokes **Follow System** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/follow-system-agent.md`
- **Role:** Follow System Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/follow-system-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Follow System with cursor pagination and moderation hooks. (Follow System scope)
