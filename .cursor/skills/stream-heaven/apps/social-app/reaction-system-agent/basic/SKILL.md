---
name: stream-heaven-apps-social-app-reaction-system-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reaction System (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Reaction System — Basic

## When to use

- User invokes **Reaction System** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/reaction-system-agent.md`
- **Role:** Reaction System Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/reaction-system-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Reaction System with cursor pagination and moderation hooks. (Reaction System scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/reaction-system-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/reaction-system-agent/advanced/SKILL.md`
