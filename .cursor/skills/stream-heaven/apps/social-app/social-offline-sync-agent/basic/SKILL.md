---
name: stream-heaven-apps-social-app-social-offline-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Offline Sync (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Social Offline Sync — Basic

## When to use

- User invokes **Social Offline Sync** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/social-offline-sync-agent.md`
- **Role:** Social Offline Sync Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/social-offline-sync-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Social Offline Sync with cursor pagination and moderation hooks. (Social Offline Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/social-offline-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/social-offline-sync-agent/advanced/SKILL.md`
