---
name: stream-heaven-apps-social-app-social-offline-sync-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Offline Sync (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Social Offline Sync — Advanced
