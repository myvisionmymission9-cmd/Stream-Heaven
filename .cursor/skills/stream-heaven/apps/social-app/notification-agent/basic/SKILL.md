---
name: stream-heaven-apps-social-app-notification-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Notification (phase 8).
...
- User invokes **Notification** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/notification-agent.md`
- **Role:** Notification Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/notification-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Notification with cursor pagination and moderation hooks. (Notification scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/notification-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/notification-agent/advanced/SKILL.md`
