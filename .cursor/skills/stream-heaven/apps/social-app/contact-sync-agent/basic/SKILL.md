---
name: stream-heaven-apps-social-app-contact-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Contact Sync (phase 8).
...
- User invokes **Contact Sync** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/contact-sync-agent.md`
- **Role:** Contact Sync Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/contact-sync-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Contact Sync with cursor pagination and moderation hooks. (Contact Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/contact-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/contact-sync-agent/advanced/SKILL.md`
