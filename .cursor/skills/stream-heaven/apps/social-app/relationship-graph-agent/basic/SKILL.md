---
name: stream-heaven-apps-social-app-relationship-graph-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Relationship Graph (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Relationship Graph — Basic

## When to use

- User invokes **Relationship Graph** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/relationship-graph-agent.md`
- **Role:** Relationship Graph Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/relationship-graph-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Relationship Graph with cursor pagination and moderation hooks. (Relationship Graph scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/relationship-graph-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/relationship-graph-agent/advanced/SKILL.md`
