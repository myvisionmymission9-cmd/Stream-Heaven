---
name: stream-heaven-apps-social-app-relationship-graph-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Relationship Graph (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Relationship Graph — Advanced
