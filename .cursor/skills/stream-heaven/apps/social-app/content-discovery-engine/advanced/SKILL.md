---
name: stream-heaven-apps-social-app-content-discovery-engine-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Content Discovery Engine (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Content Discovery Engine — Advanced
