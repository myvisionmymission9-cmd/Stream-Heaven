---
name: stream-heaven-apps-social-app-content-discovery-engine-basic
description: >-
  Basic Cursor skill for Stream Heaven Content Discovery Engine (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Content Discovery Engine — Basic

## When to use

- User invokes **Content Discovery Engine** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/content-discovery-engine.md`
- **Role:** Content Discovery Engine specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/content-discovery-engine.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Content Discovery with cursor pagination and moderation hooks. (Content Discovery Engine scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/content-discovery-engine/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/content-discovery-engine/advanced/SKILL.md`
