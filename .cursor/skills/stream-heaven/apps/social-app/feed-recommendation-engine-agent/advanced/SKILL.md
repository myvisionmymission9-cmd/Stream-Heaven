---
name: stream-heaven-apps-social-app-feed-recommendation-engine-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Feed Recommendation Engine (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Feed Recommendation Engine — Advanced
