---
name: stream-heaven-apps-social-app-social-analytics-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Analytics (phase 8).
...
Architect:
- Design and implement social app capabilities for Stream Heaven. (Social Analytics scope)
