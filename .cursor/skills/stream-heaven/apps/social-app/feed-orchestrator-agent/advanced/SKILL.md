---
name: stream-heaven-apps-social-app-feed-orchestrator-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Feed Orchestrator (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Feed Orchestrator — Advanced
