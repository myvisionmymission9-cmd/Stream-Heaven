---
name: stream-heaven-apps-social-app-feed-orchestrator-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feed Orchestrator (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Feed Orchestrator — Basic

## When to use

- User invokes **Feed Orchestrator** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/feed-orchestrator-agent.md`
- **Role:** Feed Orchestrator Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/feed-orchestrator-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Feed with cursor pagination and moderation hooks. (Feed Orchestrator scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/feed-orchestrator-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/feed-orchestrator-agent/advanced/SKILL.md`
