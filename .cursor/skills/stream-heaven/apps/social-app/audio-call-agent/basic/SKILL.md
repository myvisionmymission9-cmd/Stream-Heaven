---
name: stream-heaven-apps-social-app-audio-call-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Audio Call (phase 8).
...
- User invokes **Audio Call** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/audio-call-agent.md`
- **Role:** Audio Call Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/audio-call-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Audio Call with cursor pagination and moderation hooks. (Audio Call scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/audio-call-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/audio-call-agent/advanced/SKILL.md`
