---
name: stream-heaven-apps-social-app-feed-regional-discovery-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Feed Regional Discovery (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Feed Regional Discovery — Advanced
