---
name: stream-heaven-apps-social-app-comment-thread-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Comment Thread Specialist (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Comment Thread Specialist — Basic

## When to use

- User invokes **Comment Thread Specialist** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/comment-thread-specialist.md`
- **Role:** Comment Thread Specialist specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/comment-thread-specialist.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Comment Thread with cursor pagination and moderation hooks. (Comment Thread Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/comment-thread-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/comment-thread-specialist/advanced/SKILL.md`
