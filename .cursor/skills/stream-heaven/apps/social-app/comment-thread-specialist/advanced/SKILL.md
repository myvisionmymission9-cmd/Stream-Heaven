---
name: stream-heaven-apps-social-app-comment-thread-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Comment Thread Specialist (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Comment Thread Specialist — Advanced
