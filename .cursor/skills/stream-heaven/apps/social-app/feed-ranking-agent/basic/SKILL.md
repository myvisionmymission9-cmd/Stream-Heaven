---
name: stream-heaven-apps-social-app-feed-ranking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feed Ranking (phase 8).
...
- User invokes **Feed Ranking** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/feed-ranking-agent.md`
- **Role:** Feed Ranking Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/feed-ranking-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Feed Ranking with cursor pagination and moderation hooks. (Feed Ranking scope)
