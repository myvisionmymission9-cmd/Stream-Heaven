---
name: stream-heaven-apps-social-app-home-feed-architect-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Home Feed Architect (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Home Feed Architect — Advanced
