---
name: stream-heaven-apps-social-app-reels-short-video-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reels Short Video (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Reels Short Video — Basic

## When to use

- User invokes **Reels Short Video** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/reels-short-video-agent.md`
- **Role:** Reels Short Video Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/reels-short-video-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Reels Short Video with cursor pagination and moderation hooks. (Reels Short Video scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/reels-short-video-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/reels-short-video-agent/advanced/SKILL.md`
