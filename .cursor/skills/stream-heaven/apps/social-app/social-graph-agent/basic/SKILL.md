---
name: stream-heaven-apps-social-app-social-graph-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Graph (phase 8).
...
- User invokes **Social Graph** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/social-graph-agent.md`
- **Role:** Social Graph Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/social-graph-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Social Graph with cursor pagination and moderation hooks. (Social Graph scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/social-graph-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/social-graph-agent/advanced/SKILL.md`
