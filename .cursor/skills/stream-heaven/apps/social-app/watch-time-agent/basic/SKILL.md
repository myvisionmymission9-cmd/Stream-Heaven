---
name: stream-heaven-apps-social-app-watch-time-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Watch Time (phase 8).
...
- User invokes **Watch Time** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/watch-time-agent.md`
- **Role:** Watch Time Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/watch-time-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Watch Time with cursor pagination and moderation hooks. (Watch Time scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/watch-time-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/watch-time-agent/advanced/SKILL.md`
