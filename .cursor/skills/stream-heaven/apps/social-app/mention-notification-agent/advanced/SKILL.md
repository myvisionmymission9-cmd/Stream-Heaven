---
name: stream-heaven-apps-social-app-mention-notification-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Mention Notification (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Mention Notification — Advanced
