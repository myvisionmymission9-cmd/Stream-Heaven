---
name: stream-heaven-apps-social-app-mention-notification-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Mention Notification (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Mention Notification — Basic

## When to use

- User invokes **Mention Notification** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/mention-notification-agent.md`
- **Role:** Mention Notification Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/mention-notification-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Mention Notification with cursor pagination and moderation hooks. (Mention Notification scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/mention-notification-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/mention-notification-agent/advanced/SKILL.md`
