---
name: stream-heaven-apps-social-app-hashtag-trending-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Hashtag Trending (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Hashtag Trending — Advanced
