---
name: stream-heaven-apps-social-app-hashtag-trending-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Hashtag Trending (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Hashtag Trending — Basic

## When to use

- User invokes **Hashtag Trending** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/hashtag-trending-agent.md`
- **Role:** Hashtag Trending Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/hashtag-trending-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/hashtag-trending-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/hashtag-trending-agent/advanced/SKILL.md`
