---
name: stream-heaven-apps-social-app-block-report-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Block Report (phase 8).
...
- User invokes **Block Report** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/block-report-agent.md`
- **Role:** Block Report Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/block-report-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Block Report with cursor pagination and moderation hooks. (Block Report scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/block-report-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/block-report-agent/advanced/SKILL.md`
