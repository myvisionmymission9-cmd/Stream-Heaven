---
name: stream-heaven-apps-social-app-creator-profile-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Profile (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Profile — Basic
...
- Open agent: `apps/social-app/creator-profile-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement social app capabilities for Stream Heaven. (Creator Profile scope)
