---
name: stream-heaven-apps-social-app-conversation-quality-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Conversation Quality (phase 8).
...
- User invokes **Conversation Quality** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/conversation-quality-agent.md`
- **Role:** Conversation Quality Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/conversation-quality-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Conversation Quality with cursor pagination and moderation hooks. (Conversation Quality scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/conversation-quality-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/conversation-quality-agent/advanced/SKILL.md`
