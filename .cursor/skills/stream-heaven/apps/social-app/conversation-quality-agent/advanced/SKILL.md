---
name: stream-heaven-apps-social-app-conversation-quality-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Conversation Quality (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Conversation Quality — Advanced
