---
name: stream-heaven-apps-social-app-creator-distribution-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Distribution (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Distribution — Basic

## When to use

- User invokes **Creator Distribution** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/creator-distribution-agent.md`
- **Role:** Creator Distribution Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/creator-distribution-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Creator Distribution with cursor pagination and moderation hooks. (Creator Distribution scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/creator-distribution-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/creator-distribution-agent/advanced/SKILL.md`
