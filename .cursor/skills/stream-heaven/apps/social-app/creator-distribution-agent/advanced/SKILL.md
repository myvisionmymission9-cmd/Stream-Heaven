---
name: stream-heaven-apps-social-app-creator-distribution-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Distribution (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Creator Distribution — Advanced
