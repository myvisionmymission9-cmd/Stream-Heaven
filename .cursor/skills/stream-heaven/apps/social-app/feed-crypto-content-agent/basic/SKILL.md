---
name: stream-heaven-apps-social-app-feed-crypto-content-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feed Crypto Content (phase 8).
  Home Feed scoped — single-agent execution with governance prefix.
---

# Feed Crypto Content — Basic

## When to use

- User invokes **Feed Crypto Content** or Home Feed work in **apps/mobile/lib/features/home_feed/**
- Phase 8 social-app; scope limited to Home Feed (not full platform)

## Agent

- **Path:** `apps/social-app/agents/home-feed/feed-crypto-content-agent.md`
