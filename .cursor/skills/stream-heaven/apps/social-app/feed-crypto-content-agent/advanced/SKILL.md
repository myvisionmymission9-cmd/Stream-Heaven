---
name: stream-heaven-apps-social-app-feed-crypto-content-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Feed Crypto Content (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Feed Crypto Content — Advanced
