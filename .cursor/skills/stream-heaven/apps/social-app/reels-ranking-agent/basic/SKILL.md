---
name: stream-heaven-apps-social-app-reels-ranking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Reels Ranking (phase 8).
...
- User invokes **Reels Ranking** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/reels-ranking-agent.md`
- **Role:** Reels Ranking Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/reels-ranking-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Reels Ranking ML pipelines: feature store, training jobs, inference endpoints, and fallbacks. (Reels Ranking scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/reels-ranking-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/reels-ranking-agent/advanced/SKILL.md`
