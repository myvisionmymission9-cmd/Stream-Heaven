---
name: stream-heaven-apps-social-app-video-call-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Video Call (phase 8).
...
- User invokes **Video Call** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/video-call-agent.md`
- **Role:** Video Call Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/video-call-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Video Call with cursor pagination and moderation hooks. (Video Call scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/video-call-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/video-call-agent/advanced/SKILL.md`
