---
name: stream-heaven-apps-social-app-typing-indicator-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Typing Indicator (phase 8).
...
- User invokes **Typing Indicator** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/typing-indicator-agent.md`
- **Role:** Typing Indicator Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/typing-indicator-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Typing Indicator with cursor pagination and moderation hooks. (Typing Indicator scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/typing-indicator-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/typing-indicator-agent/advanced/SKILL.md`
