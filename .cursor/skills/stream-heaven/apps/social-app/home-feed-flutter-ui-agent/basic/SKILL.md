---
name: stream-heaven-apps-social-app-home-feed-flutter-ui-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Home Feed Flutter UI (phase 8).
  Home Feed scoped — single-agent execution with governance prefix.
---

# Home Feed Flutter UI — Basic

## When to use

- User invokes **Home Feed Flutter UI** or Home Feed work in **apps/mobile/lib/features/home_feed/**
- Phase 8 social-app; scope limited to Home Feed (not full platform)

## Agent

- **Path:** `apps/social-app/agents/home-feed/home-feed-flutter-ui-agent.md`
