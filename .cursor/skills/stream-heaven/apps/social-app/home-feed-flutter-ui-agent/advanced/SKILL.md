---
name: stream-heaven-apps-social-app-home-feed-flutter-ui-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Home Feed Flutter UI (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Home Feed Flutter UI — Advanced
