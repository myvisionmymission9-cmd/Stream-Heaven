---
name: stream-heaven-apps-social-app-creator-public-profile-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Public Profile (Phase 12).
  Cross-agent orchestration, ADRs, production validation.
---

# Creator Public Profile — Advanced
...
- Phase 12+ changes to social-app (Creator Profile)
...
- Enforce social-app (Creator Profile) boundary — defer wallet/live backend to their domain agents
