---
name: stream-heaven-apps-social-app-presence-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Presence (phase 8).
...
- User invokes **Presence** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/presence-agent.md`
- **Role:** Presence Agent specialist for Stream Heaven's social-app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/presence-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/presence-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/presence-agent/advanced/SKILL.md`
