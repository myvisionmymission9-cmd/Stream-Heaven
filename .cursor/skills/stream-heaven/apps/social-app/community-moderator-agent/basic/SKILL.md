---
name: stream-heaven-apps-social-app-community-moderator-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Community Moderator (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Community Moderator — Basic

## When to use

- User invokes **Community Moderator** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/community-moderator-agent.md`
- **Role:** Community Moderator Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/community-moderator-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Community with cursor pagination and moderation hooks. (Community Moderator scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/community-moderator-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/community-moderator-agent/advanced/SKILL.md`
