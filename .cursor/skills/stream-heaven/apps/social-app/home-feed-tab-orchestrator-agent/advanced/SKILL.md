---
name: stream-heaven-apps-social-app-home-feed-tab-orchestrator-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Home Feed Tab Orchestrator (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Home Feed Tab Orchestrator — Advanced
