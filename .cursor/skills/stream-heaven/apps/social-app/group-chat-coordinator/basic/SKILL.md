---
name: stream-heaven-apps-social-app-group-chat-coordinator-basic
description: >-
  Basic Cursor skill for Stream Heaven Group Chat Coordinator (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Group Chat Coordinator — Basic

## When to use

- User invokes **Group Chat Coordinator** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/group-chat-coordinator.md`
- **Role:** Group Chat Coordinator specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/group-chat-coordinator.md` and copy its `## Prompt Template` block
...
Design:
- Define /v1/social/* OpenAPI contracts for Group Chat with cursor pagination and moderation hooks. (Group Chat Coordinator scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/group-chat-coordinator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/group-chat-coordinator/advanced/SKILL.md`
