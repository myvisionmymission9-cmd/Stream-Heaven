---
name: stream-heaven-apps-social-app-group-chat-coordinator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Group Chat Coordinator (phase 8).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Group Chat Coordinator — Advanced
