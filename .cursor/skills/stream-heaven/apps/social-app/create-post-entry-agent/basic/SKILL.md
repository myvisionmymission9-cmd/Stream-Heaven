---
name: stream-heaven-apps-social-app-create-post-entry-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Create Post Entry (phase 8).
  Home Feed scoped — single-agent execution with governance prefix.
---

# Create Post Entry — Basic

## When to use

- User invokes **Create Post Entry** or Home Feed work in **apps/mobile/lib/features/home_feed/**
