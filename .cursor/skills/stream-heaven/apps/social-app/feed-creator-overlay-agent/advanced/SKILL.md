---
name: stream-heaven-apps-social-app-feed-creator-overlay-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Feed Creator Overlay (phase 8).
  Home Feed multi-agent orchestration, ADRs, production validation.
---

# Feed Creator Overlay — Advanced
