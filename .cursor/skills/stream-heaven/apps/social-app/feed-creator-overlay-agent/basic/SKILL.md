---
name: stream-heaven-apps-social-app-feed-creator-overlay-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Feed Creator Overlay (phase 8).
  Home Feed scoped — single-agent execution with governance prefix.
---

# Feed Creator Overlay — Basic

## When to use

- User invokes **Feed Creator Overlay** or Home Feed work in **apps/mobile/lib/features/home_feed/**
- Phase 8 social-app; scope limited to Home Feed (not full platform)

## Agent

- **Path:** `apps/social-app/agents/home-feed/feed-creator-overlay-agent.md`
