---
name: stream-heaven-apps-social-app-share-deeplink-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Share Deeplink (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Share Deeplink — Basic

## When to use

- User invokes **Share Deeplink** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/share-deeplink-agent.md`
- **Role:** Share Deeplink Agent specialist for Stream Heaven's social app domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/share-deeplink-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/apps/social-app/share-deeplink-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/social-app/share-deeplink-agent/advanced/SKILL.md`
