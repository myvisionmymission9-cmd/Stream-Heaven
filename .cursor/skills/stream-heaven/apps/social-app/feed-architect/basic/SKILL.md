---
name: stream-heaven-apps-social-app-feed-architect-basic
description: >-
  Basic Cursor skill for Stream Heaven Feed Architect (phase 8).
  Single-agent execution with governance prefix and structural validation.
---

# Feed Architect — Basic

## When to use

- User invokes **Feed Architect** or work in **apps/social-app** (phase 8)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/social-app/agents/feed-architect.md`
- **Role:** Feed Architect specialist for Stream Heaven social app — home feed composition, pagination, ranking integration, and offline-first cache strategy.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/social-app/agents/feed-architect.md` and copy its `## Prompt Template` block
...
Design:
- Design feed item union type (post, reel, story ring, live card, suggested follow). (Feed Architect scope)
