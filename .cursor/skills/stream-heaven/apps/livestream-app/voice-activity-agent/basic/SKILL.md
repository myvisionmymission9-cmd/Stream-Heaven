---
name: stream-heaven-apps-livestream-app-voice-activity-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Voice Activity (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Voice Activity — Basic

## When to use

- User invokes **Voice Activity** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/voice-activity-agent.md`
- **Role:** Apps/Livestream App/Agents/Multi Guest/Voice Activity specialist for Stream Heaven's multi-guest domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/voice-activity-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Implement VAD on client with server-side validation to prevent spoofing. (Voice Activity scope)
