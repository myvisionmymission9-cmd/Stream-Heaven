---
name: stream-heaven-apps-livestream-app-pk-tournament-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Pk Tournament (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Pk Tournament — Advanced
