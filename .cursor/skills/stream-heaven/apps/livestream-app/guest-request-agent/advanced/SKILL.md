---
name: stream-heaven-apps-livestream-app-guest-request-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Guest Request (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Guest Request — Advanced
