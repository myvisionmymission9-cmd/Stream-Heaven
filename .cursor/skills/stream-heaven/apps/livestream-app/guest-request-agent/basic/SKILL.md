---
name: stream-heaven-apps-livestream-app-guest-request-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Guest Request (phase 9).
...
- User invokes **Guest Request** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/guest-request-agent.md`
- **Role:** Viewer requests to join stage — apply, approve, deny, timeout.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/guest-request-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- FIFO queue with host overrides. (Guest Request scope)
