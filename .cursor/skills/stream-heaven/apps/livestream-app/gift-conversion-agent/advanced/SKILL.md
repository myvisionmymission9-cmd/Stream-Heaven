---
name: stream-heaven-apps-livestream-app-gift-conversion-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Conversion (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Conversion — Advanced
