---
name: stream-heaven-apps-livestream-app-global-ranking-event-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Global Ranking Event (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Global Ranking Event — Basic

## When to use

- User invokes **Global Ranking Event** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/operations/global-ranking-event-agent.md`
- **Role:** Cross-region rankings with timezone fairness.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/operations/global-ranking-event-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Define global-ranking-event-agent models in PostgreSQL; hot leaderboards in Redis. (Global Ranking Event scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/global-ranking-event-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/global-ranking-event-agent/advanced/SKILL.md`
