---
name: stream-heaven-apps-livestream-app-global-ranking-event-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Global Ranking Event (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Global Ranking Event — Advanced
