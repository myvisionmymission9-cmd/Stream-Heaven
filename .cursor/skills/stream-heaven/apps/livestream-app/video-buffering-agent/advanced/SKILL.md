---
name: stream-heaven-apps-livestream-app-video-buffering-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Video Buffering (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Video Buffering — Advanced
