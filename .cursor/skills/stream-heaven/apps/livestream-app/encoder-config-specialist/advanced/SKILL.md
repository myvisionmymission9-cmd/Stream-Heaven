---
name: stream-heaven-apps-livestream-app-encoder-config-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Encoder Config Specialist (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Encoder Config Specialist — Advanced
