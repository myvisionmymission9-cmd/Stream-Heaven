---
name: stream-heaven-apps-livestream-app-encoder-config-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Encoder Config Specialist (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Encoder Config Specialist — Basic

## When to use

- User invokes **Encoder Config Specialist** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/video-systems/encoder-config-specialist.md`
- **Role:** Encoder Config Specialist specialist for Stream Heaven's video systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/video-systems/encoder-config-specialist.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Encoder Config. (Encoder Config Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/encoder-config-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/encoder-config-specialist/advanced/SKILL.md`
