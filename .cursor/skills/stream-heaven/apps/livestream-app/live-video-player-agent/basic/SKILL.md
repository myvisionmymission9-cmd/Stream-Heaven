---
name: stream-heaven-apps-livestream-app-live-video-player-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Live Video Player (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Live Video Player — Basic

## When to use

- User invokes **Live Video Player** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/video-systems/live-video-player-agent.md`
- **Role:** Apps/Livestream App/Agents/Video Systems/Live Video Player specialist for Stream Heaven's video-systems domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/video-systems/live-video-player-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Implement HLS/RTC hybrid player with texture-backed rendering for smooth gift animations. (Live Video Player scope)
