---
name: stream-heaven-apps-livestream-app-livestream-scaling-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Livestream Scaling (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Livestream Scaling — Advanced
