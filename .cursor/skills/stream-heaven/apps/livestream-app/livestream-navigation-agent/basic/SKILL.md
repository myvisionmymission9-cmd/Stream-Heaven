---
name: stream-heaven-apps-livestream-app-livestream-navigation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Livestream Navigation (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Livestream Navigation — Basic
...
- Open agent: `apps/livestream-app/agents/core/livestream-navigation-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Design and implement core capabilities for Stream Heaven. (Livestream Navigation scope)
