---
name: stream-heaven-apps-livestream-app-agora-integration-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Agora Integration (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Agora Integration — Advanced
