---
name: stream-heaven-apps-livestream-app-agora-integration-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Agora Integration (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Agora Integration — Basic

## When to use

- User invokes **Agora Integration** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/video-systems/agora-integration-agent.md`
- **Role:** Agora Integration Agent specialist for Stream Heaven's video systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/video-systems/agora-integration-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Agora. (Agora Integration scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/agora-integration-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/agora-integration-agent/advanced/SKILL.md`
