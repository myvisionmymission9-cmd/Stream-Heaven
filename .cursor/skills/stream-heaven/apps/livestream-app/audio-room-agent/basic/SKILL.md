---
name: stream-heaven-apps-livestream-app-audio-room-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Audio Room (phase 9).
...
- User invokes **Audio Room** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/core/audio-room-agent.md`
- **Role:** Audio-only live rooms with seat maps, mute policies, and low-bandwidth profiles.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/core/audio-room-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Model speaker/listener seats separate from video stage. (Audio Room scope)
