---
name: stream-heaven-apps-livestream-app-host-competition-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Host Competition (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Host Competition — Basic

## When to use

- User invokes **Host Competition** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/operations/host-competition-agent.md`
- **Role:** Host competitions with judging and appeals.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/operations/host-competition-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Define host-competition-agent models in PostgreSQL; hot leaderboards in Redis. (Host Competition scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/host-competition-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/host-competition-agent/advanced/SKILL.md`
