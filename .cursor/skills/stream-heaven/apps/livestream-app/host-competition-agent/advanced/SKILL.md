---
name: stream-heaven-apps-livestream-app-host-competition-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Host Competition (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Host Competition — Advanced
