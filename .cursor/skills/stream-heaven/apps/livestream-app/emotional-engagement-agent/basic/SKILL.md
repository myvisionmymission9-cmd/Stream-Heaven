---
name: stream-heaven-apps-livestream-app-emotional-engagement-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Emotional Engagement (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Emotional Engagement — Basic

## When to use

- User invokes **Emotional Engagement** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/emotional-engagement-agent.md`
- **Role:** Emotional hooks in live UX timing.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/emotional-engagement-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- PostgreSQL rules + Redis aggregates for emotional-engagement-agent. (Emotional Engagement scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/emotional-engagement-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/emotional-engagement-agent/advanced/SKILL.md`
