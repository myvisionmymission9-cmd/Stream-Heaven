---
name: stream-heaven-apps-livestream-app-recording-playback-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Recording Playback (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Recording Playback — Advanced
