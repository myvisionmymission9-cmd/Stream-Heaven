---
name: stream-heaven-apps-livestream-app-recording-playback-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Recording Playback (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Recording Playback — Basic

## When to use

- User invokes **Recording Playback** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/video-systems/recording-playback-agent.md`
- **Role:** Recording Playback Agent specialist for Stream Heaven's video systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/video-systems/recording-playback-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Recording Playback. (Recording Playback scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/recording-playback-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/recording-playback-agent/advanced/SKILL.md`
