---
name: stream-heaven-apps-livestream-app-audio-mixer-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Audio Mixer (phase 9).
...
- User invokes **Audio Mixer** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/audio-mixer-agent.md`
- **Role:** Apps/Livestream App/Agents/Multi Guest/Audio Mixer specialist for Stream Heaven's multi-guest domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/audio-mixer-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Define per-guest gain staging and auto-ducking when host speaks. (Audio Mixer scope)
