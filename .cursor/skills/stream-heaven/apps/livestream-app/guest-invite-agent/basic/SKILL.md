---
name: stream-heaven-apps-livestream-app-guest-invite-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Guest Invite (phase 9).
...
- User invokes **Guest Invite** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/guest-invite-agent.md`
- **Role:** Guest Invite Agent specialist for Stream Heaven's multi guest domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/guest-invite-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Guest Invite. (Guest Invite scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/guest-invite-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/guest-invite-agent/advanced/SKILL.md`
