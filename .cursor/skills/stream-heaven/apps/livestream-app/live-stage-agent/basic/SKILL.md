---
name: stream-heaven-apps-livestream-app-live-stage-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Live Stage (phase 9).
...
- User invokes **Live Stage** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/live-stage-agent.md`
- **Role:** Multi-guest stage modes — grid, spotlight, PK split.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/live-stage-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Stage mode state machine over Socket.IO. (Live Stage scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/live-stage-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/live-stage-agent/advanced/SKILL.md`
