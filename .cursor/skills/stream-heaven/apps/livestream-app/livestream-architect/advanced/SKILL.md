---
name: stream-heaven-apps-livestream-app-livestream-architect-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Livestream Architect (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Livestream Architect — Advanced
