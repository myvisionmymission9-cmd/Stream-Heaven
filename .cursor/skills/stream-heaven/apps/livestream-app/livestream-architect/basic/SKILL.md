---
name: stream-heaven-apps-livestream-app-livestream-architect-basic
description: >-
  Basic Cursor skill for Stream Heaven Livestream Architect (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Livestream Architect — Basic

## When to use

- User invokes **Livestream Architect** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/core/livestream-architect.md`
- **Role:** Livestream Architect specialist for Stream Heaven's core domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/core/livestream-architect.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Livestream. (Livestream Architect scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/livestream-architect/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/livestream-architect/advanced/SKILL.md`
