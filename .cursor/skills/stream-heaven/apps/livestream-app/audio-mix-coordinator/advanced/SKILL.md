---
name: stream-heaven-apps-livestream-app-audio-mix-coordinator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Audio Mix Coordinator (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Audio Mix Coordinator — Advanced
