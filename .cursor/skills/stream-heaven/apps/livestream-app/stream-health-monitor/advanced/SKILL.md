---
name: stream-heaven-apps-livestream-app-stream-health-monitor-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Stream Health Monitor (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Stream Health Monitor — Advanced
