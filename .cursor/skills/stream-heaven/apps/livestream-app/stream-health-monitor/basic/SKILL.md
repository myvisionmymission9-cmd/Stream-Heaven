---
name: stream-heaven-apps-livestream-app-stream-health-monitor-basic
description: >-
  Basic Cursor skill for Stream Heaven Stream Health Monitor (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Stream Health Monitor — Basic

## When to use

- User invokes **Stream Health Monitor** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/operations/stream-health-monitor.md`
- **Role:** Stream Health Monitor specialist for Stream Heaven's operations domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/operations/stream-health-monitor.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Design and implement operations capabilities for Stream Heaven. (Stream Health Monitor scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/stream-health-monitor/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/stream-health-monitor/advanced/SKILL.md`
