---
name: stream-heaven-apps-livestream-app-livestream-recommendation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Livestream Recommendation (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Livestream Recommendation — Basic

## When to use

- User invokes **Livestream Recommendation** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/core/livestream-recommendation-agent.md`
- **Role:** Livestream Recommendation Agent specialist for Stream Heaven's core domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/core/livestream-recommendation-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Livestream Recommendation. (Livestream Recommendation scope)
