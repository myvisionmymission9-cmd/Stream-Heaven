---
name: stream-heaven-apps-livestream-app-livestream-recommendation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Livestream Recommendation (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Livestream Recommendation — Advanced
