---
name: stream-heaven-apps-livestream-app-ban-kick-moderator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ban Kick Moderator (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Ban Kick Moderator — Advanced
...
Scale:
- Own livestream domain contracts and NestJS livestream-service behavior for Ban Kick. (Ban Kick Moderator scope)
