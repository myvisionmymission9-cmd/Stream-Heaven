---
name: stream-heaven-apps-livestream-app-fomo-mechanics-designer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Fomo Mechanics Designer (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Fomo Mechanics Designer — Advanced
