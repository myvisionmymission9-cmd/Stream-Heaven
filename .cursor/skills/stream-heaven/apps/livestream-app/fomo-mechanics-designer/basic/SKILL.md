---
name: stream-heaven-apps-livestream-app-fomo-mechanics-designer-basic
description: >-
  Basic Cursor skill for Stream Heaven Fomo Mechanics Designer (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Fomo Mechanics Designer — Basic

## When to use

- User invokes **Fomo Mechanics Designer** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/fomo-mechanics-designer.md`
- **Role:** Fomo Mechanics Designer specialist for Stream Heaven's economy psychology domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/fomo-mechanics-designer.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Fomo Mechanics. (Fomo Mechanics Designer scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/fomo-mechanics-designer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/fomo-mechanics-designer/advanced/SKILL.md`
