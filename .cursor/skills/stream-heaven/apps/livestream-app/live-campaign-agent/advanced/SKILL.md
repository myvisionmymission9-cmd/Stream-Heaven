---
name: stream-heaven-apps-livestream-app-live-campaign-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Live Campaign (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Live Campaign — Advanced
