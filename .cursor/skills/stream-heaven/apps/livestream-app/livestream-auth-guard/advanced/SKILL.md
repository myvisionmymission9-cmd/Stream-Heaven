---
name: stream-heaven-apps-livestream-app-livestream-auth-guard-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Livestream Auth Guard (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Livestream Auth Guard — Advanced
