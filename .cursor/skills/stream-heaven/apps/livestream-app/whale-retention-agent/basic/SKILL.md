---
name: stream-heaven-apps-livestream-app-whale-retention-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Whale Retention (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Whale Retention — Basic
...
- Open agent: `apps/livestream-app/agents/economy-psychology/whale-retention-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Whale Retention. (Whale Retention scope)
