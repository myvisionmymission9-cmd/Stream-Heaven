---
name: stream-heaven-apps-livestream-app-high-spender-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven High Spender (phase 9).
...
- User invokes **High Spender** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/high-spender-agent.md`
- **Role:** Whale detection and VIP treatment.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/high-spender-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- PostgreSQL rules + Redis aggregates for high-spender-agent. (High Spender scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/high-spender-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/high-spender-agent/advanced/SKILL.md`
