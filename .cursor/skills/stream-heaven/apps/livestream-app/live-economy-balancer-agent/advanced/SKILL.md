---
name: stream-heaven-apps-livestream-app-live-economy-balancer-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Live Economy Balancer (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Live Economy Balancer — Advanced
