---
name: stream-heaven-apps-livestream-app-live-economy-balancer-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Live Economy Balancer (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Live Economy Balancer — Basic

## When to use

- User invokes **Live Economy Balancer** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/live-economy-balancer-agent.md`
- **Role:** Virtual economy sinks/sources balance.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/live-economy-balancer-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- PostgreSQL rules + Redis aggregates for live-economy-balancer-agent. (Live Economy Balancer scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/live-economy-balancer-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/live-economy-balancer-agent/advanced/SKILL.md`
