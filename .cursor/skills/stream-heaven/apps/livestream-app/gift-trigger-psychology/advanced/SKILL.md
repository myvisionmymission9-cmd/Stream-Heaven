---
name: stream-heaven-apps-livestream-app-gift-trigger-psychology-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Gift Trigger Psychology (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Gift Trigger Psychology — Advanced
