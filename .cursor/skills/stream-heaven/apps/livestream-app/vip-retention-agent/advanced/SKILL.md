---
name: stream-heaven-apps-livestream-app-vip-retention-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Vip Retention (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Vip Retention — Advanced
