---
name: stream-heaven-apps-livestream-app-vip-retention-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Vip Retention (phase 9).
...
- User invokes **Vip Retention** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/vip-retention-agent.md`
- **Role:** VIP tiers, churn, and win-back.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/vip-retention-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- PostgreSQL rules + Redis aggregates for vip-retention-agent. (Vip Retention scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/vip-retention-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/vip-retention-agent/advanced/SKILL.md`
