---
name: stream-heaven-apps-livestream-app-viewer-session-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Viewer Session (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Viewer Session — Basic

## When to use

- User invokes **Viewer Session** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/core/viewer-session-agent.md`
- **Role:** Viewer Session Agent specialist for Stream Heaven's core domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/core/viewer-session-agent.md` and copy its `## Prompt Template` block
