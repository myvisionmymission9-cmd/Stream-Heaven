---
name: stream-heaven-apps-livestream-app-viewer-session-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Viewer Session (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Viewer Session — Advanced
