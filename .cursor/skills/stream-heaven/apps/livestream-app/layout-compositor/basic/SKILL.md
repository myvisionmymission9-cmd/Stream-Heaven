---
name: stream-heaven-apps-livestream-app-layout-compositor-basic
description: >-
  Basic Cursor skill for Stream Heaven Layout Compositor (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Layout Compositor — Basic

## When to use

- User invokes **Layout Compositor** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/layout-compositor.md`
- **Role:** Layout Compositor specialist for Stream Heaven's multi guest domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/layout-compositor.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Design and implement multi guest capabilities for Stream Heaven. (Layout Compositor scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/layout-compositor/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/layout-compositor/advanced/SKILL.md`
