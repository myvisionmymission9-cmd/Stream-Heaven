---
name: stream-heaven-apps-livestream-app-layout-compositor-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Layout Compositor (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Layout Compositor — Advanced
