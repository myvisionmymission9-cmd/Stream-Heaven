---
name: stream-heaven-apps-livestream-app-spender-segmentation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Spender Segmentation (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Spender Segmentation — Basic

## When to use

- User invokes **Spender Segmentation** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/spender-segmentation-agent.md`
- **Role:** RFM segmentation for live spenders.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/spender-segmentation-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- PostgreSQL rules + Redis aggregates for spender-segmentation-agent. (Spender Segmentation scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/spender-segmentation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/spender-segmentation-agent/advanced/SKILL.md`
