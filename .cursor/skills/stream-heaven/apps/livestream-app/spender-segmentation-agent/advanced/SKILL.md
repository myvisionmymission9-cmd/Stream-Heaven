---
name: stream-heaven-apps-livestream-app-spender-segmentation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Spender Segmentation (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Spender Segmentation — Advanced
