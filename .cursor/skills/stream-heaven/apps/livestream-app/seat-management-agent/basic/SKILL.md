---
name: stream-heaven-apps-livestream-app-seat-management-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Seat Management (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Seat Management — Basic

## When to use

- User invokes **Seat Management** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/seat-management-agent.md`
- **Role:** Speaker seats, locks, promotions, and layout slots.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/seat-management-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Seat graph per room tier in PostgreSQL. (Seat Management scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/seat-management-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/seat-management-agent/advanced/SKILL.md`
