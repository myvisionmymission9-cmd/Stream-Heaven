---
name: stream-heaven-apps-livestream-app-seat-management-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Seat Management (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Seat Management — Advanced
