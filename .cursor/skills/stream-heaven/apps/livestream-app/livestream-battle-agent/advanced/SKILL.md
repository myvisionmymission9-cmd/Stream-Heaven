---
name: stream-heaven-apps-livestream-app-livestream-battle-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Livestream Battle (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Livestream Battle — Advanced
