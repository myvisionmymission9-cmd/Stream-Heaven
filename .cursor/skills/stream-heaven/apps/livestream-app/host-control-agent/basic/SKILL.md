---
name: stream-heaven-apps-livestream-app-host-control-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Host Control (phase 9).
...
- User invokes **Host Control** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/host-control-agent.md`
- **Role:** Apps/Livestream App/Agents/Multi Guest/Host Control specialist for Stream Heaven's multi-guest domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/host-control-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Centralize host-only actions: mute guest, remove from stage, lock seats, end room. (Host Control scope)
