---
name: stream-heaven-apps-livestream-app-live-event-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Live Event (phase 9).
...
- User invokes **Live Event** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/operations/live-event-agent.md`
- **Role:** One-off live events — reminders and go-live.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/operations/live-event-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Define live-event-agent models in PostgreSQL; hot leaderboards in Redis. (Live Event scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/live-event-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/live-event-agent/advanced/SKILL.md`
