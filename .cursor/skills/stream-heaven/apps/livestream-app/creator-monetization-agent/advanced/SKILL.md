---
name: stream-heaven-apps-livestream-app-creator-monetization-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Monetization (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Creator Monetization — Advanced
