---
name: stream-heaven-apps-livestream-app-co-host-manager-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Co Host Manager (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Co Host Manager — Advanced
