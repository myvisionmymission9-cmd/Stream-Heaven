---
name: stream-heaven-apps-livestream-app-co-host-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Co Host Manager (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Co Host Manager — Basic

## When to use

- User invokes **Co Host Manager** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/co-host-manager.md`
- **Role:** Co Host Manager specialist for Stream Heaven's multi guest domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/co-host-manager.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Co Host. (Co Host Manager scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/co-host-manager/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/co-host-manager/advanced/SKILL.md`
