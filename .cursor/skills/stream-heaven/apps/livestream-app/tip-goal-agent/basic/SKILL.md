---
name: stream-heaven-apps-livestream-app-tip-goal-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Tip Goal (phase 9).
...
- User invokes **Tip Goal** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/tip-goal-agent.md`
- **Role:** Tip Goal Agent specialist for Stream Heaven's economy psychology domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/tip-goal-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Tip Goal. (Tip Goal scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/tip-goal-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/tip-goal-agent/advanced/SKILL.md`
