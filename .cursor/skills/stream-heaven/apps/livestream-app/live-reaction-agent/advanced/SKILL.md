---
name: stream-heaven-apps-livestream-app-live-reaction-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Live Reaction (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Live Reaction — Advanced
