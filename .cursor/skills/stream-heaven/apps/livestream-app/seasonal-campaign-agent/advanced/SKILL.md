---
name: stream-heaven-apps-livestream-app-seasonal-campaign-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Seasonal Campaign (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Seasonal Campaign — Advanced
