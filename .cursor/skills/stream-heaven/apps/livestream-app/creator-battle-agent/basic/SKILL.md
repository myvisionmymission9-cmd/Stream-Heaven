---
name: stream-heaven-apps-livestream-app-creator-battle-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Battle (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Battle — Basic

## When to use

- User invokes **Creator Battle** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/creator-battle-agent.md`
- **Role:** Creator battle psychology and pacing.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/creator-battle-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- PostgreSQL rules + Redis aggregates for creator-battle-agent. (Creator Battle scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/creator-battle-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/creator-battle-agent/advanced/SKILL.md`
