---
name: stream-heaven-apps-livestream-app-creator-battle-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Battle (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Creator Battle — Advanced
