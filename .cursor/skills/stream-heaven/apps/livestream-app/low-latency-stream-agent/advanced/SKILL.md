---
name: stream-heaven-apps-livestream-app-low-latency-stream-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Low Latency Stream (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Low Latency Stream — Advanced
