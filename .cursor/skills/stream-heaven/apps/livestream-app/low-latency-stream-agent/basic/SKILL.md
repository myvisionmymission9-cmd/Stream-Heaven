---
name: stream-heaven-apps-livestream-app-low-latency-stream-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Low Latency Stream (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Low Latency Stream — Basic

## When to use

- User invokes **Low Latency Stream** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/video-systems/low-latency-stream-agent.md`
- **Role:** Ultra-low-latency paths for PK and host-viewer sync.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/video-systems/low-latency-stream-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Agora interactive vs HLS latency budgets. (Low Latency Stream scope)
