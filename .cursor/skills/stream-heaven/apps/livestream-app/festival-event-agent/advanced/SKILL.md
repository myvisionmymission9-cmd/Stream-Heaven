---
name: stream-heaven-apps-livestream-app-festival-event-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Festival Event (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Festival Event — Advanced
