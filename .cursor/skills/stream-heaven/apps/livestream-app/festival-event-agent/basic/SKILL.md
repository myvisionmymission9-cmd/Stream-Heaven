---
name: stream-heaven-apps-livestream-app-festival-event-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Festival Event (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Festival Event — Basic

## When to use

- User invokes **Festival Event** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/operations/festival-event-agent.md`
- **Role:** Multi-day festival schedules and sponsor zones.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/operations/festival-event-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Define festival-event-agent models in PostgreSQL; hot leaderboards in Redis. (Festival Event scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/festival-event-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/festival-event-agent/advanced/SKILL.md`
