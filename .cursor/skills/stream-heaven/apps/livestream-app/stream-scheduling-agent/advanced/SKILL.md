---
name: stream-heaven-apps-livestream-app-stream-scheduling-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Stream Scheduling (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Stream Scheduling — Advanced
