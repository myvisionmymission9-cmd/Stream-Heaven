---
name: stream-heaven-apps-livestream-app-stream-scheduling-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Stream Scheduling (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Stream Scheduling — Basic

## When to use

- User invokes **Stream Scheduling** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/operations/stream-scheduling-agent.md`
- **Role:** Stream Scheduling Agent specialist for Stream Heaven's operations domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/operations/stream-scheduling-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Stream Scheduling. (Stream Scheduling scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/stream-scheduling-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/stream-scheduling-agent/advanced/SKILL.md`
