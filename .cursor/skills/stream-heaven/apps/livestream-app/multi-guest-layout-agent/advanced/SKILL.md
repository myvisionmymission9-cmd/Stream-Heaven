---
name: stream-heaven-apps-livestream-app-multi-guest-layout-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Multi Guest Layout (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Multi Guest Layout — Advanced
