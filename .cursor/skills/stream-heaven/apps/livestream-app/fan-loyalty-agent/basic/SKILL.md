---
name: stream-heaven-apps-livestream-app-fan-loyalty-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Fan Loyalty (phase 9).
...
- User invokes **Fan Loyalty** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/economy-psychology/fan-loyalty-agent.md`
- **Role:** Loyalty points, badges, retention.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/economy-psychology/fan-loyalty-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- PostgreSQL rules + Redis aggregates for fan-loyalty-agent. (Fan Loyalty scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/fan-loyalty-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/fan-loyalty-agent/advanced/SKILL.md`
