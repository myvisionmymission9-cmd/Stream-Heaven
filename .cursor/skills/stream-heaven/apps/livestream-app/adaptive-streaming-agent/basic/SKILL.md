---
name: stream-heaven-apps-livestream-app-adaptive-streaming-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Adaptive Streaming (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Adaptive Streaming — Basic

## When to use

- User invokes **Adaptive Streaming** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/video-systems/adaptive-streaming-agent.md`
- **Role:** Apps/Livestream App/Agents/Video Systems/Adaptive Streaming specialist for Stream Heaven's video-systems domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/video-systems/adaptive-streaming-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Define multi-bitrate ladder templates per content type: PK battle, solo host, screen share. (Adaptive Streaming scope)
