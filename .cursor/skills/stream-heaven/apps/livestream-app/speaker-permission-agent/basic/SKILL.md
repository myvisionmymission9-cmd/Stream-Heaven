---
name: stream-heaven-apps-livestream-app-speaker-permission-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Speaker Permission (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Speaker Permission — Basic

## When to use

- User invokes **Speaker Permission** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/multi-guest/speaker-permission-agent.md`
- **Role:** Apps/Livestream App/Agents/Multi Guest/Speaker Permission specialist for Stream Heaven's multi-guest domain within the four-app entertainment ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/multi-guest/speaker-permission-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Map seat assignments to Agora/Zego publish privileges with short-lived tokens. (Speaker Permission scope)
