---
name: stream-heaven-apps-livestream-app-speaker-permission-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Speaker Permission (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Speaker Permission — Advanced
