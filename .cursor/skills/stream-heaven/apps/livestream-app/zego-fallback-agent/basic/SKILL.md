---
name: stream-heaven-apps-livestream-app-zego-fallback-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Zego Fallback (phase 9).
...
- User invokes **Zego Fallback** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/video-systems/zego-fallback-agent.md`
- **Role:** Zego Fallback Agent specialist for Stream Heaven's video systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/video-systems/zego-fallback-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Zego Fallback. (Zego Fallback scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/zego-fallback-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/zego-fallback-agent/advanced/SKILL.md`
