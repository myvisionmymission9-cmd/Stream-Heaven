---
name: stream-heaven-apps-livestream-app-zego-fallback-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Zego Fallback (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Zego Fallback — Advanced
