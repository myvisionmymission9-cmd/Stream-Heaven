---
name: stream-heaven-apps-livestream-app-fan-engagement-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Fan Engagement (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Fan Engagement — Advanced
