---
name: stream-heaven-apps-livestream-app-room-lifecycle-manager-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Room Lifecycle Manager (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Room Lifecycle Manager — Advanced
