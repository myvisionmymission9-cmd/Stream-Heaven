---
name: stream-heaven-apps-livestream-app-room-lifecycle-manager-basic
description: >-
  Basic Cursor skill for Stream Heaven Room Lifecycle Manager (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Room Lifecycle Manager — Basic

## When to use

- User invokes **Room Lifecycle Manager** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/core/room-lifecycle-manager.md`
- **Role:** Room Lifecycle Manager specialist for Stream Heaven's core domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/core/room-lifecycle-manager.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/room-lifecycle-manager/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/room-lifecycle-manager/advanced/SKILL.md`
