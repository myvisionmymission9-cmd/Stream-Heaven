---
name: stream-heaven-apps-livestream-app-live-ops-dashboard-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Live Ops Dashboard (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Live Ops Dashboard — Basic

## When to use

- User invokes **Live Ops Dashboard** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/operations/live-ops-dashboard-agent.md`
- **Role:** Live Ops Dashboard Agent specialist for Stream Heaven's operations domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/operations/live-ops-dashboard-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Live Ops Dashboard. (Live Ops Dashboard scope)
