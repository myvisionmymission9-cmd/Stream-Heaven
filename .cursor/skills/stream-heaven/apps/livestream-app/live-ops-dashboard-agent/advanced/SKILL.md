---
name: stream-heaven-apps-livestream-app-live-ops-dashboard-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Live Ops Dashboard (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Live Ops Dashboard — Advanced
