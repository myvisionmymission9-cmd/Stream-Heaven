---
name: stream-heaven-apps-livestream-app-community-event-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Community Event (phase 9).
...
- User invokes **Community Event** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/operations/community-event-agent.md`
- **Role:** Community watch parties and shared rooms.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/operations/community-event-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Define community-event-agent models in PostgreSQL; hot leaderboards in Redis. (Community Event scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/community-event-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/community-event-agent/advanced/SKILL.md`
