---
name: stream-heaven-apps-livestream-app-bitrate-adaptation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Bitrate Adaptation (phase 9).
  Single-agent execution with governance prefix and structural validation.
---

# Bitrate Adaptation — Basic

## When to use

- User invokes **Bitrate Adaptation** or work in **apps/livestream-app** (phase 9)
- Focused task within this agent's scope

## Agent

- **Path:** `apps/livestream-app/agents/video-systems/bitrate-adaptation-agent.md`
- **Role:** Bitrate Adaptation Agent specialist for Stream Heaven's video systems domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `apps/livestream-app/agents/video-systems/bitrate-adaptation-agent.md` and copy its `## Prompt Template` block
...
### Live Room Lifecycle
Own:
- Own livestream domain contracts and NestJS livestream-service behavior for Bitrate Adaptation. (Bitrate Adaptation scope)
...
- Basic: `.cursor/skills/stream-heaven/apps/livestream-app/bitrate-adaptation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/apps/livestream-app/bitrate-adaptation-agent/advanced/SKILL.md`
