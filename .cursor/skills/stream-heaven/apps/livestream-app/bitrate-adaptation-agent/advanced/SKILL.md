---
name: stream-heaven-apps-livestream-app-bitrate-adaptation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Bitrate Adaptation (phase 9).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Bitrate Adaptation — Advanced
