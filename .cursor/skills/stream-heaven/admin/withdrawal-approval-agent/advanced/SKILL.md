---
name: stream-heaven-admin-withdrawal-approval-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Withdrawal Approval (Phase 20).
  Cross-agent orchestration, ADRs, production validation.
---

# Withdrawal Approval — Advanced
