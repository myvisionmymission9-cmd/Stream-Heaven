---
name: stream-heaven-orchestration-chat-coordinator-basic
description: >-
  Basic Cursor skill for Stream Heaven Chat Coordinator (phase 4).
  Single-agent execution with governance prefix and structural validation.
---

# Chat Coordinator — Basic

## When to use

- User invokes **Chat Coordinator** or work in **orchestration** (phase 4)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/orchestration/chat-coordinator.md`
- **Role:** Chat Coordinator specialist for Stream Heaven's orchestration domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/orchestration/chat-coordinator.md` and copy its `## Prompt Template` block
...
Route:
- Orchestrate Chat workflows across ai-agents/ with explicit task ownership and phase gates. (Chat Coordinator scope)
...
- Basic: `.cursor/skills/stream-heaven/orchestration/chat-coordinator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/orchestration/chat-coordinator/advanced/SKILL.md`
