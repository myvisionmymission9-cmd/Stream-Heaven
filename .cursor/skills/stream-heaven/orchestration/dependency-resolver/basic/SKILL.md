---
name: stream-heaven-orchestration-dependency-resolver-basic
description: >-
  Basic Cursor skill for Stream Heaven Dependency Resolver (phase 4).
  Single-agent execution with governance prefix and structural validation.
---

# Dependency Resolver — Basic

## When to use

- User invokes **Dependency Resolver** or work in **orchestration** (phase 4)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/orchestration/dependency-resolver.md`
- **Role:** Dependency Resolver specialist for Stream Heaven's orchestration domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/orchestration/dependency-resolver.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement orchestration capabilities for Stream Heaven. (Dependency Resolver scope)
