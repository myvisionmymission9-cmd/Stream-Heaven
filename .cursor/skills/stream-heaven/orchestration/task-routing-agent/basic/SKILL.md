---
name: stream-heaven-orchestration-task-routing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Task Routing (phase 4).
...
- Open agent: `ai-agents/orchestration/task-routing-agent.md` and copy its `## Prompt Template` block
...
Route:
- Design and implement orchestration capabilities for Stream Heaven. (Task Routing scope)
