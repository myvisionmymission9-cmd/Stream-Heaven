---
name: stream-heaven-orchestration-prompt-orchestrator-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Prompt Orchestrator (phase 4).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Prompt Orchestrator — Advanced
