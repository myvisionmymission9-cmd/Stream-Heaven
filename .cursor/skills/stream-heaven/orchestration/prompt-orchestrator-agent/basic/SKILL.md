---
name: stream-heaven-orchestration-prompt-orchestrator-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Prompt Orchestrator (phase 4).
  Single-agent execution with governance prefix and structural validation.
---

# Prompt Orchestrator — Basic

## When to use

- User invokes **Prompt Orchestrator** or work in **orchestration** (phase 4)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/orchestration/prompt-orchestrator-agent.md`
- **Role:** Prompt Orchestrator Agent specialist for Stream Heaven's orchestration domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/orchestration/prompt-orchestrator-agent.md` and copy its `## Prompt Template` block
...
Route:
- Orchestrate Prompt workflows across ai-agents/ with explicit task ownership and phase gates. (Prompt Orchestrator scope)
...
- Basic: `.cursor/skills/stream-heaven/orchestration/prompt-orchestrator-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/orchestration/prompt-orchestrator-agent/advanced/SKILL.md`
