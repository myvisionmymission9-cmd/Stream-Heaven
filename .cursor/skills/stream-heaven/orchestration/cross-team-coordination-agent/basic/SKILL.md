---
name: stream-heaven-orchestration-cross-team-coordination-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross Team Coordination (phase 4).
  Single-agent execution with governance prefix and structural validation.
---

# Cross Team Coordination — Basic

## When to use

- User invokes **Cross Team Coordination** or work in **orchestration** (phase 4)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/orchestration/cross-team-coordination-agent.md`
- **Role:** Cross Team Coordination Agent specialist for Stream Heaven's orchestration domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/orchestration/cross-team-coordination-agent.md` and copy its `## Prompt Template` block
...
Route:
- Orchestrate Cross Team Coordination workflows across ai-agents/ with explicit task ownership and phase gates. (Cross Team Coordination scope)
...
- Basic: `.cursor/skills/stream-heaven/orchestration/cross-team-coordination-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/orchestration/cross-team-coordination-agent/advanced/SKILL.md`
