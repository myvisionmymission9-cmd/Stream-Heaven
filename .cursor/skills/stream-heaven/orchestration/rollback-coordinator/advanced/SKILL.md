---
name: stream-heaven-orchestration-rollback-coordinator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Rollback Coordinator (phase 4).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Rollback Coordinator — Advanced
