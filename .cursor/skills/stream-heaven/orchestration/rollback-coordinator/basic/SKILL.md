---
name: stream-heaven-orchestration-rollback-coordinator-basic
description: >-
  Basic Cursor skill for Stream Heaven Rollback Coordinator (phase 4).
  Single-agent execution with governance prefix and structural validation.
---

# Rollback Coordinator — Basic

## When to use

- User invokes **Rollback Coordinator** or work in **orchestration** (phase 4)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/orchestration/rollback-coordinator.md`
- **Role:** Rollback Coordinator specialist for Stream Heaven's orchestration domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/orchestration/rollback-coordinator.md` and copy its `## Prompt Template` block
...
Route:
- Orchestrate Rollback workflows across ai-agents/ with explicit task ownership and phase gates. (Rollback Coordinator scope)
...
- Basic: `.cursor/skills/stream-heaven/orchestration/rollback-coordinator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/orchestration/rollback-coordinator/advanced/SKILL.md`
