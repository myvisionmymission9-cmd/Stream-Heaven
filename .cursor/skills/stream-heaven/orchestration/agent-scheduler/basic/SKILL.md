---
name: stream-heaven-orchestration-agent-scheduler-basic
description: >-
  Basic Cursor skill for Stream Heaven Agent Scheduler (phase 4).
  Single-agent execution with governance prefix and structural validation.
---

# Agent Scheduler — Basic

## When to use

- User invokes **Agent Scheduler** or work in **orchestration** (phase 4)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/orchestration/agent-scheduler.md`
- **Role:** Agent Scheduler specialist for Stream Heaven's orchestration domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/orchestration/agent-scheduler.md` and copy its `## Prompt Template` block
...
Route:
- Orchestrate Agent Scheduler workflows across ai-agents/ with explicit task ownership and phase gates. (Agent Scheduler scope)
...
- Basic: `.cursor/skills/stream-heaven/orchestration/agent-scheduler/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/orchestration/agent-scheduler/advanced/SKILL.md`
