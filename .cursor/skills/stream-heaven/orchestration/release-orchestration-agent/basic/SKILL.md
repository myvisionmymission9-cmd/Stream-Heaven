---
name: stream-heaven-orchestration-release-orchestration-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Release Orchestration (phase 4).
  Single-agent execution with governance prefix and structural validation.
---

# Release Orchestration — Basic

## When to use

- User invokes **Release Orchestration** or work in **orchestration** (phase 4)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/orchestration/release-orchestration-agent.md`
- **Role:** Release Orchestration Agent specialist for Stream Heaven's orchestration domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/orchestration/release-orchestration-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/orchestration/release-orchestration-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/orchestration/release-orchestration-agent/advanced/SKILL.md`
