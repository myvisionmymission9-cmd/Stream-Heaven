---
name: stream-heaven-orchestration-system-design-reviewer-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven System Design Reviewer (phase 4).
  Single-agent execution with governance prefix and structural validation.
---

# System Design Reviewer — Basic

## When to use

- User invokes **System Design Reviewer** or work in **orchestration** (phase 4)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/orchestration/system-design-reviewer-agent.md`
- **Role:** System Design Reviewer Agent specialist for Stream Heaven's orchestration domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/orchestration/system-design-reviewer-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/orchestration/system-design-reviewer-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/orchestration/system-design-reviewer-agent/advanced/SKILL.md`
