---
name: stream-heaven-user-experience-intelligence-journey-mapper-basic
description: >-
  Basic Cursor skill for Stream Heaven Journey Mapper (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Journey Mapper — Basic

## When to use

- User invokes **Journey Mapper** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/journey-mapper.md`
- **Role:** Journey Mapper specialist for Stream Heaven's user experience intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/journey-mapper.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement user experience intelligence capabilities for Stream Heaven. (Journey Mapper scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/journey-mapper/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/journey-mapper/advanced/SKILL.md`
