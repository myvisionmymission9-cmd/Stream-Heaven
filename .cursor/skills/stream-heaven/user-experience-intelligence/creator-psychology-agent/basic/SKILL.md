---
name: stream-heaven-user-experience-intelligence-creator-psychology-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Psychology (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Psychology — Basic

## When to use

- User invokes **Creator Psychology** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/creator-psychology-agent.md`
- **Role:** Creator Psychology Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/creator-psychology-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/creator-psychology-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/creator-psychology-agent/advanced/SKILL.md`
