---
name: stream-heaven-user-experience-intelligence-habit-formation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Habit Formation (phase 7).
...
- User invokes **Habit Formation** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/habit-formation-agent.md`
- **Role:** Habit Formation Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/habit-formation-agent.md` and copy its `## Prompt Template` block
...
Research:
- Implement Habit Formation in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Habit Formation scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/habit-formation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/habit-formation-agent/advanced/SKILL.md`
