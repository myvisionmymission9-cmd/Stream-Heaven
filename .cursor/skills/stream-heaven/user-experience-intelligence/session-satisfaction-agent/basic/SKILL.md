---
name: stream-heaven-user-experience-intelligence-session-satisfaction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Session Satisfaction (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Session Satisfaction — Basic

## When to use

- User invokes **Session Satisfaction** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/session-satisfaction-agent.md`
- **Role:** Session Satisfaction Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/session-satisfaction-agent.md` and copy its `## Prompt Template` block
...
Research:
- Implement Session Satisfaction flows in NestJS auth-service with Firebase Admin SDK verification. (Session Satisfaction scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/session-satisfaction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/session-satisfaction-agent/advanced/SKILL.md`
