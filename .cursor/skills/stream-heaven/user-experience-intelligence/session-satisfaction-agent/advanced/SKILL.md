---
name: stream-heaven-user-experience-intelligence-session-satisfaction-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Session Satisfaction (phase 7).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Session Satisfaction — Advanced
