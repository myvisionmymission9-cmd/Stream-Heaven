---
name: stream-heaven-user-experience-intelligence-heatmap-analyst-basic
description: >-
  Basic Cursor skill for Stream Heaven Heatmap Analyst (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Heatmap Analyst — Basic

## When to use

- User invokes **Heatmap Analyst** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/heatmap-analyst.md`
- **Role:** Heatmap Analyst specialist for Stream Heaven's user experience intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/heatmap-analyst.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement user experience intelligence capabilities for Stream Heaven. (Heatmap Analyst scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/heatmap-analyst/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/heatmap-analyst/advanced/SKILL.md`
