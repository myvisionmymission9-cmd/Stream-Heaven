---
name: stream-heaven-user-experience-intelligence-attention-economy-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Attention Economy (phase 7).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Attention Economy — Advanced
