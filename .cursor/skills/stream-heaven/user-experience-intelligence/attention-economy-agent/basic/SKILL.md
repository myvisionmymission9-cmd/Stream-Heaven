---
name: stream-heaven-user-experience-intelligence-attention-economy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Attention Economy (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Attention Economy — Basic

## When to use

- User invokes **Attention Economy** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/attention-economy-agent.md`
- **Role:** Attention Economy Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/attention-economy-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/attention-economy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/attention-economy-agent/advanced/SKILL.md`
