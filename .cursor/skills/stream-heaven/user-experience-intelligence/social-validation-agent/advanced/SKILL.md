---
name: stream-heaven-user-experience-intelligence-social-validation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Social Validation (phase 7).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Social Validation — Advanced
