---
name: stream-heaven-user-experience-intelligence-social-validation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Social Validation (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Social Validation — Basic

## When to use

- User invokes **Social Validation** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/social-validation-agent.md`
- **Role:** Social Validation Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/social-validation-agent.md` and copy its `## Prompt Template` block
