---
name: stream-heaven-user-experience-intelligence-addiction-risk-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Addiction Risk (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Addiction Risk — Basic

## When to use

- User invokes **Addiction Risk** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/addiction-risk-agent.md`
- **Role:** Addiction Risk Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/addiction-risk-agent.md` and copy its `## Prompt Template` block
...
Research:
- Implement Addiction Risk in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Addiction Risk scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/addiction-risk-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/addiction-risk-agent/advanced/SKILL.md`
