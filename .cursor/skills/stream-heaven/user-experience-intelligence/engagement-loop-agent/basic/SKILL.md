---
name: stream-heaven-user-experience-intelligence-engagement-loop-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Engagement Loop (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Engagement Loop — Basic

## When to use

- User invokes **Engagement Loop** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/engagement-loop-agent.md`
- **Role:** Engagement Loop Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/engagement-loop-agent.md` and copy its `## Prompt Template` block
...
Research:
- Implement Engagement Loop in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Engagement Loop scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/engagement-loop-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/engagement-loop-agent/advanced/SKILL.md`
