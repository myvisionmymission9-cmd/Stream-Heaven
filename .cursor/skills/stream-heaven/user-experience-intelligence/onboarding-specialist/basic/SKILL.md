---
name: stream-heaven-user-experience-intelligence-onboarding-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Onboarding Specialist (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Onboarding Specialist — Basic

## When to use

- User invokes **Onboarding Specialist** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/onboarding-specialist.md`
- **Role:** Onboarding Specialist specialist for Stream Heaven's user experience intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/onboarding-specialist.md` and copy its `## Prompt Template` block
...
Research:
- Implement Onboarding in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Onboarding Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/onboarding-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/onboarding-specialist/advanced/SKILL.md`
