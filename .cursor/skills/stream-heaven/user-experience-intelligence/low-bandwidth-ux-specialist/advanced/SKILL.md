---
name: stream-heaven-user-experience-intelligence-low-bandwidth-ux-specialist-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Low Bandwidth Ux Specialist (phase 7).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Low Bandwidth Ux Specialist — Advanced
