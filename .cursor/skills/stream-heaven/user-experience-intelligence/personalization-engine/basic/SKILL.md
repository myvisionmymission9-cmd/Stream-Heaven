---
name: stream-heaven-user-experience-intelligence-personalization-engine-basic
description: >-
  Basic Cursor skill for Stream Heaven Personalization Engine (phase 7).
...
- User invokes **Personalization Engine** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/personalization-engine.md`
- **Role:** Personalization Engine specialist for Stream Heaven's user experience intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/personalization-engine.md` and copy its `## Prompt Template` block
...
Research:
- Implement Personalization in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Personalization Engine scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/personalization-engine/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/personalization-engine/advanced/SKILL.md`
