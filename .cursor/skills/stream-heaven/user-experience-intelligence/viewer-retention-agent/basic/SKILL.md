---
name: stream-heaven-user-experience-intelligence-viewer-retention-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Viewer Retention (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Viewer Retention — Basic

## When to use

- User invokes **Viewer Retention** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/viewer-retention-agent.md`
- **Role:** Viewer Retention Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/viewer-retention-agent.md` and copy its `## Prompt Template` block
...
Research:
- Implement Viewer Retention in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Viewer Retention scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/viewer-retention-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/viewer-retention-agent/advanced/SKILL.md`
