---
name: stream-heaven-user-experience-intelligence-viewer-retention-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Viewer Retention (phase 7).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Viewer Retention — Advanced
