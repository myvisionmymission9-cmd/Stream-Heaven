---
name: stream-heaven-user-experience-intelligence-behavioral-analytics-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Behavioral Analytics (phase 7).
...
Balance:
- Design and implement user experience intelligence capabilities for Stream Heaven. (Behavioral Analytics scope)
