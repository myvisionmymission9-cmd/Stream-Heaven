---
name: stream-heaven-user-experience-intelligence-session-depth-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Session Depth (phase 7).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Session Depth — Advanced
