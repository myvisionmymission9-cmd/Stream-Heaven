---
name: stream-heaven-user-experience-intelligence-session-depth-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Session Depth (phase 7).
...
- User invokes **Session Depth** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/session-depth-agent.md`
- **Role:** Session Depth Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/session-depth-agent.md` and copy its `## Prompt Template` block
...
Research:
- Implement Session Depth flows in NestJS auth-service with Firebase Admin SDK verification. (Session Depth scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/session-depth-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/session-depth-agent/advanced/SKILL.md`
