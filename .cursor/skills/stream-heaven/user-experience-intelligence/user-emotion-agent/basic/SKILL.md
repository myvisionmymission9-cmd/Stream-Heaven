---
name: stream-heaven-user-experience-intelligence-user-emotion-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven User Emotion (phase 7).
...
- User invokes **User Emotion** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/user-emotion-agent.md`
- **Role:** User Emotion Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/user-emotion-agent.md` and copy its `## Prompt Template` block
...
Research:
- Implement User Emotion in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (User Emotion scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/user-emotion-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/user-emotion-agent/advanced/SKILL.md`
