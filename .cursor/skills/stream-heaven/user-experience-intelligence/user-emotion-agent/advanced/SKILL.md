---
name: stream-heaven-user-experience-intelligence-user-emotion-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven User Emotion (phase 7).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# User Emotion — Advanced
