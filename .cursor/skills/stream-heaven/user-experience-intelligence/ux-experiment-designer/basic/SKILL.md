---
name: stream-heaven-user-experience-intelligence-ux-experiment-designer-basic
description: >-
  Basic Cursor skill for Stream Heaven Ux Experiment Designer (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Ux Experiment Designer — Basic

## When to use

- User invokes **Ux Experiment Designer** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/ux-experiment-designer.md`
- **Role:** Ux Experiment Designer specialist for Stream Heaven's user experience intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/ux-experiment-designer.md` and copy its `## Prompt Template` block
...
Research:
- Implement Ux Experiment in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Ux Experiment Designer scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/ux-experiment-designer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/ux-experiment-designer/advanced/SKILL.md`
