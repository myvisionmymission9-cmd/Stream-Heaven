---
name: stream-heaven-user-experience-intelligence-micro-reward-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Micro Reward (phase 7).
...
- Open agent: `ai-agents/user-experience-intelligence/micro-reward-agent.md` and copy its `## Prompt Template` block
...
Research:
- Design and implement user experience intelligence capabilities for Stream Heaven. (Micro Reward scope)
