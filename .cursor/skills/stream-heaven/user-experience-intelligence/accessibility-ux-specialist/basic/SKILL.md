---
name: stream-heaven-user-experience-intelligence-accessibility-ux-specialist-basic
description: >-
  Basic Cursor skill for Stream Heaven Accessibility Ux Specialist (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Accessibility Ux Specialist — Basic

## When to use

- User invokes **Accessibility Ux Specialist** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/accessibility-ux-specialist.md`
- **Role:** Accessibility Ux Specialist specialist for Stream Heaven's user experience intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/accessibility-ux-specialist.md` and copy its `## Prompt Template` block
...
Research:
- Implement Accessibility Ux in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Accessibility Ux Specialist scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/accessibility-ux-specialist/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/accessibility-ux-specialist/advanced/SKILL.md`
