---
name: stream-heaven-user-experience-intelligence-dopamine-loop-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Dopamine Loop (phase 7).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Dopamine Loop — Advanced
