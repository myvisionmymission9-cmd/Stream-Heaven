---
name: stream-heaven-user-experience-intelligence-dopamine-loop-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Dopamine Loop (phase 7).
...
- User invokes **Dopamine Loop** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/dopamine-loop-agent.md`
- **Role:** Dopamine Loop Agent specialist for Stream Heaven's user-experience-intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/dopamine-loop-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/dopamine-loop-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/dopamine-loop-agent/advanced/SKILL.md`
