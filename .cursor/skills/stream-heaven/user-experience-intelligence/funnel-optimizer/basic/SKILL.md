---
name: stream-heaven-user-experience-intelligence-funnel-optimizer-basic
description: >-
  Basic Cursor skill for Stream Heaven Funnel Optimizer (phase 7).
  Single-agent execution with governance prefix and structural validation.
---

# Funnel Optimizer — Basic

## When to use

- User invokes **Funnel Optimizer** or work in **user-experience-intelligence** (phase 7)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/user-experience-intelligence/funnel-optimizer.md`
- **Role:** Funnel Optimizer specialist for Stream Heaven's user experience intelligence domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/user-experience-intelligence/funnel-optimizer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement user experience intelligence capabilities for Stream Heaven. (Funnel Optimizer scope)
...
- Basic: `.cursor/skills/stream-heaven/user-experience-intelligence/funnel-optimizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/user-experience-intelligence/funnel-optimizer/advanced/SKILL.md`
