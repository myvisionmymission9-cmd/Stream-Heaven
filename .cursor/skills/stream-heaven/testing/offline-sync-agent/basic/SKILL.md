---
name: stream-heaven-testing-offline-sync-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Offline Sync (phase 20).
...
- User invokes **Offline Sync** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/offline-sync-agent.md`
- **Role:** Offline queue sync validation.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/offline-sync-agent.md` and copy its `## Prompt Template` block
...
Plan:
- offline-sync-agent test plans in CI with flake controls. (Offline Sync scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/offline-sync-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/offline-sync-agent/advanced/SKILL.md`
