---
name: stream-heaven-testing-chaos-test-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Chaos Test (phase 20).
...
- User invokes **Chaos Test** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/chaos-test-agent.md`
- **Role:** Chaos Test Agent specialist for Stream Heaven's testing domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/chaos-test-agent.md` and copy its `## Prompt Template` block
...
Plan:
- Define automated tests for Chaos Test: unit, integration, contract, and smoke layers. (Chaos Test scope)
