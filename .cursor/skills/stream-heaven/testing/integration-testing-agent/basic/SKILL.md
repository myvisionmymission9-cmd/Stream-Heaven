---
name: stream-heaven-testing-integration-testing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Integration Testing (phase 20).
...
- User invokes **Integration Testing** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/integration-testing-agent.md`
- **Role:** Service integration test suites.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/integration-testing-agent.md` and copy its `## Prompt Template` block
...
Plan:
- integration-testing-agent test plans in CI with flake controls. (Integration Testing scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/integration-testing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/integration-testing-agent/advanced/SKILL.md`
