---
name: stream-heaven-testing-chaos-engineering-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Chaos Engineering (phase 20).
...
- User invokes **Chaos Engineering** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/chaos-engineering-agent.md`
- **Role:** Chaos experiments in staging.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/chaos-engineering-agent.md` and copy its `## Prompt Template` block
...
Plan:
- chaos-engineering-agent test plans in CI with flake controls. (Chaos Engineering scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/chaos-engineering-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/chaos-engineering-agent/advanced/SKILL.md`
