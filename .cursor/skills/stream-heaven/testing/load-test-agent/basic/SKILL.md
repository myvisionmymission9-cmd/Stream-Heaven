---
name: stream-heaven-testing-load-test-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Load Test (phase 20).
...
- User invokes **Load Test** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/load-test-agent.md`
- **Role:** Load Test Agent specialist for Stream Heaven's testing domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/load-test-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/testing/load-test-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/load-test-agent/advanced/SKILL.md`
