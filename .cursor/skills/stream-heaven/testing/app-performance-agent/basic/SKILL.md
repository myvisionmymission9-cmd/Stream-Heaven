---
name: stream-heaven-testing-app-performance-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven App Performance (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# App Performance — Basic

## When to use

- User invokes **App Performance** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/app-performance-agent.md`
- **Role:** Mobile app performance budgets.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/app-performance-agent.md` and copy its `## Prompt Template` block
...
Plan:
- app-performance-agent test plans in CI with flake controls. (App Performance scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/app-performance-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/app-performance-agent/advanced/SKILL.md`
