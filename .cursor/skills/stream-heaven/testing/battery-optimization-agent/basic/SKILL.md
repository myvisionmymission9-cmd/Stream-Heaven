---
name: stream-heaven-testing-battery-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Battery Optimization (phase 20).
...
- User invokes **Battery Optimization** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/battery-optimization-agent.md`
- **Role:** Battery drain profiling.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/battery-optimization-agent.md` and copy its `## Prompt Template` block
...
Plan:
- battery-optimization-agent test plans in CI with flake controls. (Battery Optimization scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/battery-optimization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/battery-optimization-agent/advanced/SKILL.md`
