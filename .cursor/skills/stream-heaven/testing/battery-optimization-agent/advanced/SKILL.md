---
name: stream-heaven-testing-battery-optimization-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Battery Optimization (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Battery Optimization — Advanced
