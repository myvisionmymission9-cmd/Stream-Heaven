---
name: stream-heaven-testing-openapi-contract-validation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Openapi Contract Validation (phase 1 (foundation) + ongoing).
  Single-agent execution with governance prefix and structural validation.
---

# Openapi Contract Validation — Basic

## When to use

- User invokes **Openapi Contract Validation** or work in **testing** (phase 1 (foundation) + ongoing)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/openapi-contract-validation-agent.md`
- **Role:** Specialist for validating OpenAPI specs in packages/shared-contracts against NestJS implementations, consumer SDKs, and breaking-change policy.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/openapi-contract-validation-agent.md` and copy its `## Prompt Template` block
...
Define:
- Lint all OpenAPI files in packages/shared-contracts with spectral or equivalent rules. (Openapi Contract Validation scope)
