---
name: stream-heaven-testing-openapi-contract-validation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Openapi Contract Validation (phase 1 (foundation) + ongoing).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Openapi Contract Validation — Advanced
