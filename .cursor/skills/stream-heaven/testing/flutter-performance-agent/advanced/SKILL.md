---
name: stream-heaven-testing-flutter-performance-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Flutter Performance (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Flutter Performance — Advanced
