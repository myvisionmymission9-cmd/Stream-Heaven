---
name: stream-heaven-testing-qa-automation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Qa Automation (phase 20).
...
- User invokes **Qa Automation** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/qa-automation-agent.md`
- **Role:** QA automation frameworks and CI gates.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/qa-automation-agent.md` and copy its `## Prompt Template` block
...
Plan:
- qa-automation-agent test plans in CI with flake controls. (Qa Automation scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/qa-automation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/qa-automation-agent/advanced/SKILL.md`
