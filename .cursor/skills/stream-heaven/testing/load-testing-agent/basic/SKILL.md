---
name: stream-heaven-testing-load-testing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Load Testing (phase 20).
...
- User invokes **Load Testing** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/load-testing-agent.md`
- **Role:** Load tests for live and API peaks.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/load-testing-agent.md` and copy its `## Prompt Template` block
...
Plan:
- load-testing-agent test plans in CI with flake controls. (Load Testing scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/load-testing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/load-testing-agent/advanced/SKILL.md`
