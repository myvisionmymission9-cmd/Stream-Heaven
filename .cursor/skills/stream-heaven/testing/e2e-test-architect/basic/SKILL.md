---
name: stream-heaven-testing-e2e-test-architect-basic
description: >-
  Basic Cursor skill for Stream Heaven E2e Test Architect (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# E2e Test Architect — Basic

## When to use

- User invokes **E2e Test Architect** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/e2e-test-architect.md`
- **Role:** E2e Test Architect specialist for Stream Heaven's testing domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/e2e-test-architect.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/testing/e2e-test-architect/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/e2e-test-architect/advanced/SKILL.md`
