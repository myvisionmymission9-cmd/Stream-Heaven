---
name: stream-heaven-testing-integration-smoke-test-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Integration Smoke Test (phase 1 + ongoing).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Integration Smoke Test — Advanced
