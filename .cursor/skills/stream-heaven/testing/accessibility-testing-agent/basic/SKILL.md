---
name: stream-heaven-testing-accessibility-testing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Accessibility Testing (phase 20).
...
- User invokes **Accessibility Testing** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/accessibility-testing-agent.md`
- **Role:** a11y audits WCAG mobile.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/accessibility-testing-agent.md` and copy its `## Prompt Template` block
...
Plan:
- accessibility-testing-agent test plans in CI with flake controls. (Accessibility Testing scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/accessibility-testing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/accessibility-testing-agent/advanced/SKILL.md`
