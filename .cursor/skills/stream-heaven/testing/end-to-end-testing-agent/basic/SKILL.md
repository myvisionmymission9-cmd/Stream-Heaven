---
name: stream-heaven-testing-end-to-end-testing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven End To End Testing (phase 20).
...
- User invokes **End To End Testing** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/end-to-end-testing-agent.md`
- **Role:** E2E flows across four apps.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/end-to-end-testing-agent.md` and copy its `## Prompt Template` block
...
Plan:
- end-to-end-testing-agent test plans in CI with flake controls. (End To End Testing scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/end-to-end-testing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/end-to-end-testing-agent/advanced/SKILL.md`
