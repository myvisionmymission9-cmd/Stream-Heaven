---
name: stream-heaven-testing-network-resilience-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Network Resilience (phase 20).
...
- User invokes **Network Resilience** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/network-resilience-agent.md`
- **Role:** Network chaos on 2G/3G profiles.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/network-resilience-agent.md` and copy its `## Prompt Template` block
...
Plan:
- network-resilience-agent test plans in CI with flake controls. (Network Resilience scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/network-resilience-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/network-resilience-agent/advanced/SKILL.md`
