---
name: stream-heaven-testing-network-resilience-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Network Resilience (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Network Resilience — Advanced
