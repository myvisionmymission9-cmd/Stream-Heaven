---
name: stream-heaven-testing-memory-leak-detection-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Memory Leak Detection (phase 20).
...
- User invokes **Memory Leak Detection** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/memory-leak-detection-agent.md`
- **Role:** Leak detection in long sessions.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/memory-leak-detection-agent.md` and copy its `## Prompt Template` block
...
Plan:
- memory-leak-detection-agent test plans in CI with flake controls. (Memory Leak Detection scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/memory-leak-detection-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/memory-leak-detection-agent/advanced/SKILL.md`
