---
name: stream-heaven-testing-memory-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Memory Optimization (phase 20).
...
- User invokes **Memory Optimization** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/memory-optimization-agent.md`
- **Role:** Heap/GPU memory optimization.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/memory-optimization-agent.md` and copy its `## Prompt Template` block
...
Plan:
- memory-optimization-agent test plans in CI with flake controls. (Memory Optimization scope)
