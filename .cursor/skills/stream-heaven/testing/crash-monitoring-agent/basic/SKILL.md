---
name: stream-heaven-testing-crash-monitoring-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Crash Monitoring (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Crash Monitoring — Basic
...
- Open agent: `ai-agents/testing/crash-monitoring-agent.md` and copy its `## Prompt Template` block
