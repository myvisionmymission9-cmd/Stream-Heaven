---
name: stream-heaven-testing-low-end-device-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Low End Device (phase 20).
...
- User invokes **Low End Device** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/low-end-device-agent.md`
- **Role:** Low-end Android soak tests.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/low-end-device-agent.md` and copy its `## Prompt Template` block
...
Plan:
- low-end-device-agent test plans in CI with flake controls. (Low End Device scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/low-end-device-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/low-end-device-agent/advanced/SKILL.md`
