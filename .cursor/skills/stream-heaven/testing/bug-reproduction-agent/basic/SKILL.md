---
name: stream-heaven-testing-bug-reproduction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Bug Reproduction (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Bug Reproduction — Basic

## When to use

- User invokes **Bug Reproduction** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/bug-reproduction-agent.md`
- **Role:** Minimal repro scripts from tickets.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/bug-reproduction-agent.md` and copy its `## Prompt Template` block
...
Plan:
- bug-reproduction-agent test plans in CI with flake controls. (Bug Reproduction scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/bug-reproduction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/bug-reproduction-agent/advanced/SKILL.md`
