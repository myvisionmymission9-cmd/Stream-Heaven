---
name: stream-heaven-testing-flutter-widget-test-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Flutter Widget Test (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Flutter Widget Test — Advanced
