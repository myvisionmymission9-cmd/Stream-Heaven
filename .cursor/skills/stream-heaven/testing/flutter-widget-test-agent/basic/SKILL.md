---
name: stream-heaven-testing-flutter-widget-test-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Flutter Widget Test (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Flutter Widget Test — Basic

## When to use

- User invokes **Flutter Widget Test** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/flutter-widget-test-agent.md`
- **Role:** Flutter Widget Test Agent specialist for Stream Heaven's testing domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/flutter-widget-test-agent.md` and copy its `## Prompt Template` block
...
Define:
- Implement Flutter Widget Test in Flutter using Riverpod state and GoRouter navigation per flutter-ui-rules.md. (Flutter Widget Test scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/flutter-widget-test-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/flutter-widget-test-agent/advanced/SKILL.md`
