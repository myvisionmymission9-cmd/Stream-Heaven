---
name: stream-heaven-testing-device-compatibility-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Device Compatibility (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Device Compatibility — Basic

## When to use

- User invokes **Device Compatibility** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/device-compatibility-agent.md`
- **Role:** Device matrix compatibility.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/device-compatibility-agent.md` and copy its `## Prompt Template` block
...
Plan:
- device-compatibility-agent test plans in CI with flake controls. (Device Compatibility scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/device-compatibility-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/device-compatibility-agent/advanced/SKILL.md`
