---
name: stream-heaven-testing-startup-time-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Startup Time (phase 20).
...
- User invokes **Startup Time** or work in **testing** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/testing/startup-time-agent.md`
- **Role:** Cold start and TTI budgets.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/testing/startup-time-agent.md` and copy its `## Prompt Template` block
...
Plan:
- startup-time-agent test plans in CI with flake controls. (Startup Time scope)
...
- Basic: `.cursor/skills/stream-heaven/testing/startup-time-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/testing/startup-time-agent/advanced/SKILL.md`
