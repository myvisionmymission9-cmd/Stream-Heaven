---
name: stream-heaven-creator-economy-host-management-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Host Management (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Host Management — Basic

## When to use

- User invokes **Host Management** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/host-management-agent.md`
- **Role:** Host Management Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/host-management-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Host Management deliverables in creator-economy domain for Stream Heaven Phase 12. (Host Management scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/host-management-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/host-management-agent/advanced/SKILL.md`
