---
name: stream-heaven-creator-economy-payout-scheduler-basic
description: >-
  Basic Cursor skill for Stream Heaven Payout Scheduler (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Payout Scheduler — Basic

## When to use

- User invokes **Payout Scheduler** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/payout-scheduler.md`
- **Role:** Payout Scheduler specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/payout-scheduler.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement creator economy capabilities for Stream Heaven. (Payout Scheduler scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/payout-scheduler/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/payout-scheduler/advanced/SKILL.md`
