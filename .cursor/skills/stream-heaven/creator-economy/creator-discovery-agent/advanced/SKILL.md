---
name: stream-heaven-creator-economy-creator-discovery-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Discovery (phase 12).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Creator Discovery — Advanced
