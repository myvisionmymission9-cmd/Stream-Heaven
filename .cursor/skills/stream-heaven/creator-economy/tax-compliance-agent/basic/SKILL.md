---
name: stream-heaven-creator-economy-tax-compliance-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Tax Compliance (phase 12).
...
- User invokes **Tax Compliance** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/tax-compliance-agent.md`
- **Role:** Tax Compliance Agent specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/tax-compliance-agent.md` and copy its `## Prompt Template` block
...
Follow:
- Design and implement creator economy capabilities for Stream Heaven. (Tax Compliance scope)
