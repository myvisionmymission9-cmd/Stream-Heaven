---
name: stream-heaven-creator-economy-sponsor-matching-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Sponsor Matching (phase 12).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Sponsor Matching — Advanced
