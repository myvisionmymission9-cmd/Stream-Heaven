---
name: stream-heaven-creator-economy-sponsor-matching-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Sponsor Matching (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Sponsor Matching — Basic

## When to use

- User invokes **Sponsor Matching** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/sponsor-matching-agent.md`
- **Role:** Sponsor Matching Agent specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/sponsor-matching-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Sponsor Matching ad insertion, targeting, and measurement with NestJS ad-network services. (Sponsor Matching scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/sponsor-matching-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/sponsor-matching-agent/advanced/SKILL.md`
