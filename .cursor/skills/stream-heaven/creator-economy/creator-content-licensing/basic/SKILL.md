---
name: stream-heaven-creator-economy-creator-content-licensing-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Content Licensing (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Content Licensing — Basic

## When to use

- User invokes **Creator Content Licensing** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-content-licensing.md`
- **Role:** Creator Content Licensing specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-content-licensing.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement creator economy capabilities for Stream Heaven. (Creator Content Licensing scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/creator-content-licensing/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/creator-content-licensing/advanced/SKILL.md`
