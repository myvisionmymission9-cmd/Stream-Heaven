---
name: stream-heaven-creator-economy-creator-dashboard-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Dashboard (phase 12).
...
- User invokes **Creator Dashboard** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-dashboard-agent.md`
- **Role:** Creator Dashboard Agent specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-dashboard-agent.md` and copy its `## Prompt Template` block
