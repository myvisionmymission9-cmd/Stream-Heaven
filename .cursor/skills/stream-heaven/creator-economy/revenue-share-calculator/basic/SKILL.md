---
name: stream-heaven-creator-economy-revenue-share-calculator-basic
description: >-
  Basic Cursor skill for Stream Heaven Revenue Share Calculator (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Revenue Share Calculator — Basic

## When to use

- User invokes **Revenue Share Calculator** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/revenue-share-calculator.md`
- **Role:** Revenue Share Calculator specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/revenue-share-calculator.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement creator economy capabilities for Stream Heaven. (Revenue Share Calculator scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/revenue-share-calculator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/revenue-share-calculator/advanced/SKILL.md`
