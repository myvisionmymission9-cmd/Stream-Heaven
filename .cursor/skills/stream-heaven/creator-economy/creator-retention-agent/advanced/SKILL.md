---
name: stream-heaven-creator-economy-creator-retention-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Retention (phase 12).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Creator Retention — Advanced
