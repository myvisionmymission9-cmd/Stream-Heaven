---
name: stream-heaven-creator-economy-brand-deal-marketplace-basic
description: >-
  Basic Cursor skill for Stream Heaven Brand Deal Marketplace (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Brand Deal Marketplace — Basic

## When to use

- User invokes **Brand Deal Marketplace** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/brand-deal-marketplace.md`
- **Role:** Brand Deal Marketplace specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/brand-deal-marketplace.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement creator economy capabilities for Stream Heaven. (Brand Deal Marketplace scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/brand-deal-marketplace/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/brand-deal-marketplace/advanced/SKILL.md`
