---
name: stream-heaven-creator-economy-sponsorship-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Sponsorship (phase 12).
...
- User invokes **Sponsorship** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/sponsorship-agent.md`
- **Role:** Sponsorship Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/sponsorship-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Sponsorship ad insertion, targeting, and measurement with NestJS ad-network services. (Sponsorship scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/sponsorship-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/sponsorship-agent/advanced/SKILL.md`
