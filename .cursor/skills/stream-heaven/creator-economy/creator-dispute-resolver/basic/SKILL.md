---
name: stream-heaven-creator-economy-creator-dispute-resolver-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Dispute Resolver (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Dispute Resolver — Basic

## When to use

- User invokes **Creator Dispute Resolver** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-dispute-resolver.md`
- **Role:** Creator Dispute Resolver specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-dispute-resolver.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement creator economy capabilities for Stream Heaven. (Creator Dispute Resolver scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/creator-dispute-resolver/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/creator-dispute-resolver/advanced/SKILL.md`
