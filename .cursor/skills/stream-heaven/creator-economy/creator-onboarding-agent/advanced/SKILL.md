---
name: stream-heaven-creator-economy-creator-onboarding-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Creator Onboarding (phase 12).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Creator Onboarding — Advanced
