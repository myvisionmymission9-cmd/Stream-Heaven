---
name: stream-heaven-creator-economy-creator-contract-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Contract (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Contract — Basic

## When to use

- User invokes **Creator Contract** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-contract-agent.md`
- **Role:** Creator Contract Agent specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-contract-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define automated tests for Creator Contract: unit, integration, contract, and smoke layers. (Creator Contract scope)
