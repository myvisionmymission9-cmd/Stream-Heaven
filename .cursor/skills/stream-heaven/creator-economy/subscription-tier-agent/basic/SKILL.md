---
name: stream-heaven-creator-economy-subscription-tier-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Subscription Tier (phase 12).
...
- Open agent: `ai-agents/creator-economy/subscription-tier-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement creator economy capabilities for Stream Heaven. (Subscription Tier scope)
