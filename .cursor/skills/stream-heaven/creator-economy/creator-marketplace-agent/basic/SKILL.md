---
name: stream-heaven-creator-economy-creator-marketplace-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Marketplace (phase 12).
...
- User invokes **Creator Marketplace** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-marketplace-agent.md`
- **Role:** Creator Marketplace Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-marketplace-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Creator Marketplace deliverables in creator-economy domain for Stream Heaven Phase 12. (Creator Marketplace scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/creator-marketplace-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/creator-marketplace-agent/advanced/SKILL.md`
