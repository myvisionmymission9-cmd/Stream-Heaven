---
name: stream-heaven-creator-economy-creator-tier-progression-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Tier Progression (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Tier Progression — Basic

## When to use

- User invokes **Creator Tier Progression** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-tier-progression.md`
- **Role:** Creator Tier Progression specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-tier-progression.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement creator economy capabilities for Stream Heaven. (Creator Tier Progression scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/creator-tier-progression/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/creator-tier-progression/advanced/SKILL.md`
