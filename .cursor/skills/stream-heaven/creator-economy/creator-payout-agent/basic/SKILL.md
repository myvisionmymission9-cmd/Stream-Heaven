---
name: stream-heaven-creator-economy-creator-payout-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Payout (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Payout — Basic

## When to use

- User invokes **Creator Payout** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-payout-agent.md`
- **Role:** Creator Payout Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-payout-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Creator Payout flows with idempotent ledger entries and PostgreSQL transactional integrity. (Creator Payout scope)
