---
name: stream-heaven-creator-economy-creator-brand-score-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Brand Score (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Brand Score — Basic

## When to use

- User invokes **Creator Brand Score** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-brand-score-agent.md`
- **Role:** Creator Brand Score Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-brand-score-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Creator Brand Score deliverables in creator-economy domain for Stream Heaven Phase 12. (Creator Brand Score scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/creator-brand-score-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/creator-brand-score-agent/advanced/SKILL.md`
