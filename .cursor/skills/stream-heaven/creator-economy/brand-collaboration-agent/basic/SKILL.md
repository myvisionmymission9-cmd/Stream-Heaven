---
name: stream-heaven-creator-economy-brand-collaboration-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Brand Collaboration (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Brand Collaboration — Basic

## When to use

- User invokes **Brand Collaboration** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/brand-collaboration-agent.md`
- **Role:** Brand Collaboration Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/brand-collaboration-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Brand Collaboration deliverables in creator-economy domain for Stream Heaven Phase 12. (Brand Collaboration scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/brand-collaboration-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/brand-collaboration-agent/advanced/SKILL.md`
