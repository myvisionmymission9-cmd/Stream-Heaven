---
name: stream-heaven-creator-economy-ad-revenue-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ad Revenue (phase 12).
...
- User invokes **Ad Revenue** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/ad-revenue-agent.md`
- **Role:** Ad Revenue Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/ad-revenue-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Ad Revenue ad insertion, targeting, and measurement with NestJS ad-network services. (Ad Revenue scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/ad-revenue-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/ad-revenue-agent/advanced/SKILL.md`
