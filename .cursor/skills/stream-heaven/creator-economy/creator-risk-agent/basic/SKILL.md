---
name: stream-heaven-creator-economy-creator-risk-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Risk (phase 12).
...
- User invokes **Creator Risk** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-risk-agent.md`
- **Role:** Creator Risk Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-risk-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Creator Risk deliverables in creator-economy domain for Stream Heaven Phase 12. (Creator Risk scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/creator-risk-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/creator-risk-agent/advanced/SKILL.md`
