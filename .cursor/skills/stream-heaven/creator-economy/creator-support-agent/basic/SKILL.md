---
name: stream-heaven-creator-economy-creator-support-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Support (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Support — Basic

## When to use

- User invokes **Creator Support** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/creator-support-agent.md`
- **Role:** Creator Support Agent specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/creator-support-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Creator Support deliverables in creator-economy domain for Stream Heaven Phase 12. (Creator Support scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/creator-support-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/creator-support-agent/advanced/SKILL.md`
