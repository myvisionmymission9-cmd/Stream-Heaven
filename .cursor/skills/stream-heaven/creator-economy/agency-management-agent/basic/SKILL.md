---
name: stream-heaven-creator-economy-agency-management-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Agency Management (phase 12).
  Single-agent execution with governance prefix and structural validation.
---

# Agency Management — Basic

## When to use

- User invokes **Agency Management** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/agency-management-agent.md`
- **Role:** Agency Management Agent specialist for Stream Heaven's creator-economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/agency-management-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Agency Management deliverables in creator-economy domain for Stream Heaven Phase 12. (Agency Management scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/agency-management-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/agency-management-agent/advanced/SKILL.md`
