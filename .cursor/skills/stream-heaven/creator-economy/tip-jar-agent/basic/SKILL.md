---
name: stream-heaven-creator-economy-tip-jar-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Tip Jar (phase 12).
...
- User invokes **Tip Jar** or work in **creator-economy** (phase 12)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/creator-economy/tip-jar-agent.md`
- **Role:** Tip Jar Agent specialist for Stream Heaven's creator economy domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/creator-economy/tip-jar-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Tip Jar deliverables in creator-economy domain for Stream Heaven Phase 12. (Tip Jar scope)
...
- Basic: `.cursor/skills/stream-heaven/creator-economy/tip-jar-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/creator-economy/tip-jar-agent/advanced/SKILL.md`
