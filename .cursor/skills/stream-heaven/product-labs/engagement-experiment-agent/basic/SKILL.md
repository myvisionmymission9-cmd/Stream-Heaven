---
name: stream-heaven-product-labs-engagement-experiment-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Engagement Experiment (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Engagement Experiment — Basic

## When to use

- User invokes **Engagement Experiment** or work in **product-labs** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/product-labs/engagement-experiment-agent.md`
- **Role:** Engagement Experiment Agent specialist for Stream Heaven's product-labs domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/product-labs/engagement-experiment-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Engagement Experiment deliverables in product-labs domain for Stream Heaven Phase 20. (Engagement Experiment scope)
...
- Basic: `.cursor/skills/stream-heaven/product-labs/engagement-experiment-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/product-labs/engagement-experiment-agent/advanced/SKILL.md`
