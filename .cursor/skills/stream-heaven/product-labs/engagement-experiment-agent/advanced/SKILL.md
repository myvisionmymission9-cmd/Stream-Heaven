---
name: stream-heaven-product-labs-engagement-experiment-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Engagement Experiment (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Engagement Experiment — Advanced
