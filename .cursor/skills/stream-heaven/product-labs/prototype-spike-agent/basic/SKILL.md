...
description: >-
  Basic Cursor skill for Stream Heaven Prototype Spike (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Prototype Spike — Basic

## When to use

- User invokes **Prototype Spike** or work in **product-labs** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/product-labs/prototype-spike-agent.md`
- **Role:** Prototype Spike Agent specialist for Stream Heaven's product labs domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/product-labs/prototype-spike-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Prototype Spike deliverables in product-labs domain for Stream Heaven Phase 20. (Prototype Spike scope)
...
- Basic: `.cursor/skills/stream-heaven/product-labs/prototype-spike-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/product-labs/prototype-spike-agent/advanced/SKILL.md`
