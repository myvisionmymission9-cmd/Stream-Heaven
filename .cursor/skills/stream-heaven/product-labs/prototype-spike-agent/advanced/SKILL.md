---
name: stream-heaven-product-labs-prototype-spike-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Prototype Spike (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Prototype Spike — Advanced
