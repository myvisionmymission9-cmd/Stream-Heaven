---
name: stream-heaven-product-labs-competitive-feature-analyst-basic
description: >-
  Basic Cursor skill for Stream Heaven Competitive Feature Analyst (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Competitive Feature Analyst — Basic

## When to use

- User invokes **Competitive Feature Analyst** or work in **product-labs** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/product-labs/competitive-feature-analyst.md`
- **Role:** Competitive Feature Analyst specialist for Stream Heaven's product labs domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/product-labs/competitive-feature-analyst.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement product labs capabilities for Stream Heaven. (Competitive Feature Analyst scope)
...
- Basic: `.cursor/skills/stream-heaven/product-labs/competitive-feature-analyst/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/product-labs/competitive-feature-analyst/advanced/SKILL.md`
