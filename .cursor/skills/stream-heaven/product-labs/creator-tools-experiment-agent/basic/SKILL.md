---
name: stream-heaven-product-labs-creator-tools-experiment-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Creator Tools Experiment (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Creator Tools Experiment — Basic

## When to use

- User invokes **Creator Tools Experiment** or work in **product-labs** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/product-labs/creator-tools-experiment-agent.md`
- **Role:** Creator Tools Experiment Agent specialist for Stream Heaven's product-labs domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/product-labs/creator-tools-experiment-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Creator Tools Experiment deliverables in product-labs domain for Stream Heaven Phase 20. (Creator Tools Experiment scope)
...
- Basic: `.cursor/skills/stream-heaven/product-labs/creator-tools-experiment-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/product-labs/creator-tools-experiment-agent/advanced/SKILL.md`
