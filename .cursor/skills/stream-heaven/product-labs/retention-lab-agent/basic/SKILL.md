---
name: stream-heaven-product-labs-retention-lab-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Retention Lab (phase 20).
...
- User invokes **Retention Lab** or work in **product-labs** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/product-labs/retention-lab-agent.md`
- **Role:** Retention Lab Agent specialist for Stream Heaven's product-labs domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/product-labs/retention-lab-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Retention Lab deliverables in product-labs domain for Stream Heaven Phase 20. (Retention Lab scope)
...
- Basic: `.cursor/skills/stream-heaven/product-labs/retention-lab-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/product-labs/retention-lab-agent/advanced/SKILL.md`
