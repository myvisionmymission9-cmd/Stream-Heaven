---
name: stream-heaven-product-labs-algorithm-experiment-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Algorithm Experiment (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Algorithm Experiment — Advanced
