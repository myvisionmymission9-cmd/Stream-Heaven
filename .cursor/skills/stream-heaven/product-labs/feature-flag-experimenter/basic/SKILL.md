---
name: stream-heaven-product-labs-feature-flag-experimenter-basic
description: >-
  Basic Cursor skill for Stream Heaven Feature Flag Experimenter (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Feature Flag Experimenter — Basic

## When to use

- User invokes **Feature Flag Experimenter** or work in **product-labs** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/product-labs/feature-flag-experimenter.md`
- **Role:** Feature Flag Experimenter specialist for Stream Heaven's product labs domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/product-labs/feature-flag-experimenter.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement product labs capabilities for Stream Heaven. (Feature Flag Experimenter scope)
...
- Basic: `.cursor/skills/stream-heaven/product-labs/feature-flag-experimenter/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/product-labs/feature-flag-experimenter/advanced/SKILL.md`
