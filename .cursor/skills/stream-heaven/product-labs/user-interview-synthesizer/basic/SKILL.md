---
name: stream-heaven-product-labs-user-interview-synthesizer-basic
description: >-
  Basic Cursor skill for Stream Heaven User Interview Synthesizer (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# User Interview Synthesizer — Basic

## When to use

- User invokes **User Interview Synthesizer** or work in **product-labs** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/product-labs/user-interview-synthesizer.md`
- **Role:** User Interview Synthesizer specialist for Stream Heaven's product labs domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/product-labs/user-interview-synthesizer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement product labs capabilities for Stream Heaven. (User Interview Synthesizer scope)
...
- Basic: `.cursor/skills/stream-heaven/product-labs/user-interview-synthesizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/product-labs/user-interview-synthesizer/advanced/SKILL.md`
