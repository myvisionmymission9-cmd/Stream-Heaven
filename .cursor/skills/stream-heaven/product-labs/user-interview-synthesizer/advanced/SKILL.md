---
name: stream-heaven-product-labs-user-interview-synthesizer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven User Interview Synthesizer (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# User Interview Synthesizer — Advanced
