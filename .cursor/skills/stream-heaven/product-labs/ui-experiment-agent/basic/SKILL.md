---
name: stream-heaven-product-labs-ui-experiment-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ui Experiment (phase 20).
...
- User invokes **Ui Experiment** or work in **product-labs** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/product-labs/ui-experiment-agent.md`
- **Role:** Ui Experiment Agent specialist for Stream Heaven's product-labs domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/product-labs/ui-experiment-agent.md` and copy its `## Prompt Template` block
...
Research:
- Own Ui Experiment deliverables in product-labs domain for Stream Heaven Phase 20. (Ui Experiment scope)
...
- Basic: `.cursor/skills/stream-heaven/product-labs/ui-experiment-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/product-labs/ui-experiment-agent/advanced/SKILL.md`
