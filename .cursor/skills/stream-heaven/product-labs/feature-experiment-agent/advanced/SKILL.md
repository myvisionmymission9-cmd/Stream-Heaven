---
name: stream-heaven-product-labs-feature-experiment-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Feature Experiment (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Feature Experiment — Advanced
