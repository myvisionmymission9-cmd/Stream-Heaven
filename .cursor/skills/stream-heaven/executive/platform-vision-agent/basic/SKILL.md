---
name: stream-heaven-executive-platform-vision-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Platform Vision (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Platform Vision — Basic

## When to use

- User invokes **Platform Vision** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/platform-vision-agent.md`
- **Role:** Platform Vision Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/platform-vision-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Platform Vision across Social, Livestream, Astro, and Media strategic priorities. (Platform Vision scope)
