---
name: stream-heaven-executive-revenue-strategy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Revenue Strategy (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Revenue Strategy — Basic

## When to use

- User invokes **Revenue Strategy** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/revenue-strategy-agent.md`
- **Role:** Revenue Strategy Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/revenue-strategy-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Revenue Strategy across Social, Livestream, Astro, and Media strategic priorities. (Revenue Strategy scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/revenue-strategy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/revenue-strategy-agent/advanced/SKILL.md`
