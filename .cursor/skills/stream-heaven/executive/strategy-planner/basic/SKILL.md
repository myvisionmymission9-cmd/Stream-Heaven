---
name: stream-heaven-executive-strategy-planner-basic
description: >-
  Basic Cursor skill for Stream Heaven Strategy Planner (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Strategy Planner — Basic

## When to use

- User invokes **Strategy Planner** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/strategy-planner.md`
- **Role:** Strategy Planner specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/strategy-planner.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Strategy across Social, Livestream, Astro, and Media strategic priorities. (Strategy Planner scope)
