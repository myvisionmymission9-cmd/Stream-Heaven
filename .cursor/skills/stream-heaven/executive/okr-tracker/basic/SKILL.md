---
name: stream-heaven-executive-okr-tracker-basic
description: >-
  Basic Cursor skill for Stream Heaven Okr Tracker (phase 2).
...
- User invokes **Okr Tracker** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/okr-tracker.md`
- **Role:** Okr Tracker specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/okr-tracker.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Okr across Social, Livestream, Astro, and Media strategic priorities. (Okr Tracker scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/okr-tracker/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/okr-tracker/advanced/SKILL.md`
