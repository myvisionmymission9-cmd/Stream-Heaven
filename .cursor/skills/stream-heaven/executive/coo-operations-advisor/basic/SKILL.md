---
name: stream-heaven-executive-coo-operations-advisor-basic
description: >-
  Basic Cursor skill for Stream Heaven Coo Operations Advisor (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Coo Operations Advisor — Basic

## When to use

- User invokes **Coo Operations Advisor** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/coo-operations-advisor.md`
- **Role:** Coo Operations Advisor specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/coo-operations-advisor.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Coo Operations across Social, Livestream, Astro, and Media strategic priorities. (Coo Operations Advisor scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/coo-operations-advisor/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/coo-operations-advisor/advanced/SKILL.md`
