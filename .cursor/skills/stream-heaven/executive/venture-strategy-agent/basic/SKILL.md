---
name: stream-heaven-executive-venture-strategy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Venture Strategy (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Venture Strategy — Basic

## When to use

- User invokes **Venture Strategy** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/venture-strategy-agent.md`
- **Role:** Venture Strategy Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/venture-strategy-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Venture Strategy across Social, Livestream, Astro, and Media strategic priorities. (Venture Strategy scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/venture-strategy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/venture-strategy-agent/advanced/SKILL.md`
