---
name: stream-heaven-executive-board-reporting-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Board Reporting (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Board Reporting — Basic

## When to use

- User invokes **Board Reporting** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/board-reporting-agent.md`
- **Role:** Board Reporting Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/board-reporting-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Board Reporting across Social, Livestream, Astro, and Media strategic priorities. (Board Reporting scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/board-reporting-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/board-reporting-agent/advanced/SKILL.md`
