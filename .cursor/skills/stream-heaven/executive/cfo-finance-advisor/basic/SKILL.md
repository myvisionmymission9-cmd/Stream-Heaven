---
name: stream-heaven-executive-cfo-finance-advisor-basic
description: >-
  Basic Cursor skill for Stream Heaven Cfo Finance Advisor (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Cfo Finance Advisor — Basic

## When to use

- User invokes **Cfo Finance Advisor** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/cfo-finance-advisor.md`
- **Role:** Cfo Finance Advisor specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/cfo-finance-advisor.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Cfo Finance across Social, Livestream, Astro, and Media strategic priorities. (Cfo Finance Advisor scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/cfo-finance-advisor/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/cfo-finance-advisor/advanced/SKILL.md`
