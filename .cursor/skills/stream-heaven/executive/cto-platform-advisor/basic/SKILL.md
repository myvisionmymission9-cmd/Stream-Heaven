---
name: stream-heaven-executive-cto-platform-advisor-basic
description: >-
  Basic Cursor skill for Stream Heaven Cto Platform Advisor (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Cto Platform Advisor — Basic

## When to use

- User invokes **Cto Platform Advisor** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/cto-platform-advisor.md`
- **Role:** Cto Platform Advisor specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/cto-platform-advisor.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Cto Platform across Social, Livestream, Astro, and Media strategic priorities. (Cto Platform Advisor scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/cto-platform-advisor/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/cto-platform-advisor/advanced/SKILL.md`
