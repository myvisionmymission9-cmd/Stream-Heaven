---
name: stream-heaven-executive-cto-platform-advisor-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cto Platform Advisor (phase 2).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cto Platform Advisor — Advanced
