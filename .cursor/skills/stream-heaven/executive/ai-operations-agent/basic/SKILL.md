---
name: stream-heaven-executive-ai-operations-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ai Operations (phase 2).
...
- User invokes **Ai Operations** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/ai-operations-agent.md`
- **Role:** Ai Operations Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/ai-operations-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Ai Operations across Social, Livestream, Astro, and Media strategic priorities. (Ai Operations scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/ai-operations-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/ai-operations-agent/advanced/SKILL.md`
