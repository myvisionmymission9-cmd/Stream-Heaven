---
name: stream-heaven-executive-market-expansion-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Market Expansion (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Market Expansion — Basic

## When to use

- User invokes **Market Expansion** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/market-expansion-agent.md`
- **Role:** Market Expansion Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/market-expansion-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Market Expansion across Social, Livestream, Astro, and Media strategic priorities. (Market Expansion scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/market-expansion-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/market-expansion-agent/advanced/SKILL.md`
