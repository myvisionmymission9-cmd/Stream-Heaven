---
name: stream-heaven-executive-ceo-strategic-advisor-basic
description: >-
  Basic Cursor skill for Stream Heaven Ceo Strategic Advisor (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Ceo Strategic Advisor — Basic

## When to use

- User invokes **Ceo Strategic Advisor** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/ceo-strategic-advisor.md`
- **Role:** Ceo Strategic Advisor specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/ceo-strategic-advisor.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Ceo Strategic across Social, Livestream, Astro, and Media strategic priorities. (Ceo Strategic Advisor scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/ceo-strategic-advisor/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/ceo-strategic-advisor/advanced/SKILL.md`
