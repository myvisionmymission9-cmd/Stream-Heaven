---
name: stream-heaven-executive-innovation-director-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Innovation Director (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Innovation Director — Basic

## When to use

- User invokes **Innovation Director** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/innovation-director-agent.md`
- **Role:** Innovation Director Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/innovation-director-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/executive/innovation-director-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/innovation-director-agent/advanced/SKILL.md`
