---
name: stream-heaven-executive-product-manager-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Product Manager (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Product Manager — Basic

## When to use

- User invokes **Product Manager** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/product-manager-agent.md`
- **Role:** Product Manager Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/product-manager-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Product across Social, Livestream, Astro, and Media strategic priorities. (Product Manager scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/product-manager-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/product-manager-agent/advanced/SKILL.md`
