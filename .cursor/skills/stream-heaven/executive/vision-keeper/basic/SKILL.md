---
name: stream-heaven-executive-vision-keeper-basic
description: >-
  Basic Cursor skill for Stream Heaven Vision Keeper (phase 2).
...
- User invokes **Vision Keeper** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/vision-keeper.md`
- **Role:** Vision Keeper specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/vision-keeper.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Vision across Social, Livestream, Astro, and Media strategic priorities. (Vision Keeper scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/vision-keeper/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/vision-keeper/advanced/SKILL.md`
