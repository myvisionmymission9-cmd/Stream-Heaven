---
name: stream-heaven-executive-sprint-planning-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Sprint Planning (phase 2).
...
- User invokes **Sprint Planning** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/sprint-planning-agent.md`
- **Role:** Sprint Planning Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/sprint-planning-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Sprint Planning across Social, Livestream, Astro, and Media strategic priorities. (Sprint Planning scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/sprint-planning-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/sprint-planning-agent/advanced/SKILL.md`
