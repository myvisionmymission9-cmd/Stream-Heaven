---
name: stream-heaven-executive-cpo-product-advisor-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cpo Product Advisor (phase 2).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cpo Product Advisor — Advanced
