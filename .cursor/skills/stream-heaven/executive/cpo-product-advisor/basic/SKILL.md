---
name: stream-heaven-executive-cpo-product-advisor-basic
description: >-
  Basic Cursor skill for Stream Heaven Cpo Product Advisor (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Cpo Product Advisor — Basic

## When to use

- User invokes **Cpo Product Advisor** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/cpo-product-advisor.md`
- **Role:** Cpo Product Advisor specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/cpo-product-advisor.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Cpo Product across Social, Livestream, Astro, and Media strategic priorities. (Cpo Product Advisor scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/cpo-product-advisor/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/cpo-product-advisor/advanced/SKILL.md`
