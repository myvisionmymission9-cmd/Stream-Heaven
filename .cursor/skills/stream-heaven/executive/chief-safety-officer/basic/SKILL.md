---
name: stream-heaven-executive-chief-safety-officer-basic
description: >-
  Basic Cursor skill for Stream Heaven Chief Safety Officer (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Chief Safety Officer — Basic

## When to use

- User invokes **Chief Safety Officer** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/chief-safety-officer.md`
- **Role:** Chief Safety Officer specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/chief-safety-officer.md` and copy its `## Prompt Template` block
...
Understand:
- Design and implement executive capabilities for Stream Heaven. (Chief Safety Officer scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/chief-safety-officer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/chief-safety-officer/advanced/SKILL.md`
