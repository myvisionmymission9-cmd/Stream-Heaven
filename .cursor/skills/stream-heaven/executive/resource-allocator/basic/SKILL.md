---
name: stream-heaven-executive-resource-allocator-basic
description: >-
  Basic Cursor skill for Stream Heaven Resource Allocator (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Resource Allocator — Basic

## When to use

- User invokes **Resource Allocator** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/resource-allocator.md`
- **Role:** Resource Allocator specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/resource-allocator.md` and copy its `## Prompt Template` block
...
Understand:
- Design and implement executive capabilities for Stream Heaven. (Resource Allocator scope)
