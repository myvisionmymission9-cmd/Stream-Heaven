---
name: stream-heaven-executive-business-scaling-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Business Scaling (phase 2).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Business Scaling — Advanced
...
Understand:
- Design and implement executive capabilities for Stream Heaven. (Business Scaling scope)
