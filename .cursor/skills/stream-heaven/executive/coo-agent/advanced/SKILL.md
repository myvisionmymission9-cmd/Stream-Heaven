---
name: stream-heaven-executive-coo-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Coo (phase 2).
...
Understand:
- Design and implement executive capabilities for Stream Heaven. (Coo scope)
