---
name: stream-heaven-executive-ceo-strategy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ceo Strategy (phase 2).
...
- User invokes **Ceo Strategy** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/ceo-strategy-agent.md`
- **Role:** Ceo Strategy Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/ceo-strategy-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Ceo Strategy across Social, Livestream, Astro, and Media strategic priorities. (Ceo Strategy scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/ceo-strategy-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/ceo-strategy-agent/advanced/SKILL.md`
