---
name: stream-heaven-executive-technical-architect-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Technical Architect (phase 2).
  Single-agent execution with governance prefix and structural validation.
---

# Technical Architect — Basic

## When to use

- User invokes **Technical Architect** or work in **executive** (phase 2)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/executive/technical-architect-agent.md`
- **Role:** Technical Architect Agent specialist for Stream Heaven's executive domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/executive/technical-architect-agent.md` and copy its `## Prompt Template` block
...
Understand:
- Provide executive guidance for Technical across Social, Livestream, Astro, and Media strategic priorities. (Technical Architect scope)
...
- Basic: `.cursor/skills/stream-heaven/executive/technical-architect-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/executive/technical-architect-agent/advanced/SKILL.md`
