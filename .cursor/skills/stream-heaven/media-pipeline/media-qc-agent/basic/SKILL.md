---
name: stream-heaven-media-pipeline-media-qc-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Qc (phase 20).
...
- User invokes **Media Qc** or work in **media-pipeline** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/media-pipeline/media-qc-agent.md`
- **Role:** Media Qc Agent specialist for Stream Heaven's media pipeline domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/media-pipeline/media-qc-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/media-pipeline/media-qc-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/media-pipeline/media-qc-agent/advanced/SKILL.md`
