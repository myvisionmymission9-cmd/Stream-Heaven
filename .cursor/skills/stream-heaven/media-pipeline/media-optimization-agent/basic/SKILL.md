---
name: stream-heaven-media-pipeline-media-optimization-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Media Optimization (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Media Optimization — Basic

## When to use

- User invokes **Media Optimization** or work in **media-pipeline** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/media-pipeline/media-optimization-agent.md`
- **Role:** Media Optimization Agent specialist for Stream Heaven's media-pipeline domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/media-pipeline/media-optimization-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Media Optimization media pipeline: ingest, transcode, CDN delivery, and playback in Media (OTT) app. (Media Optimization scope)
...
- Basic: `.cursor/skills/stream-heaven/media-pipeline/media-optimization-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/media-pipeline/media-optimization-agent/advanced/SKILL.md`
