---
name: stream-heaven-media-pipeline-media-optimization-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Media Optimization (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Media Optimization — Advanced
