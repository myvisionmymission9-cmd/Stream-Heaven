---
name: stream-heaven-media-pipeline-transcode-scheduler-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Transcode Scheduler (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Transcode Scheduler — Advanced
