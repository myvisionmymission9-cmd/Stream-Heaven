---
name: stream-heaven-media-pipeline-video-processing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Video Processing (phase 20).
...
- User invokes **Video Processing** or work in **media-pipeline** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/media-pipeline/video-processing-agent.md`
- **Role:** Video Processing Agent specialist for Stream Heaven's media-pipeline domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/media-pipeline/video-processing-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Video Processing deliverables in media-pipeline domain for Stream Heaven Phase 20. (Video Processing scope)
...
- Basic: `.cursor/skills/stream-heaven/media-pipeline/video-processing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/media-pipeline/video-processing-agent/advanced/SKILL.md`
