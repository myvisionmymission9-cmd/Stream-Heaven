---
name: stream-heaven-media-pipeline-audio-processing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Audio Processing (phase 20).
...
- User invokes **Audio Processing** or work in **media-pipeline** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/media-pipeline/audio-processing-agent.md`
- **Role:** Audio Processing Agent specialist for Stream Heaven's media-pipeline domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/media-pipeline/audio-processing-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Audio Processing deliverables in media-pipeline domain for Stream Heaven Phase 20. (Audio Processing scope)
...
- Basic: `.cursor/skills/stream-heaven/media-pipeline/audio-processing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/media-pipeline/audio-processing-agent/advanced/SKILL.md`
