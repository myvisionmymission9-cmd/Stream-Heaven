---
name: stream-heaven-media-pipeline-cdn-routing-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cdn Routing (phase 20).
...
- User invokes **Cdn Routing** or work in **media-pipeline** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/media-pipeline/cdn-routing-agent.md`
- **Role:** Cdn Routing Agent specialist for Stream Heaven's media-pipeline domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/media-pipeline/cdn-routing-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/media-pipeline/cdn-routing-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/media-pipeline/cdn-routing-agent/advanced/SKILL.md`
