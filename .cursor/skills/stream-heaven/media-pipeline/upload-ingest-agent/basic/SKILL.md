---
name: stream-heaven-media-pipeline-upload-ingest-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Upload Ingest (phase 20).
...
- User invokes **Upload Ingest** or work in **media-pipeline** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/media-pipeline/upload-ingest-agent.md`
- **Role:** Upload Ingest Agent specialist for Stream Heaven's media pipeline domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/media-pipeline/upload-ingest-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/media-pipeline/upload-ingest-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/media-pipeline/upload-ingest-agent/advanced/SKILL.md`
