---
name: stream-heaven-media-pipeline-thumbnail-generator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Thumbnail Generator (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Thumbnail Generator — Advanced
