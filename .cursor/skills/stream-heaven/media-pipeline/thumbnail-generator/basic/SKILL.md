---
name: stream-heaven-media-pipeline-thumbnail-generator-basic
description: >-
  Basic Cursor skill for Stream Heaven Thumbnail Generator (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Thumbnail Generator — Basic

## When to use

- User invokes **Thumbnail Generator** or work in **media-pipeline** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/media-pipeline/thumbnail-generator.md`
- **Role:** Thumbnail Generator specialist for Stream Heaven's media pipeline domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/media-pipeline/thumbnail-generator.md` and copy its `## Prompt Template` block
...
Design:
- Design and implement media pipeline capabilities for Stream Heaven. (Thumbnail Generator scope)
...
- Basic: `.cursor/skills/stream-heaven/media-pipeline/thumbnail-generator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/media-pipeline/thumbnail-generator/advanced/SKILL.md`
