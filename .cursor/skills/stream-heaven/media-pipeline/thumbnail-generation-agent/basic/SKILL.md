---
name: stream-heaven-media-pipeline-thumbnail-generation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Thumbnail Generation (phase 20).
...
- User invokes **Thumbnail Generation** or work in **media-pipeline** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/media-pipeline/thumbnail-generation-agent.md`
- **Role:** Thumbnail Generation Agent specialist for Stream Heaven's media-pipeline domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/media-pipeline/thumbnail-generation-agent.md` and copy its `## Prompt Template` block
...
Build:
- Own Thumbnail Generation deliverables in media-pipeline domain for Stream Heaven Phase 20. (Thumbnail Generation scope)
...
- Basic: `.cursor/skills/stream-heaven/media-pipeline/thumbnail-generation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/media-pipeline/thumbnail-generation-agent/advanced/SKILL.md`
