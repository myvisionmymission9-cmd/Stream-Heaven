---
name: stream-heaven-media-pipeline-thumbnail-generation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Thumbnail Generation (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Thumbnail Generation — Advanced
