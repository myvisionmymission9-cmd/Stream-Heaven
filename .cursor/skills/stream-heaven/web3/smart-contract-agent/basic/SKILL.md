---
name: stream-heaven-web3-smart-contract-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Smart Contract (phase 20).
...
- User invokes **Smart Contract** or work in **web3** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/web3/smart-contract-agent.md`
- **Role:** Smart Contract Agent specialist for Stream Heaven's web3 domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/web3/smart-contract-agent.md` and copy its `## Prompt Template` block
...
Design:
- Define automated tests for Smart Contract: unit, integration, contract, and smoke layers. (Smart Contract scope)
...
- Basic: `.cursor/skills/stream-heaven/web3/smart-contract-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/web3/smart-contract-agent/advanced/SKILL.md`
