---
name: stream-heaven-web3-wallet-connect-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Wallet Connect (phase 20).
...
- User invokes **Wallet Connect** or work in **web3** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/web3/wallet-connect-agent.md`
- **Role:** Wallet Connect Agent specialist for Stream Heaven's web3 domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/web3/wallet-connect-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Wallet Connect flows with idempotent ledger entries and PostgreSQL transactional integrity. (Wallet Connect scope)
...
- Basic: `.cursor/skills/stream-heaven/web3/wallet-connect-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/web3/wallet-connect-agent/advanced/SKILL.md`
