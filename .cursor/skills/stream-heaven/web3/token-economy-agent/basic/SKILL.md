---
name: stream-heaven-web3-token-economy-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Token Economy (phase 20).
...
- User invokes **Token Economy** or work in **web3** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/web3/token-economy-agent.md`
- **Role:** Token Economy Agent specialist for Stream Heaven's web3 domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/web3/token-economy-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Token Economy flows with idempotent ledger entries and PostgreSQL transactional integrity. (Token Economy scope)
