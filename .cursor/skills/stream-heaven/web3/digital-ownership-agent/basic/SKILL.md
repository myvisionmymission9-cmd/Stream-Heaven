---
name: stream-heaven-web3-digital-ownership-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Digital Ownership (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Digital Ownership — Basic

## When to use

- User invokes **Digital Ownership** or work in **web3** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/web3/digital-ownership-agent.md`
- **Role:** Digital Ownership Agent specialist for Stream Heaven's web3 domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/web3/digital-ownership-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Digital Ownership web3 integrations with wallet-connect flows and explicit user consent UX. (Digital Ownership scope)
...
- Basic: `.cursor/skills/stream-heaven/web3/digital-ownership-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/web3/digital-ownership-agent/advanced/SKILL.md`
