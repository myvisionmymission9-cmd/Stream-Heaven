---
name: stream-heaven-web3-nft-minting-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Nft Minting (phase 20).
...
- User invokes **Nft Minting** or work in **web3** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/web3/nft-minting-agent.md`
- **Role:** Nft Minting Agent specialist for Stream Heaven's web3 domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/web3/nft-minting-agent.md` and copy its `## Prompt Template` block
