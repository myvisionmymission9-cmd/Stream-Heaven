---
name: stream-heaven-web3-blockchain-wallet-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Blockchain Wallet (phase 20).
...
- User invokes **Blockchain Wallet** or work in **web3** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/web3/blockchain-wallet-agent.md`
- **Role:** Blockchain Wallet Agent specialist for Stream Heaven's web3 domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/web3/blockchain-wallet-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Blockchain Wallet flows with idempotent ledger entries and PostgreSQL transactional integrity. (Blockchain Wallet scope)
...
- Basic: `.cursor/skills/stream-heaven/web3/blockchain-wallet-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/web3/blockchain-wallet-agent/advanced/SKILL.md`
