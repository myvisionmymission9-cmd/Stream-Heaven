---
name: stream-heaven-analytics-platform-privacy-analytics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Privacy Analytics (phase 19).
  Single-agent execution with governance prefix and structural validation.
---

# Privacy Analytics — Basic

## When to use

- User invokes **Privacy Analytics** or work in **analytics-platform** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `analytics-platform/agents/privacy-analytics-agent.md`
- **Role:** Privacy Analytics Agent specialist for Stream Heaven's analytics platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `analytics-platform/agents/privacy-analytics-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Privacy Analytics deliverables in analytics-platform domain for Stream Heaven Phase 19. (Privacy Analytics scope)
...
- Basic: `.cursor/skills/stream-heaven/analytics-platform/privacy-analytics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/analytics-platform/privacy-analytics-agent/advanced/SKILL.md`
