---
name: stream-heaven-analytics-platform-event-tracking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Event Tracking (phase 19).
...
- User invokes **Event Tracking** or work in **analytics-platform** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `analytics-platform/agents/event-tracking-agent.md`
- **Role:** Event Tracking Agent specialist for Stream Heaven's analytics platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `analytics-platform/agents/event-tracking-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Event Tracking deliverables in analytics-platform domain for Stream Heaven Phase 19. (Event Tracking scope)
