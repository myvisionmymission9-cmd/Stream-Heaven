---
name: stream-heaven-analytics-platform-data-warehouse-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Data Warehouse (phase 19).
...
- User invokes **Data Warehouse** or work in **analytics-platform** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `analytics-platform/agents/data-warehouse-agent.md`
- **Role:** Data Warehouse Agent specialist for Stream Heaven's analytics platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `analytics-platform/agents/data-warehouse-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Data Warehouse deliverables in analytics-platform domain for Stream Heaven Phase 19. (Data Warehouse scope)
