---
name: stream-heaven-analytics-platform-realtime-metrics-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Realtime Metrics (phase 19).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Realtime Metrics — Advanced
...
Architect:
- Design and implement analytics platform capabilities for Stream Heaven. (Realtime Metrics scope)
