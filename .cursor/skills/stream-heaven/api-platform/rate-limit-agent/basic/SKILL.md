---
name: stream-heaven-api-platform-rate-limit-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Rate Limit (phase 19).
...
- User invokes **Rate Limit** or work in **api-platform** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `api-platform/agents/rate-limit-agent.md`
- **Role:** Rate Limit Agent specialist for Stream Heaven's api platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `api-platform/agents/rate-limit-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Rate Limit deliverables in api-platform domain for Stream Heaven Phase 19. (Rate Limit scope)
...
- Basic: `.cursor/skills/stream-heaven/api-platform/rate-limit-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/api-platform/rate-limit-agent/advanced/SKILL.md`
