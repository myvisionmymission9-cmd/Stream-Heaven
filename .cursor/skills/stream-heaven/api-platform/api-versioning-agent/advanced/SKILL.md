---
name: stream-heaven-api-platform-api-versioning-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Api Versioning (phase 19).
...
Architect:
- Design and implement api platform capabilities for Stream Heaven. (Api Versioning scope)
