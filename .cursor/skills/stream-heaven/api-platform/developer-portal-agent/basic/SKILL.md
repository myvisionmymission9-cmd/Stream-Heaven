---
name: stream-heaven-api-platform-developer-portal-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Developer Portal (phase 19).
...
- User invokes **Developer Portal** or work in **api-platform** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `api-platform/agents/developer-portal-agent.md`
- **Role:** Developer Portal Agent specialist for Stream Heaven's api platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `api-platform/agents/developer-portal-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Developer Portal deliverables in api-platform domain for Stream Heaven Phase 19. (Developer Portal scope)
...
- Basic: `.cursor/skills/stream-heaven/api-platform/developer-portal-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/api-platform/developer-portal-agent/advanced/SKILL.md`
