---
name: stream-heaven-api-platform-webhook-manager-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Webhook Manager (phase 19).
  Single-agent execution with governance prefix and structural validation.
---

# Webhook Manager — Basic

## When to use

- User invokes **Webhook Manager** or work in **api-platform** (phase 19)
- Focused task within this agent's scope

## Agent

- **Path:** `api-platform/agents/webhook-manager-agent.md`
- **Role:** Webhook Manager Agent specialist for Stream Heaven's api platform domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `api-platform/agents/webhook-manager-agent.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Own Webhook deliverables in api-platform domain for Stream Heaven Phase 19. (Webhook Manager scope)
...
- Basic: `.cursor/skills/stream-heaven/api-platform/webhook-manager-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/api-platform/webhook-manager-agent/advanced/SKILL.md`
