---
name: stream-heaven-api-platform-webhook-manager-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Webhook Manager (phase 19).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Webhook Manager — Advanced
