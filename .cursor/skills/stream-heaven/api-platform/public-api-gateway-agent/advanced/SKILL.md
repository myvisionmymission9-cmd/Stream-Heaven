---
name: stream-heaven-api-platform-public-api-gateway-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Public Api Gateway (phase 19).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Public Api Gateway — Advanced
