---
name: stream-heaven-notifications-notification-dispatch-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Notification Dispatch (Phase 18).
  Cross-agent orchestration, ADRs, production validation.
---

# Notification Dispatch — Advanced
