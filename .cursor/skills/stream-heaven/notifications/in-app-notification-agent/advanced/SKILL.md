---
name: stream-heaven-notifications-in-app-notification-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven In-App Notification (Phase 18).
  Cross-agent orchestration, ADRs, production validation.
---

# In-App Notification — Advanced
