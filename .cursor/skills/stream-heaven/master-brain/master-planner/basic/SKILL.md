---
name: stream-heaven-master-brain-master-planner-basic
description: >-
  Basic Cursor skill for Stream Heaven Master Planner (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Master Planner — Basic

## When to use

- User invokes **Master Planner** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/master-planner.md`
- **Role:** Master Planner specialist for Stream Heaven's master brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/master-planner.md` and copy its `## Prompt Template` block
...
Route:
- Synthesize cross-domain context for Master from AGENT-REGISTRY.md, governance, and active roadmaps. (Master Planner scope)
...
- Basic: `.cursor/skills/stream-heaven/master-brain/master-planner/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/master-brain/master-planner/advanced/SKILL.md`
