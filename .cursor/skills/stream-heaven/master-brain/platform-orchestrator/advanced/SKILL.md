---
name: stream-heaven-master-brain-platform-orchestrator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Platform Orchestrator (phase 3).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Platform Orchestrator — Advanced
