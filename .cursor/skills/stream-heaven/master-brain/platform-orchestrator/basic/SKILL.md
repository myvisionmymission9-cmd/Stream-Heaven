---
name: stream-heaven-master-brain-platform-orchestrator-basic
description: >-
  Basic Cursor skill for Stream Heaven Platform Orchestrator (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Platform Orchestrator — Basic

## When to use

- User invokes **Platform Orchestrator** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/platform-orchestrator.md`
- **Role:** Platform Orchestrator specialist for Stream Heaven's master brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/platform-orchestrator.md` and copy its `## Prompt Template` block
