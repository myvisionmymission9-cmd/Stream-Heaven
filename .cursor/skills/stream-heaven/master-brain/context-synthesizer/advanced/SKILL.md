---
name: stream-heaven-master-brain-context-synthesizer-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Context Synthesizer (phase 3).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Context Synthesizer — Advanced
