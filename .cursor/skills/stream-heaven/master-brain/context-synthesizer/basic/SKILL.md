---
name: stream-heaven-master-brain-context-synthesizer-basic
description: >-
  Basic Cursor skill for Stream Heaven Context Synthesizer (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Context Synthesizer — Basic

## When to use

- User invokes **Context Synthesizer** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/context-synthesizer.md`
- **Role:** Context Synthesizer specialist for Stream Heaven's master brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/context-synthesizer.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement master brain capabilities for Stream Heaven. (Context Synthesizer scope)
...
- Basic: `.cursor/skills/stream-heaven/master-brain/context-synthesizer/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/master-brain/context-synthesizer/advanced/SKILL.md`
