---
name: stream-heaven-master-brain-cross-domain-coordinator-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cross Domain Coordinator (phase 3).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cross Domain Coordinator — Advanced
