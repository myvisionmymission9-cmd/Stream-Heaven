---
name: stream-heaven-master-brain-cross-domain-coordinator-basic
description: >-
  Basic Cursor skill for Stream Heaven Cross Domain Coordinator (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Cross Domain Coordinator — Basic

## When to use

- User invokes **Cross Domain Coordinator** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/cross-domain-coordinator.md`
- **Role:** Cross Domain Coordinator specialist for Stream Heaven's master brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/cross-domain-coordinator.md` and copy its `## Prompt Template` block
...
Route:
- Synthesize cross-domain context for Cross Domain from AGENT-REGISTRY.md, governance, and active roadmaps. (Cross Domain Coordinator scope)
...
- Basic: `.cursor/skills/stream-heaven/master-brain/cross-domain-coordinator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/master-brain/cross-domain-coordinator/advanced/SKILL.md`
