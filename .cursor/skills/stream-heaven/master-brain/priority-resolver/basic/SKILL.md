---
name: stream-heaven-master-brain-priority-resolver-basic
description: >-
  Basic Cursor skill for Stream Heaven Priority Resolver (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Priority Resolver — Basic
...
- Open agent: `ai-agents/master-brain/priority-resolver.md` and copy its `## Prompt Template` block
