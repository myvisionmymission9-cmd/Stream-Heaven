---
name: stream-heaven-master-brain-system-priority-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven System Priority (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# System Priority — Basic

## When to use

- User invokes **System Priority** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/system-priority-agent.md`
- **Role:** System Priority Agent specialist for Stream Heaven's master-brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/system-priority-agent.md` and copy its `## Prompt Template` block
...
Route:
- Synthesize cross-domain context for System Priority from AGENT-REGISTRY.md, governance, and active roadmaps. (System Priority scope)
...
- Basic: `.cursor/skills/stream-heaven/master-brain/system-priority-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/master-brain/system-priority-agent/advanced/SKILL.md`
