---
name: stream-heaven-master-brain-global-decision-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Global Decision (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Global Decision — Basic

## When to use

- User invokes **Global Decision** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/global-decision-agent.md`
- **Role:** Global Decision Agent specialist for Stream Heaven's master-brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/global-decision-agent.md` and copy its `## Prompt Template` block
...
Route:
- Synthesize cross-domain context for Global Decision from AGENT-REGISTRY.md, governance, and active roadmaps. (Global Decision scope)
