---
name: stream-heaven-master-brain-ecosystem-memory-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ecosystem Memory (phase 3).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Ecosystem Memory — Advanced
