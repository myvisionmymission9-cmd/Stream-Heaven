---
name: stream-heaven-master-brain-platform-coordination-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Platform Coordination (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Platform Coordination — Basic

## When to use

- User invokes **Platform Coordination** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/platform-coordination-agent.md`
- **Role:** Platform Coordination Agent specialist for Stream Heaven's master-brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/platform-coordination-agent.md` and copy its `## Prompt Template` block
...
Route:
- Synthesize cross-domain context for Platform Coordination from AGENT-REGISTRY.md, governance, and active roadmaps. (Platform Coordination scope)
...
- Basic: `.cursor/skills/stream-heaven/master-brain/platform-coordination-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/master-brain/platform-coordination-agent/advanced/SKILL.md`
