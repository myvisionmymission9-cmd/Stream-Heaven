---
name: stream-heaven-master-brain-platform-coordination-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Platform Coordination (phase 3).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Platform Coordination — Advanced
