---
name: stream-heaven-master-brain-global-orchestration-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Global Orchestration (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Global Orchestration — Basic

## When to use

- User invokes **Global Orchestration** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/global-orchestration-agent.md`
- **Role:** Global Orchestration Agent specialist for Stream Heaven's master-brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/global-orchestration-agent.md` and copy its `## Prompt Template` block
...
Route:
- Orchestrate Global Orchestration workflows across ai-agents/ with explicit task ownership and phase gates. (Global Orchestration scope)
...
- Basic: `.cursor/skills/stream-heaven/master-brain/global-orchestration-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/master-brain/global-orchestration-agent/advanced/SKILL.md`
