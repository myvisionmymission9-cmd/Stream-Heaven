---
name: stream-heaven-master-brain-global-orchestration-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Global Orchestration (phase 3).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Global Orchestration — Advanced
