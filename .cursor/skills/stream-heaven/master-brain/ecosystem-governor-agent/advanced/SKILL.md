---
name: stream-heaven-master-brain-ecosystem-governor-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ecosystem Governor (phase 3).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Ecosystem Governor — Advanced
