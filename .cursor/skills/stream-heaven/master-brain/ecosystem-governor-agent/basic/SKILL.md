---
name: stream-heaven-master-brain-ecosystem-governor-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ecosystem Governor (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Ecosystem Governor — Basic

## When to use

- User invokes **Ecosystem Governor** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/ecosystem-governor-agent.md`
- **Role:** Ecosystem Governor Agent specialist for Stream Heaven's master-brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/ecosystem-governor-agent.md` and copy its `## Prompt Template` block
...
Route:
- Synthesize cross-domain context for Ecosystem Governor from AGENT-REGISTRY.md, governance, and active roadmaps. (Ecosystem Governor scope)
...
- Basic: `.cursor/skills/stream-heaven/master-brain/ecosystem-governor-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/master-brain/ecosystem-governor-agent/advanced/SKILL.md`
