---
name: stream-heaven-master-brain-knowledge-router-basic
description: >-
  Basic Cursor skill for Stream Heaven Knowledge Router (phase 3).
  Single-agent execution with governance prefix and structural validation.
---

# Knowledge Router — Basic

## When to use

- User invokes **Knowledge Router** or work in **master-brain** (phase 3)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/master-brain/knowledge-router.md`
- **Role:** Knowledge Router specialist for Stream Heaven's master brain domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/master-brain/knowledge-router.md` and copy its `## Prompt Template` block
...
Route:
- Bootstrap NestJS api-gateway (port 3000) routing for Knowledge and Phase 1 service prefixes. (Knowledge Router scope)
