---
name: stream-heaven-platform-finance-invoice-generator-basic
description: >-
  Basic Cursor skill for Stream Heaven Invoice Generator (phase 20).
...
- User invokes **Invoice Generator** or work in **platform-finance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-finance/invoice-generator.md`
- **Role:** Invoice Generator specialist for Stream Heaven's platform finance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-finance/invoice-generator.md` and copy its `## Prompt Template` block
...
### Domain Expertise
Apply:
- Design and implement platform finance capabilities for Stream Heaven. (Invoice Generator scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-finance/invoice-generator/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-finance/invoice-generator/advanced/SKILL.md`
