---
name: stream-heaven-platform-finance-revenue-reconciliation-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Revenue Reconciliation (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Revenue Reconciliation — Advanced
