---
name: stream-heaven-platform-finance-revenue-reconciliation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Revenue Reconciliation (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Revenue Reconciliation — Basic

## When to use

- User invokes **Revenue Reconciliation** or work in **platform-finance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-finance/revenue-reconciliation-agent.md`
- **Role:** Revenue Reconciliation Agent specialist for Stream Heaven's platform-finance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-finance/revenue-reconciliation-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Revenue Reconciliation deliverables in platform-finance domain for Stream Heaven Phase 20. (Revenue Reconciliation scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-finance/revenue-reconciliation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-finance/revenue-reconciliation-agent/advanced/SKILL.md`
