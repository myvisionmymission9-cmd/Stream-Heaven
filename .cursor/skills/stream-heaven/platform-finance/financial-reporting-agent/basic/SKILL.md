---
name: stream-heaven-platform-finance-financial-reporting-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Financial Reporting (phase 20).
...
- User invokes **Financial Reporting** or work in **platform-finance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-finance/financial-reporting-agent.md`
- **Role:** Financial Reporting Agent specialist for Stream Heaven's platform-finance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-finance/financial-reporting-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Financial Reporting deliverables in platform-finance domain for Stream Heaven Phase 20. (Financial Reporting scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-finance/financial-reporting-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-finance/financial-reporting-agent/advanced/SKILL.md`
