---
name: stream-heaven-platform-finance-treasury-reporting-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Treasury Reporting (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Treasury Reporting — Advanced
