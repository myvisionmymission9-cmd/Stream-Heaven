---
name: stream-heaven-platform-finance-treasury-reporting-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Treasury Reporting (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Treasury Reporting — Basic

## When to use

- User invokes **Treasury Reporting** or work in **platform-finance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-finance/treasury-reporting-agent.md`
- **Role:** Treasury Reporting Agent specialist for Stream Heaven's platform-finance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-finance/treasury-reporting-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Treasury Reporting deliverables in platform-finance domain for Stream Heaven Phase 20. (Treasury Reporting scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-finance/treasury-reporting-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-finance/treasury-reporting-agent/advanced/SKILL.md`
