---
name: stream-heaven-platform-finance-vendor-invoice-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Vendor Invoice (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Vendor Invoice — Advanced
...
Scale:
- Design and implement platform finance capabilities for Stream Heaven. (Vendor Invoice scope)
