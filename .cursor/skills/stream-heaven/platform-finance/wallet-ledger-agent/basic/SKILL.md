---
name: stream-heaven-platform-finance-wallet-ledger-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Wallet Ledger (phase 20).
...
- User invokes **Wallet Ledger** or work in **platform-finance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-finance/wallet-ledger-agent.md`
- **Role:** Wallet Ledger Agent specialist for Stream Heaven's platform-finance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-finance/wallet-ledger-agent.md` and copy its `## Prompt Template` block
...
Design:
- Bootstrap NestJS api-gateway (port 3000) routing for Wallet Ledger and Phase 1 service prefixes. (Wallet Ledger scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-finance/wallet-ledger-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-finance/wallet-ledger-agent/advanced/SKILL.md`
