---
name: stream-heaven-platform-finance-billing-reconciliation-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Billing Reconciliation (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Billing Reconciliation — Basic

## When to use

- User invokes **Billing Reconciliation** or work in **platform-finance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-finance/billing-reconciliation-agent.md`
- **Role:** Billing Reconciliation Agent specialist for Stream Heaven's platform finance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-finance/billing-reconciliation-agent.md` and copy its `## Prompt Template` block
...
Design:
- Design Billing Reconciliation flows with idempotent ledger entries and PostgreSQL transactional integrity. (Billing Reconciliation scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-finance/billing-reconciliation-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-finance/billing-reconciliation-agent/advanced/SKILL.md`
