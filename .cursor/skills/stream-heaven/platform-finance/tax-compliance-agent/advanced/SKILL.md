---
name: stream-heaven-platform-finance-tax-compliance-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Tax Compliance (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Tax Compliance — Advanced
