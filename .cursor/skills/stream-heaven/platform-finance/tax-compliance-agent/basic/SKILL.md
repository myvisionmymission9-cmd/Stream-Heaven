---
name: stream-heaven-platform-finance-tax-compliance-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Tax Compliance (phase 20).
...
- User invokes **Tax Compliance** or work in **platform-finance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-finance/tax-compliance-agent.md`
- **Role:** Tax Compliance Agent specialist for Stream Heaven's platform-finance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-finance/tax-compliance-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/platform-finance/tax-compliance-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-finance/tax-compliance-agent/advanced/SKILL.md`
