---
name: stream-heaven-platform-finance-cost-attribution-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Cost Attribution (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Cost Attribution — Basic

## When to use

- User invokes **Cost Attribution** or work in **platform-finance** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/platform-finance/cost-attribution-agent.md`
- **Role:** Cost Attribution Agent specialist for Stream Heaven's platform finance domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/platform-finance/cost-attribution-agent.md` and copy its `## Prompt Template` block
...
Design:
- Own Cost Attribution deliverables in platform-finance domain for Stream Heaven Phase 20. (Cost Attribution scope)
...
- Basic: `.cursor/skills/stream-heaven/platform-finance/cost-attribution-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/platform-finance/cost-attribution-agent/advanced/SKILL.md`
