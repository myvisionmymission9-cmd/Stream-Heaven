---
name: stream-heaven-platform-finance-cost-attribution-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Cost Attribution (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Cost Attribution — Advanced
