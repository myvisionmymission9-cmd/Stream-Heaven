---
name: stream-heaven-ad-network-ad-ranking-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ad Ranking (phase 20).
...
- Open agent: `ai-agents/ad-network/ad-ranking-agent.md` and copy its `## Prompt Template` block
