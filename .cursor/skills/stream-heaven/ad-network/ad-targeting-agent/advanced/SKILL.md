---
name: stream-heaven-ad-network-ad-targeting-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ad Targeting (phase 20).
...
### Programmatic Scale
Scale:
- Implement Ad Targeting ad insertion, targeting, and measurement with NestJS ad-network services. (Ad Targeting scope)
