---
name: stream-heaven-ad-network-ad-fraud-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Ad Fraud (phase 20).
...
Scale:
- Design and implement ad network capabilities for Stream Heaven. (Ad Fraud scope)
