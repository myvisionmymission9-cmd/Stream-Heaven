---
name: stream-heaven-ad-network-ad-analytics-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Ad Analytics (phase 20).
...
- User invokes **Ad Analytics** or work in **ad-network** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ad-network/ad-analytics-agent.md`
- **Role:** Ad Analytics Agent specialist for Stream Heaven's ad-network domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ad-network/ad-analytics-agent.md` and copy its `## Prompt Template` block
...
Design:
- Implement Ad Analytics ad insertion, targeting, and measurement with NestJS ad-network services. (Ad Analytics scope)
...
- Basic: `.cursor/skills/stream-heaven/ad-network/ad-analytics-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ad-network/ad-analytics-agent/advanced/SKILL.md`
