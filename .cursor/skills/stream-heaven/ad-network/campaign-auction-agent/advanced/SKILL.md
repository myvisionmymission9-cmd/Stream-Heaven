---
name: stream-heaven-ad-network-campaign-auction-agent-advanced
description: >-
  Advanced Cursor skill for Stream Heaven Campaign Auction (phase 20).
  Multi-agent orchestration, ADRs, and production-grade validation.
---

# Campaign Auction — Advanced
