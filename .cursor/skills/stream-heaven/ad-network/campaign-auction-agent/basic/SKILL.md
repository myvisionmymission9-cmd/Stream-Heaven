---
name: stream-heaven-ad-network-campaign-auction-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Campaign Auction (phase 20).
  Single-agent execution with governance prefix and structural validation.
---

# Campaign Auction — Basic

## When to use

- User invokes **Campaign Auction** or work in **ad-network** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ad-network/campaign-auction-agent.md`
- **Role:** Campaign Auction Agent specialist for Stream Heaven's ad-network domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ad-network/campaign-auction-agent.md` and copy its `## Prompt Template` block
...
- Basic: `.cursor/skills/stream-heaven/ad-network/campaign-auction-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ad-network/campaign-auction-agent/advanced/SKILL.md`
