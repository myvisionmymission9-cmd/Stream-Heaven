---
name: stream-heaven-ad-network-brand-safety-agent-basic
description: >-
  Basic Cursor skill for Stream Heaven Brand Safety (phase 20).
...
- User invokes **Brand Safety** or work in **ad-network** (phase 20)
- Focused task within this agent's scope

## Agent

- **Path:** `ai-agents/ad-network/brand-safety-agent.md`
- **Role:** Brand Safety Agent specialist for Stream Heaven's ad-network domain, ensuring alignment with platform governance and the four-app ecosystem.

## Scope (basic)

- Load `platform-governance/MASTER-AI-OPERATING-SYSTEM.md` (or `MASTER-GOVERNANCE-PROMPT.md` for lighter sessions)
- Open agent: `ai-agents/ad-network/brand-safety-agent.md` and copy its `## Prompt Template` block
...
Build:
- Define moderation policies and enforcement hooks for Brand Safety across social and livestream surfaces. (Brand Safety scope)
...
- Basic: `.cursor/skills/stream-heaven/ad-network/brand-safety-agent/basic/SKILL.md`
- Advanced: `.cursor/skills/stream-heaven/ad-network/brand-safety-agent/advanced/SKILL.md`
